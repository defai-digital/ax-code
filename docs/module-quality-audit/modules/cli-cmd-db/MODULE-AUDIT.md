...
| Resolved root | `packages/ax-code/src/cli/cmd/db.ts` |
| XL filter | no |
...
| Analysis fingerprint | `c766073d2077a500` |
...
Step 5: Design: ownership vs ARCHITECTURE/PROJECT_BOUNDARIES for packages/ax-code/src/cli/cmd/db
...
| Item | Result |
|------|--------|
| Static extract | ok fp `c766073d2077a500` |
