...
| Resolved root | `packages/ax-code/src/cli/cmd/models.ts` |
| XL filter | no |
...
| Analysis fingerprint | `3557a9e15d25c5bf` |
...
### Exports (sample)
- `ModelsCommand@packages/ax-code/src/cli/cmd/models.ts:11`
...
Step 5: Design: ownership vs ARCHITECTURE/PROJECT_BOUNDARIES for packages/ax-code/src/cli/cmd/models
...
| Item | Result |
|------|--------|
| Static extract | ok fp `3557a9e15d25c5bf` |
