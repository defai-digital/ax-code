...
| Resolved root | `packages/ax-code/src/cli/cmd/design-check.ts` |
| XL filter | no |
...
| Analysis fingerprint | `060eddf5db48285e` |
...
### Exports (sample)
- `DesignCheckCommand@packages/ax-code/src/cli/cmd/design-check.ts:6`
...
Step 5: Design: ownership vs ARCHITECTURE/PROJECT_BOUNDARIES for packages/ax-code/src/cli/cmd/design-check
...
| Item | Result |
|------|--------|
| Static extract | ok fp `060eddf5db48285e` |
