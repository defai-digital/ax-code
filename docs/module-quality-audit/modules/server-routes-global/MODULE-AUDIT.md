...
| Resolved root | `packages/ax-code/src/server/routes/global.ts` |
| XL filter | no |
...
| Analysis fingerprint | `c6d9e45c94c725d8` |
...
### Exports (sample)
- `GlobalRoutes@packages/ax-code/src/server/routes/global.ts:231`
...
Step 5: Design: ownership vs ARCHITECTURE/PROJECT_BOUNDARIES for packages/ax-code/src/server/routes/global.ts
...
| Item | Result |
|------|--------|
| Static extract | ok fp `c6d9e45c94c725d8` |
