...
| Resolved root | `packages/ax-code/src/cli/cmd/init.ts` |
| XL filter | no |
...
| Analysis fingerprint | `01f0a92e4c7bf06f` |
...
### Exports (sample)
- `InitCommand@packages/ax-code/src/cli/cmd/init.ts:8`
...
Step 5: Design: ownership vs ARCHITECTURE/PROJECT_BOUNDARIES for packages/ax-code/src/cli/cmd/init
...
| Item | Result |
|------|--------|
| Static extract | ok fp `01f0a92e4c7bf06f` |
