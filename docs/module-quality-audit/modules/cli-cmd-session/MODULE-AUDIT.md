...
| Resolved root | `packages/ax-code/src/cli/cmd/session.ts` |
| XL filter | no |
...
| Analysis fingerprint | `40ef1791407772b6` |
...
|------|----:|--------:|--------------:|------:|
| `packages/ax-code/src/cli/cmd/session.ts` | 2 | 0 | 0 | 0 |
...
Step 5: Design: ownership vs ARCHITECTURE/PROJECT_BOUNDARIES for packages/ax-code/src/cli/cmd/session
...
| Item | Result |
|------|--------|
| Static extract | ok fp `40ef1791407772b6` |
