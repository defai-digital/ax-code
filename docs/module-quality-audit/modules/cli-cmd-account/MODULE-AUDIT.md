...
| Resolved root | `packages/ax-code/src/cli/cmd/account.ts` |
| XL filter | no |
...
| Analysis fingerprint | `d2cc8e76b46e242a` |
...
### Exports (sample)
- `formatAccountLabel@packages/ax-code/src/cli/cmd/account.ts:20`
- `formatOrgLine@packages/ax-code/src/cli/cmd/account.ts:26`
- `LoginCommand@packages/ax-code/src/cli/cmd/account.ts:185`
- `LogoutCommand@packages/ax-code/src/cli/cmd/account.ts:200`
- `SwitchCommand@packages/ax-code/src/cli/cmd/account.ts:214`
- `OrgsCommand@packages/ax-code/src/cli/cmd/account.ts:223`
- `OpenCommand@packages/ax-code/src/cli/cmd/account.ts:232`
- `ConsoleCommand@packages/ax-code/src/cli/cmd/account.ts:241`
...
Step 5: Design: ownership vs ARCHITECTURE/PROJECT_BOUNDARIES for packages/ax-code/src/cli/cmd/account
...
| Item | Result |
|------|--------|
| Static extract | ok fp `d2cc8e76b46e242a` |
