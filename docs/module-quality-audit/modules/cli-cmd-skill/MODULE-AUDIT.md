...
| Resolved root | `packages/ax-code/src/cli/cmd/skill.ts` |
| XL filter | no |
...
| Analysis fingerprint | `8e366caf1bfb76dd` |
...
### Exports (sample)
- `applySkillValidationExitCode@packages/ax-code/src/cli/cmd/skill.ts:31`
- `formatSkillList@packages/ax-code/src/cli/cmd/skill.ts:38`
- `formatSkillValidationReport@packages/ax-code/src/cli/cmd/skill.ts:50`
- `formatSkillDoctorReport@packages/ax-code/src/cli/cmd/skill.ts:65`
- `formatSkillTriggerReport@packages/ax-code/src/cli/cmd/skill.ts:75`
- `SkillCommand@packages/ax-code/src/cli/cmd/skill.ts:212`
...
Step 5: Design: ownership vs ARCHITECTURE/PROJECT_BOUNDARIES for packages/ax-code/src/cli/cmd/skill
...
| Item | Result |
|------|--------|
| Static extract | ok fp `8e366caf1bfb76dd` |
