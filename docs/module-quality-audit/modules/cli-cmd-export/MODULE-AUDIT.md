...
| Resolved root | `packages/ax-code/src/cli/cmd/export.ts` |
| XL filter | no |
...
| Analysis fingerprint | `4e0a1da617a327ce` |
...
### Exports (sample)
- `ExportCommand@packages/ax-code/src/cli/cmd/export.ts:3`
...
Step 5: Design: ownership vs ARCHITECTURE/PROJECT_BOUNDARIES for packages/ax-code/src/cli/cmd/export
...
| Item | Result |
|------|--------|
| Static extract | ok fp `4e0a1da617a327ce` |
