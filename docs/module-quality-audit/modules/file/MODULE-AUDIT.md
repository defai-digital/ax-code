...
Step 1: Mapped 7 source files; exports≈60
Step 2: Threat: secrets=0 files, processRisk=1 files, emptyCatch=1
Step 3: Correctness: read control flow for public surfaces; findings=AUDIT-file-empty-catch.md
Step 4: Performance: hot-path unit — checked unbounded patterns in read files
Step 5: Design: ownership vs ARCHITECTURE/PROJECT_BOUNDARIES for packages/ax-code/src/file
Step 6: Hygiene: empty=1; notes: packages/ax-code/src/file/ripgrep.ts: 1 empty catch(es) — see empty-catch finding disposition
