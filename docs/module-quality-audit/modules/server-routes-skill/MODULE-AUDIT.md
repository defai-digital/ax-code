...
| Resolved root | `packages/ax-code/src/server/routes/skill.ts` |
| XL filter | no |
...
| Analysis fingerprint | `b714ee2305dbaefe` |
...
### Exports (sample)
- `SkillRoutes@packages/ax-code/src/server/routes/skill.ts:24`
...
Step 5: Design: ownership vs ARCHITECTURE/PROJECT_BOUNDARIES for packages/ax-code/src/server/routes/skill.ts
...
| Item | Result |
|------|--------|
| Static extract | ok fp `b714ee2305dbaefe` |
