# AUDIT-pkg-util-empty-catch

| Field | Value |
|-------|-------|
| Title | Empty catch sites in pkg-util (1 sites) |
...
|------|------|-------------|-----------|
| `packages/util/src/module.ts:8` | `} catch {}` | review-needed | empty catch without local comment |
