...
|---------|----------|----------|--------|--------|
| AUDIT-desktop-electron-ipc-001 | security | Critical | prior/new | verified-fixed |
| AUDIT-desktop-electron-ipc-empty-catch | silent-error | Low | new | deferred |
...
|------|------|------|----------|
| Reviewer | codex-sol | 2026-08-11 | filesRead=35 |
