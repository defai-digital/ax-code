...
| Resolved root | `packages/ax-code/src/cli/cmd/risk.ts` |
| XL filter | no |
...
| Analysis fingerprint | `46280454e7d2c14f` |
...
### Exports (sample)
- `RiskView@packages/ax-code/src/cli/cmd/risk.ts:7`
- `lines@packages/ax-code/src/cli/cmd/risk.ts:76`
- `RiskCommand@packages/ax-code/src/cli/cmd/risk.ts:194`
...
Step 5: Design: ownership vs ARCHITECTURE/PROJECT_BOUNDARIES for packages/ax-code/src/cli/cmd/risk
...
| Item | Result |
|------|--------|
| Static extract | ok fp `46280454e7d2c14f` |
