...
| Resolved root | `packages/ax-code/src/server/routes/smart-llm.ts` |
| XL filter | no |
...
| Analysis fingerprint | `d58fdaa030305c0c` |
...
### Exports (sample)
- `SmartLlmRoutes@packages/ax-code/src/server/routes/smart-llm.ts:16`
...
Step 5: Design: ownership vs ARCHITECTURE/PROJECT_BOUNDARIES for packages/ax-code/src/server/routes/smart-llm.ts
...
| Item | Result |
|------|--------|
| Static extract | ok fp `d58fdaa030305c0c` |
