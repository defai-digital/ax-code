...
| Resolved root | `packages/ax-code/src/server/routes/audit.ts` |
| XL filter | no |
...
| Analysis fingerprint | `881b692dcbc17edc` |
...
### Exports (sample)
- `parseAuditJsonLine@packages/ax-code/src/server/routes/audit.ts:44`
- `collectAuditExportRecords@packages/ax-code/src/server/routes/audit.ts:53`
- `AuditRoutes@packages/ax-code/src/server/routes/audit.ts:89`
...
Step 5: Design: ownership vs ARCHITECTURE/PROJECT_BOUNDARIES for packages/ax-code/src/server/routes/audit.ts
...
| Item | Result |
|------|--------|
| Static extract | ok fp `881b692dcbc17edc` |
