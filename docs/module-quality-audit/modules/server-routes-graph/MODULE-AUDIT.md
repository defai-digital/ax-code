...
| Resolved root | `packages/ax-code/src/server/routes/graph.ts` |
| XL filter | no |
...
| Analysis fingerprint | `5563cae27c3dd158` |
...
### Exports (sample)
- `GraphRoutes@packages/ax-code/src/server/routes/graph.ts:12`
...
Step 5: Design: ownership vs ARCHITECTURE/PROJECT_BOUNDARIES for packages/ax-code/src/server/routes/graph.ts
...
| Item | Result |
|------|--------|
| Static extract | ok fp `5563cae27c3dd158` |
