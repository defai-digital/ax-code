...
| Resolved root | `packages/ax-code/src/cli/cmd/run.ts` |
| XL filter | no |
...
| Analysis fingerprint | `78e9c904d69ab729` |
...
### Exports (sample)
- `formatRunToolFallbackInput@packages/ax-code/src/cli/cmd/run.ts:95`
- `RunCommand@packages/ax-code/src/cli/cmd/run.ts:265`
...
Step 2: Threat: secrets=1 files, processRisk=0 files, emptyCatch=1
Step 3: Correctness: read control flow for public surfaces; findings=AUDIT-cli-cmd-run-empty-catch.md
Step 4: Performance: not hot-path; spot-checked
Step 5: Design: ownership vs ARCHITECTURE/PROJECT_BOUNDARIES for packages/ax-code/src/cli/cmd/run
Step 6: Hygiene: empty=1; notes: packages/ax-code/src/cli/cmd/run.ts: 1 empty catch(es) — see empty-catch finding disposition
...
| Item | Result |
|------|--------|
| Static extract | ok fp `78e9c904d69ab729` |
