...
| Resolved root | `packages/ax-code/src/cli/cmd/dre-graph.ts` |
| XL filter | no |
...
| Analysis fingerprint | `5114b68268285a52` |
...
### Exports (sample)
- `DreGraphCommand@packages/ax-code/src/cli/cmd/dre-graph.ts:19`
...
Step 5: Design: ownership vs ARCHITECTURE/PROJECT_BOUNDARIES for packages/ax-code/src/cli/cmd/dre-graph
...
| Item | Result |
|------|--------|
| Static extract | ok fp `5114b68268285a52` |
