...
| Resolved root | `packages/ax-code/src/cli/cmd/webui.ts` |
| XL filter | no |
...
| Analysis fingerprint | `2d816e9952e292c4` |
...
### Exports (sample)
- `WebUiCommand@packages/ax-code/src/cli/cmd/webui.ts:7`
...
Step 5: Design: ownership vs ARCHITECTURE/PROJECT_BOUNDARIES for packages/ax-code/src/cli/cmd/webui
...
| Item | Result |
|------|--------|
| Static extract | ok fp `2d816e9952e292c4` |
