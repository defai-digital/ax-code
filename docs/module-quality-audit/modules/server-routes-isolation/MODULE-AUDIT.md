...
| Resolved root | `packages/ax-code/src/server/routes/isolation.ts` |
| XL filter | no |
...
| Analysis fingerprint | `375a333776e36a0e` |
...
### Exports (sample)
- `IsolationRoutes@packages/ax-code/src/server/routes/isolation.ts:33`
...
Step 5: Design: ownership vs ARCHITECTURE/PROJECT_BOUNDARIES for packages/ax-code/src/server/routes/isolation.ts
...
| Item | Result |
|------|--------|
| Static extract | ok fp `375a333776e36a0e` |
