...
| Resolved root | `packages/ax-code/src/cli/cmd/workflow.ts` |
| XL filter | no |
...
| Analysis fingerprint | `102021e2feb9b1cd` |
...
Step 5: Design: ownership vs ARCHITECTURE/PROJECT_BOUNDARIES for packages/ax-code/src/cli/cmd/workflow
...
| Item | Result |
|------|--------|
| Static extract | ok fp `102021e2feb9b1cd` |
