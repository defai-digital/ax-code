...
| Resolved root | `packages/ax-code/src/server/routes/autonomous.ts` |
| XL filter | no |
...
| Analysis fingerprint | `85468db909ea225a` |
...
### Exports (sample)
- `AutonomousRoutes@packages/ax-code/src/server/routes/autonomous.ts:20`
...
Step 5: Design: ownership vs ARCHITECTURE/PROJECT_BOUNDARIES for packages/ax-code/src/server/routes/autonomous.ts
...
| Item | Result |
|------|--------|
| Static extract | ok fp `85468db909ea225a` |
