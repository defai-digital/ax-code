...
| Resolved root | `packages/ax-code/src/cli/cmd/github.ts` |
| XL filter | no |
...
| Analysis fingerprint | `a084de0bbff64a74` |
...
|------|----:|--------:|--------------:|------:|
| `packages/ax-code/src/cli/cmd/github.ts` | 2 | 0 | 0 | 0 |
...
Step 5: Design: ownership vs ARCHITECTURE/PROJECT_BOUNDARIES for packages/ax-code/src/cli/cmd/github
...
| Item | Result |
|------|--------|
| Static extract | ok fp `a084de0bbff64a74` |
