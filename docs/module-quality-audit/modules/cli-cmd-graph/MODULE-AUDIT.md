...
| Resolved root | `packages/ax-code/src/cli/cmd/graph.ts` |
| XL filter | no |
...
| Analysis fingerprint | `42748c3a573e925c` |
...
### Exports (sample)
- `GraphCommand@packages/ax-code/src/cli/cmd/graph.ts:9`
...
Step 5: Design: ownership vs ARCHITECTURE/PROJECT_BOUNDARIES for packages/ax-code/src/cli/cmd/graph
...
| Item | Result |
|------|--------|
| Static extract | ok fp `42748c3a573e925c` |
