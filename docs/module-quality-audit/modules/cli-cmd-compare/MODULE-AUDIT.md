...
| Resolved root | `packages/ax-code/src/cli/cmd/compare.ts` |
| XL filter | no |
...
| Analysis fingerprint | `0ee3fa8862b5afa0` |
...
### Exports (sample)
- `CompareCommand@packages/ax-code/src/cli/cmd/compare.ts:11`
- `compareEventTypes@packages/ax-code/src/cli/cmd/compare.ts:169`
...
Step 5: Design: ownership vs ARCHITECTURE/PROJECT_BOUNDARIES for packages/ax-code/src/cli/cmd/compare
...
| Item | Result |
|------|--------|
| Static extract | ok fp `0ee3fa8862b5afa0` |
