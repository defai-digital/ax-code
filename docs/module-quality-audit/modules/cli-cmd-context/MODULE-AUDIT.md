...
| Resolved root | `packages/ax-code/src/cli/cmd/context.ts` |
| XL filter | no |
...
| Analysis fingerprint | `733a2eba215dd61c` |
...
### Exports (sample)
- `ContextCommand@packages/ax-code/src/cli/cmd/context.ts:11`
...
Step 5: Design: ownership vs ARCHITECTURE/PROJECT_BOUNDARIES for packages/ax-code/src/cli/cmd/context
...
| Item | Result |
|------|--------|
| Static extract | ok fp `733a2eba215dd61c` |
