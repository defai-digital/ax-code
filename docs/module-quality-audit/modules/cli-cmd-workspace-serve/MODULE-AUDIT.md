...
| Resolved root | `packages/ax-code/src/cli/cmd/workspace-serve.ts` |
| XL filter | no |
...
| Analysis fingerprint | `a889f6888a2b5d6b` |
...
|------|----:|--------:|--------------:|------:|
| `packages/ax-code/src/cli/cmd/workspace-serve.ts` | 2 | 0 | 0 | 0 |
...
Step 5: Design: ownership vs ARCHITECTURE/PROJECT_BOUNDARIES for packages/ax-code/src/cli/cmd/workspace-serve
...
| Item | Result |
|------|--------|
| Static extract | ok fp `a889f6888a2b5d6b` |
