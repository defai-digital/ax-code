...
| Resolved root | `packages/ax-code/src/cli/cmd/serve.ts` |
| XL filter | no |
...
| Analysis fingerprint | `a2f107e1d762f62a` |
...
### Exports (sample)
- `ServeCommand@packages/ax-code/src/cli/cmd/serve.ts:4`
...
Step 5: Design: ownership vs ARCHITECTURE/PROJECT_BOUNDARIES for packages/ax-code/src/cli/cmd/serve
...
| Item | Result |
|------|--------|
| Static extract | ok fp `a2f107e1d762f62a` |
