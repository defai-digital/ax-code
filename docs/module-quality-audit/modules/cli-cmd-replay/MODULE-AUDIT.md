...
| Resolved root | `packages/ax-code/src/cli/cmd/replay.ts` |
| XL filter | no |
...
| Analysis fingerprint | `611cf8fba2e64130` |
...
### Exports (sample)
- `ReplayCommand@packages/ax-code/src/cli/cmd/replay.ts:10`
...
Step 5: Design: ownership vs ARCHITECTURE/PROJECT_BOUNDARIES for packages/ax-code/src/cli/cmd/replay
...
| Item | Result |
|------|--------|
| Static extract | ok fp `611cf8fba2e64130` |
