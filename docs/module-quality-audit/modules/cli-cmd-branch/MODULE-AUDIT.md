...
| Resolved root | `packages/ax-code/src/cli/cmd/branch.ts` |
| XL filter | no |
...
| Analysis fingerprint | `26519d7fef7dfa0b` |
...
### Exports (sample)
- `BranchCommand@packages/ax-code/src/cli/cmd/branch.ts:9`
...
Step 5: Design: ownership vs ARCHITECTURE/PROJECT_BOUNDARIES for packages/ax-code/src/cli/cmd/branch
...
| Item | Result |
|------|--------|
| Static extract | ok fp `26519d7fef7dfa0b` |
