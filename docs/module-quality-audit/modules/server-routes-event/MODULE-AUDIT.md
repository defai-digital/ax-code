...
| Resolved root | `packages/ax-code/src/server/routes/event.ts` |
| XL filter | no |
...
| Analysis fingerprint | `a807f8508430686a` |
...
### Exports (sample)
- `EventRoutes@packages/ax-code/src/server/routes/event.ts:17`
...
Step 5: Design: ownership vs ARCHITECTURE/PROJECT_BOUNDARIES for packages/ax-code/src/server/routes/event.ts
...
| Item | Result |
|------|--------|
| Static extract | ok fp `a807f8508430686a` |
