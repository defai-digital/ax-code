...
| Resolved root | `packages/ax-code/src/cli/cmd/acp.ts` |
| XL filter | no |
...
| Analysis fingerprint | `90669663c2f6e0b4` |
...
### Exports (sample)
- `AcpCommand@packages/ax-code/src/cli/cmd/acp.ts:9`
...
Step 5: Design: ownership vs ARCHITECTURE/PROJECT_BOUNDARIES for packages/ax-code/src/cli/cmd/acp
...
| Item | Result |
|------|--------|
| Static extract | ok fp `90669663c2f6e0b4` |
