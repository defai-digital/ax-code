...
| Resolved root | `packages/ax-code/src/cli/cmd/pr.ts` |
| XL filter | no |
...
| Analysis fingerprint | `533414ec0535d217` |
...
### Exports (sample)
- `PrCommand@packages/ax-code/src/cli/cmd/pr.ts:3`
...
Step 5: Design: ownership vs ARCHITECTURE/PROJECT_BOUNDARIES for packages/ax-code/src/cli/cmd/pr
...
| Item | Result |
|------|--------|
| Static extract | ok fp `533414ec0535d217` |
