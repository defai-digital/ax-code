# MODULE-AUDIT: cli-cmd-rollback

| Field | Value |
|-------|-------|
| Unit slug | `cli-cmd-rollback` |
| Scope | `packages/ax-code/src/cli/cmd/rollback` |
| Resolved root | `packages/ax-code/src/cli/cmd/rollback.ts` |
| XL filter | no |
...
| Analysis fingerprint | `acfe3d6bb5e68cf4` |
| Protocol marker | agent-protocol.json complete |
| Source files / LOC | 1 / 170 |
| Inventory ID | W6-45 |
...
|------|----:|--------:|--------------:|------:|
| `packages/ax-code/src/cli/cmd/rollback.ts` | 170 | 1 | 0 | 0 |

### Exports (sample)
- `RollbackCommand@packages/ax-code/src/cli/cmd/rollback.ts:10`
...
Step 5: Design: ownership vs ARCHITECTURE/PROJECT_BOUNDARIES for packages/ax-code/src/cli/cmd/rollback
...
| Item | Result |
|------|--------|
| Static extract | ok fp `acfe3d6bb5e68cf4` |
