...
Step 1: Mapped 3 source files; exports≈73
...
Step 5: Design: ownership vs ARCHITECTURE/PROJECT_BOUNDARIES for packages/ax-code/src/session (messages/parts)
Step 6: Hygiene: empty=0; notes: packages/ax-code/src/session/message-v2-impl.ts: contains known defensive pattern
