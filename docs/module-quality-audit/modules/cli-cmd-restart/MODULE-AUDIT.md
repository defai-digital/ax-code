...
| Resolved root | `packages/ax-code/src/cli/cmd/restart.ts` |
| XL filter | no |
...
| Analysis fingerprint | `fb567e70c2a23a02` |
...
|------|----:|--------:|--------------:|------:|
| `packages/ax-code/src/cli/cmd/restart.ts` | 2 | 0 | 0 | 0 |
...
Step 5: Design: ownership vs ARCHITECTURE/PROJECT_BOUNDARIES for packages/ax-code/src/cli/cmd/restart
...
| Item | Result |
|------|--------|
| Static extract | ok fp `fb567e70c2a23a02` |
