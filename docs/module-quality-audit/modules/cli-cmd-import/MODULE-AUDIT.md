...
| Resolved root | `packages/ax-code/src/cli/cmd/import.ts` |
| XL filter | no |
...
| Analysis fingerprint | `b9446f3cf0ed45aa` |
...
### Exports (sample)
- `formatCompatibilityImportReport@packages/ax-code/src/cli/cmd/import.ts:8`
- `ImportCommand@packages/ax-code/src/cli/cmd/import.ts:21`
...
Step 5: Design: ownership vs ARCHITECTURE/PROJECT_BOUNDARIES for packages/ax-code/src/cli/cmd/import
...
| Item | Result |
|------|--------|
| Static extract | ok fp `b9446f3cf0ed45aa` |
