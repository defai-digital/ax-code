...
| Resolved root | `packages/ax-code/src/cli/cmd/mcp.ts` |
| XL filter | no |
...
| Analysis fingerprint | `3fb49ce7ea7ae163` |
...
Step 5: Design: ownership vs ARCHITECTURE/PROJECT_BOUNDARIES for packages/ax-code/src/cli/cmd/mcp
...
| Item | Result |
|------|--------|
| Static extract | ok fp `3fb49ce7ea7ae163` |
