...
| Resolved root | `packages/ax-code/src/cli/cmd/providers.ts` |
| XL filter | no |
...
| Analysis fingerprint | `6fca0f3454528fec` |
...
Step 5: Design: ownership vs ARCHITECTURE/PROJECT_BOUNDARIES for packages/ax-code/src/cli/cmd/providers
...
| Item | Result |
|------|--------|
| Static extract | ok fp `6fca0f3454528fec` |
