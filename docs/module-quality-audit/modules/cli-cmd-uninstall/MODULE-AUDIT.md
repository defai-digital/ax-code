...
| Resolved root | `packages/ax-code/src/cli/cmd/uninstall.ts` |
| XL filter | no |
...
| Analysis fingerprint | `952ee9f9252eaad9` |
...
### Exports (sample)
- `UninstallCommand@packages/ax-code/src/cli/cmd/uninstall.ts:26`
- `formatSize@packages/ax-code/src/cli/cmd/uninstall.ts:325`
...
| Item | Result |
|------|--------|
| Static extract | ok fp `952ee9f9252eaad9` |
