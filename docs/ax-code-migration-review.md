...
*This document is the first deliverable. All classifications are based on actual repo structure, source code, package manifests, and documentation — no features were invented. Ready for team review and Keep/Cut/Later decision finalization.*
