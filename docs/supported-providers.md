...
| `openrouter`             | OpenRouter                  | `OPENROUTER_API_KEY`                                               | `openai/gpt-5.2-codex`, `openai/gpt-5.2`, `anthropic/claude-fable-5`, `anthropic/claude-sonnet-4.6`, `moonshotai/kimi-k2.7-code`, `qwen/qwen3-coder-plus`, `qwen/qwen3-coder-flash`, `google/gemini-3.5-flash`, `qwen/qwen3.7-plus`, `x-ai/grok-build-0.1`, `x-ai/grok-4.5`, `x-ai/grok-4.3`, `z-ai/glm-5.2`                                                                                       |
