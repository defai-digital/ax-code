...
| [MCP Security Layer Hardening](PRD-2026-05-26-mcp-security-layer-hardening.md) | In progress | Phase 1/2 trust-gate slice implemented; route, permission, prompt/resource, metadata, and docs phases pending | 2026-05-26 | MCP trust gate, route hardening, argument-aware permissions, prompt/resource safety, and focused tests shipped |
