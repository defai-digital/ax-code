...
| [Codex-Like AX Code Desktop App](PRD-2026-05-28-codex-like-desktop-app.md) | Draft — implementation underway | Phase 3/4 foundation plus desktop attach/auth preflight/native menu/project picker/backend attach form/network-mode warnings and Phase 5/6 explicit session creation, executable queue, queue reorder/edit/remove, restart recovery, lifecycle/status boundary guards, blocker reactivation, and first-class worktree/agent/model queue columns; Phase 7 approval/question/evidence/rollback/compare/comment actions with policy-bound auto-accept; Phase 8 worktree/isolated-branch/tool panes, terminal association, browser preview tabs, browser verification queue, tool-pane beta policy, path reveal, multi-run grouping/conflict comparison; Phase 10 long-session/accessibility-smoke/keyboard-smoke/performance-smoke/beta-qa-smoke/live-backend-qa/representative-live-qa/beta-readiness/packaged-artifact/mac-bundle/app-diagnostics/version-metadata/capability-profiles/release-diagnostics/update-check/window-recovery/browser-smoke/reconnect-banner/reconnect-retry/mac-release-pipeline/release-workflow/release-evidence-artifact/beta-runbook slices; Phase 11 settings diagnostics; Phase 12 scheduled automation scheduler/notification/shutdown slices; R14 canonical fixture catalog and representative sidecar/attach evidence closeout landed | 2026-05-29 | First-party desktop app beta starts/attaches to local backend, shows command-center UI, supports supervised queue/review workflows |
