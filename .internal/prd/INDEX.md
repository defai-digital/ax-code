...
| [Agent Workflow and Skill Productization](PRD-2026-06-07-agent-workflow-skill-productization.md) | Draft - proposal | PRD, tech spec, ADR, and implementation plan created; implementation not started | 2026-06-07 | AX Code has a unified reusable capability catalog plus file-backed skills/commands/agents/workflow entry points with OpenCode/Claude/Codex-compatible import paths |
...
| [Agent Workflow and Skill Productization Implementation Plan](PLAN-2026-06-07-agent-workflow-skill-productization-implementation.md) | Draft - implementation not started | Phased implementation plan for compatibility discovery, file-backed commands, capability catalog, skill doctor, agent permission output, workflow-backed commands, importers, and eval telemetry |
| [Agent Workflow and Skill Productization Tech Spec](TECH-SPEC-2026-06-07-agent-workflow-skill-productization.md) | Draft - proposal | Technical design for unified capability catalog, file-backed commands, skill diagnostics, agent permission generation, importers, and workflow-backed commands |
