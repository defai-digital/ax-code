...
| [Durable Session Goals](PRD-2026-05-23-durable-session-goals.md) | Phase 0 implemented | Adds persisted `/goal` state, model tools, and bounded goal-aware continuation. |
| [Qwen3.7-Max Agent Optimization](PRD-2026-05-23-qwen37-max-agent-optimization.md) | Implementation in progress; Phase 7 partial | Readiness/profile helpers, Super-Long TUI, Alibaba preserve_thinking, and initial pacing policy exist. Prompt-cache/context/trace/eval helpers still need production wiring before all phases can be closed. |
