...
| [Agent Workflow and Skill Productization](PRD-2026-06-07-agent-workflow-skill-productization.md) | Implemented - initial productization slice | Capability catalog, compatibility discovery/import, file-backed commands, skill authoring/doctor, workflow command bridge, TUI catalog, SDK/server route, and replay telemetry landed | 2026-06-07 | AX Code has a unified reusable capability catalog plus file-backed skills/commands/agents/workflow entry points with OpenCode/Claude/Codex-compatible import paths |
...
| [Agent Workflow and Skill Productization Implementation Plan](PLAN-2026-06-07-agent-workflow-skill-productization-implementation.md) | Implemented - initial productization slice | Phased implementation plan for compatibility discovery, file-backed commands, capability catalog, skill doctor, agent permission output, workflow-backed commands, importers, TUI catalog, and telemetry |
| [Agent Workflow and Skill Productization Tech Spec](TECH-SPEC-2026-06-07-agent-workflow-skill-productization.md) | Implemented - initial productization slice | Technical design for unified capability catalog, file-backed commands, skill diagnostics, agent permission generation, importers, and workflow-backed commands |
