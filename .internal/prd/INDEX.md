...
| [Qwen3.7-Max Agent Optimization](PRD-2026-05-23-qwen37-max-agent-optimization.md) | All phases (0–7) complete in v5.5.0 | All 8 phases shipped: readiness classifier, agent profile, Super-Long TUI, preserve_thinking, prompt-cache policy, context packer, optimization trace, and eval harness. |
