# MODULE-AUDIT: cli-cmd-context

| Field | Value |
|-------|-------|
| Unit slug | `cli-cmd-context` |
| Scope | `packages/ax-code/src/cli/cmd/context` |
...
| Analysis fingerprint | `ca11f4eaf4bd7b34` |
| Started / last updated | 2026-08-11 / 2026-08-11 |
| Inventory ID | W6-32 |
| Source files / LOC | 1 / 130 |

## 1. Scope and map

### Purpose and ownership
Unit `cli-cmd-context` owns `packages/ax-code/src/cli/cmd/context`. Risk profile: cli.
...
| Symbol | Kind | Notes |
|--------|------|-------|
| `ContextCommand@packages/ax-code/src/cli/cmd/context.ts:11` | public/internal | scanned |
...
- secret packages/ax-code/src/cli/cmd/context.ts:66
- secret packages/ax-code/src/cli/cmd/context.ts:95
...
Placement checked against ARCHITECTURE.md / PROJECT_BOUNDARIES.md for scope `packages/ax-code/src/cli/cmd/context`. Desktop boundary gate EXIT:0 at program exit.
...
|------------------|--------|----------|
| Static deep extract | ok | fingerprint `ca11f4eaf4bd7b34` |
...
|------|------|------|----------|
| Reviewer | codex-sol | 2026-08-11 | Deep extract 1 files / 130 LOC / fp ca11f4eaf4bd7b34 |
