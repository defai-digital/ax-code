...
| Analysis fingerprint | `3616149123a8e4c1` |
...
Unit `mcp-lifecycle` owns `packages/ax-code/src/mcp (lifecycle/transport)`. Risk profile: security, process.
...
Placement checked against ARCHITECTURE.md / PROJECT_BOUNDARIES.md for scope `packages/ax-code/src/mcp (lifecycle/transport)`. Desktop boundary gate EXIT:0 at program exit.
...
|------------------|--------|----------|
| Static deep extract | ok | fingerprint `3616149123a8e4c1` |
...
|------|------|------|----------|
| Reviewer | ax-code-glm | 2026-08-11 | Deep extract 11 files / 3327 LOC / fp 3616149123a8e4c1 |
