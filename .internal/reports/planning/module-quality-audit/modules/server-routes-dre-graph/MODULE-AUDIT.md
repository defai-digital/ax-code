...
| Analysis fingerprint | `e7a76de18f05b3b9` |
...
Unit `server-routes-dre-graph` owns `packages/ax-code/src/server/routes/dre-graph.ts`. Risk profile: network, api.
...
| Symbol | Kind | Notes |
|--------|------|-------|
| `DreGraphRoutes@packages/ax-code/src/server/routes/dre-graph.ts:163` | public/internal | scanned |
...
Placement checked against ARCHITECTURE.md / PROJECT_BOUNDARIES.md for scope `packages/ax-code/src/server/routes/dre-graph.ts`. Desktop boundary gate EXIT:0 at program exit.
...
|------------------|--------|----------|
| Static deep extract | ok | fingerprint `e7a76de18f05b3b9` |
...
|------|------|------|----------|
| Reviewer | codex-sol | 2026-08-11 | Deep extract 1 files / 225 LOC / fp e7a76de18f05b3b9 |
