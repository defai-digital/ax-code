# MODULE-AUDIT: server-routes-smart-llm

| Field | Value |
|-------|-------|
| Unit slug | `server-routes-smart-llm` |
| Scope | `packages/ax-code/src/server/routes/smart-llm.ts` |
...
| Inventory ID | W4-03-32 |
| Source files scanned | 1 (79 lines) |

## 1. Scope and map

### Purpose and ownership
Owns `packages/ax-code/src/server/routes/smart-llm.ts` within AX Code CLI/Desktop architecture per PRD inventory.

### Source, tests, and artifacts

| Kind | Paths | Notes |
|------|-------|-------|
| Source | `packages/ax-code/src/server/routes/smart-llm.ts` | 1 files |
