...
Owns `packages/ax-code/src/cli/cmd/audit` within AX Code CLI/Desktop architecture per PRD inventory.
...
| Tests | `packages/ax-code/test/acp/sdk-client-naming.test.ts`, `packages/ax-code/test/audit/bugfix.test.ts`, `packages/ax-code/test/audit/json.test.ts`, `packages/ax-code/test/audit/report.test.ts`, `packages/ax-code/test/audit/semantic-call.test.ts`, `packages/ax-code/test/audit/siem.test.ts`, `packages/ax-code/test/cli/account.test.ts`, `packages/ax-code/test/cli/acp.test.ts` | 25 matched |
