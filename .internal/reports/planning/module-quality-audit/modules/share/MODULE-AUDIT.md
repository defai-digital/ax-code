...
| Inventory ID | W4-07 |
| Source files scanned | 1 (14 lines) |

## 1. Scope and map

### Purpose and ownership
Owns `packages/ax-code/src/share` within AX Code CLI/Desktop architecture per PRD inventory.

### Source, tests, and artifacts

| Kind | Paths | Notes |
|------|-------|-------|
| Source | `packages/ax-code/src/share/share.sql.ts` | 1 files |
| Tests | `desktop/packages/web/server/lib/ax-code/shared.test.js`, `desktop/packages/web/server/lib/skills-catalog/shared.test.js` | 2 matched |
...
|-----------|---------------|-----|
| Primary unit behavior | `desktop/packages/web/server/lib/ax-code/shared.test.js` | ok |
