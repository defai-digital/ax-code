...
| Source files scanned | 55 (8044 lines) |

## 1. Scope and map

### Purpose and ownership
Owns `desktop/packages/ui/src/components/ui` within AX Code CLI/Desktop architecture per PRD inventory.

### Source, tests, and artifacts

| Kind | Paths | Notes |
|------|-------|-------|
| Source | `desktop/packages/ui/src/components/ui/AboutDialog.test.ts`, `desktop/packages/ui/src/components/ui/AboutDialog.tsx`, `desktop/packages/ui/src/components/ui/AxCodeIcon.tsx`, `desktop/packages/ui/src/components/ui/AxCodeStatusDialog.tsx`, `desktop/packages/ui/src/components/ui/CodeMirrorEditor.tsx`, `desktop/packages/ui/src/components/ui/CommandPalette.tsx`, `desktop/packages/ui/src/components/ui/ConfigUpdateOverlay.tsx`, `desktop/packages/ui/src/components/ui/ConfirmDialog.tsx`, `desktop/packages/ui/src/components/ui/ContextUsageDisplay.formatTokens.test.ts`, `desktop/packages/ui/src/components/ui/ContextUsageDisplay.tsx`, `desktop/packages/ui/src/components/ui/EmptySurface.tsx`, `desktop/packages/ui/src/components/ui/ErrorBoundary.tsx` | 55 files |
...
### Public API
Scanned 55 source files for exports/routes/commands.
...
|------|------|------|----------|
| Reviewer | codex-sol | 2026-08-11 | Protocol complete; 55 files scanned |
