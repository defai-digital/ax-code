...
| Inventory ID | W10-01 |
| Source files scanned | 7 (173 lines) |

## 1. Scope and map

### Purpose and ownership
Owns `packages/ax-code/src/constants` within AX Code CLI/Desktop architecture per PRD inventory.

### Source, tests, and artifacts

| Kind | Paths | Notes |
|------|-------|-------|
| Source | `packages/ax-code/src/constants/index.ts`, `packages/ax-code/src/constants/lsp.ts`, `packages/ax-code/src/constants/network.ts`, `packages/ax-code/src/constants/project.ts`, `packages/ax-code/src/constants/server.ts`, `packages/ax-code/src/constants/session.ts`, `packages/ax-code/src/constants/tool.ts` | 7 files |
