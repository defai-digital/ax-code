# MODULE-AUDIT: server-routes-pty

| Field | Value |
|-------|-------|
| Unit slug | `server-routes-pty` |
| Scope | `packages/ax-code/src/server/routes/pty.ts` |
...
| Inventory ID | W4-03-22 |
| Source files scanned | 1 (241 lines) |

## 1. Scope and map

### Purpose and ownership
Owns `packages/ax-code/src/server/routes/pty.ts` within AX Code CLI/Desktop architecture per PRD inventory.

### Source, tests, and artifacts

| Kind | Paths | Notes |
|------|-------|-------|
| Source | `packages/ax-code/src/server/routes/pty.ts` | 1 files |
