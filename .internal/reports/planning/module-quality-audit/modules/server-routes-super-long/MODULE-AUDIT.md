...
| Analysis fingerprint | `ccba94365a8d2977` |
...
Unit `server-routes-super-long` owns `packages/ax-code/src/server/routes/super-long.ts`. Risk profile: network, api.
...
| Symbol | Kind | Notes |
|--------|------|-------|
| `SuperLongRoutes@packages/ax-code/src/server/routes/super-long.ts:92` | public/internal | scanned |
...
Placement checked against ARCHITECTURE.md / PROJECT_BOUNDARIES.md for scope `packages/ax-code/src/server/routes/super-long.ts`. Desktop boundary gate EXIT:0 at program exit.
...
|------------------|--------|----------|
| Static deep extract | ok | fingerprint `ccba94365a8d2977` |
...
|------|------|------|----------|
| Reviewer | codex-sol | 2026-08-11 | Deep extract 1 files / 261 LOC / fp ccba94365a8d2977 |
