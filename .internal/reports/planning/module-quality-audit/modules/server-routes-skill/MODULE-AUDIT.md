# MODULE-AUDIT: server-routes-skill

| Field | Value |
|-------|-------|
| Unit slug | `server-routes-skill` |
| Scope | `packages/ax-code/src/server/routes/skill.ts` |
...
| Inventory ID | W4-03-31 |
| Source files scanned | 1 (145 lines) |

## 1. Scope and map

### Purpose and ownership
Owns `packages/ax-code/src/server/routes/skill.ts` within AX Code CLI/Desktop architecture per PRD inventory.

### Source, tests, and artifacts

| Kind | Paths | Notes |
|------|-------|-------|
| Source | `packages/ax-code/src/server/routes/skill.ts` | 1 files |
| Tests | `packages/ax-code/test/cli/cmd/tui/routes/session/autonomous-active.test.ts`, `packages/ax-code/test/cli/cmd/tui/routes/session/coalesce.test.ts`, `packages/ax-code/test/cli/cmd/tui/routes/session/footer-view-model.test.ts`, `packages/ax-code/test/cli/cmd/tui/routes/session/format.test.ts`, `packages/ax-code/test/cli/skill.test.ts`, `packages/ax-code/test/cli/tui/skill-list-data.test.ts`, `packages/ax-code/test/control-plane/workspace-server-sse.test.ts`, `packages/ax-code/test/lsp/server-config.test.ts` | 25 matched |
