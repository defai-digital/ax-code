...
| Inventory ID | W2-12 |
| Source files scanned | 1 (570 lines) |

## 1. Scope and map

### Purpose and ownership
Owns `packages/ax-code/src/snapshot` within AX Code CLI/Desktop architecture per PRD inventory.

### Source, tests, and artifacts

| Kind | Paths | Notes |
|------|-------|-------|
| Source | `packages/ax-code/src/snapshot/index.ts` | 1 files |
| Tests | `packages/ax-code/test/replay/code-graph-snapshot.test.ts`, `packages/ax-code/test/runtime/debug-snapshot.test.ts`, `packages/ax-code/test/snapshot/git-output.test.ts`, `packages/ax-code/test/snapshot/snapshot.test.ts`, `packages/ax-code/test/tool/visual-snapshot.test.ts`, `packages/ax-code/test/visual/snapshot.test.ts`, `desktop/packages/ui/src/sync/snapshot-equality.test.ts` | 7 matched |
...
|-----------|---------------|-----|
| Primary unit behavior | `packages/ax-code/test/replay/code-graph-snapshot.test.ts` | ok |
