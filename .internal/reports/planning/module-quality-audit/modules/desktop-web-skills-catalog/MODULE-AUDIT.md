...
| Inventory ID | W7-19 |
| Source files scanned | 18 (1977 lines) |

## 1. Scope and map

### Purpose and ownership
Owns `desktop/packages/web/server/lib/skills-catalog` within AX Code CLI/Desktop architecture per PRD inventory.

### Source, tests, and artifacts

| Kind | Paths | Notes |
|------|-------|-------|
| Source | `desktop/packages/web/server/lib/skills-catalog/cache.js`, `desktop/packages/web/server/lib/skills-catalog/clawdhub/api.js`, `desktop/packages/web/server/lib/skills-catalog/clawdhub/index.js`, `desktop/packages/web/server/lib/skills-catalog/clawdhub/install.js`, `desktop/packages/web/server/lib/skills-catalog/clawdhub/install.test.js`, `desktop/packages/web/server/lib/skills-catalog/clawdhub/scan.js`, `desktop/packages/web/server/lib/skills-catalog/clawdhub/scan.test.js`, `desktop/packages/web/server/lib/skills-catalog/curated-sources.js`, `desktop/packages/web/server/lib/skills-catalog/curated-sources.test.js`, `desktop/packages/web/server/lib/skills-catalog/git.js`, `desktop/packages/web/server/lib/skills-catalog/git.test.js`, `desktop/packages/web/server/lib/skills-catalog/index.js` | 18 files |
| Tests | `packages/ax-code/test/cli/tui/capability-catalog.test.ts`, `packages/ax-code/test/cli/tui/desktop-handoff.test.ts`, `packages/ax-code/test/desktop/webui.test.ts`, `packages/ax-code/test/script/desktop-release-workflow.test.ts`, `packages/ax-code/test/tool/webfetch.test.ts`, `desktop/packages/web/server/lib/ax-code/auth-state-runtime.test.js`, `desktop/packages/web/server/lib/ax-code/background-reload.test.js`, `desktop/packages/web/server/lib/ax-code/cli-options.test.js` | 25 matched |
| Prior art | `.internal/reports/reviews/2026-07-19-code-quality-stability-review.md` | linked |

### Public API
Scanned 18 source files for exports/routes/commands.
...
|-----------|---------------|-----|
| Primary unit behavior | `packages/ax-code/test/cli/tui/capability-catalog.test.ts` | ok |
...
|------|------|------|----------|
| Reviewer | ax-code-glm | 2026-08-11 | Protocol complete; 18 files scanned |
