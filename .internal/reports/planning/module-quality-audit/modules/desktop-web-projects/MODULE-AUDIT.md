...
| Inventory ID | W7-15 |
| Source files scanned | 5 (1210 lines) |

## 1. Scope and map

### Purpose and ownership
Owns `desktop/packages/web/server/lib/projects` within AX Code CLI/Desktop architecture per PRD inventory.

### Source, tests, and artifacts

| Kind | Paths | Notes |
|------|-------|-------|
| Source | `desktop/packages/web/server/lib/projects/discover-external.js`, `desktop/packages/web/server/lib/projects/discover-external.test.js`, `desktop/packages/web/server/lib/projects/project-config.js`, `desktop/packages/web/server/lib/projects/project-config.test.js`, `desktop/packages/web/server/lib/projects/project-id.js` | 5 files |
...
TODO density: 0. Residual empty-catch candidates: desktop/packages/web/server/lib/projects/project-config.js:352. Not auto-accepted without reachability proof.
