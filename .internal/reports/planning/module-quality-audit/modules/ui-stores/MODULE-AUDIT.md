...
| Inventory ID | W8-07 |
| Source files scanned | 97 (24046 lines) |

## 1. Scope and map

### Purpose and ownership
Owns `desktop/packages/ui/src/stores` within AX Code CLI/Desktop architecture per PRD inventory.

### Source, tests, and artifacts

| Kind | Paths | Notes |
|------|-------|-------|
| Source | `desktop/packages/ui/src/stores/globalSessions.ts`, `desktop/packages/ui/src/stores/messageQueueStore.test.ts`, `desktop/packages/ui/src/stores/messageQueueStore.ts`, `desktop/packages/ui/src/stores/permissionStore.test.ts`, `desktop/packages/ui/src/stores/permissionStore.ts`, `desktop/packages/ui/src/stores/types/selectionTypes.ts`, `desktop/packages/ui/src/stores/types/sessionTypes.ts`, `desktop/packages/ui/src/stores/useActiveNowStore.ts`, `desktop/packages/ui/src/stores/useAgentGroupsStore.ts`, `desktop/packages/ui/src/stores/useAgentsStore.test.ts`, `desktop/packages/ui/src/stores/useAgentsStore.ts`, `desktop/packages/ui/src/stores/useAttentionStore.ts` | 97 files |
| Tests | `desktop/packages/ui/src/stores/messageQueueStore.test.ts`, `desktop/packages/ui/src/stores/permissionStore.test.ts`, `desktop/packages/ui/src/stores/useAgentsStore.test.ts`, `desktop/packages/ui/src/stores/useCommandsStore.test.ts`, `desktop/packages/ui/src/stores/useDesktopSshStore.test.ts`, `desktop/packages/ui/src/stores/useDesktopSurfaceStore.test.ts`, `desktop/packages/ui/src/stores/useDirectoryStore.test.ts`, `desktop/packages/ui/src/stores/useExecutionModeStore.test.ts` | 25 matched |
| Prior art | `.internal/reports/reviews/2026-07-19-code-quality-stability-review.md` | linked |

### Public API
Scanned 97 source files for exports/routes/commands.
...
|-----------|---------------|-----|
| Primary unit behavior | `desktop/packages/ui/src/stores/messageQueueStore.test.ts` | ok |
...
|------|------|------|----------|
| Reviewer | codex-sol | 2026-08-11 | Protocol complete; 97 files scanned |
