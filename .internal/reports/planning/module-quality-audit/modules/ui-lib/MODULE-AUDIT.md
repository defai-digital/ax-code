...
| Inventory ID | W8-06 |
| Source files scanned | 263 (56602 lines) |

## 1. Scope and map

### Purpose and ownership
Owns `desktop/packages/ui/src/lib` within AX Code CLI/Desktop architecture per PRD inventory.

### Source, tests, and artifacts

| Kind | Paths | Notes |
|------|-------|-------|
| Source | `desktop/packages/ui/src/lib/agentColors.ts`, `desktop/packages/ui/src/lib/api/types.ts`, `desktop/packages/ui/src/lib/appOpenEvents.test.ts`, `desktop/packages/ui/src/lib/appOpenEvents.ts`, `desktop/packages/ui/src/lib/appearanceAutoSave.ts`, `desktop/packages/ui/src/lib/appearancePersistence.ts`, `desktop/packages/ui/src/lib/asyncTimeout.test.ts`, `desktop/packages/ui/src/lib/asyncTimeout.ts`, `desktop/packages/ui/src/lib/ax-code/ascending-id.test.ts`, `desktop/packages/ui/src/lib/ax-code/axEngineDownloadToasts.test.ts`, `desktop/packages/ui/src/lib/ax-code/axEngineDownloadToasts.ts`, `desktop/packages/ui/src/lib/ax-code/axEngineModelsApi.ts` | 263 files |
| Tests | `packages/ax-code/test/quality/calibration-model.test.ts`, `desktop/packages/web/server/lib/ax-code/auth-state-runtime.test.js`, `desktop/packages/web/server/lib/ax-code/background-reload.test.js`, `desktop/packages/web/server/lib/ax-code/cli-options.test.js`, `desktop/packages/web/server/lib/ax-code/core-routes.test.js`, `desktop/packages/web/server/lib/ax-code/env-config.test.js`, `desktop/packages/web/server/lib/ax-code/env-runtime.test.js`, `desktop/packages/web/server/lib/ax-code/hmr-state-runtime.test.js` | 25 matched |
| Prior art | `.internal/reports/reviews/2026-07-19-code-quality-stability-review.md` | linked |

### Public API
Scanned 263 source files for exports/routes/commands.
...
|-----------|---------------|-----|
| Primary unit behavior | `packages/ax-code/test/quality/calibration-model.test.ts` | ok |
...
|------|------|------|----------|
| Reviewer | codex-sol | 2026-08-11 | Protocol complete; 263 files scanned |
