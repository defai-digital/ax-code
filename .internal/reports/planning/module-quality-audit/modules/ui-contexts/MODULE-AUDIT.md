...
| Inventory ID | W8-04 |
| Source files scanned | 7 (1188 lines) |

## 1. Scope and map

### Purpose and ownership
Owns `desktop/packages/ui/src/contexts` within AX Code CLI/Desktop architecture per PRD inventory.

### Source, tests, and artifacts

| Kind | Paths | Notes |
|------|-------|-------|
| Source | `desktop/packages/ui/src/contexts/DiffWorkerProvider.tsx`, `desktop/packages/ui/src/contexts/RuntimeAPIProvider.tsx`, `desktop/packages/ui/src/contexts/ThemeSystemContext.tsx`, `desktop/packages/ui/src/contexts/runtimeAPIContext.ts`, `desktop/packages/ui/src/contexts/runtimeAPIRegistry.ts`, `desktop/packages/ui/src/contexts/theme-system-context.ts`, `desktop/packages/ui/src/contexts/useThemeSystem.ts` | 7 files |
| Tests | none auto-matched | 0 matched |
| Prior art | `.internal/reports/reviews/2026-07-19-code-quality-stability-review.md` | linked |

### Public API
Scanned 7 source files for exports/routes/commands.
...
|------|------|------|----------|
| Reviewer | codex-sol | 2026-08-11 | Protocol complete; 7 files scanned |
