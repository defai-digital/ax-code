...
| Inventory ID | W7-13 |
| Source files scanned | 11 (1523 lines) |

## 1. Scope and map

### Purpose and ownership
Owns `desktop/packages/web/server/lib/notifications` within AX Code CLI/Desktop architecture per PRD inventory.

### Source, tests, and artifacts

| Kind | Paths | Notes |
|------|-------|-------|
| Source | `desktop/packages/web/server/lib/notifications/emitter-runtime.js`, `desktop/packages/web/server/lib/notifications/index.js`, `desktop/packages/web/server/lib/notifications/label-format.js`, `desktop/packages/web/server/lib/notifications/label-format.test.js`, `desktop/packages/web/server/lib/notifications/message.js`, `desktop/packages/web/server/lib/notifications/message.test.js`, `desktop/packages/web/server/lib/notifications/routes.js`, `desktop/packages/web/server/lib/notifications/runtime.js`, `desktop/packages/web/server/lib/notifications/runtime.test.js`, `desktop/packages/web/server/lib/notifications/template-runtime.js`, `desktop/packages/web/server/lib/notifications/template-runtime.test.js` | 11 files |
...
TODO density: 0. Residual empty-catch candidates: desktop/packages/web/server/lib/notifications/routes.js:54; desktop/packages/web/server/lib/notifications/template-runtime.js:311. Not auto-accepted without reachability proof.
