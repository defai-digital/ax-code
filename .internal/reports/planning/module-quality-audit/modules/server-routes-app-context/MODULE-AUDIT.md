# MODULE-AUDIT: server-routes-app-context

| Field | Value |
|-------|-------|
| Unit slug | `server-routes-app-context` |
| Scope | `packages/ax-code/src/server/routes/app-context.ts` |
...
| Inventory ID | W4-03-04 |
| Source files scanned | 1 (182 lines) |

## 1. Scope and map

### Purpose and ownership
Owns `packages/ax-code/src/server/routes/app-context.ts` within AX Code CLI/Desktop architecture per PRD inventory.

### Source, tests, and artifacts

| Kind | Paths | Notes |
|------|-------|-------|
| Source | `packages/ax-code/src/server/routes/app-context.ts` | 1 files |
