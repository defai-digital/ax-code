...
| Analysis fingerprint | `49af5861b2d36832` |
...
Unit `server-routes-prompt-history` owns `packages/ax-code/src/server/routes/prompt-history.ts`. Risk profile: network, api.
...
| Symbol | Kind | Notes |
|--------|------|-------|
| `PromptHistoryRoutes@packages/ax-code/src/server/routes/prompt-history.ts:15` | public/internal | scanned |
...
Placement checked against ARCHITECTURE.md / PROJECT_BOUNDARIES.md for scope `packages/ax-code/src/server/routes/prompt-history.ts`. Desktop boundary gate EXIT:0 at program exit.
...
|------------------|--------|----------|
| Static deep extract | ok | fingerprint `49af5861b2d36832` |
...
|------|------|------|----------|
| Reviewer | codex-sol | 2026-08-11 | Deep extract 1 files / 66 LOC / fp 49af5861b2d36832 |
