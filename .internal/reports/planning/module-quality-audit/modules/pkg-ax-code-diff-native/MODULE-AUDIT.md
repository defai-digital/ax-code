# MODULE-AUDIT: pkg-ax-code-diff-native

| Field | Value |
|-------|-------|
| Unit slug | `pkg-ax-code-diff-native` |
| Scope | `packages/ax-code-diff-native` |
...
| Inventory ID | W9-11 |
| Source files scanned | 2 (78 lines) |

## 1. Scope and map

### Purpose and ownership
Owns `packages/ax-code-diff-native` within AX Code CLI/Desktop architecture per PRD inventory.

### Source, tests, and artifacts

| Kind | Paths | Notes |
|------|-------|-------|
| Source | `packages/ax-code-diff-native/index.d.ts`, `packages/ax-code-diff-native/package.json` | 2 files |
