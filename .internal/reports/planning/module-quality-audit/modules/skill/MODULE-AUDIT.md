...
| Inventory ID | W5-12 |
| Source files scanned | 4 (877 lines) |

## 1. Scope and map

### Purpose and ownership
Owns `packages/ax-code/src/skill` within AX Code CLI/Desktop architecture per PRD inventory.

### Source, tests, and artifacts

| Kind | Paths | Notes |
|------|-------|-------|
| Source | `packages/ax-code/src/skill/authoring.ts`, `packages/ax-code/src/skill/discovery.ts`, `packages/ax-code/src/skill/index.ts`, `packages/ax-code/src/skill/validate.ts` | 4 files |
| Tests | `packages/ax-code/test/cli/skill.test.ts`, `packages/ax-code/test/cli/tui/skill-list-data.test.ts`, `packages/ax-code/test/server/skill.test.ts`, `packages/ax-code/test/skill/discovery.test.ts`, `packages/ax-code/test/skill/skill.test.ts`, `packages/ax-code/test/tool/skill.test.ts`, `desktop/packages/web/server/lib/ax-code/skills.test.js`, `desktop/packages/web/server/lib/skills-catalog/clawdhub/install.test.js` | 15 matched |
...
|-----------|---------------|-----|
| Primary unit behavior | `packages/ax-code/test/cli/skill.test.ts` | ok |
