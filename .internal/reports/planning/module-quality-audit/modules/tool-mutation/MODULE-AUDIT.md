...
| Analysis fingerprint | `bb1d3238ea03d195` |
...
Unit `tool-mutation` owns `packages/ax-code/src/tool (edit/write/apply_patch/mutation)`. Risk profile: security, correctness.
...
Placement checked against ARCHITECTURE.md / PROJECT_BOUNDARIES.md for scope `packages/ax-code/src/tool (edit/write/apply_patch/mutation)`. Desktop boundary gate EXIT:0 at program exit.
...
|---------|----------|----------|--------|--------|
| AUDIT-tool-mutation-empty-catch | silent-error | Low | new | deferred |

## 9. Verification and exit

| Command / method | Result | Evidence |
|------------------|--------|----------|
| Static deep extract | ok | fingerprint `bb1d3238ea03d195` |
...
|------|------|------|----------|
| Reviewer | ax-code-glm | 2026-08-11 | Deep extract 78 files / 14580 LOC / fp bb1d3238ea03d195 |
