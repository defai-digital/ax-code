...
| Inventory ID | W5-15 |
| Source files scanned | 8 (470 lines) |

## 1. Scope and map

### Purpose and ownership
Owns `packages/ax-code/src/design-check` within AX Code CLI/Desktop architecture per PRD inventory.

### Source, tests, and artifacts

| Kind | Paths | Notes |
|------|-------|-------|
| Source | `packages/ax-code/src/design-check/index.ts`, `packages/ax-code/src/design-check/rules/alt-text.ts`, `packages/ax-code/src/design-check/rules/colors.ts`, `packages/ax-code/src/design-check/rules/form-labels.ts`, `packages/ax-code/src/design-check/rules/index.ts`, `packages/ax-code/src/design-check/rules/inline-styles.ts`, `packages/ax-code/src/design-check/rules/spacing.ts`, `packages/ax-code/src/design-check/types.ts` | 8 files |
| Tests | `packages/ax-code/test/cli/release-check.test.ts`, `packages/ax-code/test/cli/tui/upgrade-check-view-model.test.ts`, `packages/ax-code/test/planner/check-policy.test.ts`, `packages/ax-code/test/script/check-bare-json-parse.test.ts`, `packages/ax-code/test/script/check-no-effect-solid-in-v4.test.ts`, `packages/ax-code/test/script/check-tui-layering.test.ts` | 6 matched |
...
|-----------|---------------|-----|
| Primary unit behavior | `packages/ax-code/test/cli/release-check.test.ts` | ok |
