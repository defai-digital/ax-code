...
Owns `packages/ax-code/src/notification` within AX Code CLI/Desktop architecture per PRD inventory.

### Source, tests, and artifacts

| Kind | Paths | Notes |
|------|-------|-------|
| Source | `packages/ax-code/src/notification/events.ts` | 1 files |
| Tests | `desktop/packages/web/server/lib/notifications/label-format.test.js`, `desktop/packages/web/server/lib/notifications/message.test.js`, `desktop/packages/web/server/lib/notifications/runtime.test.js`, `desktop/packages/web/server/lib/notifications/template-runtime.test.js`, `desktop/packages/ui/src/components/notifications/permissionNotificationSync.test.ts` | 5 matched |
