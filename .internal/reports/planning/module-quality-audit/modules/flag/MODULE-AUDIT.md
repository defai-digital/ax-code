...
| Inventory ID | W10-02 |
| Source files scanned | 2 (477 lines) |

## 1. Scope and map

### Purpose and ownership
Owns `packages/ax-code/src/flag` within AX Code CLI/Desktop architecture per PRD inventory.

### Source, tests, and artifacts

| Kind | Paths | Notes |
|------|-------|-------|
| Source | `packages/ax-code/src/flag/flag.ts`, `packages/ax-code/src/flag/scoped.ts` | 2 files |
| Tests | `packages/ax-code/test/cli/tui/network-flags.test.ts`, `packages/ax-code/test/flag/flag.test.ts`, `packages/ax-code/test/flag/scoped.test.ts` | 3 matched |
...
|-----------|---------------|-----|
| Primary unit behavior | `packages/ax-code/test/cli/tui/network-flags.test.ts` | ok |
