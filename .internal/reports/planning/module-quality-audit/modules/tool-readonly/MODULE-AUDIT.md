...
| Analysis fingerprint | `9ab1b1284f2066aa` |
...
Unit `tool-readonly` owns `packages/ax-code/src/tool (read/grep/glob/ls)`. Risk profile: correctness.
...
Placement checked against ARCHITECTURE.md / PROJECT_BOUNDARIES.md for scope `packages/ax-code/src/tool (read/grep/glob/ls)`. Desktop boundary gate EXIT:0 at program exit.
...
|---------|----------|----------|--------|--------|
| AUDIT-tool-readonly-empty-catch | silent-error | Low | new | deferred |

## 9. Verification and exit

| Command / method | Result | Evidence |
|------------------|--------|----------|
| Static deep extract | ok | fingerprint `9ab1b1284f2066aa` |
...
|------|------|------|----------|
| Reviewer | ax-code-glm | 2026-08-11 | Deep extract 78 files / 14580 LOC / fp 9ab1b1284f2066aa |
