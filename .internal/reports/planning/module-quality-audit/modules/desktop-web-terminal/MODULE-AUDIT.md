...
| Inventory ID | W7-20 |
| Source files scanned | 9 (1737 lines) |

## 1. Scope and map

### Purpose and ownership
Owns `desktop/packages/web/server/lib/terminal` within AX Code CLI/Desktop architecture per PRD inventory.

### Source, tests, and artifacts

| Kind | Paths | Notes |
|------|-------|-------|
| Source | `desktop/packages/web/server/lib/terminal/index.js`, `desktop/packages/web/server/lib/terminal/output-replay-buffer.js`, `desktop/packages/web/server/lib/terminal/output-replay-buffer.test.js`, `desktop/packages/web/server/lib/terminal/runtime.js`, `desktop/packages/web/server/lib/terminal/runtime.test.js`, `desktop/packages/web/server/lib/terminal/terminal-dimensions.js`, `desktop/packages/web/server/lib/terminal/terminal-dimensions.test.js`, `desktop/packages/web/server/lib/terminal/terminal-ws-protocol.js`, `desktop/packages/web/server/lib/terminal/terminal-ws-protocol.test.js` | 9 files |
| Tests | `packages/ax-code/test/cli/tui/desktop-handoff.test.ts`, `packages/ax-code/test/cli/tui/terminal-cleanup.test.ts`, `packages/ax-code/test/cli/tui/terminal-suspend.test.ts`, `packages/ax-code/test/desktop/webui.test.ts`, `packages/ax-code/test/script/desktop-release-workflow.test.ts`, `packages/ax-code/test/tool/webfetch.test.ts`, `desktop/packages/web/server/lib/ax-code/auth-state-runtime.test.js`, `desktop/packages/web/server/lib/ax-code/background-reload.test.js` | 25 matched |
| Prior art | `.internal/reports/reviews/2026-07-19-code-quality-stability-review.md` | linked |

### Public API
Scanned 9 source files for exports/routes/commands.
...
Static signals: emptyCatch=8, todo=0, asAny=0
...
TODO density: 0. Residual empty-catch candidates: desktop/packages/web/server/lib/terminal/runtime.js:209; desktop/packages/web/server/lib/terminal/runtime.js:280; desktop/packages/web/server/lib/terminal/runtime.js:287; desktop/packages/web/server/lib/terminal/runtime.js:297; desktop/packages/web/server/lib/terminal/runtime.js:341. Not auto-accepted without reachability proof.
...
| Targeted regression | ok | desktop/packages/web/server/lib/terminal/runtime.test.js |
...
|------|------|------|----------|
| Reviewer | ax-code-glm | 2026-08-11 | Protocol complete; 9 files scanned |
