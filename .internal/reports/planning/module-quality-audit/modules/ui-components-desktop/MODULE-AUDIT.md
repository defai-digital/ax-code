...
| Source files scanned | 2 (1647 lines) |

## 1. Scope and map

### Purpose and ownership
Owns `desktop/packages/ui/src/components/desktop` within AX Code CLI/Desktop architecture per PRD inventory.

### Source, tests, and artifacts

| Kind | Paths | Notes |
|------|-------|-------|
| Source | `desktop/packages/ui/src/components/desktop/DesktopHostSwitcher.tsx`, `desktop/packages/ui/src/components/desktop/OpenInAppButton.tsx` | 2 files |
| Tests | `packages/ax-code/test/cli/tui/desktop-handoff.test.ts`, `packages/ax-code/test/desktop/webui.test.ts`, `packages/ax-code/test/script/desktop-release-workflow.test.ts`, `desktop/packages/web/server/lib/ax-code/auth-state-runtime.test.js`, `desktop/packages/web/server/lib/ax-code/background-reload.test.js`, `desktop/packages/web/server/lib/ax-code/cli-options.test.js`, `desktop/packages/web/server/lib/ax-code/core-routes.test.js`, `desktop/packages/web/server/lib/ax-code/env-config.test.js` | 25 matched |
