...
| Inventory ID | W6-18 |
| Source files scanned | 2 (818 lines) |

## 1. Scope and map

### Purpose and ownership
Owns `packages/ax-code/src/cli/cmd/release` within AX Code CLI/Desktop architecture per PRD inventory.

### Source, tests, and artifacts

| Kind | Paths | Notes |
|------|-------|-------|
| Source | `packages/ax-code/src/cli/cmd/release/check.ts`, `packages/ax-code/src/cli/cmd/release/index.ts` | 2 files |
