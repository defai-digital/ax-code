...
| Analysis fingerprint | `b6f2e26818147c55` |
...
Unit `server-routes-project` owns `packages/ax-code/src/server/routes/project.ts`. Risk profile: network, api.
...
| Symbol | Kind | Notes |
|--------|------|-------|
| `ProjectRoutes@packages/ax-code/src/server/routes/project.ts:12` | public/internal | scanned |
...
Placement checked against ARCHITECTURE.md / PROJECT_BOUNDARIES.md for scope `packages/ax-code/src/server/routes/project.ts`. Desktop boundary gate EXIT:0 at program exit.
...
|------------------|--------|----------|
| Static deep extract | ok | fingerprint `b6f2e26818147c55` |
...
|------|------|------|----------|
| Reviewer | codex-sol | 2026-08-11 | Deep extract 1 files / 120 LOC / fp b6f2e26818147c55 |
