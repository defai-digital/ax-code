...
| Analysis fingerprint | `f5638badc39e2d81` |
...
Unit `pkg-ax-code-daemon` owns `packages/ax-code-daemon`. Risk profile: native.
...
Placement checked against ARCHITECTURE.md / PROJECT_BOUNDARIES.md for scope `packages/ax-code-daemon`. Desktop boundary gate EXIT:0 at program exit.
...
|------------------|--------|----------|
| Static deep extract | ok | fingerprint `f5638badc39e2d81` |
...
|------|------|------|----------|
| Reviewer | ax-code-glm | 2026-08-11 | Deep extract 0 files / 0 LOC / fp f5638badc39e2d81 |
