...
| Inventory ID | W9-14 |
| Source files scanned | 1 (32 lines) |

## 1. Scope and map

### Purpose and ownership
Owns `packages/ax-code-daemon` within AX Code CLI/Desktop architecture per PRD inventory.

### Source, tests, and artifacts

| Kind | Paths | Notes |
|------|-------|-------|
| Source | `packages/ax-code-daemon/package.json` | 1 files |
