...
| Inventory ID | W8-01 |
| Source files scanned | 3 (7 lines) |

## 1. Scope and map

### Purpose and ownership
Owns `desktop/packages/ui/src/api` within AX Code CLI/Desktop architecture per PRD inventory.

### Source, tests, and artifacts

| Kind | Paths | Notes |
|------|-------|-------|
| Source | `desktop/packages/ui/src/api/endpoints.ts`, `desktop/packages/ui/src/api/gitApiHttp.ts`, `desktop/packages/ui/src/api/types.ts` | 3 files |
| Tests | `packages/ax-code/test/code-intelligence/api.test.ts`, `packages/ax-code/test/provider/cloud-api-providers.test.ts` | 2 matched |
...
|-----------|---------------|-----|
| Primary unit behavior | `packages/ax-code/test/code-intelligence/api.test.ts` | ok |
