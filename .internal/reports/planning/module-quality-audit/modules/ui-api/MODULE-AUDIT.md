...
| Analysis fingerprint | `db6efdd095beef9e` |
...
Unit `ui-api` owns `desktop/packages/ui/src/api`. Risk profile: desktop, api.
...
Placement checked against ARCHITECTURE.md / PROJECT_BOUNDARIES.md for scope `desktop/packages/ui/src/api`. Desktop boundary gate EXIT:0 at program exit.
...
|------------------|--------|----------|
| Static deep extract | ok | fingerprint `db6efdd095beef9e` |
...
|------|------|------|----------|
| Reviewer | codex-sol | 2026-08-11 | Deep extract 3 files / 7 LOC / fp db6efdd095beef9e |
