...
| Inventory ID | W3-01 |
| Source files scanned | 5 (948 lines) |

## 1. Scope and map

### Purpose and ownership
Owns `packages/ax-code/src/permission` within AX Code CLI/Desktop architecture per PRD inventory.

### Source, tests, and artifacts

| Kind | Paths | Notes |
|------|-------|-------|
| Source | `packages/ax-code/src/permission/arity.ts`, `packages/ax-code/src/permission/evaluate.ts`, `packages/ax-code/src/permission/index.ts`, `packages/ax-code/src/permission/risk-classes.ts`, `packages/ax-code/src/permission/schema.ts` | 5 files |
| Tests | `packages/ax-code/test/cli/tui/p-permission-question-reply-sdk-error.test.ts`, `packages/ax-code/test/cli/tui/permission-submit-latch.test.ts`, `packages/ax-code/test/config/permission-env.test.ts`, `packages/ax-code/test/mcp/permission-contract.test.ts`, `packages/ax-code/test/mcp/permission-pattern.test.ts`, `packages/ax-code/test/permission/arity.test.ts`, `packages/ax-code/test/permission/next.test.ts`, `packages/ax-code/test/permission/risk-classes.test.ts` | 16 matched |
...
|-----------|---------------|-----|
| Primary unit behavior | `packages/ax-code/test/cli/tui/p-permission-question-reply-sdk-error.test.ts` | ok |
