...
| Inventory ID | W2-05 |
| Source files scanned | 10 (2159 lines) |

## 1. Scope and map

### Purpose and ownership
Owns `packages/ax-code/src/planner` within AX Code CLI/Desktop architecture per PRD inventory.

### Source, tests, and artifacts

| Kind | Paths | Notes |
|------|-------|-------|
| Source | `packages/ax-code/src/planner/complexity.ts`, `packages/ax-code/src/planner/dependency.ts`, `packages/ax-code/src/planner/estimator.ts`, `packages/ax-code/src/planner/index.ts`, `packages/ax-code/src/planner/replan-llm.ts`, `packages/ax-code/src/planner/types.ts`, `packages/ax-code/src/planner/verification/check-policy.ts`, `packages/ax-code/src/planner/verification/index.ts`, `packages/ax-code/src/planner/verification/repair-handoff.ts`, `packages/ax-code/src/planner/verification/runner.ts` | 10 files |
| Tests | `packages/ax-code/test/planner/check-policy.test.ts`, `packages/ax-code/test/planner/complexity-hint.test.ts`, `packages/ax-code/test/planner/constraints.test.ts`, `packages/ax-code/test/planner/index.test.ts`, `packages/ax-code/test/planner/phase-reviewer.test.ts`, `packages/ax-code/test/planner/repair-handoff.test.ts`, `packages/ax-code/test/planner/replan-llm.test.ts`, `packages/ax-code/test/planner/replan.test.ts` | 11 matched |
...
|-----------|---------------|-----|
| Primary unit behavior | `packages/ax-code/test/planner/check-policy.test.ts` | ok |
...
|------|------|------|----------|
| Reviewer | codex-sol | 2026-08-11 | Protocol complete; 10 files scanned |
