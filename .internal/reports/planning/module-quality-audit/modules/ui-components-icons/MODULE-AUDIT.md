...
| Source files scanned | 6 (136 lines) |

## 1. Scope and map

### Purpose and ownership
Owns `desktop/packages/ui/src/components/icons` within AX Code CLI/Desktop architecture per PRD inventory.

### Source, tests, and artifacts

| Kind | Paths | Notes |
|------|-------|-------|
| Source | `desktop/packages/ui/src/components/icons/ArrowsMerge.tsx`, `desktop/packages/ui/src/components/icons/DiffIcon.tsx`, `desktop/packages/ui/src/components/icons/FileTypeIcon.tsx`, `desktop/packages/ui/src/components/icons/FusionIcon.tsx`, `desktop/packages/ui/src/components/icons/McpIcon.tsx`, `desktop/packages/ui/src/components/icons/StopIcon.tsx` | 6 files |
