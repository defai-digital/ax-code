...
| Inventory ID | W10-03 |
| Source files scanned | 2 (637 lines) |

## 1. Scope and map

### Purpose and ownership
Owns `packages/ax-code/src/format` within AX Code CLI/Desktop architecture per PRD inventory.

### Source, tests, and artifacts

| Kind | Paths | Notes |
|------|-------|-------|
| Source | `packages/ax-code/src/format/formatter.ts`, `packages/ax-code/src/format/index.ts` | 2 files |
| Tests | `packages/ax-code/test/cli/cmd/tui/routes/session/format.test.ts`, `packages/ax-code/test/cli/tui/session-format.test.ts`, `packages/ax-code/test/cli/uninstall-format-size.test.ts`, `packages/ax-code/test/format/format.test.ts`, `packages/ax-code/test/quality/dre-graph-format.test.ts`, `packages/ax-code/test/util/format.test.ts`, `desktop/packages/web/server/lib/notifications/label-format.test.js`, `desktop/packages/web/server/lib/quota/utils/formatters.test.js` | 11 matched |
...
|-----------|---------------|-----|
| Primary unit behavior | `packages/ax-code/test/cli/cmd/tui/routes/session/format.test.ts` | ok |
