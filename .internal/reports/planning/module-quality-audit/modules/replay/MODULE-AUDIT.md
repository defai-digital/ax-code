...
| Inventory ID | W2-11 |
| Source files scanned | 9 (2197 lines) |

## 1. Scope and map

### Purpose and ownership
Owns `packages/ax-code/src/replay` within AX Code CLI/Desktop architecture per PRD inventory.

### Source, tests, and artifacts

| Kind | Paths | Notes |
|------|-------|-------|
| Source | `packages/ax-code/src/replay/agent-control-query.ts`, `packages/ax-code/src/replay/compare.ts`, `packages/ax-code/src/replay/event-log.sql.ts`, `packages/ax-code/src/replay/event.ts`, `packages/ax-code/src/replay/index.ts`, `packages/ax-code/src/replay/query.ts`, `packages/ax-code/src/replay/recorder.ts`, `packages/ax-code/src/replay/replay.ts`, `packages/ax-code/src/replay/tool-call-query.ts` | 9 files |
| Tests | `packages/ax-code/test/cli/debug-replay.test.ts`, `packages/ax-code/test/replay/agent-control-events.test.ts`, `packages/ax-code/test/replay/agent-control-query.test.ts`, `packages/ax-code/test/replay/code-graph-snapshot.test.ts`, `packages/ax-code/test/replay/code-intelligence-replay.test.ts`, `packages/ax-code/test/replay/query.test.ts`, `packages/ax-code/test/replay/reconstruct.test.ts`, `packages/ax-code/test/replay/recorder-batching.test.ts` | 12 matched |
...
|-----------|---------------|-----|
| Primary unit behavior | `packages/ax-code/test/cli/debug-replay.test.ts` | ok |
...
|------|------|------|----------|
| Reviewer | codex-sol | 2026-08-11 | Protocol complete; 9 files scanned |
