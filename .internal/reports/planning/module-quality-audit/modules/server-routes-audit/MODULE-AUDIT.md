...
| Source files scanned | 1 (159 lines) |

## 1. Scope and map

### Purpose and ownership
Owns `packages/ax-code/src/server/routes/audit.ts` within AX Code CLI/Desktop architecture per PRD inventory.

### Source, tests, and artifacts

| Kind | Paths | Notes |
|------|-------|-------|
| Source | `packages/ax-code/src/server/routes/audit.ts` | 1 files |
| Tests | `packages/ax-code/test/audit/bugfix.test.ts`, `packages/ax-code/test/audit/json.test.ts`, `packages/ax-code/test/audit/report.test.ts`, `packages/ax-code/test/audit/semantic-call.test.ts`, `packages/ax-code/test/audit/siem.test.ts`, `packages/ax-code/test/cli/audit.test.ts`, `packages/ax-code/test/cli/cmd/tui/routes/session/autonomous-active.test.ts`, `packages/ax-code/test/cli/cmd/tui/routes/session/coalesce.test.ts` | 25 matched |
