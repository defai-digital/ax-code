...
| Inventory ID | W3-07 |
| Source files scanned | 1 (787 lines) |

## 1. Scope and map

### Purpose and ownership
Owns `packages/ax-code/src/patch` within AX Code CLI/Desktop architecture per PRD inventory.

### Source, tests, and artifacts

| Kind | Paths | Notes |
|------|-------|-------|
| Source | `packages/ax-code/src/patch/index.ts` | 1 files |
| Tests | `packages/ax-code/test/cli/tui/dialogs-action-dispatch.test.ts`, `packages/ax-code/test/code-intelligence/query-native-dispatch.test.ts`, `packages/ax-code/test/dispatch/index.test.ts`, `packages/ax-code/test/dispatch/merge-strategies.test.ts`, `packages/ax-code/test/patch/patch.test.ts`, `packages/ax-code/test/tool/apply_patch.test.ts`, `packages/ax-code/test/workflow/dispatch-adapter.test.ts` | 7 matched |
...
|-----------|---------------|-----|
| Primary unit behavior | `packages/ax-code/test/cli/tui/dialogs-action-dispatch.test.ts` | ok |
