...
| Inventory ID | W2-07 |
| Source files scanned | 20 (6084 lines) |

## 1. Scope and map

### Purpose and ownership
Owns `packages/ax-code/src/workflow` within AX Code CLI/Desktop architecture per PRD inventory.

### Source, tests, and artifacts

| Kind | Paths | Notes |
|------|-------|-------|
| Source | `packages/ax-code/src/workflow/artifact.ts`, `packages/ax-code/src/workflow/budget.ts`, `packages/ax-code/src/workflow/dispatch-adapter.ts`, `packages/ax-code/src/workflow/eval-corpus.ts`, `packages/ax-code/src/workflow/eval.ts`, `packages/ax-code/src/workflow/fixtures.ts`, `packages/ax-code/src/workflow/index.ts`, `packages/ax-code/src/workflow/planner.ts`, `packages/ax-code/src/workflow/projection.ts`, `packages/ax-code/src/workflow/routine.ts`, `packages/ax-code/src/workflow/run/budget.ts`, `packages/ax-code/src/workflow/run/final-report.ts` | 20 files |
| Tests | `packages/ax-code/test/cli/tui/session-workflow-status.test.ts`, `packages/ax-code/test/cli/tui/workflow-dashboard.test.ts`, `packages/ax-code/test/cli/workflow.test.ts`, `packages/ax-code/test/fixture/workflow/verified-bug-sweep-seeded/src/auth.ts`, `packages/ax-code/test/fixture/workflow/verified-bug-sweep-seeded/src/cache.ts`, `packages/ax-code/test/fixture/workflow/verified-bug-sweep-seeded/src/render.ts`, `packages/ax-code/test/fixture/workflow/verified-bug-sweep-seeded/src/retry.ts`, `packages/ax-code/test/script/desktop-release-workflow.test.ts` | 25 matched |
...
|-----------|---------------|-----|
| Primary unit behavior | `packages/ax-code/test/cli/tui/session-workflow-status.test.ts` | ok |
...
|------|------|------|----------|
| Reviewer | codex-sol | 2026-08-11 | Protocol complete; 20 files scanned |
