# MODULE-AUDIT: server-routes-graph

| Field | Value |
|-------|-------|
| Unit slug | `server-routes-graph` |
| Scope | `packages/ax-code/src/server/routes/graph.ts` |
...
| Inventory ID | W4-03-14 |
| Source files scanned | 1 (90 lines) |

## 1. Scope and map

### Purpose and ownership
Owns `packages/ax-code/src/server/routes/graph.ts` within AX Code CLI/Desktop architecture per PRD inventory.

### Source, tests, and artifacts

| Kind | Paths | Notes |
|------|-------|-------|
| Source | `packages/ax-code/src/server/routes/graph.ts` | 1 files |
| Tests | `packages/ax-code/test/cli/cmd/tui/routes/session/autonomous-active.test.ts`, `packages/ax-code/test/cli/cmd/tui/routes/session/coalesce.test.ts`, `packages/ax-code/test/cli/cmd/tui/routes/session/footer-view-model.test.ts`, `packages/ax-code/test/cli/cmd/tui/routes/session/format.test.ts`, `packages/ax-code/test/cli/index-graph.test.ts`, `packages/ax-code/test/code-intelligence/graph-context.test.ts`, `packages/ax-code/test/code-intelligence/graph-envelope.test.ts`, `packages/ax-code/test/code-intelligence/graph-highlights.test.ts` | 25 matched |
