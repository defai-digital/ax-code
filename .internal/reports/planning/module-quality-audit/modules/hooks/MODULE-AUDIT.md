...
| Inventory ID | W1-04 |
| Source files scanned | 1 (350 lines) |

## 1. Scope and map

### Purpose and ownership
Owns `packages/ax-code/src/hooks` within AX Code CLI/Desktop architecture per PRD inventory.

### Source, tests, and artifacts

| Kind | Paths | Notes |
|------|-------|-------|
| Source | `packages/ax-code/src/hooks/lifecycle.ts` | 1 files |
