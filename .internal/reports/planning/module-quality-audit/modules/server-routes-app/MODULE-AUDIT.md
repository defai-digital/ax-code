...
| Analysis fingerprint | `bb012d93361b3f0b` |
...
Unit `server-routes-app` owns `packages/ax-code/src/server/routes/app.ts`. Risk profile: network, api.
...
| Symbol | Kind | Notes |
|--------|------|-------|
| `AppRoutes@packages/ax-code/src/server/routes/app.ts:34` | public/internal | scanned |
...
Placement checked against ARCHITECTURE.md / PROJECT_BOUNDARIES.md for scope `packages/ax-code/src/server/routes/app.ts`. Desktop boundary gate EXIT:0 at program exit.
...
|------------------|--------|----------|
| Static deep extract | ok | fingerprint `bb012d93361b3f0b` |
...
|------|------|------|----------|
| Reviewer | codex-sol | 2026-08-11 | Deep extract 1 files / 274 LOC / fp bb012d93361b3f0b |
