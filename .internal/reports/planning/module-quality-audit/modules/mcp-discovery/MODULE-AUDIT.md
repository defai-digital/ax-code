...
Owns `packages/ax-code/src/mcp (discovery/config/disposal)` within AX Code CLI/Desktop architecture per PRD inventory.
...
| Tests | `packages/ax-code/test/cli/mcp-config-lock.test.ts`, `packages/ax-code/test/cli/mcp-debug.test.ts`, `packages/ax-code/test/mcp/auth.test.ts`, `packages/ax-code/test/mcp/connect-lock.test.ts`, `packages/ax-code/test/mcp/discovery-playwright.test.ts`, `packages/ax-code/test/mcp/discovery-spawn.test.ts`, `packages/ax-code/test/mcp/headers.test.ts`, `packages/ax-code/test/mcp/oauth-auto-connect.test.ts` | 18 matched |
...
|-----------|---------------|-----|
| Primary unit behavior | `packages/ax-code/test/cli/mcp-config-lock.test.ts` | ok |
