...
| Analysis fingerprint | `a4c751a39bad1452` |
...
Unit `mcp-discovery` owns `packages/ax-code/src/mcp (discovery/config/disposal)`. Risk profile: security.
...
Placement checked against ARCHITECTURE.md / PROJECT_BOUNDARIES.md for scope `packages/ax-code/src/mcp (discovery/config/disposal)`. Desktop boundary gate EXIT:0 at program exit.
...
|------------------|--------|----------|
| Static deep extract | ok | fingerprint `a4c751a39bad1452` |
...
|------|------|------|----------|
| Reviewer | ax-code-glm | 2026-08-11 | Deep extract 11 files / 3327 LOC / fp a4c751a39bad1452 |
