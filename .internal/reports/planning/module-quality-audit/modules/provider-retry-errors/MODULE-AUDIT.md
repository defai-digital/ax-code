...
| Analysis fingerprint | `7e73d0b88c4080be` |
...
Unit `provider-retry-errors` owns `packages/ax-code/src/provider (retry/error translation)`. Risk profile: stability.
...
Placement checked against ARCHITECTURE.md / PROJECT_BOUNDARIES.md for scope `packages/ax-code/src/provider (retry/error translation)`. Desktop boundary gate EXIT:0 at program exit.
...
|------------------|--------|----------|
| Static deep extract | ok | fingerprint `7e73d0b88c4080be` |
...
|------|------|------|----------|
| Reviewer | ax-code-glm | 2026-08-11 | Deep extract 52 files / 11481 LOC / fp 7e73d0b88c4080be |
