...
| Inventory ID | W6-00 |
| Source files scanned | 364 (55097 lines) |

## 1. Scope and map

### Purpose and ownership
Owns `packages/ax-code/src/cli` within AX Code CLI/Desktop architecture per PRD inventory.

### Source, tests, and artifacts

| Kind | Paths | Notes |
|------|-------|-------|
| Source | `packages/ax-code/src/cli/attach-auth.ts`, `packages/ax-code/src/cli/boolean-flag.ts`, `packages/ax-code/src/cli/boot-node.ts`, `packages/ax-code/src/cli/boot.ts`, `packages/ax-code/src/cli/bootstrap/env.ts`, `packages/ax-code/src/cli/bootstrap/fatal.ts`, `packages/ax-code/src/cli/bootstrap/migrate.ts`, `packages/ax-code/src/cli/bootstrap/windows-console.ts`, `packages/ax-code/src/cli/bootstrap.ts`, `packages/ax-code/src/cli/cmd/account.ts`, `packages/ax-code/src/cli/cmd/acp.ts`, `packages/ax-code/src/cli/cmd/agent.ts` | 364 files |
...
### Public API
Scanned 364 source files for exports/routes/commands.
...
Static signals: emptyCatch=4, todo=2, asAny=34
...
TODO density: 2. Residual empty-catch candidates: packages/ax-code/src/cli/cmd/github-agent/github-api.ts:49; packages/ax-code/src/cli/cmd/run.ts:839; packages/ax-code/src/cli/cmd/storage/session.ts:453; packages/ax-code/src/cli/cmd/tui/component/prompt/index.tsx:1590. Not auto-accepted without reachability proof.
...
|------|------|------|----------|
| Reviewer | codex-sol | 2026-08-11 | Protocol complete; 364 files scanned |
