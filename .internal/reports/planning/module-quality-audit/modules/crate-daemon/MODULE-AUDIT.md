...
| Inventory ID | W9-20 |
| Source files scanned | 3 (412 lines) |

## 1. Scope and map

### Purpose and ownership
Owns `crates/ax-code-daemon` within AX Code CLI/Desktop architecture per PRD inventory.

### Source, tests, and artifacts

| Kind | Paths | Notes |
|------|-------|-------|
| Source | `crates/ax-code-daemon/build.rs`, `crates/ax-code-daemon/src/daemon.rs`, `crates/ax-code-daemon/src/lib.rs` | 3 files |
