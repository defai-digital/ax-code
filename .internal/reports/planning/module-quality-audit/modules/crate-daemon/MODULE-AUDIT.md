...
| Analysis fingerprint | `f10a7859af72c182` |
...
Unit `crate-daemon` owns `crates/ax-code-daemon`. Risk profile: native.
...
- process crates/ax-code-daemon/src/daemon.rs:260
...
Placement checked against ARCHITECTURE.md / PROJECT_BOUNDARIES.md for scope `crates/ax-code-daemon`. Desktop boundary gate EXIT:0 at program exit.
...
|------------------|--------|----------|
| Static deep extract | ok | fingerprint `f10a7859af72c182` |
...
|------|------|------|----------|
| Reviewer | ax-code-glm | 2026-08-11 | Deep extract 3 files / 412 LOC / fp f10a7859af72c182 |
