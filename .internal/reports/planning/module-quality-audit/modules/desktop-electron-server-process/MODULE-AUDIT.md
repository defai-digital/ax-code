...
| Analysis fingerprint | `693d918ade1510e3` |
...
Unit `desktop-electron-server-process` owns `desktop/packages/electron/src/server-process.js`. Risk profile: desktop, stability.

### Source inventory (extracted)

| File | LOC | Exports | Empty catches | TODOs |
|------|----:|--------:|--------------:|------:|
| `desktop/packages/electron/src/server-process.js` | 88 | 0 | 1 | 0 |
...
- io desktop/packages/electron/src/server-process.js:37
...
- Empty catch residual: desktop/packages/electron/src/server-process.js:51
- TODOs: none
...
Placement checked against ARCHITECTURE.md / PROJECT_BOUNDARIES.md for scope `desktop/packages/electron/src/server-process.js`. Desktop boundary gate EXIT:0 at program exit.
...
|------------------|--------|----------|
| Static deep extract | ok | fingerprint `693d918ade1510e3` |
...
|------|------|------|----------|
| Reviewer | ax-code-glm | 2026-08-11 | Deep extract 1 files / 88 LOC / fp 693d918ade1510e3 |
