...
| Inventory ID | W9-02 |
| Source files scanned | 8 (548 lines) |

## 1. Scope and map

### Purpose and ownership
Owns `packages/plugin` within AX Code CLI/Desktop architecture per PRD inventory.

### Source, tests, and artifacts

| Kind | Paths | Notes |
|------|-------|-------|
| Source | `packages/plugin/package.json`, `packages/plugin/script/publish.ts`, `packages/plugin/src/example.ts`, `packages/plugin/src/index.ts`, `packages/plugin/src/shell.ts`, `packages/plugin/src/tool.ts`, `packages/plugin/sst-env.d.ts`, `packages/plugin/tsconfig.json` | 8 files |
| Tests | `packages/ax-code/test/cli/plugin-auth-picker.test.ts`, `packages/ax-code/test/plugin/auth-override.test.ts`, `packages/ax-code/test/provider/xai/auth-plugin.test.ts`, `packages/ax-code/test/script/esbuild-solid-plugin.test.ts`, `desktop/packages/web/server/lib/ax-code/plugin-routes.test.js`, `desktop/packages/web/server/lib/ax-code/plugin-spec.test.js`, `desktop/packages/web/server/lib/ax-code/plugins.test.js`, `desktop/packages/ui/src/components/sections/plugins/pluginFileLoad.test.ts` | 8 matched |
...
|-----------|---------------|-----|
| Primary unit behavior | `packages/ax-code/test/cli/plugin-auth-picker.test.ts` | ok |
