...
| Inventory ID | W9-07 |
| Source files scanned | 6 (521 lines) |

## 1. Scope and map

### Purpose and ownership
Owns `packages/opentui-spinner` within AX Code CLI/Desktop architecture per PRD inventory.

### Source, tests, and artifacts

| Kind | Paths | Notes |
|------|-------|-------|
| Source | `packages/opentui-spinner/package.json`, `packages/opentui-spinner/src/index.ts`, `packages/opentui-spinner/src/presets.ts`, `packages/opentui-spinner/src/solid.ts`, `packages/opentui-spinner/src/utils.ts`, `packages/opentui-spinner/tsconfig.json` | 6 files |
| Tests | `packages/ax-code/test/cli/tui/opentui-ffi-coordinate-guard.test.ts`, `packages/ax-code/test/cli/tui/opentui-ffi-pointer-pin.test.ts`, `packages/ax-code/test/cli/tui/opentui-spinner.test.ts`, `packages/ax-code/test/cli/tui/spinner-profile.test.ts`, `packages/ax-code/test/cli/tui/spinner.test.ts`, `packages/ax-code/test/script/opentui-package-integrity.test.ts` | 6 matched |
...
|------|------|------|----------|
| Reviewer | ax-code-glm | 2026-08-11 | Protocol complete; 6 files scanned |
