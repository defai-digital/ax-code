...
| Inventory ID | W5-07 |
| Source files scanned | 12 (4974 lines) |

## 1. Scope and map

### Purpose and ownership
Owns `packages/ax-code/src/code-intelligence` within AX Code CLI/Desktop architecture per PRD inventory.

### Source, tests, and artifacts

| Kind | Paths | Notes |
|------|-------|-------|
| Source | `packages/ax-code/src/code-intelligence/auto-index.ts`, `packages/ax-code/src/code-intelligence/builder-impl.ts`, `packages/ax-code/src/code-intelligence/builder.ts`, `packages/ax-code/src/code-intelligence/graph-context.ts`, `packages/ax-code/src/code-intelligence/id.ts`, `packages/ax-code/src/code-intelligence/index.ts`, `packages/ax-code/src/code-intelligence/lockfile.ts`, `packages/ax-code/src/code-intelligence/native-store.ts`, `packages/ax-code/src/code-intelligence/query.ts`, `packages/ax-code/src/code-intelligence/schema.sql.ts`, `packages/ax-code/src/code-intelligence/syntactic.ts`, `packages/ax-code/src/code-intelligence/watcher.ts` | 12 files |
...
### Public API
Scanned 12 source files for exports/routes/commands.
...
|------|------|------|----------|
| Reviewer | ax-code-glm | 2026-08-11 | Protocol complete; 12 files scanned |
