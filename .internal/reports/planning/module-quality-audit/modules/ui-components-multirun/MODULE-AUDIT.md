...
| Source files scanned | 6 (2122 lines) |

## 1. Scope and map

### Purpose and ownership
Owns `desktop/packages/ui/src/components/multirun` within AX Code CLI/Desktop architecture per PRD inventory.

### Source, tests, and artifacts

| Kind | Paths | Notes |
|------|-------|-------|
| Source | `desktop/packages/ui/src/components/multirun/AgentSelector.tsx`, `desktop/packages/ui/src/components/multirun/BranchSelector.tsx`, `desktop/packages/ui/src/components/multirun/ModelMultiSelect.tsx`, `desktop/packages/ui/src/components/multirun/MultiRunFusionDialog.tsx`, `desktop/packages/ui/src/components/multirun/MultiRunLauncher.tsx`, `desktop/packages/ui/src/components/multirun/index.ts` | 6 files |
