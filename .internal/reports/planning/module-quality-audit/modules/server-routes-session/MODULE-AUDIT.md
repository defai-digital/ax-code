...
| Source files scanned | 1 (2 lines) |

## 1. Scope and map

### Purpose and ownership
Owns `packages/ax-code/src/server/routes/session.ts` within AX Code CLI/Desktop architecture per PRD inventory.

### Source, tests, and artifacts

| Kind | Paths | Notes |
|------|-------|-------|
| Source | `packages/ax-code/src/server/routes/session.ts` | 1 files |
