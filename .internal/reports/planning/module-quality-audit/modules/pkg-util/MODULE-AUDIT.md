...
| Inventory ID | W9-03 |
| Source files scanned | 15 (479 lines) |

## 1. Scope and map

### Purpose and ownership
Owns `packages/util` within AX Code CLI/Desktop architecture per PRD inventory.

### Source, tests, and artifacts

| Kind | Paths | Notes |
|------|-------|-------|
| Source | `packages/util/package.json`, `packages/util/src/array.ts`, `packages/util/src/binary.ts`, `packages/util/src/encode.ts`, `packages/util/src/error.ts`, `packages/util/src/fn.ts`, `packages/util/src/identifier.ts`, `packages/util/src/iife.ts`, `packages/util/src/lazy.ts`, `packages/util/src/module.ts`, `packages/util/src/path.ts`, `packages/util/src/retry.ts` | 15 files |
...
TODO density: 0. Residual empty-catch candidates: packages/util/src/module.ts:8. Not auto-accepted without reachability proof.
