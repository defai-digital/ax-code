...
| Inventory ID | W8-02 |
| Source files scanned | 6 (527 lines) |

## 1. Scope and map

### Purpose and ownership
Owns `desktop/packages/ui/src/apps` within AX Code CLI/Desktop architecture per PRD inventory.

### Source, tests, and artifacts

| Kind | Paths | Notes |
|------|-------|-------|
| Source | `desktop/packages/ui/src/apps/AppEffects.tsx`, `desktop/packages/ui/src/apps/ElectronMiniChatApp.tsx`, `desktop/packages/ui/src/apps/miniChatPresence.test.ts`, `desktop/packages/ui/src/apps/miniChatPresence.ts`, `desktop/packages/ui/src/apps/renderElectronMiniChatApp.tsx`, `desktop/packages/ui/src/apps/useAppFontEffects.ts` | 6 files |
| Tests | `desktop/packages/electron/src/installed-apps-cache.test.mjs`, `desktop/packages/ui/src/apps/miniChatPresence.test.ts` | 2 matched |
...
|-----------|---------------|-----|
| Primary unit behavior | `desktop/packages/electron/src/installed-apps-cache.test.mjs` | ok |
