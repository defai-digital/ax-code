...
| Analysis fingerprint | `9a4bff1d1607ec6b` |
...
Unit `cli-cmd-tui-boot` owns `packages/ax-code/src/cli/cmd/tui boot/worker`. Risk profile: cli.
...
Placement checked against ARCHITECTURE.md / PROJECT_BOUNDARIES.md for scope `packages/ax-code/src/cli/cmd/tui boot/worker`. Desktop boundary gate EXIT:0 at program exit.
...
|------------------|--------|----------|
| Static deep extract | ok | fingerprint `9a4bff1d1607ec6b` |
...
|------|------|------|----------|
| Reviewer | codex-sol | 2026-08-11 | Deep extract 233 files / 36902 LOC / fp 9a4bff1d1607ec6b |
