...
Owns `packages/ax-code/src/tool (task/arena/council/orchestration)` within AX Code CLI/Desktop architecture per PRD inventory.
...
| Tests | `packages/ax-code/test/cli/tui/session-tool-rendering.test.ts`, `packages/ax-code/test/mcp/tool-conversion.test.ts`, `packages/ax-code/test/replay/tool-call-query.test.ts`, `packages/ax-code/test/replay/tool-result-metadata.test.ts`, `packages/ax-code/test/session/prompt-tools.test.ts`, `packages/ax-code/test/session/tool-error-pattern.test.ts`, `packages/ax-code/test/tool/apply_patch.test.ts`, `packages/ax-code/test/tool/arena-implement.test.ts` | 25 matched |
