# MODULE-AUDIT: pkg-ax-code-fs-native

| Field | Value |
|-------|-------|
| Unit slug | `pkg-ax-code-fs-native` |
| Scope | `packages/ax-code-fs-native` |
...
| Inventory ID | W9-10 |
| Source files scanned | 2 (119 lines) |

## 1. Scope and map

### Purpose and ownership
Owns `packages/ax-code-fs-native` within AX Code CLI/Desktop architecture per PRD inventory.

### Source, tests, and artifacts

| Kind | Paths | Notes |
|------|-------|-------|
| Source | `packages/ax-code-fs-native/index.d.ts`, `packages/ax-code-fs-native/package.json` | 2 files |
