...
| Analysis fingerprint | `98d3043a083364f7` |
...
Unit `session-fork-revert` owns `packages/ax-code/src/session (fork/revert/rollback)`. Risk profile: correctness, persistence.
...
Placement checked against ARCHITECTURE.md / PROJECT_BOUNDARIES.md for scope `packages/ax-code/src/session (fork/revert/rollback)`. Desktop boundary gate EXIT:0 at program exit.
...
|------------------|--------|----------|
| Static deep extract | ok | fingerprint `98d3043a083364f7` |
...
|------|------|------|----------|
| Reviewer | codex-sol | 2026-08-11 | Deep extract 135 files / 26283 LOC / fp 98d3043a083364f7 |
