...
| Inventory ID | W6-17 |
| Source files scanned | 13 (2621 lines) |

## 1. Scope and map

### Purpose and ownership
Owns `packages/ax-code/src/cli/cmd/debug` within AX Code CLI/Desktop architecture per PRD inventory.

### Source, tests, and artifacts

| Kind | Paths | Notes |
|------|-------|-------|
| Source | `packages/ax-code/src/cli/cmd/debug/agent.ts`, `packages/ax-code/src/cli/cmd/debug/config.ts`, `packages/ax-code/src/cli/cmd/debug/explain-impl.ts`, `packages/ax-code/src/cli/cmd/debug/explain.ts`, `packages/ax-code/src/cli/cmd/debug/file.ts`, `packages/ax-code/src/cli/cmd/debug/index.ts`, `packages/ax-code/src/cli/cmd/debug/lsp.ts`, `packages/ax-code/src/cli/cmd/debug/perf.ts`, `packages/ax-code/src/cli/cmd/debug/replay.ts`, `packages/ax-code/src/cli/cmd/debug/ripgrep.ts`, `packages/ax-code/src/cli/cmd/debug/scrap.ts`, `packages/ax-code/src/cli/cmd/debug/skill.ts` | 13 files |
