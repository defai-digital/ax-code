...
| Source files scanned | 1 (862 lines) |

## 1. Scope and map

### Purpose and ownership
Owns `desktop/packages/ui/src/components/model-picker` within AX Code CLI/Desktop architecture per PRD inventory.

### Source, tests, and artifacts

| Kind | Paths | Notes |
|------|-------|-------|
| Source | `desktop/packages/ui/src/components/model-picker/ModelPickerList.tsx` | 1 files |
| Tests | `packages/ax-code/test/cli/cmd/tui/routes/session/footer-view-model.test.ts`, `packages/ax-code/test/cli/plugin-auth-picker.test.ts`, `packages/ax-code/test/cli/prompt-view-model.test.ts`, `packages/ax-code/test/cli/tui/dialog-help-view-model.test.ts`, `packages/ax-code/test/cli/tui/dialog-model-options.test.ts`, `packages/ax-code/test/cli/tui/dialog-select-view-model.test.ts`, `packages/ax-code/test/cli/tui/directory-view-model.test.ts`, `packages/ax-code/test/cli/tui/footer-view-model.test.ts` | 25 matched |
