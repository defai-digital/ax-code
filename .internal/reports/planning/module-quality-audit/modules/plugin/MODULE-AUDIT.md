...
| Inventory ID | W1-06 |
| Source files scanned | 1 (184 lines) |

## 1. Scope and map

### Purpose and ownership
Owns `packages/ax-code/src/plugin` within AX Code CLI/Desktop architecture per PRD inventory.

### Source, tests, and artifacts

| Kind | Paths | Notes |
|------|-------|-------|
| Source | `packages/ax-code/src/plugin/index.ts` | 1 files |
