...
| Inventory ID | W4-09 |
| Source files scanned | 2 (272 lines) |

## 1. Scope and map

### Purpose and ownership
Owns `packages/ax-code/src/telemetry` within AX Code CLI/Desktop architecture per PRD inventory.

### Source, tests, and artifacts

| Kind | Paths | Notes |
|------|-------|-------|
| Source | `packages/ax-code/src/telemetry/index.ts`, `packages/ax-code/src/telemetry/span.ts` | 2 files |
| Tests | `packages/ax-code/test/telemetry/index.test.ts` | 1 matched |
...
Static signals: emptyCatch=1, todo=0, asAny=1
...
TODO density: 0. Residual empty-catch candidates: packages/ax-code/src/telemetry/span.ts:59. Not auto-accepted without reachability proof.

## 7. Test coverage map

| Risk path | Existing test | Gap |
|-----------|---------------|-----|
| Primary unit behavior | `packages/ax-code/test/telemetry/index.test.ts` | ok |
