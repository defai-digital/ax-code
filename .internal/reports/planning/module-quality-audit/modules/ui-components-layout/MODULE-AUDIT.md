...
| Source files scanned | 26 (10157 lines) |

## 1. Scope and map

### Purpose and ownership
Owns `desktop/packages/ui/src/components/layout` within AX Code CLI/Desktop architecture per PRD inventory.

### Source, tests, and artifacts

| Kind | Paths | Notes |
|------|-------|-------|
| Source | `desktop/packages/ui/src/components/layout/BottomTerminalDock.tsx`, `desktop/packages/ui/src/components/layout/ContextPanel-impl.tsx`, `desktop/packages/ui/src/components/layout/ContextPanel.tsx`, `desktop/packages/ui/src/components/layout/ContextSidebarTab.tsx`, `desktop/packages/ui/src/components/layout/DesktopSurfaceToggle.tsx`, `desktop/packages/ui/src/components/layout/Header.tsx`, `desktop/packages/ui/src/components/layout/MainLayout.tsx`, `desktop/packages/ui/src/components/layout/ProjectActionsButton.tsx`, `desktop/packages/ui/src/components/layout/ProjectEditDialog.tsx`, `desktop/packages/ui/src/components/layout/RightSidebar.tsx`, `desktop/packages/ui/src/components/layout/RightSidebarTabs.tsx`, `desktop/packages/ui/src/components/layout/Sidebar.tsx` | 26 files |
| Tests | `packages/ax-code/test/cli/tui/footer-layout.test.ts`, `packages/ax-code/test/cli/tui/session-layout.test.ts`, `desktop/packages/ui/src/components/chat/ChatContainer.test.ts`, `desktop/packages/ui/src/components/chat/CommandAutocomplete.test.ts`, `desktop/packages/ui/src/components/chat/FileAttachment.formatSize.test.ts`, `desktop/packages/ui/src/components/chat/MarkdownRendererImpl.test.ts`, `desktop/packages/ui/src/components/chat/PermissionCardTools.test.ts`, `desktop/packages/ui/src/components/chat/TimelineDialog.test.ts` | 25 matched |
| Prior art | `.internal/reports/reviews/2026-07-19-code-quality-stability-review.md` | linked |

### Public API
Scanned 26 source files for exports/routes/commands.
...
|-----------|---------------|-----|
| Primary unit behavior | `packages/ax-code/test/cli/tui/footer-layout.test.ts` | ok |
...
|------|------|------|----------|
| Reviewer | codex-sol | 2026-08-11 | Protocol complete; 26 files scanned |
