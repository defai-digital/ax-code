...
| Analysis fingerprint | `41a6ab372b9e7669` |
...
Unit `server-routes-tui` owns `packages/ax-code/src/server/routes/tui.ts`. Risk profile: network, api.
...
| Symbol | Kind | Notes |
|--------|------|-------|
| `TuiRoutes@packages/ax-code/src/server/routes/tui.ts:34` | public/internal | scanned |
...
Placement checked against ARCHITECTURE.md / PROJECT_BOUNDARIES.md for scope `packages/ax-code/src/server/routes/tui.ts`. Desktop boundary gate EXIT:0 at program exit.
...
|------------------|--------|----------|
| Static deep extract | ok | fingerprint `41a6ab372b9e7669` |
...
|------|------|------|----------|
| Reviewer | codex-sol | 2026-08-11 | Deep extract 1 files / 303 LOC / fp 41a6ab372b9e7669 |
