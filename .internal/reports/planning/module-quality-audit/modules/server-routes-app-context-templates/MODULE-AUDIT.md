...
| Analysis fingerprint | `38d4802df133a0b8` |
...
Unit `server-routes-app-context-templates` owns `packages/ax-code/src/server/routes/app-context-templates.ts`. Risk profile: network, api.
...
| Symbol | Kind | Notes |
|--------|------|-------|
| `contextTemplates@packages/ax-code/src/server/routes/app-context-templates.ts:8` | public/internal | scanned |
| `templateBody@packages/ax-code/src/server/routes/app-context-templates.ts:53` | public/internal | scanned |
...
Placement checked against ARCHITECTURE.md / PROJECT_BOUNDARIES.md for scope `packages/ax-code/src/server/routes/app-context-templates.ts`. Desktop boundary gate EXIT:0 at program exit.
...
|------------------|--------|----------|
| Static deep extract | ok | fingerprint `38d4802df133a0b8` |
...
|------|------|------|----------|
| Reviewer | codex-sol | 2026-08-11 | Deep extract 1 files / 118 LOC / fp 38d4802df133a0b8 |
