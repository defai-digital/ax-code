...
| Inventory ID | W5-10 |
| Source files scanned | 8 (1747 lines) |

## 1. Scope and map

### Purpose and ownership
Owns `packages/ax-code/src/acp` within AX Code CLI/Desktop architecture per PRD inventory.

### Source, tests, and artifacts

| Kind | Paths | Notes |
|------|-------|-------|
| Source | `packages/ax-code/src/acp/agent-adapter.ts`, `packages/ax-code/src/acp/agent.ts`, `packages/ax-code/src/acp/prompt.ts`, `packages/ax-code/src/acp/session-mode.ts`, `packages/ax-code/src/acp/session.ts`, `packages/ax-code/src/acp/types.ts`, `packages/ax-code/src/acp/usage.ts`, `packages/ax-code/src/acp/utils.ts` | 8 files |
| Tests | `packages/ax-code/test/acp/agent-adapter.test.ts`, `packages/ax-code/test/acp/agent-interface.test.ts`, `packages/ax-code/test/acp/agent-prompt.test.ts`, `packages/ax-code/test/acp/event-subscription.test.ts`, `packages/ax-code/test/acp/sdk-client-naming.test.ts`, `packages/ax-code/test/acp/session-list.test.ts`, `packages/ax-code/test/acp/todo-plan-entries.test.ts`, `packages/ax-code/test/cli/acp.test.ts` | 8 matched |
