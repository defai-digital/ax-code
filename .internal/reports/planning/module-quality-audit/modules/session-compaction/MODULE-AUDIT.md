...
| Analysis fingerprint | `4301d717bef38bca` |
...
Unit `session-compaction` owns `packages/ax-code/src/session (compaction)`. Risk profile: hot-path, correctness.
...
Placement checked against ARCHITECTURE.md / PROJECT_BOUNDARIES.md for scope `packages/ax-code/src/session (compaction)`. Desktop boundary gate EXIT:0 at program exit.
...
|------------------|--------|----------|
| Static deep extract | ok | fingerprint `4301d717bef38bca` |
...
|------|------|------|----------|
| Reviewer | codex-sol | 2026-08-11 | Deep extract 135 files / 26283 LOC / fp 4301d717bef38bca |
