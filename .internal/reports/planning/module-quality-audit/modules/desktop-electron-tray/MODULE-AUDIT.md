...
| Analysis fingerprint | `813be309ef309577` |
...
Unit `desktop-electron-tray` owns `desktop/packages/electron/src/tray.mjs`. Risk profile: desktop.
...
Placement checked against ARCHITECTURE.md / PROJECT_BOUNDARIES.md for scope `desktop/packages/electron/src/tray.mjs`. Desktop boundary gate EXIT:0 at program exit.
...
|------------------|--------|----------|
| Static deep extract | ok | fingerprint `813be309ef309577` |
...
|------|------|------|----------|
| Reviewer | ax-code-glm | 2026-08-11 | Deep extract 1 files / 340 LOC / fp 813be309ef309577 |
