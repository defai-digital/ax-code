...
| Inventory ID | W7-03 |
| Source files scanned | 1 (340 lines) |

## 1. Scope and map

### Purpose and ownership
Owns `desktop/packages/electron/src/tray.mjs` within AX Code CLI/Desktop architecture per PRD inventory.

### Source, tests, and artifacts

| Kind | Paths | Notes |
|------|-------|-------|
| Source | `desktop/packages/electron/src/tray.mjs` | 1 files |
