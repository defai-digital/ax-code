...
| Inventory ID | W7-09 |
| Source files scanned | 3 (2335 lines) |

## 1. Scope and map

### Purpose and ownership
Owns `desktop/packages/web/server/lib/fs` within AX Code CLI/Desktop architecture per PRD inventory.

### Source, tests, and artifacts

| Kind | Paths | Notes |
|------|-------|-------|
| Source | `desktop/packages/web/server/lib/fs/routes.js`, `desktop/packages/web/server/lib/fs/routes.test.js`, `desktop/packages/web/server/lib/fs/search.js` | 3 files |
...
TODO density: 0. Residual empty-catch candidates: desktop/packages/web/server/lib/fs/routes.js:379; desktop/packages/web/server/lib/fs/routes.js:1447; desktop/packages/web/server/lib/fs/routes.js:1449. Not auto-accepted without reachability proof.
