...
| Inventory ID | W3-12 |
| Source files scanned | 1 (88 lines) |

## 1. Scope and map

### Purpose and ownership
Owns `packages/ax-code/src/native` within AX Code CLI/Desktop architecture per PRD inventory.

### Source, tests, and artifacts

| Kind | Paths | Notes |
|------|-------|-------|
| Source | `packages/ax-code/src/native/addon.ts` | 1 files |
| Tests | `packages/ax-code/test/code-intelligence/native-store.test.ts`, `packages/ax-code/test/code-intelligence/query-native-dispatch.test.ts`, `packages/ax-code/test/debug-engine/native-scan.test.ts`, `packages/ax-code/test/native/addon.test.ts`, `packages/ax-code/test/perf/native.test.ts`, `packages/ax-code/test/util/native-json.test.ts`, `packages/ax-code/test/visual/native.test.ts` | 7 matched |
...
|-----------|---------------|-----|
| Primary unit behavior | `packages/ax-code/test/code-intelligence/native-store.test.ts` | ok |
