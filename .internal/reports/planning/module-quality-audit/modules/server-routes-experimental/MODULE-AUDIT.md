...
| Analysis fingerprint | `c4b3227c09f01e46` |
...
Unit `server-routes-experimental` owns `packages/ax-code/src/server/routes/experimental.ts`. Risk profile: network, api.
...
| Symbol | Kind | Notes |
|--------|------|-------|
| `ExperimentalRoutes@packages/ax-code/src/server/routes/experimental.ts:26` | public/internal | scanned |
...
Placement checked against ARCHITECTURE.md / PROJECT_BOUNDARIES.md for scope `packages/ax-code/src/server/routes/experimental.ts`. Desktop boundary gate EXIT:0 at program exit.
...
|------------------|--------|----------|
| Static deep extract | ok | fingerprint `c4b3227c09f01e46` |
...
|------|------|------|----------|
| Reviewer | codex-sol | 2026-08-11 | Deep extract 1 files / 281 LOC / fp c4b3227c09f01e46 |
