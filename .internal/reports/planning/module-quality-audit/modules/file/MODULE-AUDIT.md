...
| Inventory ID | W3-06 |
| Source files scanned | 8 (2030 lines) |

## 1. Scope and map

### Purpose and ownership
Owns `packages/ax-code/src/file` within AX Code CLI/Desktop architecture per PRD inventory.

### Source, tests, and artifacts

| Kind | Paths | Notes |
|------|-------|-------|
| Source | `packages/ax-code/src/file/ignore-patterns.json`, `packages/ax-code/src/file/ignore.ts`, `packages/ax-code/src/file/index.ts`, `packages/ax-code/src/file/protected.ts`, `packages/ax-code/src/file/ripgrep.ts`, `packages/ax-code/src/file/status.ts`, `packages/ax-code/src/file/time.ts`, `packages/ax-code/src/file/watcher.ts` | 8 files |
| Tests | `packages/ax-code/test/cli/tui/prompt-filepath.test.ts`, `packages/ax-code/test/cli/tui/spinner-profile.test.ts`, `packages/ax-code/test/code-intelligence/lockfile.test.ts`, `packages/ax-code/test/command/file-command.test.ts`, `packages/ax-code/test/file/fsmonitor.test.ts`, `packages/ax-code/test/file/ignore-drift.test.ts`, `packages/ax-code/test/file/ignore.test.ts`, `packages/ax-code/test/file/index.test.ts` | 25 matched |
...
TODO density: 0. Residual empty-catch candidates: packages/ax-code/src/file/ripgrep.ts:275. Not auto-accepted without reachability proof.

## 7. Test coverage map

| Risk path | Existing test | Gap |
|-----------|---------------|-----|
| Primary unit behavior | `packages/ax-code/test/cli/tui/prompt-filepath.test.ts` | ok |
...
|------|------|------|----------|
| Reviewer | ax-code-glm | 2026-08-11 | Protocol complete; 8 files scanned |
