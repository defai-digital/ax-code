...
| Inventory ID | W5-17 |
| Source files scanned | 1 (394 lines) |

## 1. Scope and map

### Purpose and ownership
Owns `packages/ax-code/src/debug` within AX Code CLI/Desktop architecture per PRD inventory.

### Source, tests, and artifacts

| Kind | Paths | Notes |
|------|-------|-------|
| Source | `packages/ax-code/src/debug/diagnostic-log.ts` | 1 files |
