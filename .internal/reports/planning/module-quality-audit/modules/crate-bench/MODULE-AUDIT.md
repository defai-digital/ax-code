...
| Analysis fingerprint | `4d4e3424ce1fff57` |
...
Unit `crate-bench` owns `crates/ax-code-bench`. Risk profile: quality.
...
Placement checked against ARCHITECTURE.md / PROJECT_BOUNDARIES.md for scope `crates/ax-code-bench`. Desktop boundary gate EXIT:0 at program exit.
...
|-----------|---------------|-----|
| Primary behaviors | `packages/ax-code/test/script/bench-scripts.test.ts` | matched |
...
|------------------|--------|----------|
| Static deep extract | ok | fingerprint `4d4e3424ce1fff57` |
...
|------|------|------|----------|
| Reviewer | ax-code-glm | 2026-08-11 | Deep extract 3 files / 748 LOC / fp 4d4e3424ce1fff57 |
