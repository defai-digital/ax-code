...
| Inventory ID | W9-21 |
| Source files scanned | 3 (748 lines) |

## 1. Scope and map

### Purpose and ownership
Owns `crates/ax-code-bench` within AX Code CLI/Desktop architecture per PRD inventory.

### Source, tests, and artifacts

| Kind | Paths | Notes |
|------|-------|-------|
| Source | `crates/ax-code-bench/src/bench_diff.rs`, `crates/ax-code-bench/src/bench_fs.rs`, `crates/ax-code-bench/src/bench_index.rs` | 3 files |
| Tests | `packages/ax-code/test/script/bench-scripts.test.ts` | 1 matched |
...
|-----------|---------------|-----|
| Primary unit behavior | `packages/ax-code/test/script/bench-scripts.test.ts` | ok |
