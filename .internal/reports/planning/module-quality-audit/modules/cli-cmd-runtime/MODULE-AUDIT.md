...
| Inventory ID | W6-07 |
| Source files scanned | 3 (125 lines) |

## 1. Scope and map

### Purpose and ownership
Owns `packages/ax-code/src/cli/cmd/runtime` within AX Code CLI/Desktop architecture per PRD inventory.

### Source, tests, and artifacts

| Kind | Paths | Notes |
|------|-------|-------|
| Source | `packages/ax-code/src/cli/cmd/runtime/restart.ts`, `packages/ax-code/src/cli/cmd/runtime/serve.ts`, `packages/ax-code/src/cli/cmd/runtime/workspace-serve.ts` | 3 files |
