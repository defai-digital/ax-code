...
Owns `packages/ax-code/src/cli/cmd/account` within AX Code CLI/Desktop architecture per PRD inventory.
...
| Tests | `packages/ax-code/test/account/repo.test.ts`, `packages/ax-code/test/account/service.test.ts`, `packages/ax-code/test/account/token-decode.test.ts`, `packages/ax-code/test/acp/sdk-client-naming.test.ts`, `packages/ax-code/test/cli/account.test.ts`, `packages/ax-code/test/cli/acp.test.ts`, `packages/ax-code/test/cli/agent.test.ts`, `packages/ax-code/test/cli/audit.test.ts` | 25 matched |
