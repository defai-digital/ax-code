...
| Source files scanned | 7 (895 lines) |

## 1. Scope and map

### Purpose and ownership
Owns `desktop/packages/ui/src/components/comments` within AX Code CLI/Desktop architecture per PRD inventory.

### Source, tests, and artifacts

| Kind | Paths | Notes |
|------|-------|-------|
| Source | `desktop/packages/ui/src/components/comments/CodeMirrorCommentWidgets.tsx`, `desktop/packages/ui/src/components/comments/InlineCommentCard.tsx`, `desktop/packages/ui/src/components/comments/InlineCommentInput.tsx`, `desktop/packages/ui/src/components/comments/PierreDiffCommentOverlays.tsx`, `desktop/packages/ui/src/components/comments/PierreDiffCommentUtils.ts`, `desktop/packages/ui/src/components/comments/index.ts`, `desktop/packages/ui/src/components/comments/useInlineCommentController.ts` | 7 files |
