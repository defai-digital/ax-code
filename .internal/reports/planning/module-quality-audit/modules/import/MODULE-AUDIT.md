...
| Inventory ID | W3-14 |
| Source files scanned | 1 (163 lines) |

## 1. Scope and map

### Purpose and ownership
Owns `packages/ax-code/src/import` within AX Code CLI/Desktop architecture per PRD inventory.

### Source, tests, and artifacts

| Kind | Paths | Notes |
|------|-------|-------|
| Source | `packages/ax-code/src/import/compatibility.ts` | 1 files |
| Tests | `packages/ax-code/test/cli/import.test.ts`, `packages/ax-code/test/code-intelligence/import-edges.test.ts`, `packages/ax-code/test/import-compatibility.test.ts` | 3 matched |
...
|-----------|---------------|-----|
| Primary unit behavior | `packages/ax-code/test/cli/import.test.ts` | ok |
