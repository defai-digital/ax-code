...
| Inventory ID | W7-06 |
| Source files scanned | 84 (20115 lines) |

## 1. Scope and map

### Purpose and ownership
Owns `desktop/packages/web/server/lib/ax-code` within AX Code CLI/Desktop architecture per PRD inventory.

### Source, tests, and artifacts

| Kind | Paths | Notes |
|------|-------|-------|
| Source | `desktop/packages/web/server/lib/ax-code/agents.js`, `desktop/packages/web/server/lib/ax-code/auth-state-runtime.js`, `desktop/packages/web/server/lib/ax-code/auth-state-runtime.test.js`, `desktop/packages/web/server/lib/ax-code/auth.js`, `desktop/packages/web/server/lib/ax-code/ax-code-resolution-runtime.js`, `desktop/packages/web/server/lib/ax-code/background-reload.js`, `desktop/packages/web/server/lib/ax-code/background-reload.test.js`, `desktop/packages/web/server/lib/ax-code/bootstrap-runtime.js`, `desktop/packages/web/server/lib/ax-code/cli-entry-runtime.js`, `desktop/packages/web/server/lib/ax-code/cli-options.js`, `desktop/packages/web/server/lib/ax-code/cli-options.test.js`, `desktop/packages/web/server/lib/ax-code/commands.js` | 84 files |
| Tests | `packages/ax-code/test/account/repo.test.ts`, `packages/ax-code/test/account/service.test.ts`, `packages/ax-code/test/account/token-decode.test.ts`, `packages/ax-code/test/acp/agent-adapter.test.ts`, `packages/ax-code/test/acp/agent-interface.test.ts`, `packages/ax-code/test/acp/agent-prompt.test.ts`, `packages/ax-code/test/acp/event-subscription.test.ts`, `packages/ax-code/test/acp/sdk-client-naming.test.ts` | 25 matched |
| Prior art | `.internal/reports/reviews/2026-07-19-code-quality-stability-review.md` | linked |

### Public API
Scanned 84 source files for exports/routes/commands.
...
Static signals: emptyCatch=36, todo=0, asAny=0
...
TODO density: 0. Residual empty-catch candidates: desktop/packages/web/server/lib/ax-code/core-routes.js:73; desktop/packages/web/server/lib/ax-code/core-routes.js:174; desktop/packages/web/server/lib/ax-code/core-routes.js:181; desktop/packages/web/server/lib/ax-code/core-routes.js:268; desktop/packages/web/server/lib/ax-code/core-routes.js:275. Not auto-accepted without reachability proof.

## 7. Test coverage map

| Risk path | Existing test | Gap |
|-----------|---------------|-----|
| Primary unit behavior | `packages/ax-code/test/account/repo.test.ts` | ok |
...
|------|------|------|----------|
| Reviewer | ax-code-glm | 2026-08-11 | Protocol complete; 84 files scanned |
