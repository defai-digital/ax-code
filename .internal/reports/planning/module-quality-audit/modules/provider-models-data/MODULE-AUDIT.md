...
| Analysis fingerprint | `78d004a21f80a702` |
...
Unit `provider-models-data` owns `packages/ax-code/src/provider (models-snapshot/model data)`. Risk profile: correctness.
...
Placement checked against ARCHITECTURE.md / PROJECT_BOUNDARIES.md for scope `packages/ax-code/src/provider (models-snapshot/model data)`. Desktop boundary gate EXIT:0 at program exit.
...
|------------------|--------|----------|
| Static deep extract | ok | fingerprint `78d004a21f80a702` |
...
|------|------|------|----------|
| Reviewer | ax-code-glm | 2026-08-11 | Deep extract 52 files / 11481 LOC / fp 78d004a21f80a702 |
