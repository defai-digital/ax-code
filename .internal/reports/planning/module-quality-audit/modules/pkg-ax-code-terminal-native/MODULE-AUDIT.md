# MODULE-AUDIT: pkg-ax-code-terminal-native

| Field | Value |
|-------|-------|
| Unit slug | `pkg-ax-code-terminal-native` |
| Scope | `packages/ax-code-terminal-native` |
...
| Inventory ID | W9-13 |
| Source files scanned | 1 (31 lines) |

## 1. Scope and map

### Purpose and ownership
Owns `packages/ax-code-terminal-native` within AX Code CLI/Desktop architecture per PRD inventory.

### Source, tests, and artifacts

| Kind | Paths | Notes |
|------|-------|-------|
| Source | `packages/ax-code-terminal-native/package.json` | 1 files |
