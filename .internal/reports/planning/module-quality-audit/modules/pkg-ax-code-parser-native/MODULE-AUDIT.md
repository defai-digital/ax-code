# MODULE-AUDIT: pkg-ax-code-parser-native

| Field | Value |
|-------|-------|
| Unit slug | `pkg-ax-code-parser-native` |
| Scope | `packages/ax-code-parser-native` |
...
| Inventory ID | W9-12 |
| Source files scanned | 2 (41 lines) |

## 1. Scope and map

### Purpose and ownership
Owns `packages/ax-code-parser-native` within AX Code CLI/Desktop architecture per PRD inventory.

### Source, tests, and artifacts

| Kind | Paths | Notes |
|------|-------|-------|
| Source | `packages/ax-code-parser-native/index.d.ts`, `packages/ax-code-parser-native/package.json` | 2 files |
