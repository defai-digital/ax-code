...
| Inventory ID | W1-10 |
| Source files scanned | 2 (446 lines) |

## 1. Scope and map

### Purpose and ownership
Owns `packages/ax-code/src/installation` within AX Code CLI/Desktop architecture per PRD inventory.

### Source, tests, and artifacts

| Kind | Paths | Notes |
|------|-------|-------|
| Source | `packages/ax-code/src/installation/index.ts`, `packages/ax-code/src/installation/runtime-mode.ts` | 2 files |
| Tests | `packages/ax-code/test/installation/installation.test.ts`, `packages/ax-code/test/installation/runtime-mode.test.ts` | 2 matched |
...
|-----------|---------------|-----|
| Primary unit behavior | `packages/ax-code/test/installation/installation.test.ts` | ok |
