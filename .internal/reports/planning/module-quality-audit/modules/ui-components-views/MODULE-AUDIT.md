...
| Source files scanned | 76 (23503 lines) |

## 1. Scope and map

### Purpose and ownership
Owns `desktop/packages/ui/src/components/views` within AX Code CLI/Desktop architecture per PRD inventory.

### Source, tests, and artifacts

| Kind | Paths | Notes |
|------|-------|-------|
| Source | `desktop/packages/ui/src/components/views/ChatView.tsx`, `desktop/packages/ui/src/components/views/DiffCommentSummaryBar.tsx`, `desktop/packages/ui/src/components/views/DiffHunkReviewList.tsx`, `desktop/packages/ui/src/components/views/DiffView.tsx`, `desktop/packages/ui/src/components/views/FilesView-impl.tsx`, `desktop/packages/ui/src/components/views/FilesView-paths.test.ts`, `desktop/packages/ui/src/components/views/FilesView.tsx`, `desktop/packages/ui/src/components/views/GitView-impl.tsx`, `desktop/packages/ui/src/components/views/GitView.tsx`, `desktop/packages/ui/src/components/views/GoToLineDialog.tsx`, `desktop/packages/ui/src/components/views/MultiRunWindow.tsx`, `desktop/packages/ui/src/components/views/PierreDiffViewer.tsx` | 76 files |
...
### Public API
Scanned 76 source files for exports/routes/commands.
...
|------|------|------|----------|
| Reviewer | codex-sol | 2026-08-11 | Protocol complete; 76 files scanned |
