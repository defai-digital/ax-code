...
| Inventory ID | W9-18 |
| Source files scanned | 2 (908 lines) |

## 1. Scope and map

### Purpose and ownership
Owns `crates/ax-code-parser` within AX Code CLI/Desktop architecture per PRD inventory.

### Source, tests, and artifacts

| Kind | Paths | Notes |
|------|-------|-------|
| Source | `crates/ax-code-parser/build.rs`, `crates/ax-code-parser/src/lib.rs` | 2 files |
| Tests | `packages/ax-code/test/provider/cli/parser.test.ts` | 1 matched |
...
|-----------|---------------|-----|
| Primary unit behavior | `packages/ax-code/test/provider/cli/parser.test.ts` | ok |
