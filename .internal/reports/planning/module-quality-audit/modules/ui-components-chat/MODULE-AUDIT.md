...
| Source files scanned | 158 (39955 lines) |

## 1. Scope and map

### Purpose and ownership
Owns `desktop/packages/ui/src/components/chat` within AX Code CLI/Desktop architecture per PRD inventory.

### Source, tests, and artifacts

| Kind | Paths | Notes |
|------|-------|-------|
| Source | `desktop/packages/ui/src/components/chat/ActivityBreadcrumb.tsx`, `desktop/packages/ui/src/components/chat/AllowPatternBuilder.tsx`, `desktop/packages/ui/src/components/chat/ChangedFilesList.tsx`, `desktop/packages/ui/src/components/chat/ChatContainer.test.ts`, `desktop/packages/ui/src/components/chat/ChatContainer.tsx`, `desktop/packages/ui/src/components/chat/ChatEmptyState.tsx`, `desktop/packages/ui/src/components/chat/ChatErrorBoundary.test.tsx`, `desktop/packages/ui/src/components/chat/ChatErrorBoundary.tsx`, `desktop/packages/ui/src/components/chat/ChatInput-impl.tsx`, `desktop/packages/ui/src/components/chat/ChatInput.tsx`, `desktop/packages/ui/src/components/chat/ChatMessage.tsx`, `desktop/packages/ui/src/components/chat/ChatSurfaceContext.tsx` | 158 files |
| Tests | `desktop/packages/electron/src/mini-chat-tray-action.test.mjs`, `desktop/packages/ui/src/components/chat/ChatContainer.test.ts`, `desktop/packages/ui/src/components/chat/CommandAutocomplete.test.ts`, `desktop/packages/ui/src/components/chat/FileAttachment.formatSize.test.ts`, `desktop/packages/ui/src/components/chat/MarkdownRendererImpl.test.ts`, `desktop/packages/ui/src/components/chat/PermissionCardTools.test.ts`, `desktop/packages/ui/src/components/chat/TimelineDialog.test.ts`, `desktop/packages/ui/src/components/chat/__tests__/attachmentCitations.test.ts` | 25 matched |
| Prior art | `.internal/reports/reviews/2026-07-19-code-quality-stability-review.md` | linked |

### Public API
Scanned 158 source files for exports/routes/commands.
...
Static signals: emptyCatch=0, todo=1, asAny=0
...
TODO density: 1. Residual empty-catch candidates: none. Not auto-accepted without reachability proof.

## 7. Test coverage map

| Risk path | Existing test | Gap |
|-----------|---------------|-----|
| Primary unit behavior | `desktop/packages/electron/src/mini-chat-tray-action.test.mjs` | ok |
...
|------|------|------|----------|
| Reviewer | codex-sol | 2026-08-11 | Protocol complete; 158 files scanned |
