...
| Analysis fingerprint | `7bb9657004772cb4` |
...
Unit `server-routes-question` owns `packages/ax-code/src/server/routes/question.ts`. Risk profile: network, api.
...
| Symbol | Kind | Notes |
|--------|------|-------|
| `QuestionRoutes@packages/ax-code/src/server/routes/question.ts:11` | public/internal | scanned |
...
Placement checked against ARCHITECTURE.md / PROJECT_BOUNDARIES.md for scope `packages/ax-code/src/server/routes/question.ts`. Desktop boundary gate EXIT:0 at program exit.
...
|------------------|--------|----------|
| Static deep extract | ok | fingerprint `7bb9657004772cb4` |
...
|------|------|------|----------|
| Reviewer | codex-sol | 2026-08-11 | Deep extract 1 files / 158 LOC / fp 7bb9657004772cb4 |
