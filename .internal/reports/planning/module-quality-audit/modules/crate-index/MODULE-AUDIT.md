...
| Inventory ID | W9-15 |
| Source files scanned | 13 (2432 lines) |

## 1. Scope and map

### Purpose and ownership
Owns `crates/ax-code-index` within AX Code CLI/Desktop architecture per PRD inventory.

### Source, tests, and artifacts

| Kind | Paths | Notes |
|------|-------|-------|
| Source | `crates/ax-code-index/build.rs`, `crates/ax-code-index/examples/bench.rs`, `crates/ax-code-index/src/cursor.rs`, `crates/ax-code-index/src/edge.rs`, `crates/ax-code-index/src/file.rs`, `crates/ax-code-index/src/hasher.rs`, `crates/ax-code-index/src/id.rs`, `crates/ax-code-index/src/interval_tree.rs`, `crates/ax-code-index/src/lib.rs`, `crates/ax-code-index/src/lock.rs`, `crates/ax-code-index/src/node.rs`, `crates/ax-code-index/src/schema.rs` | 13 files |
| Tests | `packages/ax-code/test/cli/index-graph.test.ts`, `packages/ax-code/test/cli/tui/session-sidebar-index.test.ts`, `packages/ax-code/test/code-intelligence/auto-index.test.ts`, `packages/ax-code/test/dispatch/index.test.ts`, `packages/ax-code/test/file/index.test.ts`, `packages/ax-code/test/lsp/index.test.ts`, `packages/ax-code/test/planner/index.test.ts`, `packages/ax-code/test/quality/dre-graph-index-page.test.ts` | 10 matched |
...
|-----------|---------------|-----|
| Primary unit behavior | `packages/ax-code/test/cli/index-graph.test.ts` | ok |
...
|------|------|------|----------|
| Reviewer | ax-code-glm | 2026-08-11 | Protocol complete; 13 files scanned |
