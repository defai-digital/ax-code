...
| Analysis fingerprint | `6601f76167b1c782` |
...
Unit `provider-auth-caps` owns `packages/ax-code/src/provider (auth/capabilities)`. Risk profile: security.
...
Placement checked against ARCHITECTURE.md / PROJECT_BOUNDARIES.md for scope `packages/ax-code/src/provider (auth/capabilities)`. Desktop boundary gate EXIT:0 at program exit.
...
|------------------|--------|----------|
| Static deep extract | ok | fingerprint `6601f76167b1c782` |
...
|------|------|------|----------|
| Reviewer | ax-code-glm | 2026-08-11 | Deep extract 52 files / 11481 LOC / fp 6601f76167b1c782 |
