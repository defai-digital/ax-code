...
| Inventory ID | W5-19 |
| Source files scanned | 3 (250 lines) |

## 1. Scope and map

### Purpose and ownership
Owns `packages/ax-code/src/wiki` within AX Code CLI/Desktop architecture per PRD inventory.

### Source, tests, and artifacts

| Kind | Paths | Notes |
|------|-------|-------|
| Source | `packages/ax-code/src/wiki/config.ts`, `packages/ax-code/src/wiki/index.ts`, `packages/ax-code/src/wiki/native.ts` | 3 files |
