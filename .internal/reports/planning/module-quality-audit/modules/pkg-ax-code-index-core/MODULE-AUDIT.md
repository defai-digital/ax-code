...
| Inventory ID | W9-09 |
| Source files scanned | 2 (143 lines) |

## 1. Scope and map

### Purpose and ownership
Owns `packages/ax-code-index-core` within AX Code CLI/Desktop architecture per PRD inventory.

### Source, tests, and artifacts

| Kind | Paths | Notes |
|------|-------|-------|
| Source | `packages/ax-code-index-core/index.d.ts`, `packages/ax-code-index-core/package.json` | 2 files |
