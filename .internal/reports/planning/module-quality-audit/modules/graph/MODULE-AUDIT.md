...
| Inventory ID | W5-08 |
| Source files scanned | 2 (1032 lines) |

## 1. Scope and map

### Purpose and ownership
Owns `packages/ax-code/src/graph` within AX Code CLI/Desktop architecture per PRD inventory.

### Source, tests, and artifacts

| Kind | Paths | Notes |
|------|-------|-------|
| Source | `packages/ax-code/src/graph/format.ts`, `packages/ax-code/src/graph/index.ts` | 2 files |
| Tests | `packages/ax-code/test/cli/index-graph.test.ts`, `packages/ax-code/test/code-intelligence/graph-context.test.ts`, `packages/ax-code/test/code-intelligence/graph-envelope.test.ts`, `packages/ax-code/test/code-intelligence/graph-highlights.test.ts`, `packages/ax-code/test/graph/execution-graph.test.ts`, `packages/ax-code/test/quality/dre-graph-activity-section.test.ts`, `packages/ax-code/test/quality/dre-graph-activity.test.ts`, `packages/ax-code/test/quality/dre-graph-assets.test.ts` | 24 matched |
