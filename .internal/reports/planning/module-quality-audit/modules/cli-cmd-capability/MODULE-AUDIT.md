# MODULE-AUDIT: cli-cmd-capability

| Field | Value |
|-------|-------|
| Unit slug | `cli-cmd-capability` |
| Scope | `packages/ax-code/src/cli/cmd/capability` |
...
Owns `packages/ax-code/src/cli/cmd/capability` within AX Code CLI/Desktop architecture per PRD inventory.
...
| Tests | `packages/ax-code/test/acp/sdk-client-naming.test.ts`, `packages/ax-code/test/capability/capability.test.ts`, `packages/ax-code/test/cli/account.test.ts`, `packages/ax-code/test/cli/acp.test.ts`, `packages/ax-code/test/cli/agent.test.ts`, `packages/ax-code/test/cli/audit.test.ts`, `packages/ax-code/test/cli/boot.test.ts`, `packages/ax-code/test/cli/bootstrap/windows-console.test.ts` | 25 matched |
