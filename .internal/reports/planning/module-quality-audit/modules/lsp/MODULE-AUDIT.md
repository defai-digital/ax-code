...
| Inventory ID | W5-06 |
| Source files scanned | 34 (6329 lines) |

## 1. Scope and map

### Purpose and ownership
Owns `packages/ax-code/src/lsp` within AX Code CLI/Desktop architecture per PRD inventory.

### Source, tests, and artifacts

| Kind | Paths | Notes |
|------|-------|-------|
| Source | `packages/ax-code/src/lsp/broken-server.ts`, `packages/ax-code/src/lsp/cache-probe.ts`, `packages/ax-code/src/lsp/cache.ts`, `packages/ax-code/src/lsp/client-notify.ts`, `packages/ax-code/src/lsp/client.ts`, `packages/ax-code/src/lsp/diagnostics.ts`, `packages/ax-code/src/lsp/document-symbol.ts`, `packages/ax-code/src/lsp/envelope-runner.ts`, `packages/ax-code/src/lsp/envelope.ts`, `packages/ax-code/src/lsp/index-impl.ts`, `packages/ax-code/src/lsp/index.ts`, `packages/ax-code/src/lsp/jdtls-data-dir.ts` | 34 files |
| Tests | `packages/ax-code/test/code-intelligence/lsp-cache.test.ts`, `packages/ax-code/test/debug-engine/prewarm-lsp.test.ts`, `packages/ax-code/test/lsp/cache-probe.test.ts`, `packages/ax-code/test/lsp/cache.test.ts`, `packages/ax-code/test/lsp/call-hierarchy.test.ts`, `packages/ax-code/test/lsp/client-cap.test.ts`, `packages/ax-code/test/lsp/client-notify.test.ts`, `packages/ax-code/test/lsp/client.test.ts` | 25 matched |
| Prior art | `.internal/reports/reviews/2026-07-19-code-quality-stability-review.md` | linked |

### Public API
Scanned 34 source files for exports/routes/commands.
...
Static signals: emptyCatch=0, todo=0, asAny=3
...
|-----------|---------------|-----|
| Primary unit behavior | `packages/ax-code/test/code-intelligence/lsp-cache.test.ts` | ok |
...
|------|------|------|----------|
| Reviewer | ax-code-glm | 2026-08-11 | Protocol complete; 34 files scanned |
