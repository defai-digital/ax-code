...
| Inventory ID | W9-06 |
| Source files scanned | 38 (4279 lines) |

## 1. Scope and map

### Purpose and ownership
Owns `packages/opentui-solid` within AX Code CLI/Desktop architecture per PRD inventory.

### Source, tests, and artifacts

| Kind | Paths | Notes |
|------|-------|-------|
| Source | `packages/opentui-solid/components.d.ts`, `packages/opentui-solid/components.js`, `packages/opentui-solid/index.bun.js`, `packages/opentui-solid/index.d.ts`, `packages/opentui-solid/index.js`, `packages/opentui-solid/jsx-dev-runtime.d.ts`, `packages/opentui-solid/jsx-dev-runtime.js`, `packages/opentui-solid/jsx-runtime.d.ts`, `packages/opentui-solid/jsx-runtime.js`, `packages/opentui-solid/package.json`, `packages/opentui-solid/scripts/preload.js`, `packages/opentui-solid/scripts/preload.node.js` | 38 files |
| Tests | `packages/ax-code/test/cli/tui/opentui-ffi-coordinate-guard.test.ts`, `packages/ax-code/test/cli/tui/opentui-ffi-pointer-pin.test.ts`, `packages/ax-code/test/cli/tui/opentui-spinner.test.ts`, `packages/ax-code/test/script/check-no-effect-solid-in-v4.test.ts`, `packages/ax-code/test/script/esbuild-solid-plugin.test.ts`, `packages/ax-code/test/script/opentui-package-integrity.test.ts` | 6 matched |
| Prior art | `.internal/reports/reviews/2026-07-19-code-quality-stability-review.md` | linked |

### Public API
Scanned 38 source files for exports/routes/commands.
...
Static signals: emptyCatch=2, todo=0, asAny=0
...
TODO density: 0. Residual empty-catch candidates: packages/opentui-solid/index.bun.js:959; packages/opentui-solid/index.js:982. Not auto-accepted without reachability proof.
...
|------|------|------|----------|
| Reviewer | ax-code-glm | 2026-08-11 | Protocol complete; 38 files scanned |
