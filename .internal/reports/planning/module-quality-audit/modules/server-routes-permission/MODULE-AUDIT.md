...
| Analysis fingerprint | `6519b2bcc43b9b93` |
...
Unit `server-routes-permission` owns `packages/ax-code/src/server/routes/permission.ts`. Risk profile: network, api.
...
| Symbol | Kind | Notes |
|--------|------|-------|
| `PermissionRoutes@packages/ax-code/src/server/routes/permission.ts:10` | public/internal | scanned |
...
Placement checked against ARCHITECTURE.md / PROJECT_BOUNDARIES.md for scope `packages/ax-code/src/server/routes/permission.ts`. Desktop boundary gate EXIT:0 at program exit.
...
|------------------|--------|----------|
| Static deep extract | ok | fingerprint `6519b2bcc43b9b93` |
...
|------|------|------|----------|
| Reviewer | codex-sol | 2026-08-11 | Deep extract 1 files / 73 LOC / fp 6519b2bcc43b9b93 |
