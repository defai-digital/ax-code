...
| Analysis fingerprint | `9cde1b0597a248da` |
...
Unit `desktop-web-desktop` owns `desktop/packages/web/server/lib/desktop`. Risk profile: desktop.
...
| Symbol | Kind | Notes |
|--------|------|-------|
| `createStartupDiagnosticsRuntime@desktop/packages/web/server/lib/desktop/startup-diagnostics.js:49` | public/internal | scanned |
...
- secret desktop/packages/web/server/lib/desktop/startup-diagnostics.js:4
- secret desktop/packages/web/server/lib/desktop/startup-diagnostics.test.js:16
- secret desktop/packages/web/server/lib/desktop/startup-diagnostics.test.js:29
...
### Path notes
- Files scanned: 2; total LOC: 219
- Empty catch residual: desktop/packages/web/server/lib/desktop/startup-diagnostics.js:73
- TODOs: none
...
Placement checked against ARCHITECTURE.md / PROJECT_BOUNDARIES.md for scope `desktop/packages/web/server/lib/desktop`. Desktop boundary gate EXIT:0 at program exit.
...
|------------------|--------|----------|
| Static deep extract | ok | fingerprint `9cde1b0597a248da` |
...
|------|------|------|----------|
| Reviewer | ax-code-glm | 2026-08-11 | Deep extract 2 files / 219 LOC / fp 9cde1b0597a248da |
