...
| Inventory ID | W7-07 |
| Source files scanned | 2 (219 lines) |

## 1. Scope and map

### Purpose and ownership
Owns `desktop/packages/web/server/lib/desktop` within AX Code CLI/Desktop architecture per PRD inventory.

### Source, tests, and artifacts

| Kind | Paths | Notes |
|------|-------|-------|
| Source | `desktop/packages/web/server/lib/desktop/startup-diagnostics.js`, `desktop/packages/web/server/lib/desktop/startup-diagnostics.test.js` | 2 files |
...
TODO density: 0. Residual empty-catch candidates: desktop/packages/web/server/lib/desktop/startup-diagnostics.js:73. Not auto-accepted without reachability proof.
