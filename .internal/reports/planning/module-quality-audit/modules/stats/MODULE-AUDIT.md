...
| Inventory ID | W4-08 |
| Source files scanned | 3 (147 lines) |

## 1. Scope and map

### Purpose and ownership
Owns `packages/ax-code/src/stats` within AX Code CLI/Desktop architecture per PRD inventory.

### Source, tests, and artifacts

| Kind | Paths | Notes |
|------|-------|-------|
| Source | `packages/ax-code/src/stats/breakdown.ts`, `packages/ax-code/src/stats/index.ts`, `packages/ax-code/src/stats/types.ts` | 3 files |
| Tests | `packages/ax-code/test/cli/stats.test.ts`, `packages/ax-code/test/stats/breakdown.test.ts` | 2 matched |
...
|-----------|---------------|-----|
| Primary unit behavior | `packages/ax-code/test/cli/stats.test.ts` | ok |
