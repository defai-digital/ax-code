...
| Analysis fingerprint | `4b386141b07b1506` |
...
Unit `server-routes-file` owns `packages/ax-code/src/server/routes/file.ts`. Risk profile: network, api.
...
| Symbol | Kind | Notes |
|--------|------|-------|
| `FileRoutes@packages/ax-code/src/server/routes/file.ts:17` | public/internal | scanned |
...
Placement checked against ARCHITECTURE.md / PROJECT_BOUNDARIES.md for scope `packages/ax-code/src/server/routes/file.ts`. Desktop boundary gate EXIT:0 at program exit.
...
|------------------|--------|----------|
| Static deep extract | ok | fingerprint `4b386141b07b1506` |
...
|------|------|------|----------|
| Reviewer | codex-sol | 2026-08-11 | Deep extract 1 files / 192 LOC / fp 4b386141b07b1506 |
