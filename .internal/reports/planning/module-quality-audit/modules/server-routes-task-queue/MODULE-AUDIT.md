...
| Analysis fingerprint | `e1823986a7dae8c3` |
...
Unit `server-routes-task-queue` owns `packages/ax-code/src/server/routes/task-queue.ts`. Risk profile: network, api.
...
| Symbol | Kind | Notes |
|--------|------|-------|
| `TaskQueueRoutes@packages/ax-code/src/server/routes/task-queue.ts:40` | public/internal | scanned |
...
Placement checked against ARCHITECTURE.md / PROJECT_BOUNDARIES.md for scope `packages/ax-code/src/server/routes/task-queue.ts`. Desktop boundary gate EXIT:0 at program exit.
...
|------------------|--------|----------|
| Static deep extract | ok | fingerprint `e1823986a7dae8c3` |
...
|------|------|------|----------|
| Reviewer | codex-sol | 2026-08-11 | Deep extract 1 files / 282 LOC / fp e1823986a7dae8c3 |
