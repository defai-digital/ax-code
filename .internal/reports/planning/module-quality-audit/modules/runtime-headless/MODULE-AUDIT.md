...
| Inventory ID | W2-03 |
| Source files scanned | 11 (1407 lines) |

## 1. Scope and map

### Purpose and ownership
Owns `packages/ax-code/src/runtime/headless` within AX Code CLI/Desktop architecture per PRD inventory.

### Source, tests, and artifacts

| Kind | Paths | Notes |
|------|-------|-------|
| Source | `packages/ax-code/src/runtime/headless/command.ts`, `packages/ax-code/src/runtime/headless/effects.ts`, `packages/ax-code/src/runtime/headless/event-log.ts`, `packages/ax-code/src/runtime/headless/event-sink-node.ts`, `packages/ax-code/src/runtime/headless/event-sink.ts`, `packages/ax-code/src/runtime/headless/event.ts`, `packages/ax-code/src/runtime/headless/index.ts`, `packages/ax-code/src/runtime/headless/projection.ts`, `packages/ax-code/src/runtime/headless/replay.ts`, `packages/ax-code/src/runtime/headless/runner.ts`, `packages/ax-code/src/runtime/headless/runtime.ts` | 11 files |
| Tests | `packages/ax-code/test/cli/runtime-restart.test.ts`, `packages/ax-code/test/cli/tui/headless-sync-boundary.test.ts`, `packages/ax-code/test/cli/tui/sync-runtime-adapter.test.ts`, `packages/ax-code/test/cli/tui/sync-runtime-probe.test.ts`, `packages/ax-code/test/cli/tui/sync-runtime-store.test.ts`, `packages/ax-code/test/cli/tui/sync-runtime-sync.test.ts`, `packages/ax-code/test/debug-engine/runtime-debug.test.ts`, `packages/ax-code/test/harness/agentic-runtime-eval.test.ts` | 25 matched |
...
|------|------|------|----------|
| Reviewer | codex-sol | 2026-08-11 | Protocol complete; 11 files scanned |
