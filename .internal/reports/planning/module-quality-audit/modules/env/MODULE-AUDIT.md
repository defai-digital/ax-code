...
| Inventory ID | W1-05 |
| Source files scanned | 1 (29 lines) |

## 1. Scope and map

### Purpose and ownership
Owns `packages/ax-code/src/env` within AX Code CLI/Desktop architecture per PRD inventory.

### Source, tests, and artifacts

| Kind | Paths | Notes |
|------|-------|-------|
| Source | `packages/ax-code/src/env/index.ts` | 1 files |
| Tests | `packages/ax-code/test/cli/tui/env.test.ts`, `packages/ax-code/test/code-intelligence/graph-envelope.test.ts`, `packages/ax-code/test/config/permission-env.test.ts`, `packages/ax-code/test/lsp/envelope-coverage.test.ts`, `packages/ax-code/test/lsp/envelope-freshness.test.ts`, `packages/ax-code/test/quality/verification-envelope-builder.test.ts`, `packages/ax-code/test/quality/verification-envelope.test.ts`, `packages/ax-code/test/runtime/shell-env.test.ts` | 12 matched |
...
|-----------|---------------|-----|
| Primary unit behavior | `packages/ax-code/test/cli/tui/env.test.ts` | ok |
