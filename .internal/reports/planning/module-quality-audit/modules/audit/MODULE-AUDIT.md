...
| Inventory ID | W1-07 |
| Source files scanned | 8 (920 lines) |

## 1. Scope and map

### Purpose and ownership
Owns `packages/ax-code/src/audit` within AX Code CLI/Desktop architecture per PRD inventory.

### Source, tests, and artifacts

| Kind | Paths | Notes |
|------|-------|-------|
| Source | `packages/ax-code/src/audit/export.ts`, `packages/ax-code/src/audit/id.ts`, `packages/ax-code/src/audit/index.ts`, `packages/ax-code/src/audit/json.ts`, `packages/ax-code/src/audit/query.ts`, `packages/ax-code/src/audit/report.ts`, `packages/ax-code/src/audit/schema.sql.ts`, `packages/ax-code/src/audit/semantic-call.ts` | 8 files |
| Tests | `packages/ax-code/test/audit/bugfix.test.ts`, `packages/ax-code/test/audit/json.test.ts`, `packages/ax-code/test/audit/report.test.ts`, `packages/ax-code/test/audit/semantic-call.test.ts`, `packages/ax-code/test/audit/siem.test.ts`, `packages/ax-code/test/cli/audit.test.ts`, `packages/ax-code/test/cli/tui/setinterval-audit.test.ts`, `packages/ax-code/test/quality/promotion-audit-manifest.test.ts` | 10 matched |
...
|-----------|---------------|-----|
| Primary unit behavior | `packages/ax-code/test/audit/bugfix.test.ts` | ok |
