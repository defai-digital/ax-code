...
| Inventory ID | W4-11 |
| Source files scanned | 2 (1193 lines) |

## 1. Scope and map

### Purpose and ownership
Owns `packages/ax-code/src/sdk` within AX Code CLI/Desktop architecture per PRD inventory.

### Source, tests, and artifacts

| Kind | Paths | Notes |
|------|-------|-------|
| Source | `packages/ax-code/src/sdk/programmatic-impl.ts`, `packages/ax-code/src/sdk/programmatic.ts` | 2 files |
