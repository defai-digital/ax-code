...
| Inventory ID | W5-09 |
| Source files scanned | 1 (227 lines) |

## 1. Scope and map

### Purpose and ownership
Owns `packages/ax-code/src/capability` within AX Code CLI/Desktop architecture per PRD inventory.

### Source, tests, and artifacts

| Kind | Paths | Notes |
|------|-------|-------|
| Source | `packages/ax-code/src/capability/index.ts` | 1 files |
| Tests | `packages/ax-code/test/capability/capability.test.ts`, `packages/ax-code/test/cli/capability.test.ts`, `packages/ax-code/test/cli/tui/capability-catalog.test.ts`, `packages/ax-code/test/server/capability.test.ts`, `packages/ax-code/test/visual/capability.test.ts` | 5 matched |
...
|-----------|---------------|-----|
| Primary unit behavior | `packages/ax-code/test/capability/capability.test.ts` | ok |
