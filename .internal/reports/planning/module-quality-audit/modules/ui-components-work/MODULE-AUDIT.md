...
| Analysis fingerprint | `90f3f95fe1b8c9c3` |
...
Unit `ui-components-work` owns `desktop/packages/ui/src/components/work`. Risk profile: desktop, ui.
...
| Symbol | Kind | Notes |
|--------|------|-------|
| `WorkHome@desktop/packages/ui/src/components/work/WorkHome.tsx:75` | public/internal | scanned |
...
Placement checked against ARCHITECTURE.md / PROJECT_BOUNDARIES.md for scope `desktop/packages/ui/src/components/work`. Desktop boundary gate EXIT:0 at program exit.
...
|------------------|--------|----------|
| Static deep extract | ok | fingerprint `90f3f95fe1b8c9c3` |
...
|------|------|------|----------|
| Reviewer | codex-sol | 2026-08-11 | Deep extract 1 files / 160 LOC / fp 90f3f95fe1b8c9c3 |
