...
| Inventory ID | W3-08 |
| Source files scanned | 2 (941 lines) |

## 1. Scope and map

### Purpose and ownership
Owns `packages/ax-code/src/worktree` within AX Code CLI/Desktop architecture per PRD inventory.

### Source, tests, and artifacts

| Kind | Paths | Notes |
|------|-------|-------|
| Source | `packages/ax-code/src/worktree/index-impl.ts`, `packages/ax-code/src/worktree/index.ts` | 2 files |
| Tests | `packages/ax-code/test/mode/worktree-policy.test.ts`, `packages/ax-code/test/project/worktree-remove.test.ts`, `packages/ax-code/test/worktree/worktree.test.ts`, `desktop/packages/ui/src/lib/worktrees/path.test.ts`, `desktop/packages/ui/src/lib/worktrees/worktreeStatus.test.ts`, `desktop/packages/ui/src/sync/session-worktree-contract.test.ts`, `desktop/packages/ui/src/sync/session-worktree-store.test.ts` | 7 matched |
...
|-----------|---------------|-----|
| Primary unit behavior | `packages/ax-code/test/mode/worktree-policy.test.ts` | ok |
