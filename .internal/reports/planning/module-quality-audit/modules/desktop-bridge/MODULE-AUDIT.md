...
| Inventory ID | W1-11 |
| Source files scanned | 1 (266 lines) |

## 1. Scope and map

### Purpose and ownership
Owns `packages/ax-code/src/desktop` within AX Code CLI/Desktop architecture per PRD inventory.

### Source, tests, and artifacts

| Kind | Paths | Notes |
|------|-------|-------|
| Source | `packages/ax-code/src/desktop/webui.ts` | 1 files |
