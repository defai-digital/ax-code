...
| Inventory ID | W8-05 |
| Source files scanned | 32 (4711 lines) |

## 1. Scope and map

### Purpose and ownership
Owns `desktop/packages/ui/src/hooks` within AX Code CLI/Desktop architecture per PRD inventory.

### Source, tests, and artifacts

| Kind | Paths | Notes |
|------|-------|-------|
| Source | `desktop/packages/ui/src/hooks/useAssistantStatus.ts`, `desktop/packages/ui/src/hooks/useAxCodeReadiness.ts`, `desktop/packages/ui/src/hooks/useChatAutoFollow.ts`, `desktop/packages/ui/src/hooks/useChatSearchDirectory.ts`, `desktop/packages/ui/src/hooks/useDebouncedValue.ts`, `desktop/packages/ui/src/hooks/useDetectedWorktreeRoot.ts`, `desktop/packages/ui/src/hooks/useEffectiveDirectory.ts`, `desktop/packages/ui/src/hooks/useFileSystemAccess.ts`, `desktop/packages/ui/src/hooks/useFontPreferences.ts`, `desktop/packages/ui/src/hooks/useIsTextTruncated.ts`, `desktop/packages/ui/src/hooks/useKeyboardShortcuts.ts`, `desktop/packages/ui/src/hooks/useMenuActions.ts` | 32 files |
| Tests | `packages/ax-code/test/hooks/lifecycle.test.ts`, `packages/ax-code/test/session/prompt-loop-result-stop-hooks.test.ts`, `desktop/packages/ui/src/components/session/sidebar/hooks/useProjectSessionSelection.test.ts`, `desktop/packages/ui/src/hooks/useQueuedMessageAutoSend.test.ts`, `desktop/packages/ui/src/hooks/useSessionBadgeState.test.ts`, `desktop/packages/ui/src/hooks/useWindowTitle.test.ts` | 6 matched |
| Prior art | `.internal/reports/reviews/2026-07-19-code-quality-stability-review.md` | linked |

### Public API
Scanned 32 source files for exports/routes/commands.
...
|-----------|---------------|-----|
| Primary unit behavior | `packages/ax-code/test/hooks/lifecycle.test.ts` | ok |
...
|------|------|------|----------|
| Reviewer | codex-sol | 2026-08-11 | Protocol complete; 32 files scanned |
