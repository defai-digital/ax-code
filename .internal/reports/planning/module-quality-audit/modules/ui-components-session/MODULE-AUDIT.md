...
| Source files scanned | 66 (19831 lines) |

## 1. Scope and map

### Purpose and ownership
Owns `desktop/packages/ui/src/components/session` within AX Code CLI/Desktop architecture per PRD inventory.

### Source, tests, and artifacts

| Kind | Paths | Notes |
|------|-------|-------|
| Source | `desktop/packages/ui/src/components/session/DirectoryExplorerDialog-paths.test.ts`, `desktop/packages/ui/src/components/session/DirectoryExplorerDialog-paths.ts`, `desktop/packages/ui/src/components/session/DirectoryExplorerDialog.tsx`, `desktop/packages/ui/src/components/session/GitHubIntegrationDialog.tsx`, `desktop/packages/ui/src/components/session/GitHubIssuePickerDialog.tsx`, `desktop/packages/ui/src/components/session/GitHubPrPickerDialog.tsx`, `desktop/packages/ui/src/components/session/NewWorktreeDialog.tsx`, `desktop/packages/ui/src/components/session/ProjectNotesTodoPanel.tsx`, `desktop/packages/ui/src/components/session/SaveProjectPlanDialog.test.tsx`, `desktop/packages/ui/src/components/session/SaveProjectPlanDialog.tsx`, `desktop/packages/ui/src/components/session/ScheduledTaskEditorDialog.tsx`, `desktop/packages/ui/src/components/session/ScheduledTasksDialog.relativeTime.test.ts` | 66 files |
| Tests | `packages/ax-code/test/acp/session-list.test.ts`, `packages/ax-code/test/cli/cmd/tui/routes/session/autonomous-active.test.ts`, `packages/ax-code/test/cli/cmd/tui/routes/session/coalesce.test.ts`, `packages/ax-code/test/cli/cmd/tui/routes/session/footer-view-model.test.ts`, `packages/ax-code/test/cli/cmd/tui/routes/session/format.test.ts`, `packages/ax-code/test/cli/session-clear-project.test.ts`, `packages/ax-code/test/cli/tui/h-session-undo-redo-revert-error.test.ts`, `packages/ax-code/test/cli/tui/s-dialog-session-list-rename-sdk-error.test.ts` | 25 matched |
| Prior art | `.internal/reports/reviews/2026-07-19-code-quality-stability-review.md` | linked |

### Public API
Scanned 66 source files for exports/routes/commands.
...
|-----------|---------------|-----|
| Primary unit behavior | `packages/ax-code/test/acp/session-list.test.ts` | ok |
...
|------|------|------|----------|
| Reviewer | codex-sol | 2026-08-11 | Protocol complete; 66 files scanned |
