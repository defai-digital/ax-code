...
| Status | deferred |
| Module | server |
| Evidence | packages/ax-code/src/server/ipc-transport.ts:319; packages/ax-code/src/server/runtime-adapter.ts:132 |
...
## Impact
Affects `packages/ax-code/src/server` (security, network).
