...
| Source files scanned | 6 (203 lines) |

## 1. Scope and map

### Purpose and ownership
Owns `desktop/packages/ui/src/components/files` within AX Code CLI/Desktop architecture per PRD inventory.

### Source, tests, and artifacts

| Kind | Paths | Notes |
|------|-------|-------|
| Source | `desktop/packages/ui/src/components/files/FileStatusDot.tsx`, `desktop/packages/ui/src/components/files/fileStatus.test.ts`, `desktop/packages/ui/src/components/files/fileStatus.ts`, `desktop/packages/ui/src/components/files/latestDirectoryLoadTracker.test.ts`, `desktop/packages/ui/src/components/files/latestDirectoryLoadTracker.ts`, `desktop/packages/ui/src/components/files/types.ts` | 6 files |
| Tests | `packages/ax-code/test/util/filesystem.test.ts`, `desktop/packages/ui/src/components/chat/ChatContainer.test.ts`, `desktop/packages/ui/src/components/chat/CommandAutocomplete.test.ts`, `desktop/packages/ui/src/components/chat/FileAttachment.formatSize.test.ts`, `desktop/packages/ui/src/components/chat/MarkdownRendererImpl.test.ts`, `desktop/packages/ui/src/components/chat/PermissionCardTools.test.ts`, `desktop/packages/ui/src/components/chat/TimelineDialog.test.ts`, `desktop/packages/ui/src/components/chat/__tests__/attachmentCitations.test.ts` | 25 matched |
...
|-----------|---------------|-----|
| Primary unit behavior | `packages/ax-code/test/util/filesystem.test.ts` | ok |
