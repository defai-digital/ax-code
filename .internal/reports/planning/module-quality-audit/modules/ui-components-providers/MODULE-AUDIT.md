...
| Analysis fingerprint | `ef100d03e7c71490` |
...
Unit `ui-components-providers` owns `desktop/packages/ui/src/components/providers`. Risk profile: desktop, ui.
...
| Symbol | Kind | Notes |
|--------|------|-------|
| `ThemeProvider@desktop/packages/ui/src/components/providers/ThemeProvider.tsx:9` | public/internal | scanned |
...
Placement checked against ARCHITECTURE.md / PROJECT_BOUNDARIES.md for scope `desktop/packages/ui/src/components/providers`. Desktop boundary gate EXIT:0 at program exit.
...
|------------------|--------|----------|
| Static deep extract | ok | fingerprint `ef100d03e7c71490` |
...
|------|------|------|----------|
| Reviewer | codex-sol | 2026-08-11 | Deep extract 1 files / 24 LOC / fp ef100d03e7c71490 |
