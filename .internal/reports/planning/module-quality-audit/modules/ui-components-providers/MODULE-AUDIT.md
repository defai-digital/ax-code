...
| Source files scanned | 1 (24 lines) |

## 1. Scope and map

### Purpose and ownership
Owns `desktop/packages/ui/src/components/providers` within AX Code CLI/Desktop architecture per PRD inventory.

### Source, tests, and artifacts

| Kind | Paths | Notes |
|------|-------|-------|
| Source | `desktop/packages/ui/src/components/providers/ThemeProvider.tsx` | 1 files |
| Tests | `packages/ax-code/test/cli/providers.test.ts`, `packages/ax-code/test/provider/cloud-api-providers.test.ts`, `desktop/packages/web/server/lib/ax-code/providers.test.js`, `desktop/packages/web/server/lib/quota/providers/ollama-cloud.test.js`, `desktop/packages/ui/src/components/chat/ChatContainer.test.ts`, `desktop/packages/ui/src/components/chat/CommandAutocomplete.test.ts`, `desktop/packages/ui/src/components/chat/FileAttachment.formatSize.test.ts`, `desktop/packages/ui/src/components/chat/MarkdownRendererImpl.test.ts` | 25 matched |
