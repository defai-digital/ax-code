...
| Inventory ID | W1-02 |
| Source files scanned | 4 (824 lines) |

## 1. Scope and map

### Purpose and ownership
Owns `packages/ax-code/src/account` within AX Code CLI/Desktop architecture per PRD inventory.

### Source, tests, and artifacts

| Kind | Paths | Notes |
|------|-------|-------|
| Source | `packages/ax-code/src/account/account.sql.ts`, `packages/ax-code/src/account/index.ts`, `packages/ax-code/src/account/repo.ts`, `packages/ax-code/src/account/schema.ts` | 4 files |
| Tests | `packages/ax-code/test/account/repo.test.ts`, `packages/ax-code/test/account/service.test.ts`, `packages/ax-code/test/account/token-decode.test.ts`, `packages/ax-code/test/cli/account.test.ts` | 4 matched |
