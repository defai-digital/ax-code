...
| Analysis fingerprint | `aa5a2b8408d6b7ba` |
...
Unit `provider-stream` owns `packages/ax-code/src/provider (stream transforms)`. Risk profile: hot-path, stability.
...
Placement checked against ARCHITECTURE.md / PROJECT_BOUNDARIES.md for scope `packages/ax-code/src/provider (stream transforms)`. Desktop boundary gate EXIT:0 at program exit.
...
|------------------|--------|----------|
| Static deep extract | ok | fingerprint `aa5a2b8408d6b7ba` |
...
|------|------|------|----------|
| Reviewer | ax-code-glm | 2026-08-11 | Deep extract 52 files / 11481 LOC / fp aa5a2b8408d6b7ba |
