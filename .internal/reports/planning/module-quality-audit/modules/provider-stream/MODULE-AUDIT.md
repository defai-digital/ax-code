...
Owns `packages/ax-code/src/provider (stream transforms)` within AX Code CLI/Desktop architecture per PRD inventory.
...
| Tests | `packages/ax-code/test/cli/providers.test.ts`, `packages/ax-code/test/cli/tui/c-dialog-provider-auth-errors.test.ts`, `packages/ax-code/test/cli/tui/coalesce-stream-events.test.ts`, `packages/ax-code/test/cli/tui/dialog-provider-options.test.ts`, `packages/ax-code/test/cli/tui/stream-paint.test.ts`, `packages/ax-code/test/cli/tui/stream-resilience.test.ts`, `packages/ax-code/test/cli/tui/worker-event-stream.test.ts`, `packages/ax-code/test/image/provider.test.ts` | 25 matched |
