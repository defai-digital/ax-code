...
| Inventory ID | W9-01 |
| Source files scanned | 92 (60199 lines) |

## 1. Scope and map

### Purpose and ownership
Owns `packages/sdk/js` within AX Code CLI/Desktop architecture per PRD inventory.

### Source, tests, and artifacts

| Kind | Paths | Notes |
|------|-------|-------|
| Source | `packages/sdk/js/example/example.ts`, `packages/sdk/js/example/headless-app.ts`, `packages/sdk/js/example/programmatic.ts`, `packages/sdk/js/package.json`, `packages/sdk/js/script/build.ts`, `packages/sdk/js/script/publish.ts`, `packages/sdk/js/script/validate-openapi.ts`, `packages/sdk/js/src/client.ts`, `packages/sdk/js/src/gen/client/client.gen.ts`, `packages/sdk/js/src/gen/client/index.ts`, `packages/sdk/js/src/gen/client/types.gen.ts`, `packages/sdk/js/src/gen/client/utils.gen.ts` | 92 files |
| Tests | `packages/ax-code/test/acp/sdk-client-naming.test.ts`, `packages/ax-code/test/cli/tui/p-permission-question-reply-sdk-error.test.ts`, `packages/ax-code/test/cli/tui/s-dialog-session-list-rename-sdk-error.test.ts`, `packages/ax-code/test/cli/tui/sdk-client-naming.test.ts`, `packages/ax-code/test/sdk/programmatic.test.ts`, `desktop/packages/web/server/lib/ax-code/sdk-contract.test.js` | 6 matched |
| Prior art | `.internal/reports/reviews/2026-07-19-code-quality-stability-review.md` | linked |

### Public API
Scanned 92 source files for exports/routes/commands.
...
Static signals: emptyCatch=9, todo=3, asAny=9
...
TODO density: 3. Residual empty-catch candidates: packages/sdk/js/src/grpc.ts:2327; packages/sdk/js/src/headless/lifecycle.ts:450; packages/sdk/js/src/headless/lifecycle.ts:463; packages/sdk/js/src/headless/lifecycle.ts:469; packages/sdk/js/src/internal/server-shared.ts:92. Not auto-accepted without reachability proof.
...
|------|------|------|----------|
| Reviewer | ax-code-glm | 2026-08-11 | Protocol complete; 92 files scanned |
