...
Owns `packages/ax-code/src/ide` within AX Code CLI/Desktop architecture per PRD inventory.

### Source, tests, and artifacts

| Kind | Paths | Notes |
|------|-------|-------|
| Source | `packages/ax-code/src/ide/index.ts` | 1 files |
| Tests | `packages/ax-code/test/cli/providers.test.ts`, `packages/ax-code/test/cli/tui/c-dialog-provider-auth-errors.test.ts`, `packages/ax-code/test/cli/tui/dialog-provider-options.test.ts`, `packages/ax-code/test/cli/tui/session-sidebar-index.test.ts`, `packages/ax-code/test/ide/ide.test.ts`, `packages/ax-code/test/image/provider.test.ts`, `packages/ax-code/test/perf/sidebar-activity-recent.test.ts`, `packages/ax-code/test/perf/sidebar-rollback-points.test.ts` | 25 matched |
