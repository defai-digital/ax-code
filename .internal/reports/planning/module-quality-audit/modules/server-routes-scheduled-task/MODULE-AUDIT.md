...
| Analysis fingerprint | `dbf2b2b71b94be30` |
...
Unit `server-routes-scheduled-task` owns `packages/ax-code/src/server/routes/scheduled-task.ts`. Risk profile: network, api.
...
| Symbol | Kind | Notes |
|--------|------|-------|
| `ScheduledTaskRoutes@packages/ax-code/src/server/routes/scheduled-task.ts:29` | public/internal | scanned |
...
Placement checked against ARCHITECTURE.md / PROJECT_BOUNDARIES.md for scope `packages/ax-code/src/server/routes/scheduled-task.ts`. Desktop boundary gate EXIT:0 at program exit.
...
|------------------|--------|----------|
| Static deep extract | ok | fingerprint `dbf2b2b71b94be30` |
...
|------|------|------|----------|
| Reviewer | codex-sol | 2026-08-11 | Deep extract 1 files / 191 LOC / fp dbf2b2b71b94be30 |
