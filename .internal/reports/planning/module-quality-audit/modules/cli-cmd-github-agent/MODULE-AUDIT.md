...
| Inventory ID | W6-15 |
| Source files scanned | 8 (1968 lines) |

## 1. Scope and map

### Purpose and ownership
Owns `packages/ax-code/src/cli/cmd/github-agent` within AX Code CLI/Desktop architecture per PRD inventory.

### Source, tests, and artifacts

| Kind | Paths | Notes |
|------|-------|-------|
| Source | `packages/ax-code/src/cli/cmd/github-agent/git-ops.ts`, `packages/ax-code/src/cli/cmd/github-agent/github-api.ts`, `packages/ax-code/src/cli/cmd/github-agent/index.ts`, `packages/ax-code/src/cli/cmd/github-agent/install.ts`, `packages/ax-code/src/cli/cmd/github-agent/pr.ts`, `packages/ax-code/src/cli/cmd/github-agent/prompts.ts`, `packages/ax-code/src/cli/cmd/github-agent/run.ts`, `packages/ax-code/src/cli/cmd/github-agent/types.ts` | 8 files |
| Tests | `packages/ax-code/test/acp/agent-adapter.test.ts`, `packages/ax-code/test/acp/agent-interface.test.ts`, `packages/ax-code/test/acp/agent-prompt.test.ts`, `packages/ax-code/test/acp/sdk-client-naming.test.ts`, `packages/ax-code/test/agent/agent.test.ts`, `packages/ax-code/test/agent/router.test.ts`, `packages/ax-code/test/cli/account.test.ts`, `packages/ax-code/test/cli/acp.test.ts` | 25 matched |
| Prior art | `.internal/reports/reviews/2026-07-19-code-quality-stability-review.md` | linked |

### Public API
Scanned 8 source files for exports/routes/commands.
...
TODO density: 0. Residual empty-catch candidates: packages/ax-code/src/cli/cmd/github-agent/github-api.ts:49. Not auto-accepted without reachability proof.

## 7. Test coverage map

| Risk path | Existing test | Gap |
|-----------|---------------|-----|
| Primary unit behavior | `packages/ax-code/test/acp/agent-adapter.test.ts` | ok |
...
|------|------|------|----------|
| Reviewer | codex-sol | 2026-08-11 | Protocol complete; 8 files scanned |
