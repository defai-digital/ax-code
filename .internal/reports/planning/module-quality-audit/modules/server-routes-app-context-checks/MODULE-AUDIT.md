# MODULE-AUDIT: server-routes-app-context-checks

| Field | Value |
|-------|-------|
| Unit slug | `server-routes-app-context-checks` |
| Scope | `packages/ax-code/src/server/routes/app-context-checks.ts` |
...
| Inventory ID | W4-03-01 |
| Source files scanned | 1 (228 lines) |

## 1. Scope and map

### Purpose and ownership
Owns `packages/ax-code/src/server/routes/app-context-checks.ts` within AX Code CLI/Desktop architecture per PRD inventory.

### Source, tests, and artifacts

| Kind | Paths | Notes |
|------|-------|-------|
| Source | `packages/ax-code/src/server/routes/app-context-checks.ts` | 1 files |
| Tests | `packages/ax-code/test/cli/cmd/tui/routes/session/autonomous-active.test.ts`, `packages/ax-code/test/cli/cmd/tui/routes/session/coalesce.test.ts`, `packages/ax-code/test/cli/cmd/tui/routes/session/footer-view-model.test.ts`, `packages/ax-code/test/cli/cmd/tui/routes/session/format.test.ts`, `packages/ax-code/test/cli/github-agent-run-context.test.ts`, `packages/ax-code/test/cli/tui/context-kv-race.test.ts`, `packages/ax-code/test/code-intelligence/graph-context.test.ts`, `packages/ax-code/test/context/analyzer.test.ts` | 25 matched |
...
|-----------|---------------|-----|
| Primary unit behavior | `packages/ax-code/test/cli/cmd/tui/routes/session/autonomous-active.test.ts` | ok |
...
|------|------|------|----------|
| Reviewer | codex-sol | 2026-08-11 | Protocol complete; 1 files scanned |
