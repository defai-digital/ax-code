...
| Inventory ID | W8-08 |
| Source files scanned | 71 (20253 lines) |

## 1. Scope and map

### Purpose and ownership
Owns `desktop/packages/ui/src/sync` within AX Code CLI/Desktop architecture per PRD inventory.

### Source, tests, and artifacts

| Kind | Paths | Notes |
|------|-------|-------|
| Source | `desktop/packages/ui/src/sync/__tests__/event-pipeline-online.test.ts`, `desktop/packages/ui/src/sync/__tests__/event-pipeline-permanent-error.test.ts`, `desktop/packages/ui/src/sync/__tests__/event-pipeline-resume.test.ts`, `desktop/packages/ui/src/sync/__tests__/event-pipeline-test-helpers.ts`, `desktop/packages/ui/src/sync/__tests__/event-pipeline.bench.ts`, `desktop/packages/ui/src/sync/__tests__/event-pipeline.test.ts`, `desktop/packages/ui/src/sync/__tests__/event-reducer.test.ts`, `desktop/packages/ui/src/sync/__tests__/eviction.test.ts`, `desktop/packages/ui/src/sync/__tests__/live-aggregate.test.ts`, `desktop/packages/ui/src/sync/__tests__/live-selector-memo.test.ts`, `desktop/packages/ui/src/sync/__tests__/materialization.test.ts`, `desktop/packages/ui/src/sync/__tests__/session-prefetch-cache.test.ts` | 71 files |
| Tests | `packages/ax-code/test/cli/tui/headless-sync-boundary.test.ts`, `packages/ax-code/test/cli/tui/session-entry-sync.test.ts`, `packages/ax-code/test/cli/tui/sync-bootstrap-assembly.test.ts`, `packages/ax-code/test/cli/tui/sync-bootstrap-controller.test.ts`, `packages/ax-code/test/cli/tui/sync-bootstrap-flow.test.ts`, `packages/ax-code/test/cli/tui/sync-bootstrap-phase-plan.test.ts`, `packages/ax-code/test/cli/tui/sync-bootstrap-phase.test.ts`, `packages/ax-code/test/cli/tui/sync-bootstrap-plan.test.ts` | 25 matched |
| Prior art | `.internal/reports/reviews/2026-07-19-code-quality-stability-review.md` | linked |

### Public API
Scanned 71 source files for exports/routes/commands.
...
|-----------|---------------|-----|
| Primary unit behavior | `packages/ax-code/test/cli/tui/headless-sync-boundary.test.ts` | ok |
...
|------|------|------|----------|
| Reviewer | codex-sol | 2026-08-11 | Protocol complete; 71 files scanned |
