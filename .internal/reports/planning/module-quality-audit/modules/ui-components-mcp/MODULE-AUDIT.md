...
| Source files scanned | 1 (446 lines) |

## 1. Scope and map

### Purpose and ownership
Owns `desktop/packages/ui/src/components/mcp` within AX Code CLI/Desktop architecture per PRD inventory.

### Source, tests, and artifacts

| Kind | Paths | Notes |
|------|-------|-------|
| Source | `desktop/packages/ui/src/components/mcp/McpDropdown.tsx` | 1 files |
| Tests | `packages/ax-code/test/cli/mcp-config-lock.test.ts`, `packages/ax-code/test/cli/mcp-debug.test.ts`, `packages/ax-code/test/mcp/auth.test.ts`, `packages/ax-code/test/mcp/connect-lock.test.ts`, `packages/ax-code/test/mcp/discovery-playwright.test.ts`, `packages/ax-code/test/mcp/discovery-spawn.test.ts`, `packages/ax-code/test/mcp/headers.test.ts`, `packages/ax-code/test/mcp/oauth-auto-connect.test.ts` | 25 matched |
