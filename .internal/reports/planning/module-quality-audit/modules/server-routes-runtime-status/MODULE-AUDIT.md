...
| Analysis fingerprint | `0916e73ae6d411d6` |
...
Unit `server-routes-runtime-status` owns `packages/ax-code/src/server/routes/runtime-status.ts`. Risk profile: network, api.
...
| Symbol | Kind | Notes |
|--------|------|-------|
| `RuntimeStatusRoutes@packages/ax-code/src/server/routes/runtime-status.ts:15` | public/internal | scanned |
...
Placement checked against ARCHITECTURE.md / PROJECT_BOUNDARIES.md for scope `packages/ax-code/src/server/routes/runtime-status.ts`. Desktop boundary gate EXIT:0 at program exit.
...
|------------------|--------|----------|
| Static deep extract | ok | fingerprint `0916e73ae6d411d6` |
...
|------|------|------|----------|
| Reviewer | codex-sol | 2026-08-11 | Deep extract 1 files / 198 LOC / fp 0916e73ae6d411d6 |
