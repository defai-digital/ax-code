...
| Inventory ID | W10-05 |
| Source files scanned | 13 (1810 lines) |

## 1. Scope and map

### Purpose and ownership
Owns `packages/ax-code/src/visual` within AX Code CLI/Desktop architecture per PRD inventory.

### Source, tests, and artifacts

| Kind | Paths | Notes |
|------|-------|-------|
| Source | `packages/ax-code/src/visual/artifact.ts`, `packages/ax-code/src/visual/capability.ts`, `packages/ax-code/src/visual/compare.ts`, `packages/ax-code/src/visual/findings.ts`, `packages/ax-code/src/visual/index.ts`, `packages/ax-code/src/visual/native.ts`, `packages/ax-code/src/visual/permission.ts`, `packages/ax-code/src/visual/repair.ts`, `packages/ax-code/src/visual/risk-summary.ts`, `packages/ax-code/src/visual/router.ts`, `packages/ax-code/src/visual/run.ts`, `packages/ax-code/src/visual/snapshot.ts` | 13 files |
| Tests | `packages/ax-code/test/cli/tui/visual-primitives.test.ts`, `packages/ax-code/test/tool/visual-compare.test.ts`, `packages/ax-code/test/tool/visual-critique.test.ts`, `packages/ax-code/test/tool/visual-snapshot.test.ts`, `packages/ax-code/test/visual/artifact.test.ts`, `packages/ax-code/test/visual/capability.test.ts`, `packages/ax-code/test/visual/compare.test.ts`, `packages/ax-code/test/visual/findings.test.ts` | 15 matched |
| Prior art | `.internal/reports/reviews/2026-07-19-code-quality-stability-review.md` | linked |

### Public API
Scanned 13 source files for exports/routes/commands.
...
|-----------|---------------|-----|
| Primary unit behavior | `packages/ax-code/test/cli/tui/visual-primitives.test.ts` | ok |
...
|------|------|------|----------|
| Reviewer | codex-sol | 2026-08-11 | Protocol complete; 13 files scanned |
