...
| Inventory ID | W7-11 |
| Source files scanned | 10 (2935 lines) |

## 1. Scope and map

### Purpose and ownership
Owns `desktop/packages/web/server/lib/github` within AX Code CLI/Desktop architecture per PRD inventory.

### Source, tests, and artifacts

| Kind | Paths | Notes |
|------|-------|-------|
| Source | `desktop/packages/web/server/lib/github/auth.js`, `desktop/packages/web/server/lib/github/auth.test.js`, `desktop/packages/web/server/lib/github/device-flow.js`, `desktop/packages/web/server/lib/github/index.js`, `desktop/packages/web/server/lib/github/octokit.js`, `desktop/packages/web/server/lib/github/pr-status.js`, `desktop/packages/web/server/lib/github/repo/fork-detection.js`, `desktop/packages/web/server/lib/github/repo/index.js`, `desktop/packages/web/server/lib/github/routes.js`, `desktop/packages/web/server/lib/github/routes.test.js` | 10 files |
