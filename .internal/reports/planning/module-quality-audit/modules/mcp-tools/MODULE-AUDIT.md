...
| Analysis fingerprint | `3080a5b7316080af` |
...
Unit `mcp-tools` owns `packages/ax-code/src/mcp (tool conversion)`. Risk profile: security.
...
Placement checked against ARCHITECTURE.md / PROJECT_BOUNDARIES.md for scope `packages/ax-code/src/mcp (tool conversion)`. Desktop boundary gate EXIT:0 at program exit.
...
|------------------|--------|----------|
| Static deep extract | ok | fingerprint `3080a5b7316080af` |
...
|------|------|------|----------|
| Reviewer | ax-code-glm | 2026-08-11 | Deep extract 11 files / 3327 LOC / fp 3080a5b7316080af |
