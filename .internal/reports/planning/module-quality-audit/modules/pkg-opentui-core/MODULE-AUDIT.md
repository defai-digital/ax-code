...
| Inventory ID | W9-05 |
| Source files scanned | 133 (49859 lines) |

## 1. Scope and map

### Purpose and ownership
Owns `packages/opentui-core` within AX Code CLI/Desktop architecture per PRD inventory.

### Source, tests, and artifacts

| Kind | Paths | Notes |
|------|-------|-------|
| Source | `packages/opentui-core/NativeSpanFeed.d.ts`, `packages/opentui-core/Renderable.d.ts`, `packages/opentui-core/animation/Timeline.d.ts`, `packages/opentui-core/ansi.d.ts`, `packages/opentui-core/audio.d.ts`, `packages/opentui-core/buffer.d.ts`, `packages/opentui-core/console.d.ts`, `packages/opentui-core/edit-buffer.d.ts`, `packages/opentui-core/editor-view.d.ts`, `packages/opentui-core/index-07zpr2dg.js`, `packages/opentui-core/index-pcvh9d34.js`, `packages/opentui-core/index.d.ts` | 133 files |
| Tests | `packages/ax-code/test/cli/tui/opentui-ffi-coordinate-guard.test.ts`, `packages/ax-code/test/cli/tui/opentui-ffi-pointer-pin.test.ts`, `packages/ax-code/test/cli/tui/opentui-spinner.test.ts`, `packages/ax-code/test/script/opentui-package-integrity.test.ts`, `packages/ax-code/test/session/semantic-core.test.ts`, `desktop/packages/web/server/lib/ax-code/core-routes.test.js` | 6 matched |
| Prior art | `.internal/reports/reviews/2026-07-19-code-quality-stability-review.md` | linked |

### Public API
Scanned 133 source files for exports/routes/commands.
...
Static signals: emptyCatch=6, todo=0, asAny=0
...
TODO density: 0. Residual empty-catch candidates: packages/opentui-core/index-07zpr2dg.js:1261; packages/opentui-core/index-07zpr2dg.js:5237; packages/opentui-core/index-pcvh9d34.js:8321; packages/opentui-core/index-pcvh9d34.js:15106; packages/opentui-core/lib/tree-sitter/update-assets.js:40. Not auto-accepted without reachability proof.

## 7. Test coverage map

| Risk path | Existing test | Gap |
|-----------|---------------|-----|
| Primary unit behavior | `packages/ax-code/test/cli/tui/opentui-ffi-coordinate-guard.test.ts` | ok |
...
|------|------|------|----------|
| Reviewer | ax-code-glm | 2026-08-11 | Protocol complete; 133 files scanned |
