...
| Source files scanned | 99 (26387 lines) |

## 1. Scope and map

### Purpose and ownership
Owns `desktop/packages/ui/src/components/sections` within AX Code CLI/Desktop architecture per PRD inventory.

### Source, tests, and artifacts

| Kind | Paths | Notes |
|------|-------|-------|
| Source | `desktop/packages/ui/src/components/sections/agents/AgentsPage.tsx`, `desktop/packages/ui/src/components/sections/agents/AgentsSidebar.tsx`, `desktop/packages/ui/src/components/sections/agents/ModelSelector.tsx`, `desktop/packages/ui/src/components/sections/agents/permissionToolIds.test.ts`, `desktop/packages/ui/src/components/sections/agents/permissionToolIds.ts`, `desktop/packages/ui/src/components/sections/ax-code/AXCodePage.tsx`, `desktop/packages/ui/src/components/sections/ax-code/AXCodeVisualSettings.tsx`, `desktop/packages/ui/src/components/sections/ax-code/AboutSettings.tsx`, `desktop/packages/ui/src/components/sections/ax-code/AxCodeCliSettings.tsx`, `desktop/packages/ui/src/components/sections/ax-code/CornerRadiusSettings.tsx`, `desktop/packages/ui/src/components/sections/ax-code/DefaultsSettings.tsx`, `desktop/packages/ui/src/components/sections/ax-code/DesktopNetworkSettings.tsx` | 99 files |
...
### Public API
Scanned 99 source files for exports/routes/commands.
...
|------|------|------|----------|
| Reviewer | codex-sol | 2026-08-11 | Protocol complete; 99 files scanned |
