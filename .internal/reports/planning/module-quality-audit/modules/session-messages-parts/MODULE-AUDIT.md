...
| Analysis fingerprint | `0c22dec9e9f5f368` |
...
Unit `session-messages-parts` owns `packages/ax-code/src/session (messages/parts)`. Risk profile: hot-path, persistence.
...
Placement checked against ARCHITECTURE.md / PROJECT_BOUNDARIES.md for scope `packages/ax-code/src/session (messages/parts)`. Desktop boundary gate EXIT:0 at program exit.
...
|------------------|--------|----------|
| Static deep extract | ok | fingerprint `0c22dec9e9f5f368` |
...
|------|------|------|----------|
| Reviewer | codex-sol | 2026-08-11 | Deep extract 135 files / 26283 LOC / fp 0c22dec9e9f5f368 |
