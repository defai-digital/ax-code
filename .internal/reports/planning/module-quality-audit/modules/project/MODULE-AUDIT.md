...
| Inventory ID | W4-04 |
| Source files scanned | 8 (1409 lines) |

## 1. Scope and map

### Purpose and ownership
Owns `packages/ax-code/src/project` within AX Code CLI/Desktop architecture per PRD inventory.

### Source, tests, and artifacts

| Kind | Paths | Notes |
|------|-------|-------|
| Source | `packages/ax-code/src/project/bootstrap.ts`, `packages/ax-code/src/project/instance.ts`, `packages/ax-code/src/project/project-identity.ts`, `packages/ax-code/src/project/project.sql.ts`, `packages/ax-code/src/project/project.ts`, `packages/ax-code/src/project/schema.ts`, `packages/ax-code/src/project/state.ts`, `packages/ax-code/src/project/vcs.ts` | 8 files |
| Tests | `packages/ax-code/test/cli/session-clear-project.test.ts`, `packages/ax-code/test/project/instance-context.test.ts`, `packages/ax-code/test/project/migrate-global.test.ts`, `packages/ax-code/test/project/project.test.ts`, `packages/ax-code/test/project/state.test.ts`, `packages/ax-code/test/project/vcs.test.ts`, `packages/ax-code/test/project/worktree-remove.test.ts`, `packages/ax-code/test/runtime/headless/projection.test.ts` | 25 matched |
...
|-----------|---------------|-----|
| Primary unit behavior | `packages/ax-code/test/cli/session-clear-project.test.ts` | ok |
