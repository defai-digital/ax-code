...
Owns `packages/ax-code/src/tool (bash/shell execution)` within AX Code CLI/Desktop architecture per PRD inventory.
...
| Tests | `packages/ax-code/test/cli/tui/session-tool-rendering.test.ts`, `packages/ax-code/test/control-plane/execution-controller.test.ts`, `packages/ax-code/test/graph/execution-graph.test.ts`, `packages/ax-code/test/mcp/tool-conversion.test.ts`, `packages/ax-code/test/replay/tool-call-query.test.ts`, `packages/ax-code/test/replay/tool-result-metadata.test.ts`, `packages/ax-code/test/session/prompt-command-execution.test.ts`, `packages/ax-code/test/session/prompt-tools.test.ts` | 25 matched |
...
|-----------|---------------|-----|
| Primary unit behavior | `packages/ax-code/test/cli/tui/session-tool-rendering.test.ts` | ok |
