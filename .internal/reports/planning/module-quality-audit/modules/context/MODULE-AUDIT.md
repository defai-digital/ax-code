...
| Inventory ID | W2-08 |
| Source files scanned | 4 (1000 lines) |

## 1. Scope and map

### Purpose and ownership
Owns `packages/ax-code/src/context` within AX Code CLI/Desktop architecture per PRD inventory.

### Source, tests, and artifacts

| Kind | Paths | Notes |
|------|-------|-------|
| Source | `packages/ax-code/src/context/analyzer.ts`, `packages/ax-code/src/context/generator.ts`, `packages/ax-code/src/context/index.ts`, `packages/ax-code/src/context/long-agent-packer.ts` | 4 files |
| Tests | `packages/ax-code/test/cli/github-agent-run-context.test.ts`, `packages/ax-code/test/cli/tui/context-kv-race.test.ts`, `packages/ax-code/test/code-intelligence/graph-context.test.ts`, `packages/ax-code/test/context/analyzer.test.ts`, `packages/ax-code/test/context/generator.test.ts`, `packages/ax-code/test/context/long-agent-packer.test.ts`, `packages/ax-code/test/project/instance-context.test.ts`, `packages/ax-code/test/quality/reentry-context.test.ts` | 15 matched |
...
|-----------|---------------|-----|
| Primary unit behavior | `packages/ax-code/test/cli/github-agent-run-context.test.ts` | ok |
