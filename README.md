...
[![Release v7.19.3](https://img.shields.io/badge/Release-v7.19.3-2F6FED)](https://github.com/defai-digital/ax-code/releases/tag/v7.19.3)
...
| CLI providers            | Claude Code, Codex CLI, Grok Build CLI, Kimi Code, Muse Code, MiniMax Code                                                                  | One model ID per CLI bridge, reusing the local vendor CLI session |
