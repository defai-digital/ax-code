...
nix run nixpkgs#opencode           # oder github:defai-digital/ax-code für den neuesten dev-Branch
```
...
ax-code ist auch als Desktop-Anwendung verfügbar. Lade sie direkt von der [Releases-Seite](https://github.com/defai-digital/ax-code/releases) oder [opencode.ai/download](https://opencode.ai/download) herunter.
...
Mehr Infos zur Konfiguration von ax-code findest du in unseren [**Docs**](https://opencode.ai/docs).
...
Wenn du an einem Projekt arbeitest, das mit ax-code zusammenhängt und "ax-code" als Teil seines Namens verwendet (z.B. "opencode-dashboard" oder "opencode-mobile"), füge bitte einen Hinweis in deine README ein, dass es nicht vom ax-code-Team gebaut wird und nicht in irgendeiner Weise mit uns verbunden ist.
