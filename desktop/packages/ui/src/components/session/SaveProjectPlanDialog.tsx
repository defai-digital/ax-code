      ...
      <DialogContent className="max-w-lg">
        ...
        <div className="space-y-3">
          <div className="space-y-1.5">
            <label htmlFor={titleInputId} className="typography-ui-label font-medium text-foreground">
              {t("saveProjectPlanDialog.field.title")}
            </label>
            <Input
              id={titleInputId}
              value={title}
          ...
          <div className="space-y-1.5">
            <label className="typography-ui-label font-medium text-foreground">
              {t("saveProjectPlanDialog.field.contentPreview")}
            </label>
        ...
        <DialogFooter>
          <Button variant="outline" onClick={() => onOpenChange(false)} disabled={saving}>
            {t("saveProjectPlanDialog.actions.cancel")}
          </Button>
