                  ...
                  <button
                    ...
                    className={cn(
                      ...
                      isRepo && !hideDirectoryControls
                        ? alwaysShowActions
                          ? "pr-20"
                          : "pr-7 group-hover/project:pr-20 group-focus-within/project:pr-20"
                        : alwaysShowActions
                          ? "pr-14"
                          : "pr-7 group-hover/project:pr-14 group-focus-within/project:pr-14",
                    )}
                  >
                    <span className="inline-flex h-3.5 w-3.5 flex-shrink-0 items-center justify-center">
                      <span
                        className={cn(
                          ...
                          alwaysShowActions
                            ? "inline-flex"
                            : "hidden group-hover/project:inline-flex group-focus-within/project:inline-flex",
                        )}
                      >
                        {isCollapsed ? (
                      ...
                      {imageUrl ? (
                        <span
                          className={cn(
                            ...
                            alwaysShowActions
                              ? "hidden"
                              : "inline-flex group-hover/project:hidden group-focus-within/project:hidden",
                          )}
...
const SortableGroupItemBase: React.FC<{
  ...
  return (
    <div
      ...
      className={cn("space-y-0.5 rounded-md", isDragging && "opacity-50")}
    >
