...
const LEGACY_EXPANSION_CONTEXT_PREFIXES = ["project:active:", "project:archived:", "recent:active:", "recent:archived:"]
...
export const useSidebarPersistence = (args: Args) => {
  ...
  const scheduleCollapsedProjectsPersist = React.useCallback(
