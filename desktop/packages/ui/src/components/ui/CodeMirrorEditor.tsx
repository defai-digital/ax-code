...
class BlockWidget extends WidgetType {
  constructor(
    readonly id: string,
    readonly containerMap: Map<string, HTMLElement>,
  ) {
    super()
  }
...
export function CodeMirrorEditor({
  ...
  const [portalWidgets, setPortalWidgets] = React.useState<
    Array<{ id: string; content: React.ReactNode; container: HTMLElement }>
  >([])
    ...
    view.dispatch({
      effects: [
        ...
        searchCompartment.reconfigure(
          enableSearch ? [search({ top: true }), keymap.of(toViewKeyBindings(searchKeymap))] : [],
        ),
      ],
    })
