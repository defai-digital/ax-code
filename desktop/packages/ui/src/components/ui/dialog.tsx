...
function DialogClose({ asChild, children, ...props }: React.ComponentProps<typeof BaseDialog.Close> & AsChildProps) {
  const r = renderFromAsChild(asChild, children)
...
function DialogFooter({ className, ...props }: React.ComponentProps<"div">) {
  return (
    <div
      ...
      className={cn("flex flex-col-reverse gap-2 bottom-safe-area sm:flex-row sm:justify-end", className)}
      {...props}
    />
  )
}
