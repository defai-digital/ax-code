...
export const FadeInDisabledProvider: React.FC<{ disabled: boolean; children: React.ReactNode }> = ({
  disabled,
  children,
}) => <FadeInDisabledContext.Provider value={disabled}>{children}</FadeInDisabledContext.Provider>
