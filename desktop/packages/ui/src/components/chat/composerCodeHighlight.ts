...
type SyntaxKey = "keyword" | "string" | "number" | "comment" | "function" | "type" | "variable" | "operator"
...
const codeHighlighter = tagHighlighter([
  ...
  {
    tag: [t.variableName, t.propertyName, t.attributeName, t.labelName, t.definition(t.variableName)],
    class: "variable",
  },
  ...
  {
    tag: [t.heading, t.heading1, t.heading2, t.heading3, t.heading4, t.heading5, t.heading6, t.strong],
    class: "keyword",
  },
