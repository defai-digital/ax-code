        ...
        <div className="flex min-w-0 flex-1 items-center gap-2">
          ...
          >
            <div className="flex items-center gap-1.5">
              <span className="truncate typography-ui-label font-normal text-foreground">{group.name}</span>
  ...
  return (
    <div className={cn("flex h-full flex-col text-foreground border-r border-border/30", className)}>
      ...
      <div className="px-2.5 pb-2">
        <Button variant="outline" className="w-full justify-start gap-2 h-8" onClick={onNewAgent}>
      ...
      {/* Group List */}
      <ScrollableOverlay outerClassName="flex-1 min-h-0" className="space-y-0.5 px-2.5 pb-2">
        ...
        {!isLoading && filteredGroups.length === 0 && (
          <div className="py-4 text-center">
            <p className="typography-meta text-muted-foreground">
              {searchQuery.trim()
                ? t("agentManager.sidebar.state.noGroupsFound")
                : t("agentManager.sidebar.state.noGroupsYet")}
            </p>
            {!searchQuery.trim() && (
