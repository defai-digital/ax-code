 ...
 */
export const GitGraphSegment: React.FC<GitGraphSegmentProps> = ({ laned, totalLanes, isExpanded }) => {
  ...
  React.useLayoutEffect(() => {
    ...
    for (const seg of sorted) {
      ...
      const lineAlpha = seg.type === "passing" ? 0.72 : seg.type === "branch-out" || seg.type === "merge-in" ? 0.95 : 1
