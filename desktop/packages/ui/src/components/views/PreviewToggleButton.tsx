 ...
 */
export const PreviewToggleButton: React.FC<PreviewToggleButtonProps> = ({ currentMode, onToggle }) => {
  ...
  return (
    <Tooltip>
      <TooltipTrigger asChild>
        <Button variant="ghost" size="sm" onClick={onToggle} aria-label={ariaLabel} className="h-5 w-5 p-0">
          {isPreview ? (
