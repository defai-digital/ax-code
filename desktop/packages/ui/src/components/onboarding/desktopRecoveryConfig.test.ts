...
describe("getDesktopRecoveryConfig", () => {
  ...
  test("remote-unreachable description redacts sensitive query params in URL", () => {
    const sensitiveUrl = "https://example.com:4096?token=super-secret&auth=abc123"
    const config = getDesktopRecoveryConfig("remote-unreachable", undefined, sensitiveUrl)
  ...
  test("remote-wrong-service description redacts sensitive query params in URL", () => {
    const sensitiveUrl = "https://wrong.example.com?api_key=sk-12345&secret=mysecret"
    const config = getDesktopRecoveryConfig("remote-wrong-service", undefined, sensitiveUrl)
  ...
  test("local-unavailable description does not reference host URL", () => {
    const config = getDesktopRecoveryConfig("local-unavailable", "Some Host", "https://example.com?token=secret")
  ...
  test("missing-default-host description does not reference host URL", () => {
    const config = getDesktopRecoveryConfig("missing-default-host", "Some Host", "https://example.com?token=secret")
  ...
  test("remote-unreachable redacts URL-like hostLabel containing sensitive query params", () => {
    const urlAsLabel = "https://example.com:4096?token=super-secret&auth=abc123"
    const config = getDesktopRecoveryConfig("remote-unreachable", urlAsLabel, "https://fallback.example.com")
  ...
  test("remote-wrong-service redacts URL-like hostLabel containing sensitive query params", () => {
    const urlAsLabel = "https://wrong.example.com?api_key=sk-12345&secret=mysecret"
    const config = getDesktopRecoveryConfig("remote-wrong-service", urlAsLabel, "https://fallback.example.com")
  ...
  test("remote-unreachable redacts embedded credentials in URL-like hostLabel", () => {
    ...
    const config = getDesktopRecoveryConfig("remote-unreachable", urlWithCreds, "https://fallback.example.com")
  ...
  test("remote-wrong-service redacts embedded credentials in URL-like hostLabel", () => {
    ...
    const config = getDesktopRecoveryConfig("remote-wrong-service", urlWithCreds, "https://fallback.example.com")
  ...
  test("non-URL hostLabel is used as-is without redaction", () => {
    const config = getDesktopRecoveryConfig("remote-unreachable", "My Server", "https://example.com?token=secret")
  ...
  test("whitespace-only hostLabel falls back to hostUrl", () => {
    const config = getDesktopRecoveryConfig("remote-unreachable", "   ", "https://fallback.example.com?token=secret")
