...
export function RemoteConnectionForm({
  ...
  const handleConnect = useCallback(async () => {
    ...
    try {
      ...
      const existingHost = config.hosts.find((h) => h.url === normalizedUrl)
      ...
      <div className="w-full max-w-md space-y-6">
        ...
        <div className="flex gap-3">
          <Button variant="outline" onClick={handleTest} disabled={!canTest}>
            {isTesting
              ? t("onboarding.remoteConnection.actions.testing")
              : t("onboarding.remoteConnection.actions.testConnection")}
          </Button>
          ...
          <div className="flex flex-col gap-2 pt-2 border-t border-border">
            ...
            <div className="flex gap-2">
              ...
              {!isRecoveryMode && onSwitchToLocal && (
                <Button variant="outline" size="sm" onClick={onSwitchToLocal} className="flex-1">
