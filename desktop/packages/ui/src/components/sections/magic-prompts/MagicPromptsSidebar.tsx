    ...
    return [
      {
        ...
        items: [
          ...
          {
            id: "git.integrate.cherrypick.resolve",
            titleKey: "settings.magicPrompts.sidebar.item.gitCherrypickConflictResolve",
          },
        ],
      },
      {
        ...
        items: [
          ...
          {
            id: "github.pr.comment.single",
            titleKey: "settings.magicPrompts.sidebar.item.githubSinglePrCommentReview",
          },
        ],
      },
      {
