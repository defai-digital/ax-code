...
import {
  PROJECT_COLORS,
  PROJECT_ICONS,
  PROJECT_COLOR_MAP as COLOR_MAP,
        ...
        <div className="mb-8">
          <section className="px-2 pb-2 pt-0 space-y-0.5">
            ...
            <div className="py-1.5">
              <div className="flex min-w-0 flex-col">
                <span className="typography-ui-label text-foreground">
                  {t("settings.projects.page.field.projectName")}
                </span>
              </div>
            ...
            <div className="py-1.5">
              <div className="flex min-w-0 flex-col">
                <span className="typography-ui-label text-foreground">
                  {t("settings.projects.page.field.accentColor")}
                </span>
              </div>
            ...
            <div className="py-1.5">
              <div className="flex min-w-0 flex-col">
                <span className="typography-ui-label text-foreground">
                  {t("settings.projects.page.field.projectIcon")}
                </span>
              </div>
              <input
                ref={fileInputRef}
                  ...
                  return (
                    ...
                    >
                      <Icon
                        name={iconName}
                        className="w-4 h-4"
                        style={currentColorVar && icon === i.key ? { color: currentColorVar } : undefined}
                      />
                    </button>
                  )
                })}
              ...
              <div className="mt-2 flex flex-wrap items-center gap-2">
                {!hasCustomIcon && (
                  <>
                    ...
                    >
                      {isUploadingIcon
                        ? t("settings.projects.page.actions.uploading")
                        : t("settings.projects.page.actions.uploadIcon")}
                    </Button>
                    <Button
                      size="xs"
                      className="h-6 !font-normal"
                    ...
                    >
                      {isDiscoveringIcon
                        ? t("settings.projects.page.actions.discovering")
                        : t("settings.projects.page.actions.discoverFavicon")}
                    </Button>
                  </>
                )}
                {hasRemovableImageIcon && (
                  ...
                  >
                    {isRemovingCustomIcon
                      ? t("settings.projects.page.actions.removing")
                      : t("settings.projects.page.actions.removeProjectIcon")}
                  </Button>
                )}
                {pendingRemoveImageIcon && (
                  <Button
