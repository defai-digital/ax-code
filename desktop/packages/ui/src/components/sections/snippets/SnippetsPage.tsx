...
export const SnippetsPage: React.FC = () => {
  ...
  const selectedSnippet = React.useMemo(
    () =>
      selectedSnippetName
        ? (snippets.find(
            (snippet) => snippet.name === selectedSnippetName || snippet.aliases.includes(selectedSnippetName),
          ) ?? null)
        : null,
    ...
    <ScrollableOverlay outerClassName="h-full" className="w-full">
      <div className="mx-auto w-full max-w-3xl p-3 sm:p-6 sm:pt-8">
        <div className="mb-4 min-w-0">
          ...
          {selectedSnippet ? (
            <p className="typography-meta text-muted-foreground truncate">{selectedSnippet.filePath}</p>
          ) : null}
        </div>
        ...
        <div className="mb-8 space-y-3 px-2">
          <div>
            ...
            <Input
              ...
              className="mt-1.5 h-7 w-full max-w-sm px-2"
            />
          </div>
          <div>
        ...
        <div className="mb-2 px-2">
          ...
          <Textarea
            ...
            placeholder={t("settings.snippets.page.field.contentPlaceholder")}
            rows={12}
            className="mt-1.5 w-full font-mono typography-meta min-h-[160px] max-h-[60vh] bg-transparent"
          />
