...
export const UsageSidebar: React.FC<UsageSidebarProps> = ({ onItemSelect }) => {
  ...
  const persistUsageSettings = React.useCallback(
    async (changes: {
  ...
  const handleUsageAutoRefreshChange = React.useCallback(
    (enabled: boolean) => {
  ...
  const handleUsageRefreshIntervalChange = React.useCallback(
    (value: string) => {
  ...
  const handleUsageDisplayModeChange = React.useCallback(
    (value: string) => {
  ...
  const handleShowPredValuesChange = React.useCallback(
    (enabled: boolean) => {
        ...
        <div className="flex items-center justify-between gap-2">
          ...
          <div className="flex items-center gap-2">
            <Tooltip>
              ...
              <TooltipContent side="bottom">{t("settings.usage.sidebar.tooltip.autoRefresh")}</TooltipContent>
            </Tooltip>
            <Select
