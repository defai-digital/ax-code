 ...
 */
export const PaceIndicator: React.FC<PaceIndicatorProps> = ({ paceInfo, className, compact = false }) => {
  const { t } = useI18n()
  ...
  return (
    <div className={cn("flex items-center justify-between gap-2", className)}>
      ...
      <div className="flex items-center gap-1.5">
        <span className="typography-micro tabular-nums" style={{ color: statusColor }}>
          {paceInfo.isExhausted ? (
            <>
