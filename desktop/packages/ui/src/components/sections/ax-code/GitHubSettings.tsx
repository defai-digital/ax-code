  ...
  return (
    <div className="mb-8">
      ...
      <div className="rounded-lg bg-[var(--surface-elevated)]/70 overflow-hidden flex flex-col">
        {connected ? (
          <div
            className={cn("px-4 py-3", isMobile ? "flex flex-col gap-3" : "flex items-center justify-between gap-4")}
          >
            <div className={cn("flex min-w-0 items-center gap-4", isMobile ? "w-full" : undefined)}>
              {user?.avatarUrl ? (
                <img
                  ...
                  alt={
                    user.login
                      ? t("settings.github.page.avatarAlt.withLogin", { login: user.login })
                      : t("settings.github.page.avatarAlt.fallback")
                  }
              ...
              <div className="min-w-0 flex-1">
                ...
                <div
                  className={cn(
                    "flex items-center gap-2 typography-meta text-muted-foreground mt-0.5",
                    isMobile ? "flex-wrap" : "truncate",
                  )}
                >
          ...
          <div className="flex items-center justify-between gap-4 px-4 py-4">
            <div className="flex min-w-0 flex-col">
              <span className="typography-ui-label text-foreground">
                {t("settings.github.page.status.notConnected")}
              </span>
            </div>
                    ...
                    <div className="flex min-w-0 items-center gap-3">
                      {accountUser?.avatarUrl ? (
                        <img
                          ...
                          alt={
                            accountUser.login
                              ? t("settings.github.page.avatarAlt.withLogin", { login: accountUser.login })
                              : t("settings.github.page.avatarAlt.fallback")
                          }
      ...
      {flow && (
        <div className="mt-4 rounded-lg bg-[var(--surface-elevated)]/70 p-4 border border-[var(--interactive-border)]">
          ...
          <div className="flex items-center justify-between gap-3 mt-4">
            <div className="font-mono text-xl tracking-widest text-foreground bg-[var(--surface-muted)] px-3 py-1.5 rounded-md border border-[var(--interactive-border)]">
              {flow.userCode}
            </div>
