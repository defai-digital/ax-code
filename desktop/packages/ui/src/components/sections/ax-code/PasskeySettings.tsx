    ...
    <div className="mb-8">
      ...
      <section className="px-2 pb-2 pt-0 space-y-2">
        <div className="flex flex-col gap-2 py-1.5 sm:flex-row sm:items-center sm:gap-8">
          <div className="flex min-w-0 flex-col sm:w-56 shrink-0">
            <span className="typography-ui-label text-foreground">
              {t("settings.openchamber.passkeys.field.currentDevice")}
            </span>
          </div>
          <div className="flex items-center gap-2 sm:w-fit">
            ...
            >
              {isRegistering
                ? t("settings.openchamber.passkeys.actions.cancelSetup")
                : t("settings.openchamber.passkeys.actions.add")}
            </Button>
            <Button
              type="button"
              variant="ghost"
            ...
            >
              {isResetting
                ? t("settings.openchamber.passkeys.actions.signingOut")
                : t("settings.openchamber.passkeys.actions.signOutEverywhere")}
            </Button>
          </div>
        </div>
        ...
        {status.enabled && !supportsPasskeys && (
          <p className="typography-meta text-muted-foreground">{supportState.reason}</p>
        )}
                ...
                <div className="flex min-w-0 flex-1 items-center justify-between gap-3">
                  ...
                  >
                    {revokingId === passkey.id
                      ? t("settings.openchamber.passkeys.actions.removing")
