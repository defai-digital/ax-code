...
export function resolveSessionWorktreeState(input: ResolveSessionWorktreeStateInput): SessionWorktreeAttachment {
  ...
  if (runtimeResolution) {
    return {
      ...
      worktreeSource:
        runtimeResolution.worktreeSource ?? (metadata?.source === "sdk" ? "created-for-session" : "existing"),
      legacy: false,
...
export function getSessionWorktreeRepairActions(attachment: SessionWorktreeAttachment): SessionWorktreeRepairAction[] {
