export const settingsDict = {
  ...
  "settings.snippets.page.hint":
    "Use #name in prompts. Supports aliases and prepend/append blocks compatible with ax-code-snippets.",
  ...
  "settings.promptTemplates.sidebar.dialog.deleteDescription":
  ...
  "settings.promptTemplates.page.templateHint":
    "This text will be prepended to the user's prompt when selected in a multi-run group.",
  ...
  "settings.remoteInstances.sidebar.confirm.localPortInUseRetry":
    "Local port is already in use. Pick a random free local port and retry?",
  ...
  "settings.remoteInstances.page.field.modeHint":
    "Managed installs/updates and starts AX Code remotely. External assumes it is already running.",
  ...
  "settings.remoteInstances.page.field.preferredRemotePortHint":
    "Port AX Code should use on the remote host. Leave empty to let the runtime choose.",
  "settings.remoteInstances.page.field.keepServerRunning": "Keep server running",
  "settings.remoteInstances.page.field.keepServerRunningHint":
    "If enabled, AX Code daemon is left running remotely when you disconnect.",
  ...
  "settings.remoteInstances.page.field.preferredLocalPortHint":
    "Preferred local port for the main AX Code tunnel. Leave empty for auto-select.",
  ...
  "settings.remoteInstances.page.confirm.bindAllInterfaces":
  ...
  "settings.openchamber.about.title": "About AX Code",
  ...
  "settings.openchamber.cornerRadius.title": "Corner Radius",
  "settings.openchamber.cornerRadius.field.radius": "Interface corner radius",
  "settings.openchamber.cornerRadius.field.description": "Scale rounded corners throughout the interface.",
  "settings.openchamber.cornerRadius.field.radiusAria": "Interface corner radius in pixels",
  "settings.openchamber.cornerRadius.actions.resetAria": "Reset interface corner radius",
  ...
  "settings.agents.sidebar.dialog.resetDescription":
    'Are you sure you want to reset agent "{name}" to its default configuration?',
  ...
  "settings.agents.sidebar.toast.renamed": 'Agent renamed to "{name}"',
  ...
  "settings.behavior.page.warning.description":
    "Changes made here update {path}. AX Code also includes any project-level AGENTS.md rules when they exist.",
  "settings.behavior.page.section.systemPrompt": "Global AGENTS.md",
  "settings.behavior.page.field.systemPromptPlaceholder":
  ...
  "settings.behavior.page.responseStyle.tooltip":
    "When enabled, these instructions guide how the assistant responds in each new conversation. They are sent with your first message and do not change your global AGENTS.md rules.",
  ...
  "settings.commands.sidebar.dialog.resetDescription":
    'Are you sure you want to reset command "{name}" to its default configuration?',
  ...
  "settings.commands.sidebar.toast.renamed": 'Command renamed to "{name}"',
  ...
  "settings.commands.page.field.templatePlaceholder":
  ...
  "settings.gitIdentities.editor.field.emailAddressTooltip":
  ...
  "settings.skills.sidebar.toast.renamed": 'Skill renamed to "{name}"',
  ...
  "settings.skills.page.field.instructionsPlaceholder":
    "Step-by-step instructions, guidelines, or reference content...",
  ...
  "settings.skills.page.fileDialog.field.filePathHint":
  ...
  "settings.skills.page.toast.invalidSkillName":
    "Skill name must be 1-64 lowercase alphanumeric characters with hyphens, cannot start or end with hyphen",
  ...
  "settings.skills.catalog.conflicts.description":
  ...
  "settings.skills.catalog.add.descriptionPrefix":
    "Add a Git repository as a new catalog source. AX Code will scan it for folders containing",
  ...
  "settings.skills.catalog.add.field.repositoryHint":
  ...
  "settings.skills.catalog.add.toast.authenticationRequiredScan":
    "Authentication required. Select a Git identity and scan again.",
  ...
  "settings.skills.catalog.installFromRepo.authDescription":
  ...
  "settings.skills.catalog.installFromRepo.toast.authenticationRequiredScan":
    "Authentication required. Select a Git identity and try scanning again.",
  "settings.skills.catalog.installFromRepo.toast.authenticationRequiredInstall":
    "Authentication required. Select a Git identity and try installing again.",
  ...
  "settings.openchamber.passkeys.state.uiPasswordRequired":
  ...
  "settings.openchamber.desktopNetwork.field.launchAtLoginAria": "Start AX Code at login",
  "settings.openchamber.desktopNetwork.field.launchAtLogin": "Start AX Code when you log in",
  "settings.openchamber.desktopNetwork.field.launchAtLoginDescription":
    "Starts the app in the background without opening a window. Click the Dock icon to open it.",
  ...
  "settings.openchamber.desktopNetwork.field.allowLanAccessDescription":
    "Restarts the app so trusted computers on your Wi-Fi can open it.",
  "settings.openchamber.desktopNetwork.field.warning":
  ...
  "settings.openchamber.desktopPassword.field.passwordDescription":
    "AX Code asks after restart, then when the login session expires: after 12 hours, or 7 days with Trust this device. Leave empty to disable login.",
  ...
  "settings.openchamber.desktopNetwork.error.launchAtLoginUnsupported":
  ...
  "settings.openchamber.axCodeCli.field.binaryPathPlaceholder": "/opt/homebrew/bin/ax-code",
  ...
  "settings.openchamber.axCodeCli.error.saveOrReloadFailed": "Failed to save or reload AX Code configuration",
  ...
  "settings.mcp.sidebar.deleteDialog.descriptionPrefix":
    'Are you sure you want to delete "{name}"? This will remove it from',
  ...
  "settings.openchamber.keyboardShortcuts.tooltip":
  ...
  "settings.openchamber.keyboardShortcuts.warning.riskyBrowserShortcut":
    "This shortcut can conflict with browser defaults. It is still saved.",
  ...
  "settings.openchamber.keyboardShortcuts.action.open_search_mode.label": "Open search mode",
  ...
  "settings.usage.page.options.showInHeaderTooltip":
  ...
  "settings.usage.page.state.noQuotaWindowsDescription":
    "This provider does not currently report any rate limits or usage quotas.",
  ...
  "settings.remoteInstances.page.section.actionsDescription":
    "Connect, reconnect, inspect logs, or remove this instance.",
  "settings.remoteInstances.page.section.remoteServer": "Remote Server",
  "settings.remoteInstances.page.section.remoteServerDescription":
    "How AX Code is managed and started on the remote host.",
  ...
  "settings.remoteInstances.page.section.authenticationDescription":
    "Optional credentials for SSH and the remote AX Code UI.",
  ...
  "settings.remoteInstances.page.forwardTypeDescription.remote":
    "Expose a remote endpoint and forward it back to your local machine.",
  ...
  "settings.remoteInstances.page.phase.installingOpenChamber": "Installing AX Code",
  "settings.remoteInstances.page.phase.updatingOpenChamber": "Updating AX Code",
  ...
  "settings.openchamber.worktrees.setup.tooltipPrefix":
    "Run automatically inside the new worktree directory when a worktree is created. Use",
  ...
  "settings.openchamber.worktrees.list.tooltip":
    "Worktrees live outside the repo (AX Code-managed). Deleting a worktree also removes linked sessions.",
  ...
  "settings.providers.page.connect.typeField": "Type",
  "settings.providers.page.connect.selectTypePlaceholder": "Select type",
  "settings.providers.page.connect.type.local": "Local runtime",
  "settings.providers.page.connect.type.privateGpu": "Private GPU cloud",
  "settings.providers.page.connect.type.cli": "CLI plan",
  "settings.providers.page.connect.type.api": "API plan",
  ...
  "settings.providers.page.auth.apiKeyTooltip": "Keys are encrypted in AX Code auth storage.",
  ...
  "settings.providers.page.auth.useReconnectHint":
    "· Credentials apply to all projects · Use Reconnect to change key, or Disconnect to remove",
  ...
  "settings.providers.page.models.axEngineDownloadHint":
    "Download a local model here, then pick it in Chat, Code, or Work. Weights stay on this Mac.",
  ...
  "settings.providers.page.models.localStatus.downloading": "Downloading…",
  "settings.providers.page.models.localStatus.downloaded": "Downloaded",
  "settings.providers.page.models.localStatus.readyToDownload": "Ready to download",
  "settings.providers.page.models.localStatus.unavailable": "Unavailable on this Mac",
  "settings.providers.page.models.localStatus.readyForChat": "Ready in chat",
  ...
  "settings.providers.page.models.actions.download": "Download",
  "settings.providers.page.models.actions.cancelDownload": "Cancel",
  "settings.providers.page.actions.saving": "Saving...",
  "settings.providers.page.actions.saveKey": "Save Key",
  "settings.providers.page.actions.useCli": "Use CLI",
  "settings.providers.page.actions.enableLocal": "Enable local",
  "settings.providers.page.actions.refreshLocal": "Refresh",
  ...
  "settings.providers.page.toast.cliProviderConnectFailed": "Failed to connect CLI provider",
  "settings.providers.page.toast.cliProviderConnected": "CLI provider connected",
  "settings.providers.page.toast.localProviderConnectFailed": "Failed to enable local provider",
  "settings.providers.page.toast.localProviderConnected": "Local provider enabled",
  ...
  "settings.providers.custom.option.name": "Custom API provider",
  "settings.providers.custom.field.name": "Provider name",
  "settings.providers.custom.field.namePlaceholder": "Company gateway",
  "settings.providers.custom.field.id": "Provider ID",
  "settings.providers.custom.field.idPlaceholder": "company-gateway",
  "settings.providers.custom.field.idHint": "Lowercase letters, numbers, dots, underscores, and hyphens.",
  "settings.providers.custom.field.protocol": "Protocol",
  "settings.providers.custom.protocol.openai": "OpenAI-compatible",
  "settings.providers.custom.protocol.anthropic": "Anthropic-compatible",
  "settings.providers.custom.field.url": "Base URL",
  "settings.providers.custom.field.insecureAria": "Allow insecure HTTP transport",
  "settings.providers.custom.field.insecureWarning":
    "This remote endpoint uses unencrypted HTTP. Confirm only when the network is trusted.",
  "settings.providers.custom.field.token": "API token",
  ...
  "settings.providers.custom.models.id": "Model ID",
  "settings.providers.custom.models.name": "Display name",
  "settings.providers.custom.models.namePlaceholder": "Optional",
  "settings.providers.custom.models.context": "Context window",
  "settings.providers.custom.models.output": "Output limit",
  "settings.providers.custom.models.capability.tools": "Tool calling",
  "settings.providers.custom.models.capability.reasoning": "Reasoning",
  "settings.providers.custom.models.capability.attachments": "Image input",
  ...
  "settings.mcp.page.status.description.needsAuth":
    "This remote MCP server requires authorization before it can connect.",
  "settings.mcp.page.status.description.needsClientRegistrationDefault":
  ...
  "settings.mcp.page.auth.manualFallbackDescription":
  ...
  "settings.mcp.page.auth.waitingForAxCode":
    "Waiting for AX Code to observe the completed browser authorization flow...",
  "settings.mcp.page.resources.title": "Resources",
  "settings.mcp.page.resources.refreshAria": "Refresh MCP resources",
  "settings.mcp.page.resources.refreshTitle": "Refresh resources",
  "settings.mcp.page.resources.connectFirst": "Connect this server to load resources.",
  "settings.mcp.page.resources.loading": "Loading resources...",
  ...
  "settings.mcp.page.resources.preview.truncated": "Preview truncated.",
  "settings.mcp.page.resources.preview.binary": "Binary content ({mime})",
  "settings.mcp.page.resources.preview.readFailed": "Failed to read resource",
  ...
  "settings.mcp.page.advanced.oauthHint":
    "Leave these fields blank to let AX Code infer OAuth settings from the MCP server.",
  "settings.mcp.page.advanced.oauthCallbackHint":
  ...
  "settings.mcp.page.importDialog.description":
  ...
  "settings.mcp.page.toast.oauthBrowserCallbackSaveFailed":
    "Failed to save the browser callback URL for MCP authorization",
  "settings.mcp.page.toast.axCodeReloadFailedAfterCallbackSave":
    "AX Code reload failed after saving the browser callback URL",
  "settings.mcp.page.toast.completeAuthorizationInBrowserWithPaste":
  ...
  "settings.mcp.page.toast.authSessionExpired":
    "Authorization session expired or was cleared during reload. Click Authorize again.",
  ...
  "settings.mcp.page.toast.missingServerDetails":
    "Missing MCP server details. Select the server again or paste the full callback URL.",
  ...
  "settings.notifications.page.delivery.permissionDenied":
    "Notification permission denied. Enable it in your browser settings.",
  "settings.notifications.page.delivery.permissionGrantedButDisabled":
  ...
  "settings.notifications.page.toast.permissionDenied.description":
    "Please enable notifications in your browser settings.",
  "settings.notifications.page.toast.permissionDenied.enableInBrowser":
  ...
  "settings.openchamber.visual.field.inputBarOffsetTooltip":
  ...
  "settings.openchamber.visual.field.queueMessagesByDefaultTooltip":
    "When enabled, Enter queues messages. Use {modifier}+Enter to send.",
  ...
  "settings.openchamber.visual.option.userMessageRendering.markdown.description":
    "Render user text with markdown formatting.",
  "settings.openchamber.visual.option.userMessageRendering.plain.label": "Plain text",
  "settings.openchamber.visual.option.userMessageRendering.plain.description":
    "Render user text with preserved whitespace and links.",
  "settings.openchamber.visual.option.chatRenderMode.sorted.label": "Sorted",
  "settings.openchamber.visual.option.chatRenderMode.sorted.description":
    "Render completed assistant messages without live streaming.",
  "settings.openchamber.visual.option.chatRenderMode.live.label": "Live",
  "settings.openchamber.visual.option.chatRenderMode.live.description":
    "Stream assistant text and tools as they arrive.",
  "settings.openchamber.visual.option.messageTransport.auto.label": "Auto",
  "settings.openchamber.visual.option.messageTransport.auto.description":
  ...
  "settings.openchamber.visual.option.messageTransport.sse.description":
    "Use Server-Sent Events for message streaming.",
  ...
  "settings.magicPrompts.page.group.gitCommitGenerate.description":
    "Prompts used for commit message generation: visible user message + hidden instructions.",
  "settings.magicPrompts.page.group.gitPrGenerate.title": "PR Generation",
  "settings.magicPrompts.page.group.gitPrGenerate.description":
    "Prompts used for PR title/body generation: visible user message + hidden instructions.",
  "settings.magicPrompts.page.group.githubPrReview.title": "PR Review",
  "settings.magicPrompts.page.group.githubPrReview.description":
    "Prompts used for PR review flow: visible user message + hidden instruction payload.",
  "settings.magicPrompts.page.group.githubIssueReview.title": "Issue Review",
  "settings.magicPrompts.page.group.githubIssueReview.description":
    "Prompts used for issue review flow: visible user message + hidden instruction payload.",
  "settings.magicPrompts.page.group.githubPrFailedChecksReview.title": "PR Failed Checks Review",
  "settings.magicPrompts.page.group.githubPrFailedChecksReview.description":
    "Prompts used for PR failed checks analysis.",
  ...
  "settings.magicPrompts.page.group.githubSinglePrCommentReview.description":
    "Prompts used for single PR comment analysis.",
  "settings.magicPrompts.page.group.gitConflictResolve.title": "Merge/Rebase Conflict Resolution",
  "settings.magicPrompts.page.group.gitConflictResolve.description":
    "Prompts used when resolving merge/rebase conflicts with AI.",
  "settings.magicPrompts.page.group.gitCherrypickConflictResolve.title": "Cherry-pick Conflict Resolution",
  "settings.magicPrompts.page.group.gitCherrypickConflictResolve.description":
    "Prompts used when resolving cherry-pick conflicts in integrate flow.",
  "settings.magicPrompts.page.group.planImprove.title": "Improve Plan",
  "settings.magicPrompts.page.group.planImprove.description":
    "Hidden prompt used when sending a saved plan into an improve flow.",
  "settings.magicPrompts.page.group.planTodo.title": "Todo Planning",
  "settings.magicPrompts.page.group.planTodo.description":
    "Hidden prompt used when sending a todo into a new planning session.",
  "settings.magicPrompts.page.group.planImplement.title": "Implement Plan",
  "settings.magicPrompts.page.group.planImplement.description":
    "Hidden prompt used when sending a saved plan into an implement flow.",
  "settings.magicPrompts.page.group.sessionSummary.title": "Session Summary",
  "settings.magicPrompts.page.group.sessionSummary.description":
    "Prompts used by the /summary slash command: visible user message + hidden instructions. Non-destructive - does not compact session history.",
  ...
  "settings.magicPrompts.page.group.sessionExplore.description":
    "Prompts used by the /explore slash command: visible user message + hidden instructions. Investigates the repository and gives a structured orientation — the big picture, main modules, how they connect, and where to start — rather than a file-by-file dump.",
  "settings.magicPrompts.page.group.sessionWorkspaceReview.description":
    "Prompts used by the /workspace-review slash command: visible user message + hidden instructions. Reviews the workspace diff for whether it achieves its intent and is correct and adequate, classifying findings by severity.",
  "settings.magicPrompts.page.group.sessionFeaturePlan.title": "Feature Planning",
  "settings.magicPrompts.page.group.sessionFeaturePlan.description":
    "Prompts used by the /plan-feature slash command: visible user message + hidden instructions. Runs a guided dialogue that researches the code and asks clarifying questions in small batches before producing an implementation plan.",
  "settings.magicPrompts.page.group.sessionCatchUp.title": "Catch Up",
  "settings.magicPrompts.page.group.sessionCatchUp.description":
    "Prompts used by the /catch-up slash command: visible user message + hidden instructions. Builds branch-aware context — the branch's commits, its PR, and uncommitted work together — to understand what you were doing, then gives a digestible summary and a product-focused next step.",
  "settings.magicPrompts.page.group.sessionDebug.title": "Debugging",
  "settings.magicPrompts.page.group.sessionDebug.description":
    "Prompts used by the /debug slash command: visible user message + hidden instructions. Runs a guided root-cause investigation — captures the symptom, forms hypotheses, checks them against the code, and confirms the cause before proposing a fix.",
  "settings.magicPrompts.page.group.sessionWeigh.title": "Weigh Options",
  "settings.magicPrompts.page.group.sessionWeigh.description":
    "Prompts used by the /weigh slash command: visible user message + hidden instructions. Investigates the code, then lays out 2-3 distinct approaches with trade-offs and a recommendation — without writing a plan or code.",
  "settings.magicPrompts.page.group.sessionFusion.title": "Fusion",
  "settings.magicPrompts.page.group.sessionFusion.description":
    "Prompts used when combining multi-run outputs into one final answer: visible user message + hidden instructions before source results.",
