export const settingsDict = {
  ...
  "settings.remoteInstances.page.field.modeHint":
    "Managed installs/updates and starts AX Code Desktop remotely. External assumes it is already running.",
  ...
  "settings.remoteInstances.page.field.preferredRemotePortHint":
    "Port AX Code Desktop should use on the remote host. Leave empty to let the runtime choose.",
  ...
  "settings.skills.catalog.add.descriptionPrefix":
    "Add a Git repository as a new catalog source. AX Code Desktop will scan it for folders containing",
  ...
  "settings.openchamber.desktopPassword.field.passwordDescription":
    "AX Code Desktop asks after restart, then when the login session expires: after 12 hours, or 7 days with Trust this device. Leave empty to disable login.",
  ...
  "settings.remoteInstances.page.section.remoteServerDescription":
    "How AX Code Desktop is managed and started on the remote host.",
  ...
  "settings.remoteInstances.page.section.authenticationDescription":
    "Optional credentials for SSH and the remote AX Code Desktop UI.",
  ...
  "settings.remoteInstances.page.field.installMethodHint":
    "How AX Code Desktop is installed when running in managed mode.",
  ...
  "settings.providers.page.auth.apiKeyTooltip":
    "Keys are sent directly to AX Code and never stored by AX Code Desktop.",
