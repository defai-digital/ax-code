...
export const dict = {
  ...
  "contextPanel.browser.trustNotice":
    "Pages opened here run with full access to AX Code Desktop — needed for inspect and screenshots. Only open sites you trust: a malicious page could read your data or act on your behalf.",
  ...
  "onboarding.localSetup.windows.stepSetBinaryPath":
    "If AX Code Desktop does not detect AX Code automatically, set the binary path below.",
  ...
  "onboarding.desktopRecovery.incompatibleServer.description":
    'The server at "{host}" is not running AX Code Desktop. Verify the address points to an AX Code Desktop server.',
  ...
  "startup.initRecovery.description":
    "AX Code Desktop could not finish initialization. Check that the server is running, then retry.",
  ...
  "updateDialog.error.takingLonger":
    "Update is taking longer than expected. Wait a bit and refresh, or install the latest build from the official release channel.",
