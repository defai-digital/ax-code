...
export const dict = {
  ...
  "app.tray.permissionResponseFailedDescription": "Could not respond to permission from tray",
  ...
  "dashboard.pulse.loading": "Loading session analysis…",
  "dashboard.pulse.errorTitle": "Couldn’t load session analysis",
  "dashboard.pulse.refresh": "Refresh",
  "dashboard.pulse.emptyTitle": "No session analysis yet",
  "dashboard.pulse.emptyDescription": "Start a chat to see a concise summary of its progress and validation.",
  "dashboard.pulse.openChat": "Open chat",
  "dashboard.pulse.files": "files",
  "dashboard.pulse.changes": "Changes",
  "dashboard.pulse.viewDiff": "View diff",
  "dashboard.pulse.noChanges": "No file changes recorded.",
  "dashboard.pulse.validation": "Validation",
  "dashboard.pulse.notes": "Notes",
  "dashboard.pulse.fullReport": "Open full report",
  ...
  "sessions.sidebar.footer.actions.aboutOpenChamber": "About AX Code",
  "sessions.sidebar.footer.actions.update": "Update",
  "sessions.sidebar.footer.actions.themeMode": "Color mode: {mode}",
  "sessions.sidebar.footer.themeMode.menuTitle": "Color mode",
  ...
  "sessions.sidebar.activity.recentTitle": "Active now",
  "sessions.sidebar.project.home": "Home",
  ...
  "sessions.sidebar.project.actions.pin": "Pin project",
  "sessions.sidebar.project.actions.unpin": "Unpin project",
  ...
  "projects.home.actions.unpin": "Unpin project",
  "projects.home.actions.newSession": "New session",
  "projects.home.status.ready": "Ready",
  "projects.home.lastUsed.justNow": "Last used just now",
  ...
  "projects.import.source.kimi": "Kimi",
  "projects.import.source.both": "Codex + Kimi",
  "projects.import.summary.codex": "Codex: {count}",
  "projects.import.summary.kimi": "Kimi: {count}",
  "projects.import.badge.imported": "Already added",
  "projects.import.badge.missing": "Folder missing",
  "projects.import.actions.retry": "Retry",
  "projects.import.actions.selectAll": "Select all",
  "projects.import.actions.clear": "Clear",
  "projects.import.actions.import": "Import {count}",
  "projects.import.toast.added": "Imported {count} project(s)",
  "projects.import.toast.noneAdded": "No new projects to import",
  "projects.import.error.loadFailed": "Could not discover external projects",
  ...
  "sessions.sidebar.session.menu.unarchive": "Unarchive session",
  "sessions.sidebar.session.menu.exportMarkdown": "Export Markdown",
  "sessions.sidebar.session.menu.runFusion": "Run fusion",
  "sessions.sidebar.session.menu.moveSession": "Move session",
  ...
  "sessions.sidebar.session.export.skippedSubtaskSingle":
    "Exported session, but skipped {count} sub-agent task that could not be loaded.",
  "sessions.sidebar.session.export.skippedSubtaskMany":
  ...
  "sessions.sidebar.session.export.dialog.descriptionSingle":
    "This session has {count} sub-agent task. Include it in the export?",
  "sessions.sidebar.session.export.dialog.descriptionMany":
    "This session has {count} sub-agent tasks. Include them in the export?",
  ...
  "sessions.sidebar.sessionMove.title": "Move session",
  "sessions.sidebar.sessionMove.description":
    "Choose another directory in this project, then validate before moving the session.",
  "sessions.sidebar.sessionMove.current": "Current",
  "sessions.sidebar.sessionMove.dirty": "dirty",
  "sessions.sidebar.sessionMove.customTarget": "Custom target",
  "sessions.sidebar.sessionMove.customTargetPlaceholder": "Enter a project or worktree path",
  "sessions.sidebar.sessionMove.validate": "Validate",
  "sessions.sidebar.sessionMove.move": "Move",
  "sessions.sidebar.sessionMove.moveFailed": "Failed to move session",
  "sessions.sidebar.sessionMove.validation.pending": "Validate the target before moving.",
  "sessions.sidebar.sessionMove.validation.ok": "Target is ready.",
  "sessions.sidebar.sessionMove.validation.targetMissing": "Target does not exist.",
  "sessions.sidebar.sessionMove.validation.targetNotDirectory": "Target is not a directory.",
  "sessions.sidebar.sessionMove.validation.outsideCurrentProject": "Target must stay inside the current project.",
  "sessions.sidebar.sessionMove.validation.sameDirectory": "Session is already in that directory.",
  "sessions.sidebar.sessionMove.validation.invalid": "Target is not valid.",
  "sessions.sidebar.sessionMove.validation.failed": "Failed to validate target",
  ...
  "sessions.sidebar.dialogs.deleteSession.withOneSubtask":
    '"{sessionTitle}" and its {count} sub-task will be permanently deleted.',
  "sessions.sidebar.dialogs.deleteSession.withManySubtasks":
    '"{sessionTitle}" and its {count} sub-tasks will be permanently deleted.',
  "sessions.sidebar.dialogs.archiveSession.withOneSubtask":
    '"{sessionTitle}" and its {count} sub-task will be archived.',
  "sessions.sidebar.dialogs.archiveSession.withManySubtasks":
    '"{sessionTitle}" and its {count} sub-tasks will be archived.',
  ...
  "sessions.sidebar.dialogs.deleteFolder.withOneSubfolder":
    '"{folderName}" will be deleted along with {count} sub-folder. Sessions inside will not be deleted.',
  "sessions.sidebar.dialogs.deleteFolder.withManySubfolders":
    '"{folderName}" will be deleted along with {count} sub-folders. Sessions inside will not be deleted.',
  "sessions.sidebar.dialogs.deleteFolder.withContentsNoSubfolders":
    '"{folderName}" will be deleted. Sessions inside will not be deleted.',
  ...
  "sessions.sidebar.dialogs.worktreeDelete.descriptionOneLinked":
    "This removes the selected worktree and archives {count} linked session.",
  "sessions.sidebar.dialogs.worktreeDelete.descriptionManyLinked":
    "This removes the selected worktree and archives {count} linked sessions.",
  "sessions.sidebar.dialogs.sessionDelete.descriptionOne": "This action permanently removes 1 session.",
  "sessions.sidebar.dialogs.sessionDelete.descriptionOneWithDate":
    "This action permanently removes 1 session from {dateLabel}.",
  "sessions.sidebar.dialogs.sessionDelete.descriptionMany": "This action permanently removes {count} sessions.",
  "sessions.sidebar.dialogs.sessionDelete.descriptionManyWithDate":
    "This action permanently removes {count} sessions from {dateLabel}.",
  ...
  "sessions.sidebar.grouping.archivedWithCount": "Archived ({count})",
  ...
  "sessions.sidebar.sessionDialogs.delete.note":
  ...
  "sessions.sidebar.sessionDialogs.worktree.archivedAndRemoteRemoved":
  ...
  "gitView.history.actions.conflictToastDescription":
    "Conflicts in: {files}. Resolve manually and commit, or abort with git cherry-pick/revert --abort.",
  ...
  "gitView.conflict.toast.resolveFailed": "Failed to resolve conflict",
  "gitView.conflict.toast.tryAgain": "Please try again",
  ...
  "contextPanel.browser.loadFailed": "This page couldn't be loaded",
  "contextPanel.browser.loadFailedHint": "Try loading it again or open the page in your default browser.",
  ...
  "contextPanel.preview.frameTimeout": "Preview did not finish loading.",
  "contextPanel.preview.frameTimeoutHint": "Open it in a browser or retry after the server is ready.",
  ...
  "contextPanel.preview.noDevServer":
    'No dev server command found. Configure a project action or add a "dev" script to package.json.',
  ...
  "contextPanel.preview.noUrlDetected":
    "Dev server started, but no URL was detected in its output. Open the Preview terminal tab to check logs.",
  ...
  "contextPanel.preview.console.attachAnnotation":
    "These are browser console logs from the dev server running for this project.",
  ...
  "contextPanel.preview.inspect.attachAnnotationWithScreenshot":
    "This is a selected DOM element from the in-app preview. A screenshot of the visible preview area with the selected element highlighted is attached.",
  ...
  "diffView.hunk.revertAria": "Revert change {hunk}",
  "diffView.hunk.revertTooltip": "Revert this change, keep the rest",
  "diffView.hunk.revertUnsupported": "Reverting a single change isn't supported here",
  "diffView.hunk.revertFailed": "Failed to revert this change",
  ...
  "rightSidebar.contextNotesTodo.toast.worktreeRequiresGitRepo":
    "Worktree actions are only available for Git repositories",
  ...
  "header.services.shutdownDev": "Stop AX Code",
  ...
  "terminalView.error.rendererFailed": "Terminal renderer failed to start: {message}",
  ...
  "aboutDialog.openChamberVersionLabel": "Desktop app version {version}",
  "aboutDialog.axCodeVersionLabel": "AX Code CLI version {version}",
  ...
  "aboutDialog.diagnosticsDescription": "Includes AX Code state, AX Code health, directories, and projects.",
  ...
  "menuActions.toast.checkUpdatesFailed": "Failed to check for updates",
  "menuActions.toast.latestVersion": "You are on the latest version",
  "menuActions.toast.collectStatusFailed": "Failed to collect ax-code status",
  "helpDialog.title": "Keyboard Shortcuts",
  "helpDialog.description": "Use these keyboard shortcuts to navigate AX Code efficiently",
  ...
  "header.actions.openDashboard": "Open Dashboard",
  "header.actions.openAppMenu": "AX Code menu",
  "header.actions.openAppMenuAria": "Open AX Code menu",
  ...
  "session.githubIssuePicker.description.createSession":
  ...
  "worktreeSessionCreator.error.noActiveProject": "No active project",
  "worktreeSessionCreator.error.noActiveProjectDescription": "Please select a project first.",
  "worktreeSessionCreator.error.notGitRepository": "Not a Git repository",
  "worktreeSessionCreator.error.notGitRepositoryDescription": "Worktrees can only be created in Git repositories.",
  "worktreeSessionCreator.error.createWorktreeFailed": "Failed to create worktree",
  "worktreeSessionCreator.error.createWorktreeSessionFailed": "Failed to create worktree session",
  "worktreeSessionCreator.error.createSessionFailed": "Failed to create session",
  "worktreeSessionCreator.error.createSessionFailedDescription": "Could not create a session for the worktree.",
  "worktreeSessionCreator.error.branchNameRequired": "Branch name is required",
  "worktreeSessionCreator.error.projectNotRegistered": "Project is not registered in AX Code",
  ...
  "chat.turnNextSteps.review": "Review changes",
  "chat.turnNextSteps.commit": "Commit",
  "chat.turnNextSteps.search": "Search chat",
  "chat.turnNextSteps.dismiss": "Dismiss",
  "chat.turnNextSteps.messageDirty": "{count} files changed — next steps",
  "chat.turnNextSteps.messageIdle": "Turn complete — next steps",
  "chat.recentPrompts.title": "Recent",
  "chat.recentPrompts.clear": "Clear recent prompts",
  ...
  "chat.draftPresets.work.planDay.label": "Plan my day",
  "chat.draftPresets.work.draftMessage.label": "Draft a message",
  "chat.draftPresets.work.research.label": "Research a topic",
  "chat.draftPresets.work.summarize.label": "Summarize notes",
  "chat.draftPresets.work.meeting.label": "Prep a meeting",
  "chat.draftPresets.work.followUp.label": "Write follow-ups",
  "chat.draftPresets.work.prioritize.label": "Prioritize tasks",
  "chat.draftPresets.work.automate.label": "Automate a workflow",
  "chat.draftPresets.work.agentTask.label": "Run an agent task",
  "chat.projectKnowledge.loaded": "{file} loaded",
  "chat.projectKnowledge.create": "Create AGENTS.md",
  "chat.projectKnowledge.createPrompt":
    "Create an AGENTS.md file for this project that documents the architecture, coding conventions, and key files for AX Code agents",
  ...
  "chat.timeline.searchPlaceholder": "Search all messages…",
  ...
  "chat.timeline.role.user": "You",
  "chat.timeline.role.assistant": "Agent",
  "chat.timeline.role.other": "Msg",
  ...
  "chat.timeline.rollback.preview": "Preview",
  "chat.timeline.rollback.previewed": "Previewed",
  "chat.timeline.rollback.previewFailed": "Failed to preview rollback",
  ...
  "chat.timeline.toast.forkFailed": "Fork failed",
  "chat.timeline.toast.revertFailed": "Revert failed",
  "chat.timeline.toast.tryAgain": "Please try again",
  ...
  "chat.timeline.rollback.confirmation": "Applying rollback restores these files and removes later session messages.",
  ...
  "chat.error.retryAria": "Retry sending the last message",
  "chat.error.retryUnavailable": "Unable to retry this message",
  "chat.error.retryFailed": "Retry failed",
  "chat.revertPopover.titleWithCount": "Reverted messages ({count})",
  ...
  "chat.revertPopover.forkFailed.title": "Fork failed",
  "chat.revertPopover.forkFailed.retry": "Please try again",
  "chat.revert.toast.undo": "Reverted to {preview}",
  "chat.revert.toast.redo": "Redone",
  "chat.revert.toast.restored": "Restored all messages",
  "chat.fork.toast.success": "Forked from {title}",
  "chat.fork.toast.failed": "Failed to fork session",
  ...
  "chat.questionCard.toast.respondFailed": "Question response failed",
  "chat.questionCard.toast.dismissFailed": "Question dismiss failed",
  "chat.questionCard.toast.tryAgain": "Please try again",
  ...
  "chat.messageBody.actions.editAria": "Edit this message and rerun",
  "chat.messageBody.actions.edit": "Edit and rerun",
  ...
  "chat.messageBody.actions.feedbackUpAria": "Mark response as helpful",
  "chat.messageBody.actions.feedbackUp": "Helpful",
  "chat.messageBody.actions.feedbackDownAria": "Mark response as needing improvement",
  "chat.messageBody.actions.feedbackDown": "Needs improvement",
  "chat.messageBody.actions.feedbackFailed": "Could not save response feedback",
  ...
  "chat.chatInput.executionMode.autonomous": "Auto",
  ...
  "chat.chatInput.executionMode.longRunHint": "Auto, up to 72h with pacing",
  ...
  "chat.chatInput.composerAria": "Message input",
  "chat.loadOlder.loading": "Loading…",
  "chat.loadOlder.action": "Load older messages",
  ...
  "chat.chatInput.toast.attachmentsTooLarge":
  ...
  "chat.chatInput.switchProject": "Switch project",
  "chat.chatInput.selectProject": "Select project",
  "chat.chatInput.searchProjects": "Search projects",
  "chat.chatInput.noProjectsFound": "No projects found",
  ...
  "chat.permissionCard.responseFailed.title": "Permission response failed",
  "chat.permissionCard.responseFailed.retry": "Please try again",
  ...
  "chat.permissionToast.needed.title": "Permission needed",
  "chat.permissionToast.needed.fallbackDescription": "Agent needs your approval",
  "chat.permissionToast.needed.openSession": "Open session",
  ...
  "chat.modelControls.localTooltip": "Runs on this machine.",
  ...
  "commandPalette.item.openPlan": "Open Plan View",
  "commandPalette.item.openGit": "Open Git View",
  "commandPalette.item.openDiff": "Open Diff View",
  "commandPalette.item.openFiles": "Open Files View",
  "commandPalette.item.openTerminal": "Open Terminal View",
  "commandPalette.item.searchConversation": "Search Conversation…",
  "commandPalette.item.themeModeSystem": "Color Mode: System",
  "commandPalette.item.themeModeLight": "Color Mode: Light",
  "commandPalette.item.themeModeDark": "Color Mode: Dark",
  "commandPalette.item.openAppearance": "Open Appearance Settings…",
  "commandPalette.session.untitled": "Untitled Session",
  "commandPalette.searchMode.placeholder": "Search everything...",
  "commandPalette.searchMode.badge": "Search",
  "commandPalette.group.commands": "Commands",
  "commandPalette.group.sessions": "Sessions",
  "commandPalette.group.files": "Files",
  "commandPalette.group.settings": "Settings",
  "splitPane.toggle.title": "Split View",
  "splitPane.resizeAria": "Resize split panes",
  "splitPane.tab.files": "Files",
  "splitPane.tab.diff": "Diff",
  "splitPane.tab.git": "Git",
  "splitPane.tab.terminal": "Terminal",
  "splitPane.tab.plan": "Plan",
  "splitPane.tab.context": "Context",
  ...
  "agentManager.sidebar.dialog.deleteGroupDescription":
    'Delete "{group}"? This removes all worktrees and sessions in this group.',
  ...
  "agentManager.detail.dialog.removeWorktreeDescription":
    'Remove "{label}"? This deletes all sessions in that worktree and removes the worktree itself.',
  "agentManager.detail.dialog.removeOtherWorktreesDescription":
    'Keep "{label}" and remove the other worktrees in "{group}".',
  ...
  "agentManager.empty.setupCommands.description":
  ...
  "agentManager.view.toast.creatingGroup": 'Creating agent group "{name}" with {count} run(s)...',
  "agentManager.view.toast.createdGroup": 'Agent group "{name}" created with {count} session(s)',
  ...
  "sessionAuth.error.networkDescription":
    "We could not verify the UI session. Check that the service is running and try again.",
  ...
  "sessionAuth.locked.unlockTitle": "Unlock AX Code",
  ...
  "desktopHostSwitcher.description": "Switch between Local and remote AX Code servers",
  ...
  "miniChat.actions.minimize": "Minimize window",
  "miniChat.actions.minimizeAria": "Minimize Mini Chat window",
  ...
  "miniChat.unavailable.description":
    "This session could not be loaded. It may have been deleted, archived, or opened from a different project context.",
  ...
  "goToLineDialog.helper.currentLineRange":
    "Current Line: {current}. Type a line number between 1 and {max} to navigate to.",
  ...
  "multiRun.window.description": "AX Code Multi-Run window.",
  ...
  "onboarding.chooser.title": "Welcome to AX Code",
  ...
  "onboarding.remoteConnection.description": "Enter the address of an AX Code server to connect to.",
  ...
  "onboarding.remoteConnection.status.suggestionsUnreachable":
  ...
  "onboarding.remoteConnection.status.suggestionsWrongService":
    "Suggestions: Verify the URL points to an AX Code server, or contact the server administrator.",
  "onboarding.remoteConnection.status.suggestionsIncompatible":
    "Suggestions: Update AX Code or use a server version compatible with this client.",
  ...
  "onboarding.remoteConnection.probe.authMessage":
    "Server requires authentication. You can still connect, but may need to provide credentials.",
  "onboarding.remoteConnection.probe.wrongServiceMessage":
    "Server responded but is not running AX Code. Verify the address points to an AX Code server.",
  ...
  "onboarding.remoteConnection.probe.incompatibleMessage":
    "Server responded but is not compatible with this AX Code version.",
  "onboarding.remoteConnection.probe.updateRecommendedMessage":
    "Server requires a newer AX Code client before connecting.",
  ...
  "onboarding.desktopRecovery.noDefaultConnection.description":
    "Your saved default connection could not be found. Choose how you want to connect.",
  "onboarding.desktopRecovery.remoteUnreachable.title": "Remote Server Unreachable",
  "onboarding.desktopRecovery.remoteUnreachable.description":
    'Could not connect to "{host}". Check your network connection and verify the server address.',
  ...
  "onboarding.desktopRecovery.incompatibleServer.description":
    'The server at "{host}" is not running AX Code. Verify the address points to an AX Code server.',
  ...
  "startup.initRecovery.description":
    "AX Code could not finish initialization. Check that the server is running, then retry.",
  ...
  "axCodeUpdate.toast.upgrading.description": "Keep AX Code open.",
  ...
  "axCodeUpdate.toast.incompatible.description":
    "Installed AX Code {version} is older than the minimum supported {minVersion}. Some features may not work until you update.",
  ...
  "openChamberLogo.aria.logo": "AX Code logo",
  ...
  "emptyState.git.description": "Open a folder with a .git directory to see branches, staging, and commits.",
  "emptyState.diff.title": "No changes to review",
  "emptyState.diff.description": "Make changes to your files to see diffs here.",
  "emptyState.files.title": "No folder open",
  "emptyState.files.description": "Open a folder to browse and edit files.",
  "emptyState.files.openFolder": "Open Folder",
  "emptyState.terminal.title": "No terminal session",
  "emptyState.terminal.description": "Open a terminal to run commands.",
  "emptyState.plan.title": "No plan file",
  "emptyState.plan.description": "Create a plan to organize your work and track progress.",
  "emptyState.chat.openFolder": "Open Folder",
  "emptyState.chat.shortcuts": "Keyboard Shortcuts",

  // Notification center
  "notificationCenter.title": "Notifications",
  "notificationCenter.empty": "No notifications",
  "notificationCenter.emptyDescription": "You're all caught up.",
  "notificationCenter.markAllRead": "Mark all read",
  "notificationCenter.clearAll": "Clear all",
  "notificationCenter.permissions": "Permissions",
  ...
  "notificationCenter.time.minutesAgo": "{count}m ago",
  ...
  "localModels.toast.downloadStartFailed": "Failed to start download",
  "localModels.toast.downloadAlreadyFinished": "Download had already finished",
  "localModels.toast.downloadCancelled": "Download cancelled",
  "localModels.toast.actionFailed": "Model action failed",
  "localModels.toast.engineInstalled": "AX Engine installed",
  "localModels.toast.engineStopped": "AX Engine stopped",
  "localModels.toast.engineStarted": "AX Engine started",
  "localModels.toast.noRunnableModel": "Download a runnable model before starting AX Engine",
  "axEngine.download.toast.downloading": "Downloading {name}…",
  "axEngine.download.toast.downloadingDescription":
    "Large models can take several minutes — you can keep working while it downloads.",
  "axEngine.download.toast.progress": "{percent}% complete",
  "axEngine.download.toast.progressWithMessage": "{percent}% — {message}",
  "axEngine.download.toast.interrupted": "{name} download interrupted",
  "axEngine.download.toast.interruptedDescription":
    "AX Code restarted while downloading. Check the model list and retry if needed.",
  "axEngine.download.toast.downloaded": "{name} downloaded",
  "axEngine.download.toast.downloadedDescription": "Ready to start.",
  "axEngine.download.toast.failed": "{name} download failed",
} as const
