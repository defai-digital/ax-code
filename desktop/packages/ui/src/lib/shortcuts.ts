...
export function getEffectiveShortcutCombo(actionId: string, overrides?: Record<string, ShortcutCombo>): ShortcutCombo {
...
export function getEffectiveShortcutLabel(actionId: string, overrides?: Record<string, ShortcutCombo>): string {
