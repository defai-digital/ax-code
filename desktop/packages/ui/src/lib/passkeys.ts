import { startAuthentication, startRegistration, WebAuthnAbortService, WebAuthnError } from "@simplewebauthn/browser"
...
export const registerCurrentDevicePasskey = async () => {
  ...
  const label =
    typeof navigator.userAgent === "string" && navigator.userAgent.trim() ? navigator.userAgent : "This device"
