...
// Referenced as an external asset URL (not inlined) so the ~1MB sprite stays
// out of the JS bundle; `<use href="url#id">` resolves it same-origin.
import spriteUrl from "../assets/icons/file-types/sprite.svg?url"
