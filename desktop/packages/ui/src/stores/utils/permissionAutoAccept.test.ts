...
describe("autoRespondsPermission", () => {
  ...
  test("returns true when grandparent has autoAccept enabled", () => {
    ...
    const sessions = [makeSession("grandparent"), makeSession("parent", "grandparent"), makeSession("child", "parent")]
    expect(
      autoRespondsPermission({
        autoAccept,
        sessions,
  ...
  test("returns false when only sibling has autoAccept enabled", () => {
    ...
    const sessions = [makeSession("parent"), makeSession("sibling", "parent"), makeSession("child", "parent")]
    expect(
      autoRespondsPermission({
        autoAccept,
        sessions,
