...
1. `$AX_CODE_INSTALL_DIR` - Tilpasset installationsmappe
...
ax-code har to indbyggede agents, som du kan skifte mellem med `Tab`-tasten.
...
Hvis du vil bidrage til ax-code, så læs vores [contributing docs](./CONTRIBUTING.md) før du sender en pull request.
