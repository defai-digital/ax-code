...
const webDir = path.join(repoRoot, 'packages', 'app');
const electronDir = path.join(repoRoot, 'packages', 'app-electron');
...
console.log('[app-electron] building web UI dist...');
run(bunExe, ['run', 'build'], webDir);

console.log('[app-electron] staging packaged resources...');
...
console.log(`[app-electron] web assets ready: ${resourcesWebDistDir}`);
