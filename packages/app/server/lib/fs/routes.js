...
const resolveWorkspacePath = ({ targetPath, baseDirectory, path, os, normalizeDirectoryPath, axCodeUserConfigRoot }) => {
  ...
  if (isPathWithinRoot(resolved, axCodeUserConfigRoot, path, os)) {
    return { ok: true, base: path.resolve(axCodeUserConfigRoot), resolved };
  }
...
const resolveWorkspacePathFromContext = async ({ req, targetPath, resolveProjectDirectory, path, os, normalizeDirectoryPath, axCodeUserConfigRoot }) => {
...
const resolveReadPathFromContext = async ({ req, targetPath, resolveProjectDirectory, path, os, normalizeDirectoryPath, axCodeUserConfigRoot }) => {
