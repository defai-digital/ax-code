import type { Message, Session, TextPart, UserMessage } from "@ax-code/sdk/v2/client"
import { Avatar } from "@ax-code/ui/avatar"
import { HoverCard } from "@ax-code/ui/hover-card"
import { Icon } from "@ax-code/ui/icon"
import { IconButton } from "@ax-code/ui/icon-button"
import { MessageNav } from "@ax-code/ui/message-nav"
import { Spinner } from "@ax-code/ui/spinner"
import { Tooltip } from "@ax-code/ui/tooltip"
    ...
    <div class={`relative size-8 shrink-0 rounded ${props.class ?? ""}`}>
      <div class="size-full rounded overflow-clip">
        <Avatar
          fallback={name()}
          src={
            props.project.id === OPENCODE_PROJECT_ID ? "https://ax-code.ai/favicon.svg" : props.project.icon?.override
          }
