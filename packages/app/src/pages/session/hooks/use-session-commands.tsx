...
import { createSessionTabs } from "../state/helpers"
...
export const useSessionCommands = (actions: SessionCommandContext) => {
  ...
  const currentIsolationMode = (): IsolationMode => globalSync.data.config.isolation?.mode ?? "workspace-write"
  ...
  const toggleIsolationNetwork = async () => {
    ...
    showToast({
      title: next ? language.t("toast.isolation.network.on.title") : language.t("toast.isolation.network.off.title"),
      description: next
