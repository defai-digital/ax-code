export const dict = {
  ...
  "command.isolation.mode.readonly": "Isolation: read-only",
  "command.isolation.mode.readonly.description": "Block all file mutations and shell commands",
  "command.isolation.mode.workspace": "Isolation: workspace write",
  "command.isolation.mode.workspace.description": "Allow writes only inside the workspace",
  "command.isolation.mode.fullaccess": "Isolation: full access",
  "command.isolation.mode.fullaccess.description": "Disable isolation (no sandbox restrictions)",
  "command.isolation.network.toggle": "Toggle network access",
  "command.isolation.network.toggle.description": "Enable or disable network access for tools",
  ...
  "dialog.provider.group.popular": "Online",
  "dialog.provider.group.other": "Offline",
  ...
  "dialog.model.unpaid.freeModels.title": "Free models provided by AX Code",
  ...
  "provider.connect.apiKey.description":
    "Enter your {{provider}} API key to connect your account and use {{provider}} models in AX Code.",
  "provider.connect.apiKey.label": "{{provider}} API key",
  "provider.connect.apiKey.placeholder": "API key",
  "provider.connect.apiKey.required": "API key is required",
  "provider.connect.opencodeZen.line1":
    "AX Code Zen gives you access to a curated set of reliable optimized models for coding agents.",
  "provider.connect.opencodeZen.line2":
    "With a single API key you'll get access to models such as Claude, GPT, Gemini, GLM and more.",
  "provider.connect.opencodeZen.visit.prefix": "Visit ",
  "provider.connect.opencodeZen.visit.link": "ax-code.ai/zen",
  "provider.connect.opencodeZen.visit.suffix": " to collect your API key.",
  "provider.connect.oauth.code.visit.prefix": "Visit ",
  "provider.connect.oauth.code.visit.link": "this link",
  "provider.connect.oauth.code.visit.suffix":
    " to collect your authorization code to connect your account and use {{provider}} models in AX Code.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " and enter the code below to connect your account and use {{provider}} models in AX Code.",
  ...
  "quickstart.home.description": "Open a new session in {{project}} with a starter prompt",
  "quickstart.session.description": "Start with a proven prompt, then refine it in the composer",
  "quickstart.plan": "Plan",
  "quickstart.plan.prompt":
    "Review this codebase, identify the relevant files, and give me a plan before making changes.",
  "quickstart.build": "Build",
  "quickstart.build.prompt":
    "Implement this feature end to end. Start by inspecting the codebase, then make the changes and explain what changed.",
  "quickstart.debug": "Debug",
  "quickstart.debug.prompt":
    "Investigate this bug, find the root cause, implement a fix, and verify the result with the relevant checks.",
  "quickstart.review": "Review",
  "quickstart.review.prompt":
    "Review the current changes for bugs, regressions, and missing tests. Prioritize findings and cite the affected files.",
  "quickstart.explain": "Explain",
  "quickstart.explain.prompt":
    "Explain how this part of the codebase works and point me to the key files and data flow.",
  "quickstart.tests": "Fix tests",
  "quickstart.tests.prompt":
    "Run the relevant tests, fix failures, and explain the root cause of each issue you changed.",

  "prompt.popover.emptyResults": "No matching results",
  "prompt.popover.emptyCommands": "No matching commands",
  "prompt.recipe.open": "Recipes",
  "prompt.recipe.title": "Recipes",
  "prompt.recipe.description": "Browse slash-command workflows and insert them into the composer.",
  "prompt.recipe.search.placeholder": "Search recipes",
  "prompt.recipe.empty": "No recipes found",
  "prompt.recipe.group.pinned": "Pinned",
  "prompt.recipe.group.recent": "Recent",
  "prompt.recipe.group.recommended": "Recommended by repo",
  "prompt.recipe.group.builtin": "Built in",
  "prompt.recipe.group.project": "Project",
  "prompt.recipe.group.skill": "Skills",
  "prompt.recipe.group.mcp": "MCP",
  "prompt.recipe.action.pin": "Pin",
  "prompt.recipe.action.unpin": "Unpin",
  ...
  "dialog.plugins.empty": "Plugins configured in ax-code.json",
  ...
  "dialog.server.description": "Switch which AX Code server this app connects to.",
  ...
  "dialog.project.edit.worktree.startup.placeholder": "e.g. pnpm install",
  ...
  "toast.isolation.mode.title": "Isolation mode: {{mode}}",
  "toast.isolation.mode.readonly": "All file mutations and shell commands are blocked",
  "toast.isolation.mode.workspace": "Writes allowed only inside the workspace",
  "toast.isolation.mode.fullaccess": "No sandbox restrictions — the agent has full access",
  "toast.isolation.network.on.title": "Network access enabled",
  "toast.isolation.network.on.description": "Tools can make network requests",
  "toast.isolation.network.off.title": "Network access disabled",
  "toast.isolation.network.off.description": "Network tools are blocked",
  ...
  "toast.update.description": "A new version of AX Code ({{version}}) is now available to install.",
  ...
  "error.page.report.prefix": "Please report this error to the AX Code team",
  ...
  "error.chain.checkConfig": "Check your config (ax-code.json) provider/model names",
  "error.chain.mcpFailed": 'MCP server "{{name}}" failed. Note, AX Code does not support MCP authentication yet.',
  ...
  "session.permission.summary": "Allow {{tool}}?",
  "session.permission.kind.read": "Reads project data",
  "session.permission.kind.write": "Writes or executes",
  "session.permission.kind.network": "Uses external sources",
  "session.permission.kind.agent": "Delegates work",
  "session.permission.kind.guard": "Overrides a safety check",
  "session.permission.request.one": "{{count}} target in this request",
  "session.permission.request.other": "{{count}} targets in this request",
  "session.permission.action.reject": "Don't allow",
  "session.permission.action.always": "Allow future matches",
  "session.permission.action.once": "Allow this request",
  "session.permission.batch.summary.one": "{{count}} more {{tool}} request is waiting in this session",
  "session.permission.batch.summary.other": "{{count}} more {{tool}} requests are waiting in this session",
  "session.permission.batch.action.reject": "Reject queued",
  "session.permission.batch.action.once": "Allow queued once",
  "session.permission.note.once": "Current request only",
  "session.permission.future.none": "No future matches will be approved automatically.",
  "session.permission.future.some.one": "{{count}} future match will be approved automatically until AX Code restarts.",
  "session.permission.future.some.other":
    "{{count}} future matches will be approved automatically until AX Code restarts.",
  "session.permission.future.all":
    "All future {{tool}} requests will be approved automatically until AX Code restarts.",
  "session.permission.showDetails": "Show details",
  "session.permission.hideDetails": "Hide details",
  "session.permission.detail.request": "Current request",
  "session.permission.detail.future": "Future matches",
  "session.permission.meta.path": "Path",
  "session.permission.meta.pattern": "Pattern",
  "session.permission.meta.command": "Command",
  "session.permission.meta.task": "Task",
  "session.permission.meta.url": "URL",
  "session.permission.meta.query": "Query",
  "session.permission.saving": "Saving decision...",
  "session.review.visible": "{{visible}} of {{total}} visible",
  "session.review.filter.all": "All",
  "session.review.filter.added": "Added",
  "session.review.filter.modified": "Modified",
  "session.review.filter.deleted": "Deleted",
  "session.review.action.next": "Next file",
  "session.review.action.open": "Open file",
  "session.review.empty.filtered.all": "No files match this view",
  "session.review.empty.filtered.added": "No added files in this view",
  "session.review.empty.filtered.modified": "No modified files in this view",
  "session.review.empty.filtered.deleted": "No deleted files in this view",
  ...
  "session.todo.current": "Current step",
  "session.todo.currentOnly": "Current step only",
  "session.todo.allSteps": "Show all steps",
  "session.todo.ask": "Ask me to do this next",
  "session.todo.explain": "Explain this step",
  "session.todo.queue": "Queue this step",
  "session.todo.done": "All planned steps are complete",
  "session.todo.ask.prompt":
    "Continue with this plan step next:\n\n{{step}}\n\nImplement it, update the todo progress, and summarize what changed.",
  "session.todo.explain.prompt":
    "Explain this plan step before you do it:\n\n{{step}}\n\nClarify the files involved, the risks, and the checks you would run.",
  "session.todo.queue.prompt":
    "When the current task finishes, continue with this plan step next:\n\n{{step}}\n\nImplement it, update the todo progress, and summarize what changed.",
  "session.question.progress": "{{current}} of {{total}} questions",
  "session.followupDock.summary.one": "{{count}} queued message",
  "session.followupDock.summary.other": "{{count}} queued messages",
  "session.followupDock.state.paused": "Paused",
  "session.followupDock.state.failed": "Needs retry",
  "session.followupDock.sendNow": "Send now",
  "session.followupDock.retryNow": "Retry now",
  "session.followupDock.retry": "Retry failed",
  ...
  "session.status.mode.label": "Mode",
  "session.status.mode.ready": "Ready",
  "session.status.mode.busy": "Working",
  "session.status.mode.retry": "Retry {{attempt}}",
  "session.status.mode.question": "Question",
  "session.status.mode.permission": "Approval needed",
  "session.status.workspace": "Workspace",
  "session.status.directory": "Directory",
  "session.status.server": "Server",
  "session.status.server.ready": "Connected",
  "session.status.server.error": "Unavailable",
  "session.status.server.checking": "Checking",
  "session.status.review": "Review",
  "session.status.review.none": "No changes",
  "session.status.review.one": "{{count}} change",
  "session.status.review.other": "{{count}} changes",
  "session.status.context": "Context",
  "session.status.context.loading": "Loading...",
  "session.status.context.unavailable": "Unavailable",
  "session.status.context.rules.none": "No rules",
  "session.status.context.rules.one": "{{count}} rule",
  "session.status.context.rules.other": "{{count}} rules",
  "session.status.context.memory.ready": "memory ready",
  "session.status.context.memory.empty": "no memory",
  "session.status.approval": "Approvals",
  "session.status.approval.ask": "Ask first",
  "session.status.approval.auto": "Auto-approve on",
  "session.status.approval.pending.one": "{{count}} pending",
  "session.status.approval.pending.other": "{{count}} pending",
  "session.status.followup": "Followups",
  "session.status.followup.queued.one": "{{count}} queued",
  "session.status.followup.queued.other": "{{count}} queued",
  ...
  "session.handoff.metric.files.other": "{{count}} files changed",
  "session.handoff.metric.additions": "+{{count}} additions",
  "session.handoff.metric.deletions": "-{{count}} deletions",
  "session.handoff.open.title": "Open items",
  "session.handoff.open.deleted": "Deleted files are included. Verify imports, routes, and references still resolve.",
  "session.handoff.open.config": "Config or dependency files changed. Check install, build, and generated outputs.",
  "session.handoff.open.added": "New files were added. Confirm they are wired into the intended entry points.",
  "session.handoff.open.generic": "No obvious risk flags from file shape. Review the changed paths before merging.",
  "session.handoff.verify.title": "Suggested verification",
  "session.handoff.verify.review": "Open the review tab and scan the changed files in order.",
  "session.handoff.verify.deleted":
  ...
  "session.context.open": "Project context",
  "session.context.title": "Project context",
  "session.context.description": "Inspect instruction files and cached memory for the current project.",
  "session.context.root": "Project root",
  "session.context.directory": "Current directory",
  "session.context.files.title": "Project files",
  "session.context.instructions.title": "Loaded instructions",
  "session.context.memory.title": "Cached memory",
  "session.context.memory.empty": "No cached memory yet",
  "session.context.memory.tokens": "{{count}} tokens",
  "session.context.memory.updated": "Updated {{time}}",
  "session.context.memory.sections": "Sections",
  "session.context.memory.refresh": "Refresh memory",
  "session.context.memory.clear": "Clear memory",
  "session.context.memory.refreshed.title": "Project memory refreshed",
  "session.context.memory.cleared.title": "Project memory cleared",
  "session.context.permissions.title": "Permission rules",
  "session.context.permissions.description": "Review and revoke future permission approvals for this workspace.",
  "session.context.permissions.empty": "No future permission approvals are active in this workspace.",
  "session.context.permissions.rule.workspace": "This workspace",
  "session.context.permissions.rule.current": "Current session",
  "session.context.permissions.rule.session": "Session {{id}}",
  "session.context.permissions.scope.workspace": "Workspace",
  "session.context.permissions.scope.current": "Current session",
  "session.context.permissions.scope.session": "Session",
  "session.context.permissions.auto": "Future matching permission requests are approved automatically.",
  "session.context.permissions.sessionID": "Session ID: {{id}}",
  "session.context.permissions.revoke": "Revoke",
  "session.context.permissions.revoked.title": "Permission rule revoked",
  "session.context.permissions.legacy": "Legacy",
  "session.context.scope.project": "Project",
  "session.context.scope.global": "Global",
  "session.context.state.missing": "Missing",
  "session.context.hash": "Hash",
  "session.context.copyPath": "Copy path",
  "session.context.templates.title": "Starter guides",
  "session.context.templates.description":
    "Create repo rules and reusable checklists as plain markdown files in this project.",
  "session.context.template.create": "Create",
  "session.context.template.created.title": "Template created",
  "session.context.template.kind.instruction": "Instruction",
  "session.context.template.kind.checklist": "Checklist",
  ...
  "sidebar.gettingStarted.line1": "AX Code includes free models so you can start immediately.",
  ...
  "sidebar.activity.clear": "Clear",
  "sidebar.activity.group.attention": "Needs attention",
  "sidebar.activity.group.running": "Running",
  "sidebar.activity.group.ready": "Ready",
  "sidebar.activity.group.error": "Errored",
  "sidebar.activity.item.running": "Working",
  "sidebar.activity.item.retry": "Retry {{attempt}}",
  "sidebar.activity.item.ready": "{{count}} new updates",
  "sidebar.activity.item.todo": "{{done}} of {{total}} tasks",
  ...
  "app.name.desktop": "AX Code Desktop",

  "settings.section.desktop": "Desktop",
  "settings.section.server": "Server",
  "settings.tab.general": "General",
  "settings.tab.shortcuts": "Shortcuts",
  "settings.tab.isolation": "Isolation",
  "settings.desktop.section.wsl": "WSL",
  "settings.desktop.wsl.title": "WSL integration",
  "settings.desktop.wsl.description": "Run the AX Code server inside WSL on Windows.",
  ...
  "settings.general.row.language.description": "Change the display language for AX Code",
  "settings.general.row.appearance.title": "Appearance",
  "settings.general.row.appearance.description": "Customise how AX Code looks on your device",
  "settings.general.row.colorScheme.title": "Color scheme",
  "settings.general.row.colorScheme.description": "Choose whether AX Code follows the system, light, or dark theme",
  "settings.general.row.theme.title": "Theme",
  "settings.general.row.theme.description": "Customise how AX Code is themed.",
  ...
  "settings.isolation.section.sandbox": "Sandbox",
  "settings.isolation.row.mode.title": "Sandbox mode",
  "settings.isolation.row.mode.description": "Controls what the agent can technically access",
  "settings.isolation.row.mode.readonly": "Read-only",
  "settings.isolation.row.mode.readonly.description": "Can inspect, cannot mutate",
  "settings.isolation.row.mode.workspace": "Workspace write",
  "settings.isolation.row.mode.workspace.description": "Can edit only inside this workspace",
  "settings.isolation.row.mode.fullaccess": "Full access",
  "settings.isolation.row.mode.fullaccess.description": "No sandbox restrictions",
  "settings.isolation.row.mode.fullaccess.warning":
    "Disables command sandboxing. The agent may modify files or execute commands with your full user access.",
  "settings.isolation.row.network.title": "Network access",
  "settings.isolation.row.network.description": "Allow tools to make network requests",
  "settings.isolation.section.protected": "Protected paths",
  "settings.isolation.row.protected.description":
    "These paths are always protected from writes, even in workspace-write mode. .git and .ax-code are always protected.",

  "settings.updates.row.startup.title": "Check for updates on startup",
  "settings.updates.row.startup.description": "Automatically check for updates when AX Code launches",
  ...
  "settings.updates.toast.latest.description": "You're running the latest version of AX Code.",
  ...
  "settings.providers.section.popular": "Connected providers",
