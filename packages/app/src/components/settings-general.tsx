...
let font: Promise<typeof import("@ax-code/ui/font-loader")> | undefined

function loadFont() {
  font ??= import("@ax-code/ui/font-loader")
  return font
}
        ...
        <SettingsRow
          ...
          description={
            <>
              ...
              <Link href="https://ax-code.ai/docs/themes/">{language.t("common.learnMore")}</Link>
            </>
          }
        >
          <Select
