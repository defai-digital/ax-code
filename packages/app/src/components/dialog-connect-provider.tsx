import type { ProviderAuthAuthorization, ProviderAuthMethod } from "@ax-code/sdk/v2/client"
...
import { List, type ListRef } from "@ax-code/ui/list"
          ...
          <Match when={provider().id === "opencode"}>
            <div class="flex flex-col gap-4">
              ...
              <div class="text-14-regular text-text-base">
                ...
                <Link href="https://ax-code.ai/zen" tabIndex={-1}>
