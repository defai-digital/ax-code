...
beforeAll(async () => {
  ...
  mock.module("@ax-code/ui/collapsible", () => ({
    Collapsible: {
      Trigger: (props: { children?: unknown }) => props.children,
      Content: (props: { children?: unknown }) => props.children,
    },
  }))
  mock.module("@ax-code/ui/file-icon", () => ({ FileIcon: () => null }))
  mock.module("@ax-code/ui/icon", () => ({ Icon: () => null }))
  mock.module("@ax-code/ui/tooltip", () => ({ Tooltip: (props: { children?: unknown }) => props.children }))
