...
const { KVProvider, useKV } = await import("../src/cli/cmd/tui/context/kv")
const { TuiConfigProvider } = await import("../src/cli/cmd/tui/context/tui-config")
const { LanguageProvider, useLanguage } = await import("../src/cli/cmd/tui/context/language")
const { ThemeProvider } = await import("../src/cli/cmd/tui/context/theme")
const { KeybindProvider } = await import("../src/cli/cmd/tui/context/keybind")
const { ToastProvider } = await import("../src/cli/cmd/tui/ui/toast")
const { DialogProvider, useDialog } = await import("../src/cli/cmd/tui/ui/dialog")
const { SetupWizard } = await import("../src/cli/cmd/tui/component/setup-wizard")
const { DialogLanguage } = await import("../src/cli/cmd/tui/component/dialog-language")
const { DialogConfirm } = await import("../src/cli/cmd/tui/ui/dialog-confirm")
const { LOCALES, LANGUAGE_LABELS, translate } = await import("../src/cli/cmd/tui/i18n")
