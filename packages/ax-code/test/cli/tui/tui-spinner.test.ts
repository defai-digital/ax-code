...
import { getSpinnerPreset, getSpinnerNames, randomSpinner } from "../../../../ax-code-tui/spinner/src/presets"
import presets from "../../../../ax-code-tui/spinner/src/presets"
import {
  createStatic,
  createPulse,
  createWave,
...
} from "../../../../ax-code-tui/spinner/src/utils"

// ---------------------------------------------------------------------------
// Presets
// ---------------------------------------------------------------------------

describe("AX Code TUI spinner presets", () => {
