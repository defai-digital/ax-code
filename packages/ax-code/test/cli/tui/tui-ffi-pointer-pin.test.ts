...
// not run yet. Bun's JSC scans the stack conservatively, so the upstream
...
// ring behavior, so an upstream renderer sync that drops the pin goes red here
...
describe("AX Code TUI FFI pointer pinning", () => {
