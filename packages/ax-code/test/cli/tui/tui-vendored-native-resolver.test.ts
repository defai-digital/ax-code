...
// Guard for the vendored native resolver in @ax-code/tui: the Zig
// shared libraries ship in-repo under packages/ax-code-tui/vendor/<target>/
...
if (!found) throw new Error("vendored native resolver missing: resolveVendoredNativeTarget() not found in @ax-code/tui")
...
describe("AX Code TUI vendored native resolver", () => {
