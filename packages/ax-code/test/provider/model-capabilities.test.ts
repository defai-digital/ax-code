  ...
  describe("Kimi and DeepSeek gateway fallbacks", () => {
    ...
    it("covers Kimi K2.7 Code across gateway spellings", () => {
      for (const [id, provider] of [
        ...
        expect(caps.promptCache, id).toBe("experimental")
    ...
    it("covers DeepSeek V4 and V3.2 across gateway spellings", () => {
      ...
      const fast = getModelCapabilities("deepseek-ai/DeepSeek-V3.2-fast", "nebius")
      expect(fast.contextWindow).toBe(8_000)
      expect(supportsLongAgent("deepseek-ai/DeepSeek-V3.2-fast", "nebius")).toBe(false)
