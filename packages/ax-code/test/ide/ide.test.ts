...
describe("ide", () => {
  ...
  test("should recognize vscode-insiders AX_CODE_CALLER", () => {
    process.env["AX_CODE_CALLER"] = "vscode-insiders"

    expect(Ide.alreadyInstalled()).toBe(true)
  })

  test("should recognize vscode AX_CODE_CALLER", () => {
    process.env["AX_CODE_CALLER"] = "vscode"

    expect(Ide.alreadyInstalled()).toBe(true)
  })

  test("should return false for unknown AX_CODE_CALLER", () => {
    process.env["AX_CODE_CALLER"] = "unknown"
