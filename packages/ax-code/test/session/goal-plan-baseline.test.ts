...
describe("GoalPlanBaseline", () => {
  ...
  test("does not treat non-git commands or pathspecs as git before-states", () => {
    ...
    expect(() =>
      GoalPlanBaseline.prepareAssurance(contract("sh -c '$GIT diff --name-only origin/main..HEAD'"), {
        objective: "refactor the core runtime then test and commit",
      }),
    ).toThrow(/origin\/main/)
    expect(() =>
      GoalPlanBaseline.prepareAssurance(contract("eval '$GIT diff --name-only origin/main..HEAD'"), {
        objective: "refactor the core runtime then test and commit",
      }),
    ).toThrow(/origin\/main/)
    expect(() =>
      GoalPlanBaseline.prepareAssurance(contract('test -z "$(git diff origin/main..HEAD)"'), {
        objective: "refactor the core runtime then test and commit",
      }),
    ).toThrow(/origin\/main/)
    expect(() =>
      GoalPlanBaseline.prepareAssurance(contract("! git diff origin/main..HEAD"), {
        objective: "refactor the core runtime then test and commit",
      }),
    ).toThrow(/origin\/main/)
    expect(() =>
      GoalPlanBaseline.prepareAssurance(contract("if git diff origin/main..HEAD; then true; fi"), {
        objective: "refactor the core runtime then test and commit",
      }),
    ).toThrow(/origin\/main/)
    expect(() =>
    ...
    expect(() =>
      GoalPlanBaseline.prepareAssurance(contract("bash script/check.sh '$GIT diff origin/main..HEAD'"), {
        objective: "refactor the core runtime then test and commit",
      }),
    ).not.toThrow()
    expect(() =>
      GoalPlanBaseline.prepareAssurance(contract("bash -o pipefail -c 'git diff origin/main..HEAD'"), {
        objective: "refactor the core runtime then test and commit",
      }),
    ).toThrow(/origin\/main/)
    expect(() =>
      GoalPlanBaseline.prepareAssurance(
        contract("bash --noprofile --rcfile /dev/null -c 'git diff origin/main..HEAD'"),
        { objective: "refactor the core runtime then test and commit" },
      ),
    ).toThrow(/origin\/main/)
    expect(() =>
    ...
    expect(() =>
      GoalPlanBaseline.prepareAssurance(contract("zsh -O -c 'git diff origin/main..HEAD'"), {
        objective: "refactor the core runtime then test and commit",
      }),
    ).toThrow(/origin\/main/)
    expect(() =>
      GoalPlanBaseline.prepareAssurance(contract("zsh -W -c 'git diff origin/main..HEAD'"), {
        objective: "refactor the core runtime then test and commit",
      }),
    ).toThrow(/origin\/main/)
    expect(() =>
      GoalPlanBaseline.prepareAssurance(contract("echo $(printf prefix)#tag $(git diff origin/main..HEAD)"), {
        objective: "refactor the core runtime then test and commit",
      }),
    ).toThrow(/origin\/main/)
    expect(() =>
      GoalPlanBaseline.prepareAssurance(contract("bash --rcfile '' -c 'git diff origin/main..HEAD'"), {
        objective: "refactor the core runtime then test and commit",
      }),
    ).toThrow(/origin\/main/)
    expect(() =>
    ...
    expect(() =>
      GoalPlanBaseline.prepareAssurance(contract("ksh -o -c 'git diff origin/main..HEAD'"), {
        objective: "refactor the core runtime then test and commit",
      }),
    ).toThrow(/origin\/main/)
    expect(() =>
      GoalPlanBaseline.prepareAssurance(contract("echo foo\\)#tag $(git diff origin/main..HEAD)"), {
        objective: "refactor the core runtime then test and commit",
      }),
    ).toThrow(/origin\/main/)
    expect(() =>
    ...
    expect(() =>
      GoalPlanBaseline.prepareAssurance(contract('echo <(true)#tag "$(git diff origin/main..HEAD)"'), {
        objective: "refactor the core runtime then test and commit",
      }),
    ).toThrow(/origin\/main/)
    expect(() =>
    ...
    expect(() =>
      GoalPlanBaseline.prepareAssurance(contract("sh -c '$GIT diff HEAD -- origin/generated'"), {
        objective: "keep the diff in scope",
      }),
    ).not.toThrow()
    expect(() =>
