...
describe("Council.providerFamily", () => {
  test("maps known providers to their canonical family", () => {
    ...
    expect(Council.providerFamily("moonshotai")).toBe("kimi")
    ...
    expect(Council.providerFamily("minimax-coding-plan")).toBe("minimax")
    expect(Council.providerFamily("deepseek")).toBe("deepseek")
