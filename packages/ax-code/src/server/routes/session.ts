  ...
  new Hono()
    ...
    .get(
      ...
      describeRoute({
        ...
        tags: ["Session"],
        description: "Return the step-level rollback points available for a session, including tool and token context. Use the optional tool query to narrow the list.",
