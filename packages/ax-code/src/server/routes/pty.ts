...
type PtyRouteContext = {
  req: {
    valid: (input: "param") => { ptyID: PtyID }
  }
}

function parsePtyID(c: PtyRouteContext) {
  return c.req.valid("param").ptyID
}
