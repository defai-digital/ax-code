/**
 * Trace command — structured log analysis for debugging
 *
 * Reads the most recent log file and presents a timeline view of
 * tool calls, errors, and key operations with timing data.
 * This turns structured logging into a user-facing diagnostic tool.
 */
