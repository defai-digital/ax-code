...
function buildKnightRiderOptions(options: KnightRiderOptions = {}) {
...
export function createFrames(options: KnightRiderOptions = {}): string[] {
  ...
  const { holdStart, holdEnd, trailOptions } = buildKnightRiderOptions(options)
...
export function createColors(options: KnightRiderOptions = {}): ColorGenerator {
  const { trailOptions } = buildKnightRiderOptions(options)
