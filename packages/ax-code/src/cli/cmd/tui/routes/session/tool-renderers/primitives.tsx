...
import { BoxRenderable, TextAttributes, type RGBA } from "ax-tui"
import { useRenderer, type JSX } from "ax-tui/solid"
...
export function BlockTool(props: {
  ...
  // existing fg() rule so the two block kinds stay visually consistent.
