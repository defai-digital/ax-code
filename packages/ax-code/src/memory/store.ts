...
const ProjectMemorySchema = z
  .object({
    ...
    sections: z
      .object({
        structure: z.object({ content: z.string(), tokens: z.number(), scannedAt: z.string().optional() }).optional(),
        readme: z.object({ content: z.string(), tokens: z.number(), scannedAt: z.string().optional() }).optional(),
        config: z.object({ content: z.string(), tokens: z.number(), scannedAt: z.string().optional() }).optional(),
        patterns: z.object({ content: z.string(), tokens: z.number(), scannedAt: z.string().optional() }).optional(),
