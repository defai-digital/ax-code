...
- **`session.ts`** - Session state management
  ...
  - Maps ACP sessions to internal ax-code sessions
...
- **Terminal Integration**: Full terminal support via ax-code's bash tool
...
ACP sessions map cleanly to ax-code's internal session model:
