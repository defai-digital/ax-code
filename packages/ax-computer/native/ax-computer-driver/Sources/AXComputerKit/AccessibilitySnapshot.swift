...
enum SnapshotBuilder {
    static func build(
        ...
        guard permissions.accessibilityTrusted else {
            throw ComputerUseError.permissionDenied("Accessibility permission is required. Run `ax-computer-driver doctor` and grant access to Open Computer Use.")
        }
...
private func copyElement(_ element: AXUIElement, attribute: String) -> AXUIElement? {
    ...
    return axUIElementValue(value)
}

// CFTypeID-verified cast: malformed AX replies return nil instead of trapping.
private func axUIElementValue(_ value: CFTypeRef) -> AXUIElement? {
