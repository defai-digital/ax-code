...
public enum PermissionSupport {
    ...
    public static let bundleIdentifier = "com.defai.ax-code.computer"
    public static let developmentBundleDisplayName = "Open Computer Use (Dev)"
    public static let developmentBundleIdentifier = "com.defai.ax-code.computer.dev"
    ...
    private static let appVariantInfoKey = "AXComputerAppVariant"
    ...
    public static func isAXComputerBundleIdentifier(_ bundleIdentifier: String?) -> Bool {
    ...
    private static func preferredInstalledAppBundleURL() -> URL? {
        ...
        for prefix in homebrewPrefixes() {
            appendCandidate(prefix
                ...
                .appendingPathComponent("ax-computer-driver", isDirectory: true)
                .appendingPathComponent(releaseAppBundleName, isDirectory: true)
            )
