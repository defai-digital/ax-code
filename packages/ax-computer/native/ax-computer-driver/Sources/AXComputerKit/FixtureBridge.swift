...
public enum FixtureBridge {
    public static let appName = "AXComputerFixture"
    public static let distributedNotificationName = Notification.Name("com.defai.ax-code.computer.fixture.command")

    public static var stateFileURL: URL {
        URL(fileURLWithPath: NSTemporaryDirectory())
            .appendingPathComponent("ax-computer-driver-fixture", isDirectory: true)
