...
const docs = `### Overview
Loads AX Code typography assets and mono nerd fonts.
...
export const Basic = {
  render: () => (
    <div style={{ display: "grid", gap: "8px" }}>
      <mod.Font />
      <div style={{ "font-family": "var(--font-family-sans)" }}>AX Code Sans Sample</div>
      <div style={{ "font-family": "var(--font-family-mono)" }}>AX Code Mono Sample</div>
    </div>
  ),
}
