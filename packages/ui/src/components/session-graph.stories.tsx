// @ts-nocheck
import * as mod from "./session-graph"
...
const story = create({ title: "UI/SessionGraph", mod, args: { graph, topology } })
export default { title: "UI/SessionGraph", id: "components-session-graph", component: story.meta.component }
