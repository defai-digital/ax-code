...
/** Bundled CLI provider ids (`claude-code`, `codex-cli`, `grok-build-cli`, `muse-cli`). */
export const CLI_PROVIDER_IDS = ["claude-code", "codex-cli", "grok-build-cli", "muse-cli"] as const
