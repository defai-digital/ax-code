...
describe("gRPC SDK facade", () => {
  test("exposes a stable headless service and proto path", () => {
    ...
    expect(resolveAxCodeGrpcProtoUrl("https://jsr.io/@defai-digital/ax-code-sdk/2.2.2/dist/grpc.js").href).toBe(
      "https://jsr.io/@defai-digital/ax-code-sdk/2.2.2/dist/proto/ax_code/v1/headless.proto",
    )
  })
  ...
  test("HTTP bridge maps session history calls to the headless backend", async () => {
    ...
    await expect(client.session.share("sess-1")).rejects.toThrow("Session sharing is not supported")
    await expect(client.session.unshare("sess-1")).rejects.toThrow("Session sharing is not supported")
