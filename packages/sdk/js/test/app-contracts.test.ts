...
describe("application contracts", () => {
  ...
  test("classifies provider connection choices", () => {
    ...
    expect(CLI_PROVIDER_IDS).not.toContain("kimi-cli")
    expect(CLI_PROVIDER_IDS).not.toContain("minimax-cli")
    expect(CLI_PROVIDER_IDS).not.toContain("qoder-cli")
    expect(providerConnectCategory("muse-cli")).toBe("cli")
    expect(providerConnectCategory("kimi-cli")).not.toBe("cli")
    expect(providerConnectCategory("minimax-cli")).not.toBe("cli")
    expect(providerConnectCategory("qoder-cli")).not.toBe("cli")
