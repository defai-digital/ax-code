...
```bash
pnpm add jsr:@defai-digital/ax-code-sdk@2.4.2
```

```bash
deno add jsr:@defai-digital/ax-code-sdk@2.4.2
```

```bash
npx jsr add @defai-digital/ax-code-sdk@2.4.2
```
...
| Before (`@ax-code/sdk` 1.4.0)                             | After (`@defai-digital/ax-code-sdk` 2.4.2)                                   |
| --------------------------------------------------------- | ---------------------------------------------------------------------------- |
