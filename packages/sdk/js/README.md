...
```bash
pnpm add jsr:@defai-digital/ax-code-sdk@2.5.35
```

```bash
deno add jsr:@defai-digital/ax-code-sdk@2.5.35
```

```bash
npx jsr add @defai-digital/ax-code-sdk@2.5.35
```

Requires **Node.js 26+** (or Deno with Node compatibility). Headless and gRPC lifecycle helpers expect a signed `ax-code` executable on `PATH`, or an absolute path passed as `binary`. This SDK release is published with AX Code CLI v7.19.1.
...
| Before (`@ax-code/sdk` 1.4.0)                             | After (`@defai-digital/ax-code-sdk` 2.5.35)                                  |
| --------------------------------------------------------- | ---------------------------------------------------------------------------- |
