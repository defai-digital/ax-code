...
```bash
pnpm add jsr:@defai-digital/ax-code-sdk@2.5.40
```

```bash
deno add jsr:@defai-digital/ax-code-sdk@2.5.40
```

```bash
npx jsr add @defai-digital/ax-code-sdk@2.5.40
```
...
| Before (`@ax-code/sdk` 1.4.0)                             | After (`@defai-digital/ax-code-sdk` 2.5.40)                                  |
| --------------------------------------------------------- | ---------------------------------------------------------------------------- |
