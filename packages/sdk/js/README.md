...
```bash
pnpm add jsr:@defai-digital/ax-code-sdk@2.5.16
```

```bash
deno add jsr:@defai-digital/ax-code-sdk@2.5.16
```
...
| Before (`@ax-code/sdk` 1.4.0)                             | After (`@defai-digital/ax-code-sdk` 2.5.16)                                  |
| --------------------------------------------------------- | ---------------------------------------------------------------------------- |
