...
```bash
pnpm add jsr:@defai-digital/ax-code-sdk@2.5.49
```

```bash
deno add jsr:@defai-digital/ax-code-sdk@2.5.49
```

```bash
npx jsr add @defai-digital/ax-code-sdk@2.5.49
```
...
| Before (`@ax-code/sdk` 1.4.0)                             | After (`@defai-digital/ax-code-sdk` 2.5.49)                                  |
| --------------------------------------------------------- | ---------------------------------------------------------------------------- |
