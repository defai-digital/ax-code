...
```bash
pnpm add jsr:@defai-digital/ax-code-sdk@2.5.10
```

```bash
deno add jsr:@defai-digital/ax-code-sdk@2.5.10
```

```bash
npx jsr add @defai-digital/ax-code-sdk@2.5.10
```
...
| Before (`@ax-code/sdk` 1.4.0)                             | After (`@defai-digital/ax-code-sdk` 2.5.10)                                  |
| --------------------------------------------------------- | ---------------------------------------------------------------------------- |
