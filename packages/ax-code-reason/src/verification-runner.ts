...
import { decodePackageJsonObject, packageJsonStringMap, parsePackageJsonObject } from "./internal/package-json"
...
export async function runTests(
  ...
  for (const file of affectedFiles) {
    const deps = codeReasonHost().graph.findDependents(projectID, file, { scope })
