import { CliRenderer, type CliRendererConfig } from "@ax-code/tui"
import { type TestRendererOptions } from "@ax-code/tui/testing"
...
) => Promise<import("@ax-code/tui/testing").TestRendererSetup>
