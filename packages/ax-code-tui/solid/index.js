...
import {
  BaseRenderable,
  createTextAttributes as _createTextAttributes,
...
import {
  BaseRenderable as BaseRenderable2,
  isTextNodeRenderable as isTextNodeRenderable2,
...
function createScrollbackWriter(node, options = {}) {
  return (ctx) => {
    ...
    try {
      dispose = _render(
        () =>
          createComponent2(RendererContext.Provider, {
            get value() {
