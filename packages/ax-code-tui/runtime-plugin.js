/*
 * Exposes runtime-only modules (for example `@ax-code/tui`, `@ax-code/tui/solid`,
 * `solid-js`) to externally loaded plugins by rewriting matching imports to
 * virtual `ax-code-tui:runtime-module:*` ids.
 *
...
const CORE_RUNTIME_SPECIFIER = "@ax-code/tui"
const CORE_TESTING_RUNTIME_SPECIFIER = "@ax-code/tui/testing"
