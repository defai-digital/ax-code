    ...
    items: [
      ...
      await Submenu.new({
        ...
        items: [
          ...
          await MenuItem.new({
            action: () => openUrl("https://ax-code.ai/docs"),
          ...
          await MenuItem.new({
            action: () => openUrl("https://github.com/defai-digital/ax-code/issues/new?template=feature_request.yml"),
            text: t("desktop.menu.help.shareFeedback"),
          }),
          await MenuItem.new({
            action: () => openUrl("https://github.com/defai-digital/ax-code/issues/new?template=bug_report.yml"),
