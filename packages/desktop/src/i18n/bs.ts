export const dict = {
  ...
  "desktop.updater.none.message": "Već koristiš najnoviju verziju AX Code-a",
  ...
  "desktop.updater.downloaded.prompt":
    "Verzija {{version}} AX Code-a je preuzeta. Želiš li da je instaliraš i ponovo pokreneš aplikaciju?",
  ...
  "desktop.cli.installed.message":
    "CLI je instaliran u {{path}}\n\nRestartuj terminal da bi koristio komandu 'ax-code'.",
  ...
  "desktop.menu.help.documentation": "AX Code Dokumentacija",
  ...
  "desktop.cli.error.sidecarMissing":
    "Nedostaje binarna datoteka AX Code CLI-a. Pokušaj ponovo instalirati desktop aplikaciju.",
