export const dict = {
  ...
  "desktop.updater.none.message": "Du bruger allerede den nyeste version af AX Code",
  ...
  "desktop.updater.downloaded.prompt":
    "Version {{version}} af AX Code er blevet downloadet. Vil du installere den og genstarte?",
  ...
  "desktop.cli.installed.message":
    "CLI installeret i {{path}}\n\nGenstart din terminal for at bruge 'ax-code'-kommandoen.",
  ...
  "desktop.cli.error.sidecarMissing": "AX Code CLI-binærfil mangler. Prøv at geninstallere desktop-appen.",
