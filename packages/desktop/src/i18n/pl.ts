export const dict = {
  ...
  "desktop.updater.none.message": "Korzystasz już z najnowszej wersji AX Code",
  ...
  "desktop.updater.downloaded.prompt":
    "Pobrano wersję {{version}} AX Code. Czy chcesz ją zainstalować i uruchomić ponownie?",
  ...
  "desktop.cli.installed.message":
    "CLI zainstalowane w {{path}}\n\nUruchom ponownie terminal, aby użyć polecenia 'ax-code'.",
  ...
  "desktop.menu.help.documentation": "Dokumentacja AX Code",
  ...
  "desktop.cli.error.sidecarMissing":
    "Brakuje pliku binarnego AX Code CLI. Spróbuj ponownie zainstalować aplikację na komputer.",
