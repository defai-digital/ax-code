export const dict = {
  ...
  "desktop.updater.none.message": "すでに最新バージョンの AX Code を使用しています",
  ...
  "desktop.updater.downloaded.prompt":
    "AX Code のバージョン {{version}} がダウンロードされました。インストールして再起動しますか？",
  ...
  "desktop.cli.installed.message":
    "CLI を {{path}} にインストールしました\n\nターミナルを再起動して 'ax-code' コマンドを使用してください。",
  ...
  "desktop.menu.help.documentation": "AX Code ドキュメント",
  ...
  "desktop.cli.error.sidecarMissing":
    "AX Code CLI のバイナリが見つかりません。デスクトップアプリを再インストールしてみてください。",
