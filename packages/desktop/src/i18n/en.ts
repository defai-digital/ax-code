export const dict = {
  ...
  "desktop.menu.help.documentation": "AX Code Documentation",
  ...
  "desktop.updater.none.message": "You are already using the latest version of AX Code",
  ...
  "desktop.updater.downloaded.prompt":
    "Version {{version}} of AX Code has been downloaded, would you like to install it and relaunch?",
  ...
  "desktop.cli.installed.message": "CLI installed to {{path}}\n\nRestart your terminal to use the 'ax-code' command.",
  ...
  "desktop.cli.error.sidecarMissing": "AX Code CLI binary is missing. Try reinstalling the desktop app.",
