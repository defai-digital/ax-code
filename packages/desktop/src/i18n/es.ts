export const dict = {
  ...
  "desktop.updater.none.message": "Ya estás usando la versión más reciente de AX Code",
  ...
  "desktop.updater.downloaded.prompt":
    "Se ha descargado la versión {{version}} de AX Code. ¿Quieres instalarla y reiniciar?",
  ...
  "desktop.menu.help.documentation": "Documentación de AX Code",
  ...
  "desktop.cli.error.sidecarMissing":
    "Falta el binario de la CLI de AX Code. Intenta reinstalar la aplicación de escritorio.",
