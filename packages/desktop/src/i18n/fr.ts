export const dict = {
  ...
  "desktop.updater.none.message": "Vous utilisez déjà la dernière version d'AX Code",
  ...
  "desktop.updater.downloaded.prompt":
    "La version {{version}} d'AX Code a été téléchargée. Voulez-vous l'installer et redémarrer ?",
  ...
  "desktop.cli.installed.message":
    "CLI installée dans {{path}}\n\nRedémarrez votre terminal pour utiliser la commande 'ax-code'.",
  ...
  "desktop.menu.help.documentation": "Documentation d'AX Code",
  ...
  "desktop.cli.error.sidecarMissing":
    "Le binaire de la CLI AX Code est manquant. Essayez de réinstaller l'application de bureau.",
