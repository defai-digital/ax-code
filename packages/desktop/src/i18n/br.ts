export const dict = {
  ...
  "desktop.updater.none.message": "Você já está usando a versão mais recente do AX Code",
  ...
  "desktop.updater.downloaded.prompt":
    "A versão {{version}} do AX Code foi baixada. Você gostaria de instalá-la e reiniciar?",
  ...
  "desktop.menu.help.documentation": "Documentação do AX Code",
  ...
  "desktop.cli.error.sidecarMissing":
    "O binário da CLI do AX Code está ausente. Tente reinstalar o aplicativo de desktop.",
