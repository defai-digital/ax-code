export const dict = {
  ...
  "desktop.updater.none.message": "Du bruker allerede den nyeste versjonen av AX Code",
  ...
  "desktop.updater.downloaded.prompt":
    "Versjon {{version}} av AX Code er lastet ned. Vil du installere den og starte på nytt?",
  ...
  "desktop.menu.help.documentation": "AX Code Dokumentasjon",
  ...
  "desktop.cli.error.sidecarMissing": "AX Code CLI-binærfil mangler. Prøv å installere skrivebordsappen på nytt.",
