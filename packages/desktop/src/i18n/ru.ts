export const dict = {
  ...
  "desktop.updater.none.message": "Вы уже используете последнюю версию AX Code",
  ...
  "desktop.updater.downloaded.prompt": "Версия AX Code {{version}} загружена. Хотите установить и перезапустить?",
  ...
  "desktop.cli.installed.message":
    "CLI установлен в {{path}}\n\nПерезапустите терминал, чтобы использовать команду 'ax-code'.",
  ...
  "desktop.menu.help.documentation": "Документация AX Code",
  ...
  "desktop.cli.error.sidecarMissing":
    "Отсутствует бинарный файл AX Code CLI. Попробуйте переустановить настольное приложение.",
