export const dict = {
  ...
  "desktop.updater.none.message": "Sie verwenden bereits die neueste Version von AX Code",
  ...
  "desktop.updater.downloaded.prompt":
    "Version {{version}} von AX Code wurde heruntergeladen. Möchten Sie sie installieren und neu starten?",
  ...
  "desktop.cli.installed.message":
    "CLI wurde in {{path}} installiert\n\nStarten Sie Ihr Terminal neu, um den Befehl 'ax-code' zu verwenden.",
  ...
  "desktop.menu.help.documentation": "AX Code-Dokumentation",
  ...
  "desktop.cli.error.sidecarMissing":
    "Das AX Code CLI-Binary fehlt. Versuchen Sie, die Desktop-App neu zu installieren.",
