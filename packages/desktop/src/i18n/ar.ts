export const dict = {
  ...
  "desktop.updater.none.message": "أنت تستخدم بالفعل أحدث إصدار من AX Code",
  ...
  "desktop.updater.downloaded.prompt": "تم تنزيل إصدار {{version}} من AX Code، هل ترغب في تثبيته وإعادة تشغيله؟",
  ...
  "desktop.menu.help.documentation": "وثائق AX Code",
  ...
  "desktop.cli.error.sidecarMissing": "ملف AX Code CLI الثنائي مفقود. حاول إعادة تثبيت تطبيق سطح المكتب.",
