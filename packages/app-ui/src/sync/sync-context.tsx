...
const SYNC_CONTEXT_GLOBAL_KEY = "__ax_code_sync_context__"
...
function isStreamHeartbeatEvent(payload: Event): boolean {
  ...
  return type === "server.heartbeat" || type === "ax-code:heartbeat"
}
...
const dispatchVSCodeRuntimeNotificationEvent = (directory: string, payload: Event) => {
  ...
  window.dispatchEvent(new CustomEvent("ax-code:vscode-notification-event", {
...
const dispatchOpenCodeUpdateAvailable = (payload: { version: string }) => {
  ...
  window.dispatchEvent(new CustomEvent("ax-code:opencode-update-available", { detail: payload }))
}
