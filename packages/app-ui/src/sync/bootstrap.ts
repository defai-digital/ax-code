import type { OpencodeClient, PermissionRequest, Project, QuestionRequest } from "@ax-code/sdk/v2/client"
...
export async function bootstrapGlobal(
  ...
  // If ALL requests failed, OpenCode is likely down — fetch the ax-code
