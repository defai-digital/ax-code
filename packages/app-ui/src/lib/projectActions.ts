import type {
  ax-codeProjectAction,
  ax-codeProjectActionPlatform,
...
export const PROJECT_ACTIONS_UPDATED_EVENT = 'ax-code:project-actions-updated';
...
export const getCurrentProjectActionPlatform = (): ax-codeProjectActionPlatform => {
...
export const isProjectActionEnabledOnPlatform = (
  action: ax-codeProjectAction,
  platform: ax-codeProjectActionPlatform
): boolean => {
