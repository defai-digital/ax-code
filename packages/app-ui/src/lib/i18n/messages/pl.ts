...
export const dict: Record<I18nKey, string> = {
  ...
  'pwa.installPrompt.description': 'Zainstaluj ax-code, aby mieć szybszy dostęp',
  'pwa.installPrompt.action': 'Zainstaluj',
  'pwa.installPrompt.dismiss': 'Odrzuć',
  'pwa.installPrompt.started': 'Instalacja rozpoczęta',
  'pwa.installPrompt.installed': 'ax-code został zainstalowany',
  ...
  'sessions.sidebar.footer.actions.aboutax-code': 'O ax-code',
  ...
  'multiRun.window.description': 'Okno wielokrotnego uruchomienia ax-code.',
  ...
  'onboarding.chooser.title': 'Witaj w ax-code',
  ...
  'onboarding.localSetup.windows.stepSetBinaryPath': 'Jeśli ax-code nie wykryje OpenCode automatycznie, ustaw ścieżkę binarki poniżej.',
  ...
  'onboarding.localSetup.helper.saveAndReload': 'Zapisuje do ustawień ax-code i przeładowuje konfigurację OpenCode.',
  ...
  'onboarding.remoteConnection.description': 'Wpisz adres serwera ax-code aby się połączyć.',
  ...
  'onboarding.remoteConnection.status.suggestionsWrongService': 'Sugestie: Zweryfikuj czy URL wskazuje na serwer ax-code, lub skontaktuj się z administratorem serwera.',
  ...
  'onboarding.remoteConnection.probe.wrongServiceMessage': 'Serwer odpowiedział, ale nie uruchomiono na nim ax-code. Zweryfikuj czy adres wskazuje na serwer ax-code.',
  ...
  'onboarding.desktopRecovery.incompatibleServer.description': 'Serwer pod adresem "{host}" nie uruchamia ax-code. Zweryfikuj czy adres wskazuje na serwer ax-code.',
  ...
  'startup.initRecovery.description': 'ax-code nie mógł dokończyć inicjalizacji. Sprawdź czy serwer działa, następnie spróbuj ponownie.',
  ...
  'aboutDialog.diagnosticsDescription': 'Zawiera stan ax-code, kondycję OpenCode, katalogi i projekty.',
  ...
  'aboutDialog.openChamberVersionLabel': 'Wersja ax-code {version}',
  ...
  'desktopHostSwitcher.description': 'Przełączaj między lokalnymi i zdalnymi serwerami ax-code',
  ...
  'header.actions.openAppMenu': 'Menu ax-code',
  'header.actions.openAppMenuAria': 'Otwórz menu ax-code',
  ...
  'header.services.shutdownDev': 'Zatrzymaj ax-code',
  ...
  'helpDialog.description': 'Użyj tych skrótów klawiaturowych, aby sprawnie poruszać się po ax-code.',
  ...
  'openChamberLogo.aria.logo': 'Logo ax-code',
  ...
  'sessionAuth.locked.unlockTitle': 'Odblokuj ax-code',
  ...
  'updateDialog.error.takingLonger': 'Aktualizacja trwa dłużej niż oczekiwano. Poczekaj chwilę i odśwież albo uruchom: ax-code update',
  ...
  'updateDialog.header.updating': 'Aktualizowanie ax-code...',
  ...
  'opencodeUpdate.toast.upgrading.description': 'Pozostaw ax-code otwarte.',
  ...
  'onboarding.localSetup.intro': 'OpenCode to serce ax-code — zainstaluj je, aby zacząć.',
  ...
  'settings.ax-code.keyboardShortcuts.action.open_timeline_dialog.label': 'Otwórz oś czasu',
  'settings.ax-code.visual.field.mobileKeyboardMode': 'Tryb klawiatury mobilnej',
  'settings.ax-code.visual.field.mobileKeyboardModeHint': 'Wybierz sposób zachowania widoku podczas otwartej klawiatury.',
  'settings.ax-code.visual.field.mobileKeyboardModeAria': 'Tryb klawiatury mobilnej',
  'settings.ax-code.visual.field.selectMobileKeyboardModePlaceholder': 'Wybierz tryb klawiatury mobilnej',
  'settings.ax-code.visual.actions.resetMobileKeyboardModeAria': 'Resetuj tryb klawiatury mobilnej',
  'settings.ax-code.visual.option.mobileKeyboardMode.native.label': 'Natywny',
  'settings.ax-code.visual.option.mobileKeyboardMode.native.description': 'Użyj domyślnego zachowania przeglądarki/systemu.',
  'settings.ax-code.visual.option.mobileKeyboardMode.resizeContent.label': 'Zmień rozmiar zawartości',
  'settings.ax-code.visual.option.mobileKeyboardMode.resizeContent.description': 'Dopasuj układ tak, aby zawartość pozostała widoczna ponad klawiaturą.',
