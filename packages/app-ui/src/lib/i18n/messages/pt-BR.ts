...
export const dict: Record<I18nKey, string> = {
 ...settingsDict,
  ...
  "pwa.installPrompt.description": "Instale o ax-code para acessar mais rápido",
  "pwa.installPrompt.action": "Instalar",
  "pwa.installPrompt.dismiss": "Dispensar",
  "pwa.installPrompt.started": "Instalação iniciada",
  "pwa.installPrompt.installed": "ax-code instalado",
  ...
  "sessions.sidebar.footer.actions.aboutax-code": "Sobre o ax-code",
  ...
  "header.services.shutdownDev": "Parar ax-code",
  ...
  "aboutDialog.openChamberVersionLabel": "Versão do ax-code {version}",
  ...
  "aboutDialog.diagnosticsDescription": "Inclui o estado do ax-code, a integridade do OpenCode, diretórios e projetos.",
  ...
  "helpDialog.description": "Use estes atalhos de teclado para navegar pelo ax-code com eficiência",
  ...
  "header.actions.openAppMenu": "Menu do ax-code",
  "header.actions.openAppMenuAria": "Abrir menu do ax-code",
  ...
  "sessionAuth.locked.unlockTitle": "Desbloquear ax-code",
  ...
  "desktopHostSwitcher.description": "Alterne entre Local e o servidor remoto do ax-code",
  ...
  "multiRun.window.description": "Janela do ax-code Multi-Run.",
  ...
  "onboarding.chooser.title": "Boas-vindas ao ax-code",
  ...
  "onboarding.localSetup.windows.stepSetBinaryPath": "Se o ax-code não detectar o OpenCode automaticamente, defina o caminho do executável a seguir.",
  "onboarding.localSetup.intro": "OpenCode é o coração do ax-code. Instale-o para começar.",
  ...
  "onboarding.localSetup.helper.saveAndReload": "Salve nas configurações do ax-code e recarregue configurações do OpenCode.",
  ...
  "onboarding.remoteConnection.description": "Digite o endereço de um servidor do ax-code para conectar.",
  ...
  "onboarding.remoteConnection.status.suggestionsWrongService": "Sugestões: verifique se a URL aponta para um servidor ax-code ou entre em contato com o administrador do servidor.",
  ...
  "onboarding.remoteConnection.probe.wrongServiceMessage": "O servidor respondeu, mas não está executando ax-code. Verifique se o endereço aponta para um servidor ax-code.",
  ...
  "onboarding.desktopRecovery.incompatibleServer.description": "O servidor em \"{host}\" não está executando ax-code. Verifique se o endereço aponta para um servidor ax-code.",
  ...
  "startup.initRecovery.description": "O ax-code não conseguiu concluir a inicialização. Verifique se o servidor está em execução e tente novamente.",
  ...
  "updateDialog.header.updating": "Atualizando ax-code...",
  ...
  "updateDialog.error.takingLonger": "A atualização está demorando mais do que o esperado. Aguarde um pouco e atualize, ou execute: ax-code update",
  ...
  "opencodeUpdate.toast.upgrading.description": "Mantenha o ax-code aberto.",
  ...
  "openChamberLogo.aria.logo": "Logo do ax-code",
