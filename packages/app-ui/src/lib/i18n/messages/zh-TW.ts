...
export const dict: Record<I18nKey, string> = {
  ...
  'pwa.installPrompt.description': '安裝 ax-code 以便更快存取',
  'pwa.installPrompt.action': '安裝',
  'pwa.installPrompt.dismiss': '忽略',
  'pwa.installPrompt.started': '已開始安裝',
  'pwa.installPrompt.installed': 'ax-code 已安裝',
  ...
  'sessions.sidebar.footer.actions.aboutax-code': '關於 ax-code',
  ...
  'header.services.shutdownDev': '停止 ax-code',
  ...
  'aboutDialog.openChamberVersionLabel': 'ax-code 版本 {version}',
  ...
  'aboutDialog.diagnosticsDescription': '包含 ax-code 狀態、OpenCode 健康資訊、目錄和專案。',
  ...
  'helpDialog.description': '使用這些快速鍵可更有效率地導覽 ax-code',
  ...
  'header.actions.openAppMenu': 'ax-code 選單',
  'header.actions.openAppMenuAria': '開啟 ax-code 選單',
  ...
  'sessionAuth.locked.unlockTitle': '解鎖 ax-code',
  ...
  'desktopHostSwitcher.description': '在 Local 與遠端 ax-code 伺服器之間切換',
  ...
  'multiRun.window.description': 'ax-code 多執行視窗。',
  ...
  'onboarding.chooser.title': '歡迎使用 ax-code',
  ...
  'onboarding.localSetup.windows.stepSetBinaryPath': '如果 ax-code 未自動偵測到 OpenCode，請在下方設定執行檔路徑。',
  'onboarding.localSetup.intro': 'OpenCode 是 ax-code 的核心，先安裝它即可開始。',
  ...
  'onboarding.localSetup.helper.saveAndReload': '將儲存到 ax-code 設定並重新載入 OpenCode 設定。',
  ...
  'onboarding.remoteConnection.description': '輸入要連接的 ax-code 伺服器位址。',
  ...
  'onboarding.remoteConnection.status.suggestionsWrongService': '建議：確認 URL 指向 ax-code 伺服器，或聯絡伺服器管理員。',
  ...
  'onboarding.remoteConnection.probe.wrongServiceMessage': '伺服器有回應，但未執行 ax-code。請確認位址是否指向 ax-code 伺服器。',
  ...
  'onboarding.desktopRecovery.incompatibleServer.description': '「{host}」上的伺服器未執行 ax-code。請確認位址是否指向 ax-code 伺服器。',
  ...
  'startup.initRecovery.description': 'ax-code 未能完成初始化。請檢查伺服器是否正在執行，然後重試。',
  ...
  'updateDialog.header.updating': '正在更新 ax-code...',
  ...
  'updateDialog.error.takingLonger': '更新耗時超出預期。請稍等後重新整理，或執行：ax-code update',
  ...
  'opencodeUpdate.toast.upgrading.description': '請保持 ax-code 開啟。',
  ...
  'openChamberLogo.aria.logo': 'ax-code 標誌',
