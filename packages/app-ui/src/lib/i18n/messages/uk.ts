...
export const dict: Record<I18nKey, string> = {
  ...
  "pwa.installPrompt.description": "Установіть ax-code для швидшого доступу",
  "pwa.installPrompt.action": "Установити",
  "pwa.installPrompt.dismiss": "Сховати",
  "pwa.installPrompt.started": "Установлення розпочато",
  "pwa.installPrompt.installed": "ax-code встановлено",
  ...
  "sessions.sidebar.footer.actions.aboutax-code": "Про ax-code",
  ...
  "header.services.shutdownDev": "Зупинити ax-code",
  ...
  "aboutDialog.openChamberVersionLabel": "Версія ax-code {version}",
  ...
  "aboutDialog.diagnosticsDescription": "Містить стан ax-code, стан OpenCode, каталоги та проєкти.",
  ...
  "helpDialog.description": "Використовуйте ці комбінації клавіш для ефективної навігації ax-code",
  ...
  "header.actions.openAppMenu": "Меню ax-code",
  "header.actions.openAppMenuAria": "Відкрити меню ax-code",
  ...
  "sessionAuth.locked.unlockTitle": "Розблокувати ax-code",
  ...
  "desktopHostSwitcher.description": "Перемикання між Local і віддаленими ax-code серверами",
  ...
  "multiRun.window.description": "Вікно мультизапуску ax-code.",
  ...
  "onboarding.chooser.title": "Ласкаво просимо до ax-code",
  ...
  "onboarding.localSetup.windows.stepSetBinaryPath": "Якщо ax-code не визначає OpenCode автоматично, укажіть шлях до виконуваного файла нижче.",
  "onboarding.localSetup.intro": "OpenCode — серце ax-code. Встановіть його, щоб почати.",
  ...
  "onboarding.localSetup.helper.saveAndReload": "Зберігає налаштування в ax-code і перезавантажує конфігурацію OpenCode.",
  ...
  "onboarding.remoteConnection.description": "Введіть адресу сервера ax-code для підключення.",
  ...
  "onboarding.remoteConnection.status.suggestionsWrongService": "Пропозиції: переконайтеся, що URL вказує на сервер ax-code або зверніться до адміністратора сервера.",
  ...
  "onboarding.remoteConnection.probe.wrongServiceMessage": "Сервер відповів, але не працює ax-code. Перевірте, чи адреса вказує на сервер ax-code.",
  ...
  "onboarding.desktopRecovery.incompatibleServer.description": "На сервері \"{host}\" не запущено ax-code. Перевірте, чи адреса вказує на сервер ax-code.",
  ...
  "startup.initRecovery.description": "ax-code не зміг завершити ініціалізацію. Перевірте, що сервер запущений, і повторіть спробу.",
  ...
  "updateDialog.header.updating": "Оновлення ax-code...",
  ...
  "updateDialog.error.takingLonger": "Оновлення триває довше, ніж очікувалося. Зачекайте трохи та оновіть або запустіть: ax-code update",
  ...
  "opencodeUpdate.toast.upgrading.description": "Залиште ax-code відкритим.",
  ...
  "openChamberLogo.aria.logo": "Логотип ax-code",
