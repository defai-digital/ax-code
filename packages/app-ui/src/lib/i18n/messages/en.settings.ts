export const settingsDict = {
  ...
  'settings.window.description': 'ax-code settings window.',
  ...
  'settings.ax-code.tunnel.title': 'Remote Tunnel',
  'settings.ax-code.tunnel.description': 'Configure secure remote access with quick links or your own managed remote Cloudflare tunnel.',
  'settings.ax-code.tunnel.note.serverSideEnforced': 'Secure tunnel access is enforced server-side.',
  'settings.ax-code.tunnel.note.connectLinksOneTime': 'Connect links are one-time and are revoked when tunnel stops or connect-link TTL expires.',
  'settings.ax-code.tunnel.note.cloudflareConnectorTarget': 'Cloudflare connector target:',
  'settings.ax-code.tunnel.note.cloudflareConnectorTargetUse': 'For Cloudflare connector target, use',
  'settings.ax-code.tunnel.note.tokensSavedPerTunnel': 'Tokens are saved per tunnel and reused from disk.',
  'settings.ax-code.tunnel.note.customConfigUsed': 'Custom config file will be used when starting the tunnel.',
  'settings.ax-code.tunnel.note.defaultConfigUsed': 'When empty, cloudflared uses its default config (~/.cloudflared/config.yml).',
  'settings.ax-code.tunnel.note.managedRemoteRequiresDomain': 'Managed remote tunnels require a purchased domain in your Cloudflare account.',
  'settings.ax-code.tunnel.note.managedLocalUsesConfig': 'Managed local tunnels use your local cloudflared configuration file.',
  'settings.ax-code.tunnel.note.startModeAndGenerateLink': 'Start a {mode} tunnel and generate a one-time connect link. Do not close the app while this tunnel is in use.',
  'settings.ax-code.tunnel.note.scanQrToConnect': 'Scan with your phone to connect.',
  'settings.ax-code.tunnel.section.redeemedAccessLinks': 'Redeemed access links',
  'settings.ax-code.tunnel.section.savedManagedRemoteTunnels': 'Saved managed remote tunnels',
  'settings.ax-code.tunnel.notAvailable.cloudflaredNotFound': 'cloudflared not found',
  'settings.ax-code.tunnel.notAvailable.installHint': 'Install it to enable remote tunnel access:',
  'settings.ax-code.tunnel.field.provider': 'Provider',
  'settings.ax-code.tunnel.field.providerPlaceholder': 'Select provider',
  'settings.ax-code.tunnel.field.tunnelType': 'Tunnel type',
  'settings.ax-code.tunnel.field.connectLinkTtl': 'Connect link TTL',
  'settings.ax-code.tunnel.field.tunnelSessionTtl': 'Tunnel session TTL',
  'settings.ax-code.tunnel.field.hostnameLabel': 'Hostname:',
  'settings.ax-code.tunnel.field.savedTokenAvailablePlaceholder': 'Saved token available (optional to replace)',
  'settings.ax-code.tunnel.field.pasteTokenPlaceholder': 'Paste token for this tunnel',
  'settings.ax-code.tunnel.field.newPresetNamePlaceholder': 'Tunnel name (e.g. Production)',
  'settings.ax-code.tunnel.field.newPresetHostnamePlaceholder': 'Hostname (e.g. oc.example.com)',
  'settings.ax-code.tunnel.field.newPresetTokenPlaceholder': 'Token',
  'settings.ax-code.tunnel.field.managedRemoteTokenInfoAria': 'Managed remote tunnel token info',
  'settings.ax-code.tunnel.field.configurationFile': 'Configuration file',
  'settings.ax-code.tunnel.field.configurationFilePlaceholder': 'Using default cloudflared config',
  'settings.ax-code.tunnel.field.managedRemoteTunnelToConnect': 'Managed remote tunnel to connect',
  'settings.ax-code.tunnel.field.selectSavedTunnelPlaceholder': 'Select saved tunnel',
  'settings.ax-code.tunnel.field.publicUrlHint': 'Public URL (not accessible without a token)',
  'settings.ax-code.tunnel.field.connectLink': 'Connect link',
  'settings.ax-code.tunnel.field.expires': 'Expires',
  'settings.ax-code.tunnel.field.connectQrAlt': 'Tunnel connect QR code',
  'settings.ax-code.tunnel.actions.removePresetAria': 'Remove {name}',
  'settings.ax-code.tunnel.actions.saveToken': 'Save token',
  'settings.ax-code.tunnel.actions.browseConfigFileAria': 'Browse config file',
  'settings.ax-code.tunnel.actions.clearConfigFileAria': 'Clear config file',
  'settings.ax-code.tunnel.actions.openManagedRemoteDocs': 'Check documentation on how to configure a managed remote tunnel',
  'settings.ax-code.tunnel.actions.openManagedLocalDocs': 'Check documentation on managed local tunnel configuration',
  'settings.ax-code.tunnel.actions.startTunnel': 'Start Tunnel',
  'settings.ax-code.tunnel.actions.startingTunnel': 'Starting tunnel...',
  'settings.ax-code.tunnel.actions.stopTunnel': 'Stop Tunnel',
  'settings.ax-code.tunnel.actions.stopping': 'Stopping...',
  'settings.ax-code.tunnel.actions.newConnectLink': 'New connect link',
  'settings.ax-code.tunnel.actions.copied': 'Copied',
  'settings.ax-code.tunnel.actions.retry': 'Retry',
  'settings.ax-code.tunnel.option.moreProvidersSoon': 'More providers coming soon',
  'settings.ax-code.tunnel.option.mode.quick.label': 'Quick',
  'settings.ax-code.tunnel.option.mode.quick.tooltip': 'Quick Tunnel is best effort and uptime is not guaranteed.',
  'settings.ax-code.tunnel.option.mode.managedRemote.label': 'Managed Remote',
  'settings.ax-code.tunnel.option.mode.managedRemote.tooltip': 'Managed Remote uses your Cloudflare account and hostname for long-lived access.',
  'settings.ax-code.tunnel.option.mode.managedLocal.label': 'Managed Local',
  'settings.ax-code.tunnel.option.mode.managedLocal.tooltip': 'Managed Local uses your local cloudflared configuration file.',
  'settings.ax-code.tunnel.warning.quickModeReliability': 'For more reliable long-lived access, switch to Managed Remote or Managed Local tunnel mode.',
  'settings.ax-code.tunnel.warning.replacesActiveTunnel': 'Starting this tunnel replaces the active tunnel and revokes existing connect links and remote sessions.',
  ...
  'settings.ax-code.tunnel.state.loading': 'Loading',
  'settings.ax-code.tunnel.state.expired': 'Expired',
  'settings.ax-code.tunnel.state.revoked': 'Revoked',
  'settings.ax-code.tunnel.state.inactive': 'Inactive',
  'settings.ax-code.tunnel.state.noExpiry': 'No expiry',
  'settings.ax-code.tunnel.state.never': 'Never',
  'settings.ax-code.tunnel.state.tunnelReady': 'Tunnel ready',
  'settings.ax-code.tunnel.session.redeemedAt': 'Redeemed {time}',
  'settings.ax-code.tunnel.session.expiresIn': 'Expires in {remaining}',
  'settings.ax-code.tunnel.session.inactiveWithReason': 'Inactive ({reason})',
  'settings.ax-code.tunnel.error.invalidConfigExtension': 'Config file must use .yml, .yaml, or .json extension.',
  'settings.ax-code.tunnel.tooltip.tokensSavedPath': 'Tokens are saved in ~/.config/ax-code/cloudflare-managed-remote-tunnels.json.',
  'settings.ax-code.tunnel.empty.noManagedRemoteTunnels': 'No managed remote tunnels saved yet.',
  'settings.ax-code.tunnel.toast.checkAvailabilityFailed': 'Failed to check tunnel availability',
  'settings.ax-code.tunnel.toast.saveSettingsFailed': 'Failed to save tunnel settings',
  'settings.ax-code.tunnel.toast.saveTtlFailed': 'Failed to save tunnel TTL settings',
  'settings.ax-code.tunnel.toast.saveTokenFailed': 'Failed to save managed remote tunnel token',
  'settings.ax-code.tunnel.toast.selectOrAddManagedRemoteFirst': 'Select or add a managed remote tunnel first',
  'settings.ax-code.tunnel.toast.managedRemoteTokenRequiredBeforeStarting': 'Managed remote tunnel token is required before starting',
  'settings.ax-code.tunnel.toast.addManagedRemoteTokenBeforeStarting': 'Add a managed remote tunnel token before starting',
  'settings.ax-code.tunnel.toast.startFailed': 'Failed to start tunnel',
  'settings.ax-code.tunnel.toast.startedButNoPublicUrl': 'Tunnel started but no public URL was returned',
  'settings.ax-code.tunnel.toast.replacedTunnelSingleSingle': 'Replaced previous tunnel: revoked 1 link, invalidated 1 session.',
  'settings.ax-code.tunnel.toast.replacedTunnelSingleManySessions': 'Replaced previous tunnel: revoked 1 link, invalidated {invalidatedSessionCount} sessions.',
  'settings.ax-code.tunnel.toast.replacedTunnelManyLinksSingleSession': 'Replaced previous tunnel: revoked {revokedBootstrapCount} links, invalidated 1 session.',
  'settings.ax-code.tunnel.toast.replacedTunnelManyMany': 'Replaced previous tunnel: revoked {revokedBootstrapCount} links, invalidated {invalidatedSessionCount} sessions.',
  'settings.ax-code.tunnel.toast.linkReady': 'Tunnel link ready',
  'settings.ax-code.tunnel.toast.stopped': 'Tunnel stopped',
  'settings.ax-code.tunnel.toast.stopFailed': 'Failed to stop tunnel',
  'settings.ax-code.tunnel.toast.connectLinkCopied': 'Connect link copied',
  'settings.ax-code.tunnel.toast.copyUrlFailed': 'Failed to copy URL',
  'settings.ax-code.tunnel.toast.saveSelectedManagedRemoteFailed': 'Failed to save selected managed remote tunnel',
  'settings.ax-code.tunnel.toast.tunnelNameRequired': 'Tunnel name is required',
  'settings.ax-code.tunnel.toast.managedRemoteHostnameRequired': 'Managed remote tunnel hostname is required',
  'settings.ax-code.tunnel.toast.managedRemoteTokenRequired': 'Managed remote tunnel token is required',
  'settings.ax-code.tunnel.toast.hostnameAlreadyExists': 'This hostname already exists',
  'settings.ax-code.tunnel.toast.managedRemoteSaved': 'Managed remote tunnel saved',
  'settings.ax-code.tunnel.toast.managedRemoteRemoved': 'Managed remote tunnel removed',
  ...
  'settings.remoteInstances.page.field.modeHint': 'Managed installs/updates and starts ax-code remotely. External assumes it is already running.',
  ...
  'settings.remoteInstances.page.field.preferredRemotePortHint': 'Port ax-code should use on the remote host. Leave empty to let the runtime choose.',
  'settings.remoteInstances.page.field.keepServerRunning': 'Keep server running',
  'settings.remoteInstances.page.field.keepServerRunningHint': 'If enabled, ax-code daemon is left running remotely when you disconnect.',
  ...
  'settings.remoteInstances.page.field.preferredLocalPortHint': 'Preferred local port for the main ax-code tunnel. Leave empty for auto-select.',
  ...
  'settings.ax-code.about.title': 'About ax-code',
  'settings.ax-code.about.field.version': 'Version',
  'settings.ax-code.about.state.checking': 'Checking...',
  'settings.ax-code.about.state.upToDate': 'Up to date',
  'settings.ax-code.about.actions.checkUpdates': 'Check updates',
  'settings.ax-code.about.actions.update': 'Update',
  'settings.ax-code.about.actions.updateToVersion': 'Update to {version}',
  'settings.ax-code.about.actions.checkForUpdates': 'Check for updates',
  'settings.ax-code.about.toast.latestVersion': 'You are on the latest version',
  ...
  'settings.skills.catalog.add.descriptionPrefix': 'Add a Git repository as a new catalog source. ax-code will scan it for folders containing',
  ...
  'settings.ax-code.passkeys.title': 'Passkeys',
  'settings.ax-code.passkeys.field.currentDevice': 'Current device',
  'settings.ax-code.passkeys.actions.add': 'Add passkey',
  'settings.ax-code.passkeys.actions.cancelSetup': 'Cancel passkey setup',
  'settings.ax-code.passkeys.actions.signOutEverywhere': 'Sign out everywhere',
  'settings.ax-code.passkeys.actions.signingOut': 'Signing out…',
  'settings.ax-code.passkeys.actions.removing': 'Removing…',
  'settings.ax-code.passkeys.state.uiPasswordRequired': 'Passkeys are available only when the UI password lock is enabled.',
  'settings.ax-code.passkeys.state.loading': 'Loading passkeys…',
  'settings.ax-code.passkeys.state.noneSaved': 'No passkeys saved for this host yet.',
  'settings.ax-code.passkeys.item.lastUsed': 'Last used {time}',
  'settings.ax-code.passkeys.item.added': 'Added {time}',
  'settings.ax-code.passkeys.time.neverUsed': 'Never used',
  'settings.ax-code.passkeys.toast.loadFailed': 'Could not load passkeys.',
  'settings.ax-code.passkeys.toast.enableUiPasswordFirst': 'Enable the UI password lock before adding passkeys.',
  'settings.ax-code.passkeys.toast.added': 'Passkey added',
  'settings.ax-code.passkeys.toast.setupCanceled': 'Passkey setup canceled',
  'settings.ax-code.passkeys.toast.addFailed': 'Could not add passkey.',
  'settings.ax-code.passkeys.toast.removed': 'Passkey removed',
  'settings.ax-code.passkeys.toast.removeFailed': 'Could not remove passkey.',
  'settings.ax-code.passkeys.toast.clearAuthFailed': 'Could not clear saved authentication.',
  'settings.ax-code.sessionRetention.title': 'Session Retention',
  'settings.ax-code.sessionRetention.tooltip': 'Automatically archive or delete inactive sessions based on last activity. Keeps the 5 most recent sessions.',
  'settings.ax-code.sessionRetention.field.enableAutoCleanupAria': 'Enable auto-cleanup',
  'settings.ax-code.sessionRetention.field.enableAutoCleanup': 'Enable Auto-Cleanup',
  'settings.ax-code.sessionRetention.field.retentionPeriod': 'Retention Period',
  'settings.ax-code.sessionRetention.field.retentionPeriodAria': 'Retention period in days',
  'settings.ax-code.sessionRetention.field.days': 'days',
  'settings.ax-code.sessionRetention.field.whenSessionsExpire': 'When sessions expire',
  'settings.ax-code.sessionRetention.actions.resetRetentionAria': 'Reset retention period',
  'settings.ax-code.sessionRetention.actions.runCleanupNow': 'Run cleanup now',
  'settings.ax-code.sessionRetention.actions.cleaningUp': 'Cleaning up...',
  'settings.ax-code.sessionRetention.action.archive': 'Archive',
  'settings.ax-code.sessionRetention.action.delete': 'Delete',
  'settings.ax-code.sessionRetention.manualCleanup.title': 'Manual Cleanup',
  'settings.ax-code.sessionRetention.manualCleanup.eligibleArchiveNow': 'Eligible for archiving right now: {count}',
  'settings.ax-code.sessionRetention.manualCleanup.eligibleDeleteNow': 'Eligible for deletion right now: {count}',
  'settings.ax-code.sessionRetention.toast.noneEligibleArchive': 'No sessions eligible for archiving',
  'settings.ax-code.sessionRetention.toast.noneEligibleDelete': 'No sessions eligible for deletion',
  'settings.ax-code.sessionRetention.toast.archivedCount': 'Archived {count} session(s)',
  'settings.ax-code.sessionRetention.toast.deletedCount': 'Deleted {count} session(s)',
  'settings.ax-code.sessionRetention.toast.failedArchiveCount': 'Failed to archive {count} session(s)',
  'settings.ax-code.sessionRetention.toast.failedDeleteCount': 'Failed to delete {count} session(s)',
  'settings.ax-code.desktopNetwork.title': 'Desktop Network Access',
  'settings.ax-code.desktopNetwork.field.launchAtLoginAria': 'Start ax-code at login',
  'settings.ax-code.desktopNetwork.field.launchAtLogin': 'Start ax-code when you log in',
  'settings.ax-code.desktopNetwork.field.launchAtLoginDescription': 'Starts the app in the background without opening a window. Click the Dock icon to open it.',
  'settings.ax-code.desktopNetwork.field.allowLanAccessAria': 'Allow LAN access to desktop sidecar',
  'settings.ax-code.desktopNetwork.field.allowLanAccess': 'Let other devices on your local network open this app',
  'settings.ax-code.desktopNetwork.field.allowLanAccessDescription': 'Restarts the app so phones, tablets, and other computers on your Wi-Fi can open it.',
  'settings.ax-code.desktopNetwork.field.warning': 'Warning: while enabled, the app is reachable by anyone on the same local network.',
  'settings.ax-code.desktopPassword.field.password': 'Desktop UI Password',
  'settings.ax-code.desktopPassword.field.passwordPlaceholder': 'No password required',
  'settings.ax-code.desktopPassword.field.passwordDescription': 'ax-code asks after restart, then when the login session expires: after 12 hours, or 7 days with Trust this device. Leave empty to disable login.',
  'settings.ax-code.desktopNetwork.hint.openAfterRestart': 'After restart, open from another device: ',
  'settings.ax-code.desktopNetwork.hint.openNow': 'Open from another device: ',
  'settings.ax-code.desktopNetwork.actions.saveAndRestart': 'Save + Restart',
  'settings.ax-code.desktopNetwork.error.loadFailed': 'Failed to load desktop settings',
  'settings.ax-code.desktopNetwork.error.saveFailed': 'Failed to save desktop settings',
  'settings.ax-code.desktopNetwork.error.savedRestartFailed': 'Saved, but failed to restart app',
  'settings.ax-code.desktopNetwork.error.launchAtLoginUnsupported': 'Launch at login is not supported on this system',
  'settings.ax-code.desktopNetwork.error.launchAtLoginSaveFailed': 'Failed to update launch at login setting',
  'settings.ax-code.opencodeCli.title': 'OpenCode CLI',
  'settings.ax-code.opencodeCli.tooltipPrefix': 'Optional absolute path to the',
  'settings.ax-code.opencodeCli.tooltipSuffix': 'binary.',
  'settings.ax-code.opencodeCli.field.binaryPath': 'OpenCode Binary Path',
  'settings.ax-code.opencodeCli.field.binaryPathPlaceholder': '/Users/you/.bun/bin/opencode',
  'settings.ax-code.opencodeCli.field.showUpdateNotifications': 'Show OpenCode update notifications',
  'settings.ax-code.opencodeCli.field.showUpdateNotificationsAria': 'Show OpenCode update notifications',
  'settings.ax-code.opencodeCli.actions.browseAria': 'Browse for OpenCode binary path',
  'settings.ax-code.opencodeCli.actions.browse': 'Browse',
  'settings.ax-code.opencodeCli.actions.saveAndReload': 'Save + Reload',
  'settings.ax-code.opencodeCli.actions.restartingOpenCode': 'Restarting OpenCode…',
  'settings.ax-code.opencodeCli.dialog.selectBinaryTitle': 'Select opencode binary',
  'settings.ax-code.opencodeCli.tipPrefix': 'Tip: you can also use',
  'settings.ax-code.opencodeCli.tipMiddle': 'env var, but this setting persists in',
  ...
  'settings.ax-code.keyboardShortcuts.title': 'Keyboard Shortcuts',
  'settings.ax-code.keyboardShortcuts.actions.resetAll': 'Reset All',
  'settings.ax-code.keyboardShortcuts.actions.overwrite': 'Overwrite',
  'settings.ax-code.keyboardShortcuts.tooltip': 'Capture a new key combo, save it, and bindings will update immediately.',
  'settings.ax-code.keyboardShortcuts.overwritePrompt': 'This combo is already used by another shortcut. Overwrite and clear that other mapping?',
  'settings.ax-code.keyboardShortcuts.field.pressKeys': 'Press keys...',
  'settings.ax-code.keyboardShortcuts.error.captureFirst': 'Capture a shortcut first.',
  'settings.ax-code.keyboardShortcuts.warning.riskyBrowserShortcut': 'This shortcut can conflict with browser defaults. It is still saved.',
  'settings.ax-code.keyboardShortcuts.action.open_go_to_line.label': 'Go to line (files editor)',
  'settings.ax-code.keyboardShortcuts.action.open_command_palette.label': 'Open command palette',
  'settings.ax-code.keyboardShortcuts.action.focus_input.label': 'Focus input',
  'settings.ax-code.keyboardShortcuts.action.open_settings.label': 'Open settings',
  'settings.ax-code.keyboardShortcuts.action.toggle_terminal.label': 'Toggle terminal dock',
  'settings.ax-code.keyboardShortcuts.action.toggle_terminal_expanded.label': 'Toggle terminal expanded',
  'settings.ax-code.keyboardShortcuts.action.toggle_sidebar.label': 'Toggle sidebar',
  'settings.ax-code.keyboardShortcuts.action.toggle_right_sidebar.label': 'Toggle right sidebar',
  'settings.ax-code.keyboardShortcuts.action.open_right_sidebar_git.label': 'Open right sidebar Git tab',
  'settings.ax-code.keyboardShortcuts.action.open_right_sidebar_files.label': 'Open right sidebar Files tab',
  'settings.ax-code.keyboardShortcuts.action.cycle_right_sidebar_tab.label': 'Cycle right sidebar tab',
  'settings.ax-code.keyboardShortcuts.action.new_chat.label': 'New session',
  'settings.ax-code.keyboardShortcuts.action.new_chat_worktree.label': 'New worktree draft',
  'settings.ax-code.keyboardShortcuts.action.new_mini_chat.label': 'New Mini Chat window',
  'settings.ax-code.keyboardShortcuts.action.open_help.label': 'Open keyboard shortcuts',
  'settings.ax-code.keyboardShortcuts.action.toggle_context_plan.label': 'Toggle plan context panel',
  'settings.ax-code.keyboardShortcuts.action.toggle_services_menu.label': 'Toggle services menu',
  'settings.ax-code.keyboardShortcuts.action.cycle_services_tab.label': 'Cycle services tab',
  'settings.ax-code.keyboardShortcuts.action.cycle_theme.label': 'Cycle theme',
  'settings.ax-code.keyboardShortcuts.action.cycle_agent.label': 'Cycle agent',
  'settings.ax-code.keyboardShortcuts.action.cycle_favorite_model_forward.label': 'Cycle favorite model forward',
  'settings.ax-code.keyboardShortcuts.action.cycle_favorite_model_backward.label': 'Cycle favorite model backward',
  'settings.ax-code.keyboardShortcuts.action.expand_input.label': 'Expand input',
  'settings.ax-code.keyboardShortcuts.action.open_timeline_dialog.label': 'Open conversation timeline',
  ...
  'settings.remoteInstances.page.section.remoteServerDescription': 'How ax-code is managed and started on the remote host.',
  ...
  'settings.remoteInstances.page.section.authenticationDescription': 'Optional credentials for SSH and the remote ax-code UI.',
  ...
  'settings.remoteInstances.page.field.installMethodHint': 'How ax-code is installed when running in managed mode.',
  ...
  'settings.remoteInstances.page.phase.installingax-code': 'Installing ax-code',
  'settings.remoteInstances.page.phase.updatingax-code': 'Updating ax-code',
  ...
  'settings.ax-code.worktrees.state.selectProject': 'Select a project to manage worktrees.',
  'settings.ax-code.worktrees.state.gitOnly': 'Worktree settings are only available for Git repositories.',
  'settings.ax-code.worktrees.setup.title': 'Setup commands',
  'settings.ax-code.worktrees.setup.tooltipPrefix': 'Run automatically inside the new worktree directory when a worktree is created. Use',
  'settings.ax-code.worktrees.setup.tooltipSuffix': 'for the project root.',
  'settings.ax-code.worktrees.setup.loading': 'Loading...',
  'settings.ax-code.worktrees.setup.commandPlaceholder': 'e.g., bun install',
  'settings.ax-code.worktrees.setup.removeCommandAria': 'Remove command',
  'settings.ax-code.worktrees.setup.addCommand': 'Add command',
  'settings.ax-code.worktrees.list.title': 'Existing worktrees',
  'settings.ax-code.worktrees.list.tooltip': 'Worktrees live outside the repo (OpenCode-managed). Deleting a worktree also removes linked sessions.',
  'settings.ax-code.worktrees.list.loading': 'Loading worktrees...',
  'settings.ax-code.worktrees.list.empty': 'No worktrees found for this project',
  'settings.ax-code.worktrees.list.detachedHead': 'Detached HEAD',
  'settings.ax-code.worktrees.list.deleteWorktreeAria': 'Delete worktree {name}',
  ...
  'settings.providers.page.auth.apiKeyTooltip': 'Keys are sent directly to OpenCode and never stored by ax-code.',
  ...
  'settings.ax-code.defaults.title': 'Session Defaults',
  'settings.ax-code.defaults.summaryPrefix': 'New sessions will start with:',
  'settings.ax-code.defaults.summaryOpenCodeDefault': 'OpenCode agent default',
  'settings.ax-code.defaults.field.defaultModel': 'Default Model',
  'settings.ax-code.defaults.field.defaultThinking': 'Default Thinking',
  'settings.ax-code.defaults.field.thinkingPlaceholder': 'Thinking',
  'settings.ax-code.defaults.field.defaultAgent': 'Default Agent',
  'settings.ax-code.defaults.field.showDeletionDialogAria': 'Show deletion dialog',
  'settings.ax-code.defaults.field.showDeletionDialog': 'Show Deletion Dialog',
  'settings.ax-code.defaults.field.openFilesPreviewAria': 'Open files in preview mode',
  'settings.ax-code.defaults.field.openFilesPreview': 'Open files in preview mode',
  'settings.ax-code.defaults.option.default': 'Default',
  'settings.ax-code.defaults.option.defaultLowercase': 'default',
  'settings.ax-code.git.title': 'Git Preferences',
  'settings.ax-code.git.changesViewTitle': 'Changes View',
  'settings.ax-code.git.changesViewAria': 'Git changes view mode',
  'settings.ax-code.git.option.flatList': 'Flat List',
  'settings.ax-code.git.option.treeView': 'Tree View',
  'settings.ax-code.git.optionAria': 'Git changes view mode: {option}',
  'settings.ax-code.git.enableGitmojiAria': 'Enable Gitmoji picker',
  'settings.ax-code.git.enableGitmoji': 'Enable Gitmoji Picker',
  'settings.ax-code.git.showGitignoredAria': 'Display gitignored files',
  'settings.ax-code.git.showGitignored': 'Display Gitignored Files',
  ...
  'settings.github.page.flow.title': 'Authorize ax-code',
  ...
  'settings.notifications.page.testNotification.body': 'This is a test notification from ax-code.',
  ...
  'settings.ax-code.visual.section.colorMode': 'Color Mode',
  'settings.ax-code.visual.section.localization': 'Localization',
  'settings.ax-code.visual.section.spacingAndLayout': 'Spacing & Layout',
  'settings.ax-code.visual.section.navigation': 'Navigation',
  'settings.ax-code.visual.section.chatRenderMode': 'Chat Render Mode',
  'settings.ax-code.visual.section.chatRenderModeAria': 'Chat render mode',
  'settings.ax-code.visual.section.messageStreamTransport': 'Message Stream Transport',
  'settings.ax-code.visual.section.activityDefault': 'Activity Default',
  'settings.ax-code.visual.section.activityDefaultAria': 'Activity default mode',
  'settings.ax-code.visual.section.showToolsOpenedByDefault': 'Show tools opened by default:',
  'settings.ax-code.visual.section.userMessageRendering': 'User Message Rendering',
  'settings.ax-code.visual.section.userMessageRenderingAria': 'User message rendering mode',
  'settings.ax-code.visual.section.mermaidRendering': 'Mermaid Rendering',
  'settings.ax-code.visual.section.mermaidRenderingAria': 'Mermaid rendering mode',
  'settings.ax-code.visual.section.diffLayout': 'Diff Layout',
  'settings.ax-code.visual.section.diffLayoutAria': 'Diff layout',
  'settings.ax-code.visual.section.diffViewMode': 'Diff View Mode',
  'settings.ax-code.visual.section.diffViewModeAria': 'Diff view mode',
  'settings.ax-code.visual.section.privacy': 'Privacy',
  'settings.ax-code.visual.field.lightTheme': 'Light Theme',
  'settings.ax-code.visual.field.darkTheme': 'Dark Theme',
  'settings.ax-code.visual.field.selectLightThemeAria': 'Select light theme',
  'settings.ax-code.visual.field.selectDarkThemeAria': 'Select dark theme',
  'settings.ax-code.visual.field.selectThemePlaceholder': 'Select theme',
  'settings.ax-code.visual.field.timeFormat': 'Time Format',
  'settings.ax-code.visual.field.weekStartsOn': 'Week Starts On',
  'settings.ax-code.visual.field.selectTimeFormatAria': 'Select time format',
  'settings.ax-code.visual.field.selectWeekStartAria': 'Select week start',
  'settings.ax-code.visual.actions.reloadThemes': 'Reload themes',
  'settings.ax-code.visual.actions.reloadingThemes': 'Reloading themes...',
  'settings.ax-code.visual.field.themeImportInfoAria': 'Theme import info',
  'settings.ax-code.visual.field.themeImportInfoTooltip': 'Import custom themes from ~/.config/ax-code/themes/',
  'settings.ax-code.visual.field.installAppName': 'Install App Name',
  'settings.ax-code.visual.field.installAppNameHint': 'Used by PWA installation process.',
  'settings.ax-code.visual.field.pwaInstallAppNameAria': 'PWA install app name',
  'settings.ax-code.visual.actions.resetInstallAppNameAria': 'Reset install app name',
  'settings.ax-code.visual.field.installOrientation': 'Install Orientation',
  'settings.ax-code.visual.field.installOrientationHint': 'Used by the installed web app. Reinstall the PWA after changing this.',
  'settings.ax-code.visual.field.pwaInstallOrientationAria': 'PWA install orientation',
  'settings.ax-code.visual.field.selectOrientationPlaceholder': 'Select orientation',
  'settings.ax-code.visual.actions.resetInstallOrientationAria': 'Reset install orientation',
  'settings.ax-code.visual.field.mobileKeyboardMode': 'Mobile Keyboard Behavior',
  'settings.ax-code.visual.field.mobileKeyboardModeHint': 'Default browser behavior is safest. Resize content asks supported browsers to shrink the app when the on-screen keyboard opens.',
  'settings.ax-code.visual.field.mobileKeyboardModeAria': 'Mobile keyboard behavior',
  'settings.ax-code.visual.field.selectMobileKeyboardModePlaceholder': 'Select keyboard behavior',
  'settings.ax-code.visual.actions.resetMobileKeyboardModeAria': 'Reset mobile keyboard behavior',
  'settings.ax-code.visual.field.interfaceFontSize': 'Interface Font Size',
  'settings.ax-code.visual.field.interfaceFont': 'Interface Font',
  'settings.ax-code.visual.field.selectInterfaceFontAria': 'Select interface font',
  'settings.ax-code.visual.actions.resetInterfaceFontAria': 'Reset interface font',
  'settings.ax-code.visual.field.fontSizePercentageAria': 'Font size percentage',
  'settings.ax-code.visual.actions.resetFontSizeAria': 'Reset font size',
  'settings.ax-code.visual.field.terminalFontSize': 'Terminal Font Size',
  'settings.ax-code.visual.field.codeFont': 'Code Font',
  'settings.ax-code.visual.field.selectCodeFontAria': 'Select code font',
  'settings.ax-code.visual.actions.resetCodeFontAria': 'Reset code font',
  'settings.ax-code.visual.actions.resetTerminalFontSizeAria': 'Reset terminal font size',
  'settings.ax-code.visual.field.spacingDensity': 'Spacing Density',
  'settings.ax-code.visual.actions.resetSpacingAria': 'Reset spacing',
  'settings.ax-code.visual.field.inputBarOffset': 'Input Bar Offset',
  'settings.ax-code.visual.field.inputBarOffsetTooltip': 'Raise input bar to avoid OS-level screen obstructions like home bars.',
  'settings.ax-code.visual.actions.resetInputBarOffsetAria': 'Reset input bar offset',
  'settings.ax-code.visual.field.terminalQuickKeysAria': 'Terminal quick keys',
  'settings.ax-code.visual.field.terminalQuickKeys': 'Terminal Quick Keys',
  'settings.ax-code.visual.field.terminalQuickKeysTooltip': 'Show Esc, Ctrl, Arrows in terminal view',
  'settings.ax-code.visual.field.activityDefaultModeAria': 'Activity default mode: {option}',
  'settings.ax-code.visual.field.showExpandedBashToolsAria': 'Show expanded bash tools',
  'settings.ax-code.visual.field.showExpandedEditToolsAria': 'Show expanded edit tools',
  'settings.ax-code.visual.field.bash': 'Bash',
  'settings.ax-code.visual.field.editTools': 'Edit tools',
  'settings.ax-code.visual.field.userMessageRenderingAria': 'User message rendering: {option}',
  'settings.ax-code.visual.field.mermaidRenderingAria': 'Mermaid rendering: {option}',
  'settings.ax-code.visual.field.diffLayoutAria': 'Diff layout: {option}',
  'settings.ax-code.visual.field.diffViewModeAria': 'Diff view mode: {option}',
  'settings.ax-code.visual.field.showReasoningTracesAria': 'Show reasoning traces',
  'settings.ax-code.visual.field.showReasoningTraces': 'Show Reasoning Traces',
  'settings.ax-code.visual.field.collapsibleThinkingBlocksAria': 'Enable collapsible reasoning blocks',
  'settings.ax-code.visual.field.collapsibleThinkingBlocks': 'Enable Collapsible Reasoning Blocks',
  'settings.ax-code.visual.field.stickyUserHeaderAria': 'Sticky user header',
  'settings.ax-code.visual.field.stickyUserHeader': 'Sticky User Header',
  'settings.ax-code.visual.field.wideChatLayoutAria': 'Wide chat layout',
  'settings.ax-code.visual.field.wideChatLayout': 'Wide Chat Layout',
  'settings.ax-code.visual.field.showSplitAssistantMessageActionsAria': 'Inline assistant actions',
  'settings.ax-code.visual.field.showSplitAssistantMessageActions': 'Inline Assistant Actions',
  'settings.ax-code.visual.field.showSplitAssistantMessageActionsTooltip': 'Show Copy Answer, Save as image, and Read aloud on assistant text blocks that appear before later tool calls in the same response.',
  'settings.ax-code.visual.field.showToolFileIconsAria': 'Show tool file icons',
  'settings.ax-code.visual.field.showToolFileIcons': 'Show Tool File Icons',
  'settings.ax-code.visual.field.showMobileStatusBarAria': 'Show mobile status bar',
  'settings.ax-code.visual.field.showMobileStatusBar': 'Show Mobile Status Bar',
  'settings.ax-code.visual.field.showDotfilesAria': 'Show dotfiles',
  'settings.ax-code.visual.field.showDotfiles': 'Show Dotfiles',
  'settings.ax-code.visual.field.queueMessagesByDefaultAria': 'Queue messages by default',
  'settings.ax-code.visual.field.queueMessagesByDefault': 'Queue Messages by Default',
  'settings.ax-code.visual.field.queueMessagesByDefaultTooltip': 'When enabled, Enter queues messages. Use {modifier}+Enter to send.',
  'settings.ax-code.visual.field.persistDraftMessagesAria': 'Persist draft messages',
  'settings.ax-code.visual.field.persistDraftMessages': 'Persist Draft Messages',
  'settings.ax-code.visual.field.enableSpellcheckInTextInputsAria': 'Enable spellcheck in text inputs',
  'settings.ax-code.visual.field.enableSpellcheckInTextInputs': 'Enable Spellcheck in Text Inputs',
  'settings.ax-code.visual.field.sendAnonymousUsageReportsAria': 'Send anonymous usage reports',
  'settings.ax-code.visual.field.sendAnonymousUsageReports': 'Send anonymous usage reports',
  'settings.ax-code.visual.field.sendAnonymousUsageReportsHint': 'Helps us understand which app versions are actively used so we can prioritize improvements. Only app version, platform, and runtime are collected - no personal data or code.',
  'settings.ax-code.visual.option.themeMode.system': 'System',
  'settings.ax-code.visual.option.themeMode.light': 'Light',
  'settings.ax-code.visual.option.themeMode.dark': 'Dark',
  'settings.ax-code.visual.option.diffLayout.dynamic.label': 'Dynamic',
  'settings.ax-code.visual.option.diffLayout.dynamic.description': 'New inline, modified side-by-side.',
  'settings.ax-code.visual.option.diffLayout.inline.label': 'Always inline',
  'settings.ax-code.visual.option.diffLayout.inline.description': 'Show as a single unified view.',
  'settings.ax-code.visual.option.diffLayout.sideBySide.label': 'Always side-by-side',
  'settings.ax-code.visual.option.diffLayout.sideBySide.description': 'Compare original and modified files.',
  'settings.ax-code.visual.option.diffViewMode.single.label': 'Single file',
  'settings.ax-code.visual.option.diffViewMode.single.description': 'Show one file at a time.',
  'settings.ax-code.visual.option.diffViewMode.stacked.label': 'All files',
  'settings.ax-code.visual.option.diffViewMode.stacked.description': 'Stack all changed files together.',
  'settings.ax-code.visual.option.mermaidRendering.svg.label': 'SVG',
  'settings.ax-code.visual.option.mermaidRendering.svg.description': 'Render diagrams as scalable graphics.',
  'settings.ax-code.visual.option.mermaidRendering.ascii.label': 'ASCII',
  'settings.ax-code.visual.option.mermaidRendering.ascii.description': 'Render diagrams as text blocks.',
  'settings.ax-code.visual.option.pwaOrientation.system.label': 'Follow system',
  'settings.ax-code.visual.option.pwaOrientation.system.description': 'Respect the device rotation setting.',
  'settings.ax-code.visual.option.pwaOrientation.portrait.label': 'Portrait lock',
  'settings.ax-code.visual.option.pwaOrientation.portrait.description': 'Install the app locked to portrait.',
  'settings.ax-code.visual.option.pwaOrientation.landscape.label': 'Landscape lock',
  'settings.ax-code.visual.option.pwaOrientation.landscape.description': 'Install the app locked to landscape.',
  'settings.ax-code.visual.option.mobileKeyboardMode.native.label': 'Follow browser',
  'settings.ax-code.visual.option.mobileKeyboardMode.native.description': 'Use the browser default for panning and viewport changes when the keyboard opens.',
  'settings.ax-code.visual.option.mobileKeyboardMode.resizeContent.label': 'Resize content',
  'settings.ax-code.visual.option.mobileKeyboardMode.resizeContent.description': 'Ask supported browsers to shrink the app layout instead of relying only on panning.',
  'settings.ax-code.visual.option.userMessageRendering.markdown.label': 'Markdown',
  'settings.ax-code.visual.option.userMessageRendering.markdown.description': 'Render user text with markdown formatting.',
  'settings.ax-code.visual.option.userMessageRendering.plain.label': 'Plain text',
  'settings.ax-code.visual.option.userMessageRendering.plain.description': 'Render user text with preserved whitespace and links.',
  'settings.ax-code.visual.option.chatRenderMode.sorted.label': 'Sorted',
  'settings.ax-code.visual.option.chatRenderMode.sorted.description': 'Render completed assistant messages without live streaming.',
  'settings.ax-code.visual.option.chatRenderMode.live.label': 'Live',
  'settings.ax-code.visual.option.chatRenderMode.live.description': 'Stream assistant text and tools as they arrive.',
  'settings.ax-code.visual.option.messageTransport.auto.label': 'Auto',
  'settings.ax-code.visual.option.messageTransport.auto.description': 'Prefer WebSocket and fall back to SSE if needed.',
  'settings.ax-code.visual.option.messageTransport.ws.label': 'WebSocket',
  'settings.ax-code.visual.option.messageTransport.ws.description': 'Use WebSocket for message streaming.',
  'settings.ax-code.visual.option.messageTransport.sse.label': 'SSE',
  'settings.ax-code.visual.option.messageTransport.sse.description': 'Use Server-Sent Events for message streaming.',
  'settings.ax-code.visual.option.activityRenderMode.collapsed.label': 'Collapsed',
  'settings.ax-code.visual.option.activityRenderMode.collapsed.description': 'Keep Activity collapsed by default.',
  'settings.ax-code.visual.option.activityRenderMode.summary.label': 'Expanded',
  'settings.ax-code.visual.option.activityRenderMode.summary.description': 'Expand Activity by default.',
  'settings.ax-code.visual.option.timeFormat.auto.label': 'Auto',
  'settings.ax-code.visual.option.timeFormat.auto.description': 'Use system locale preference.',
  'settings.ax-code.visual.option.timeFormat.24h.label': '24-hour',
  'settings.ax-code.visual.option.timeFormat.24h.description': 'Show time as 14:15.',
  'settings.ax-code.visual.option.timeFormat.12h.label': '12-hour',
  'settings.ax-code.visual.option.timeFormat.12h.description': 'Show time as 02:15 PM.',
  'settings.ax-code.visual.option.weekStart.auto.label': 'Auto',
  'settings.ax-code.visual.option.weekStart.auto.description': 'Use locale week start.',
  'settings.ax-code.visual.option.weekStart.monday.label': 'Monday',
  'settings.ax-code.visual.option.weekStart.sunday.label': 'Sunday',
