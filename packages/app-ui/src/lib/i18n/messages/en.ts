...
export const dict = {
  ...
  'pwa.installPrompt.description': 'Install ax-code for quicker access',
  'pwa.installPrompt.action': 'Install',
  'pwa.installPrompt.dismiss': 'Dismiss',
  'pwa.installPrompt.started': 'Install started',
  'pwa.installPrompt.installed': 'ax-code installed',
  ...
  'sessions.sidebar.footer.actions.aboutax-code': 'About ax-code',
  ...
  'aboutDialog.diagnosticsDescription': 'Includes ax-code state, OpenCode health, directories, and projects.',
  ...
  'onboarding.localSetup.windows.stepSetBinaryPath': 'If ax-code does not detect OpenCode automatically, set the binary path below.',
  'onboarding.localSetup.intro': 'OpenCode is the heart of ax-code — install it to get started.',
  ...
  'onboarding.localSetup.helper.saveAndReload': 'Saves to ax-code settings and reloads OpenCode configuration.',
  ...
  'onboarding.remoteConnection.status.suggestionsWrongService': 'Suggestions: Verify the URL points to an ax-code server, or contact the server administrator.',
  ...
  'onboarding.remoteConnection.probe.wrongServiceMessage': 'Server responded but is not running ax-code. Verify the address points to an ax-code server.',
  ...
  'onboarding.desktopRecovery.incompatibleServer.description': 'The server at "{host}" is not running ax-code. Verify the address points to an ax-code server.',
  ...
  'startup.initRecovery.description': 'ax-code could not finish initialization. Check that the server is running, then retry.',
  ...
  'updateDialog.header.updating': 'Updating ax-code...',
  ...
  'updateDialog.error.takingLonger': 'Update is taking longer than expected. Wait a bit and refresh, or run: ax-code update',
  ...
  'opencodeUpdate.toast.upgrading.description': 'Keep ax-code open.',
