...
export const dict: Record<I18nKey, string> = {
  ...
  'pwa.installPrompt.description': '安装 ax-code 以便更快访问',
  'pwa.installPrompt.action': '安装',
  'pwa.installPrompt.dismiss': '忽略',
  'pwa.installPrompt.started': '已开始安装',
  'pwa.installPrompt.installed': 'ax-code 已安装',
  ...
  'sessions.sidebar.footer.actions.aboutax-code': '关于 ax-code',
  ...
  'aboutDialog.diagnosticsDescription': '包含 ax-code 状态、OpenCode 健康信息、目录和项目。',
  ...
  'helpDialog.description': '使用这些快捷键可更高效地导航 ax-code',
  ...
  'header.actions.openAppMenu': 'ax-code 菜单',
  'header.actions.openAppMenuAria': '打开 ax-code 菜单',
  ...
  'sessionAuth.locked.unlockTitle': '解锁 ax-code',
  ...
  'desktopHostSwitcher.description': '在 Local 与远程 ax-code 服务器之间切换',
  ...
  'multiRun.window.description': 'ax-code 多运行窗口。',
  ...
  'onboarding.chooser.title': '欢迎使用 ax-code',
  ...
  'onboarding.localSetup.windows.stepSetBinaryPath': '如果 ax-code 未自动检测到 OpenCode，请在下方设置可执行文件路径。',
  'onboarding.localSetup.intro': 'OpenCode 是 ax-code 的核心，先安装它即可开始。',
  ...
  'onboarding.localSetup.helper.saveAndReload': '将保存到 ax-code 设置并重新加载 OpenCode 配置。',
  ...
  'onboarding.remoteConnection.description': '输入要连接的 ax-code 服务器地址。',
  ...
  'onboarding.remoteConnection.status.suggestionsWrongService': '建议：确认 URL 指向 ax-code 服务器，或联系服务器管理员。',
  ...
  'onboarding.remoteConnection.probe.wrongServiceMessage': '服务器有响应，但未运行 ax-code。请确认地址是否指向 ax-code 服务器。',
  ...
  'onboarding.desktopRecovery.incompatibleServer.description': '“{host}” 上的服务器未运行 ax-code。请确认地址是否指向 ax-code 服务器。',
  ...
  'startup.initRecovery.description': 'ax-code 未能完成初始化。请检查服务器是否正在运行，然后重试。',
  ...
  'updateDialog.error.takingLonger': '更新耗时超出预期。请稍等后刷新，或运行：ax-code update',
  ...
  'opencodeUpdate.toast.upgrading.description': '请保持 ax-code 打开。',
  ...
  'openChamberLogo.aria.logo': 'ax-code 标志',
