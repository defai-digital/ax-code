...
export const dict: Record<I18nKey, string> = {
  ...
  "pwa.installPrompt.description": "Instala ax-code para acceder más rápido",
  "pwa.installPrompt.action": "Instalar",
  "pwa.installPrompt.dismiss": "Descartar",
  "pwa.installPrompt.started": "Instalación iniciada",
  "pwa.installPrompt.installed": "ax-code se instaló",
  ...
  "sessions.sidebar.footer.actions.aboutax-code": "Acerca de ax-code",
  ...
  "header.services.shutdownDev": "Detener ax-code",
  ...
  "aboutDialog.openChamberVersionLabel": "Versión de ax-code {version}",
  ...
  "aboutDialog.diagnosticsDescription": "Incluye el estado de ax-code, el estado de OpenCode, directorios y proyectos.",
  ...
  "helpDialog.description": "Usa estos atajos de teclado para navegar por ax-code de manera eficiente",
  ...
  "header.actions.openAppMenu": "Menú de ax-code",
  "header.actions.openAppMenuAria": "Abrir menú de ax-code",
  ...
  "desktopHostSwitcher.description": "Cambia entre Local y el servidor remoto de ax-code",
  ...
  "multiRun.window.description": "Ventana de ax-code Multi-Run.",
  ...
  "onboarding.chooser.title": "Bienvenido a ax-code",
  ...
  "onboarding.localSetup.windows.stepSetBinaryPath": "Si ax-code no detecta OpenCode automáticamente, establece la ruta del ejecutable a continuación.",
  "onboarding.localSetup.intro": "OpenCode es el corazón de ax-code. Instálalo para empezar.",
  ...
  "onboarding.localSetup.helper.saveAndReload": "Guarda en la configuración de ax-code y recarga la configuración de OpenCode.",
  ...
  "onboarding.remoteConnection.description": "Introduce la dirección de un servidor de ax-code para conectar.",
  ...
  "onboarding.remoteConnection.status.suggestionsWrongService": "Sugerencias: Verifica que la URL apunte a un servidor ax-code o contacta al administrador del servidor.",
  ...
  "onboarding.remoteConnection.probe.wrongServiceMessage": "El servidor respondió pero no está ejecutando ax-code. Verifica que la dirección apunte a un servidor ax-code.",
  ...
  "onboarding.desktopRecovery.incompatibleServer.description": "El servidor en \"{host}\" no está ejecutando ax-code. Verifica que la dirección apunte a un servidor ax-code.",
  ...
  "startup.initRecovery.description": "ax-code no pudo completar la inicialización. Comprueba que el servidor esté en ejecución y vuelve a intentarlo.",
  ...
  "updateDialog.header.updating": "Actualizando ax-code...",
  ...
  "updateDialog.error.takingLonger": "La actualización está tardando más de lo esperado. Espera un poco y refresca, o ejecuta: ax-code update",
  ...
  "opencodeUpdate.toast.upgrading.description": "Mantén ax-code abierto.",
  ...
  "openChamberLogo.aria.logo": "Logo de ax-code",
