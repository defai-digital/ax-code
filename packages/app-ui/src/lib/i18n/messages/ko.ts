...
export const dict: Record<I18nKey, string> = {
  ...
  'pwa.installPrompt.description': '더 빠르게 접근하려면 ax-code를 설치하세요',
  'pwa.installPrompt.action': '설치',
  'pwa.installPrompt.dismiss': '닫기',
  'pwa.installPrompt.started': '설치가 시작되었습니다',
  'pwa.installPrompt.installed': 'ax-code가 설치되었습니다',
  ...
  'sessions.sidebar.footer.actions.aboutax-code': 'ax-code 정보',
  ...
  'header.services.shutdownDev': 'ax-code 종료',
  ...
  'aboutDialog.openChamberVersionLabel': 'ax-code 버전 {version}',
  ...
  'aboutDialog.diagnosticsDescription': 'ax-code 상태, OpenCode 상태, 디렉터리 및 프로젝트를 포함합니다.',
  ...
  'helpDialog.description': '이 단축키로 ax-code를 빠르게 탐색하세요',
  ...
  'header.actions.openAppMenu': 'ax-code 메뉴',
  'header.actions.openAppMenuAria': 'ax-code 메뉴 열기',
  ...
  'sessionAuth.locked.unlockTitle': 'ax-code 잠금 해제',
  ...
  'desktopHostSwitcher.description': '로컬과 원격 ax-code 서버 간에 전환합니다',
  ...
  'multiRun.window.description': 'ax-code 멀티런 창.',
  ...
  'onboarding.chooser.title': 'ax-code에 오신 것을 환영합니다',
  ...
  'onboarding.localSetup.windows.stepSetBinaryPath': 'ax-code가 OpenCode를 자동으로 찾지 못하면 아래에 바이너리 경로를 설정하세요.',
  'onboarding.localSetup.intro': 'OpenCode는 ax-code의 심장입니다. 먼저 설치하고 시작하세요.',
  ...
  'onboarding.localSetup.helper.saveAndReload': 'ax-code 설정에 저장하고 OpenCode 구성을 다시 로드합니다.',
  ...
  'onboarding.remoteConnection.description': '연결할 ax-code 서버 주소를 입력하세요.',
  ...
  'onboarding.remoteConnection.status.suggestionsWrongService': 'URL이 ax-code 서버를 가리키는지 확인하거나 서버 관리자에게 문의하세요.',
  ...
  'onboarding.remoteConnection.probe.wrongServiceMessage': '서버가 응답했지만 ax-code가 실행 중이 아닙니다. 주소가 ax-code 서버를 가리키는지 확인하세요.',
  ...
  'onboarding.desktopRecovery.incompatibleServer.description': '"{host}"의 서버에서 ax-code가 실행 중이 아닙니다. 주소가 ax-code 서버를 가리키는지 확인하세요.',
  ...
  'startup.initRecovery.description': 'ax-code 초기화를 완료할 수 없습니다. 서버가 실행 중인지 확인한 뒤 다시 시도하세요.',
  ...
  'updateDialog.header.updating': 'ax-code 업데이트 중…',
  ...
  'updateDialog.error.takingLonger': '업데이트가 예상보다 오래 걸립니다. 잠시 기다린 뒤 새로고침하거나 `ax-code update`를 실행하세요.',
  ...
  'opencodeUpdate.toast.upgrading.description': 'ax-code를 열어 두세요.',
  ...
  'openChamberLogo.aria.logo': 'ax-code 로고',
