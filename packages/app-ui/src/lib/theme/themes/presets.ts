...
import ax_code_dark_Raw from './fields-of-the-shire-dark.json';
import ax_code_light_Raw from './fields-of-the-shire-light.json';
...
export const presetThemes: Theme[] = [
  ax_code_dark_Raw as Theme,
  ax_code_light_Raw as Theme,
