...
import axCodeLightRaw from './fields-of-the-shire-light.json';
import axCodeDarkRaw from './fields-of-the-shire-dark.json';
...
export const axCodeLightTheme = withPrColors(axCodeLightRaw as Theme);
export const axCodeDarkTheme = withPrColors(axCodeDarkRaw as Theme);
...
export const themes: Theme[] = [
  ...
  flexokiDarkTheme,
  ...presetThemes.filter(
    (theme) => theme.metadata.id !== 'ax-code-light' && theme.metadata.id !== 'ax-code-dark',
  ),
];
