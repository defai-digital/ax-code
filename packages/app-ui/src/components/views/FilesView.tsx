...
const FILE_EDITOR_AUTO_SAVE_KEY = 'ax-code:files:auto-save-enabled';
type FileLineEnding = '\n' | '\r\n';
...
export const FilesView: React.FC<FilesViewProps> = ({ mode = 'full' }) => {
  ...
  const MD_VIEWER_MODE_KEY = 'ax-code:files:md-viewer-mode';
  const HTML_VIEWER_MODE_KEY = 'ax-code:files:html-viewer-mode';
  const JSON_VIEWER_MODE_KEY = 'ax-code:files:json-viewer-mode';
