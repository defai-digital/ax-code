...
export const OpenCodeUpdateToast: React.FC = () => {
  ...
  React.useEffect(() => {
    ...
    window.addEventListener('ax-code:opencode-update-available', onUpdateAvailable);
    return () => {
      cancelled = true;
      for (const timeoutId of timeoutIds) clearTimeout(timeoutId);
      window.removeEventListener('ax-code:opencode-update-available', onUpdateAvailable);
    };
