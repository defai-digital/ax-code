...
import { OPENCHAMBER_PROJECT_NOTES_MAX_LENGTH, getProjectNotesAndTodos, saveProjectNotesAndTodos } from '@/lib/axCodeConfig';
...
export const TextSelectionMenu: React.FC<TextSelectionMenuProps> = ({ containerRef }) => {
  ...
  const handleAddToNotes = React.useCallback(async () => {
    ...
    try {
      ...
      window.dispatchEvent(new CustomEvent('ax-code:project-notes-updated', {
