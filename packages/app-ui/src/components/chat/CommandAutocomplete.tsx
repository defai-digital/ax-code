...
type CommandSource = 'ax-code' | 'opencode' | 'skill';
      ...
      try {
        ...
        const builtInCommands: CommandInfo[] = [
          ...(hasSession && !hasMessagesInCurrentSession
            ? [{ id: 'ax-code:init', name: 'init', source: 'ax-code' as const, description: t('chat.commandAutocomplete.command.initDescription'), isBuiltIn: true }]
            : []
          ),
          ...(hasSession  // Show when session exists, not when hasMessages
            ? [
                { id: 'ax-code:undo', name: 'undo', source: 'ax-code' as const, description: t('chat.commandAutocomplete.command.undoDescription'), isBuiltIn: true },
                { id: 'ax-code:redo', name: 'redo', source: 'ax-code' as const, description: t('chat.commandAutocomplete.command.redoDescription'), isBuiltIn: true },
                { id: 'ax-code:timeline', name: 'timeline', source: 'ax-code' as const, description: t('chat.commandAutocomplete.command.timelineDescription'), isBuiltIn: true },
              ]
            : []
          ),
          { id: 'ax-code:compact', name: 'compact', source: 'ax-code' as const, description: t('chat.commandAutocomplete.command.compactDescription'), isBuiltIn: true },
          ...(hasSession
            ? [{ id: 'ax-code:summary', name: 'summary', source: 'ax-code' as const, description: t('chat.commandAutocomplete.command.summaryDescription'), isax-code: true }]
            : []
          ),
          ...(canStartSessionCommand
            ? [{ id: 'ax-code:workspace-review', name: 'workspace-review', source: 'ax-code' as const, description: t('chat.commandAutocomplete.command.workspaceReviewDescription'), isax-code: true }]
            : []
          ),
        ];
        ...
        {loading ? (
          ...
          <div>
            {commands.map((command, index) => {
              ...
              const isax-codeBadge = command.isax-code;
              return (
                <div
                  key={command.id}
