...
import { ax-codeVisualSettings } from './ax-codeVisualSettings';
...
import type { ax-codeSection } from './types';

interface ax-codePageProps {
    /** Which section to display. If undefined, shows all sections (mobile/legacy behavior) */
    section?: ax-codeSection;
}

export const ax-codePage: React.FC<ax-codePageProps> = ({ section }) => {
...
const VisualSectionContent: React.FC = () => {
    const isVSCode = isVSCodeRuntime();
    return <ax-codeVisualSettings visibleSettings={[
        'theme',
        'pwaInstallName',
        'pwaOrientation',
        'mobileKeyboardMode',
