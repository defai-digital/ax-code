...
const THEME_MODE_OPTIONS: Array<{ value: ThemeMode; labelKey: string }> = [
    {
        value: 'system',
        labelKey: 'settings.ax-code.visual.option.themeMode.system',
    },
    {
        value: 'light',
        labelKey: 'settings.ax-code.visual.option.themeMode.light',
    },
    {
        value: 'dark',
        labelKey: 'settings.ax-code.visual.option.themeMode.dark',
    },
];
...
const DIFF_LAYOUT_OPTIONS: Option<'dynamic' | 'inline' | 'side-by-side'>[] = [
    {
        id: 'dynamic',
        labelKey: 'settings.ax-code.visual.option.diffLayout.dynamic.label',
        descriptionKey: 'settings.ax-code.visual.option.diffLayout.dynamic.description',
    },
    {
        id: 'inline',
        labelKey: 'settings.ax-code.visual.option.diffLayout.inline.label',
        descriptionKey: 'settings.ax-code.visual.option.diffLayout.inline.description',
    },
    {
        id: 'side-by-side',
        labelKey: 'settings.ax-code.visual.option.diffLayout.sideBySide.label',
        descriptionKey: 'settings.ax-code.visual.option.diffLayout.sideBySide.description',
    },
];
...
const DIFF_VIEW_MODE_OPTIONS: Option<'single' | 'stacked'>[] = [
    {
        id: 'single',
        labelKey: 'settings.ax-code.visual.option.diffViewMode.single.label',
        descriptionKey: 'settings.ax-code.visual.option.diffViewMode.single.description',
    },
    {
        id: 'stacked',
        labelKey: 'settings.ax-code.visual.option.diffViewMode.stacked.label',
        descriptionKey: 'settings.ax-code.visual.option.diffViewMode.stacked.description',
    },
];
...
const MERMAID_RENDERING_OPTIONS: Option<'svg' | 'ascii'>[] = [
    {
        id: 'svg',
        labelKey: 'settings.ax-code.visual.option.mermaidRendering.svg.label',
        descriptionKey: 'settings.ax-code.visual.option.mermaidRendering.svg.description',
    },
    {
        id: 'ascii',
        labelKey: 'settings.ax-code.visual.option.mermaidRendering.ascii.label',
        descriptionKey: 'settings.ax-code.visual.option.mermaidRendering.ascii.description',
    },
];

const DEFAULT_PWA_INSTALL_NAME = 'ax-code - AI Coding Assistant';
const PWA_ORIENTATION_OPTIONS: Option<'system' | 'portrait' | 'landscape'>[] = [
    {
        id: 'system',
        labelKey: 'settings.ax-code.visual.option.pwaOrientation.system.label',
        descriptionKey: 'settings.ax-code.visual.option.pwaOrientation.system.description',
    },
    {
        id: 'portrait',
        labelKey: 'settings.ax-code.visual.option.pwaOrientation.portrait.label',
        descriptionKey: 'settings.ax-code.visual.option.pwaOrientation.portrait.description',
    },
    {
        id: 'landscape',
        labelKey: 'settings.ax-code.visual.option.pwaOrientation.landscape.label',
        descriptionKey: 'settings.ax-code.visual.option.pwaOrientation.landscape.description',
    },
];
...
const MOBILE_KEYBOARD_MODE_OPTIONS: Option<MobileKeyboardMode>[] = [
    {
        id: 'native',
        labelKey: 'settings.ax-code.visual.option.mobileKeyboardMode.native.label',
        descriptionKey: 'settings.ax-code.visual.option.mobileKeyboardMode.native.description',
    },
    {
        id: 'resize-content',
        labelKey: 'settings.ax-code.visual.option.mobileKeyboardMode.resizeContent.label',
        descriptionKey: 'settings.ax-code.visual.option.mobileKeyboardMode.resizeContent.description',
    },
];
...
const USER_MESSAGE_RENDERING_OPTIONS: Option<'markdown' | 'plain'>[] = [
    {
        id: 'markdown',
        labelKey: 'settings.ax-code.visual.option.userMessageRendering.markdown.label',
        descriptionKey: 'settings.ax-code.visual.option.userMessageRendering.markdown.description',
    },
    {
        id: 'plain',
        labelKey: 'settings.ax-code.visual.option.userMessageRendering.plain.label',
        descriptionKey: 'settings.ax-code.visual.option.userMessageRendering.plain.description',
    },
];
...
const CHAT_RENDER_MODE_OPTIONS: Option<'sorted' | 'live'>[] = [
    {
        id: 'sorted',
        labelKey: 'settings.ax-code.visual.option.chatRenderMode.sorted.label',
        descriptionKey: 'settings.ax-code.visual.option.chatRenderMode.sorted.description',
    },
    {
        id: 'live',
        labelKey: 'settings.ax-code.visual.option.chatRenderMode.live.label',
        descriptionKey: 'settings.ax-code.visual.option.chatRenderMode.live.description',
    },
];
...
const MESSAGE_STREAM_TRANSPORT_OPTIONS: Option<'auto' | 'ws' | 'sse'>[] = [
    {
        id: 'auto',
        labelKey: 'settings.ax-code.visual.option.messageTransport.auto.label',
        descriptionKey: 'settings.ax-code.visual.option.messageTransport.auto.description',
    },
    {
        id: 'ws',
        labelKey: 'settings.ax-code.visual.option.messageTransport.ws.label',
        descriptionKey: 'settings.ax-code.visual.option.messageTransport.ws.description',
    },
    {
        id: 'sse',
        labelKey: 'settings.ax-code.visual.option.messageTransport.sse.label',
        descriptionKey: 'settings.ax-code.visual.option.messageTransport.sse.description',
    },
];
...
const ACTIVITY_RENDER_MODE_OPTIONS: Option<'collapsed' | 'summary'>[] = [
    {
        id: 'collapsed',
        labelKey: 'settings.ax-code.visual.option.activityRenderMode.collapsed.label',
        descriptionKey: 'settings.ax-code.visual.option.activityRenderMode.collapsed.description',
    },
    {
        id: 'summary',
        labelKey: 'settings.ax-code.visual.option.activityRenderMode.summary.label',
        descriptionKey: 'settings.ax-code.visual.option.activityRenderMode.summary.description',
    },
];
...
const TIME_FORMAT_OPTIONS: Option<'auto' | '12h' | '24h'>[] = [
    {
        id: 'auto',
        labelKey: 'settings.ax-code.visual.option.timeFormat.auto.label',
        descriptionKey: 'settings.ax-code.visual.option.timeFormat.auto.description',
    },
    {
        id: '24h',
        labelKey: 'settings.ax-code.visual.option.timeFormat.24h.label',
        descriptionKey: 'settings.ax-code.visual.option.timeFormat.24h.description',
    },
    {
        id: '12h',
        labelKey: 'settings.ax-code.visual.option.timeFormat.12h.label',
        descriptionKey: 'settings.ax-code.visual.option.timeFormat.12h.description',
    },
];
...
const WEEK_START_OPTIONS: Option<'auto' | 'monday' | 'sunday'>[] = [
    {
        id: 'auto',
        labelKey: 'settings.ax-code.visual.option.weekStart.auto.label',
        descriptionKey: 'settings.ax-code.visual.option.weekStart.auto.description',
    },
    {
        id: 'monday',
        labelKey: 'settings.ax-code.visual.option.weekStart.monday.label',
    },
    {
        id: 'sunday',
        labelKey: 'settings.ax-code.visual.option.weekStart.sunday.label',
    },
];
...
interface ax-codeVisualSettingsProps {
    /** Which settings to show. If undefined, shows all. */
    visibleSettings?: VisibleSetting[];
}

export const ax-codeVisualSettings: React.FC<ax-codeVisualSettingsProps> = ({ visibleSettings }) => {
    ...
    const selectedTimeFormatLabel = React.useMemo(() => {
        ...
        return tUnsafe(option?.labelKey ?? 'settings.ax-code.visual.option.timeFormat.auto.label');
    ...
    const selectedWeekStartLabel = React.useMemo(() => {
        ...
        return tUnsafe(option?.labelKey ?? 'settings.ax-code.visual.option.weekStart.auto.label');
        ...
        <div className="space-y-8">
                ...
                {hasAppearanceSettings && (
                    <div className="mb-8 space-y-6">
                        {hasThemeSettings && (
                            <section className="px-2 pb-2 pt-0 space-y-2">
                                <div className="flex min-w-0 flex-col gap-1.5">
                                    <span className="typography-ui-header font-medium text-foreground">{t('settings.ax-code.visual.section.colorMode')}</span>
                                ...
                                <div className="grid grid-cols-1 gap-2 py-1.5 md:grid-cols-[14rem_auto] md:gap-x-8 md:gap-y-2">
                                    <div className="flex min-w-0 items-center gap-2">
                                        <span className="typography-ui-label text-foreground shrink-0">{t('settings.ax-code.visual.field.lightTheme')}</span>
                                        <Select value={selectedLightTheme?.metadata.id ?? ''} onValueChange={setLightThemePreference}>
                                            <SelectTrigger aria-label={t('settings.ax-code.visual.field.selectLightThemeAria')} className="w-fit">
                                                <SelectValue placeholder={t('settings.ax-code.visual.field.selectThemePlaceholder')}>
                                                    {selectedLightTheme
                                    ...
                                    <div className="flex min-w-0 items-center gap-2">
                                        <span className="typography-ui-label text-foreground shrink-0">{t('settings.ax-code.visual.field.darkTheme')}</span>
                                        <Select value={selectedDarkTheme?.metadata.id ?? ''} onValueChange={setDarkThemePreference}>
                                            <SelectTrigger aria-label={t('settings.ax-code.visual.field.selectDarkThemeAria')} className="w-fit">
                                                <SelectValue placeholder={t('settings.ax-code.visual.field.selectThemePlaceholder')}>
                                                    {selectedDarkTheme
                                ...
                                <div className="flex items-center gap-2 py-1.5">
                                    ...
                                    >
                                        {themesReloading ? t('settings.ax-code.visual.actions.reloadingThemes') : t('settings.ax-code.visual.actions.reloadThemes')}
                                    </button>
                                    <Tooltip>
                                        <TooltipTrigger asChild>
                                            <button
                                                ...
                                                aria-label={t('settings.ax-code.visual.field.themeImportInfoAria')}
                                            >
                                                <Icon name="information" className="h-3.5 w-3.5" />
                                            </button>
                                        </TooltipTrigger>
                                        <TooltipContent sideOffset={8}>
                                            {t('settings.ax-code.visual.field.themeImportInfoTooltip')}
                                        </TooltipContent>
                                    </Tooltip>
                                </div>
                            </section>
                        ...
                        {hasLocalizationSettings && (
                            <section className="px-2 pb-2 pt-0 space-y-2">
                                <h4 className="typography-ui-header font-medium text-foreground">{t('settings.ax-code.visual.section.localization')}</h4>
                                ...
                                {!isVSCode && (shouldShow('timeFormat') || shouldShow('weekStart')) && (
                                    <div className="grid grid-cols-1 gap-2 py-1.5 md:grid-cols-[14rem_auto] md:gap-x-8 md:gap-y-2">
                                        {shouldShow('timeFormat') && (
                                            <div className="flex min-w-0 items-center gap-2">
                                                <span className="typography-ui-label text-foreground shrink-0">{t('settings.ax-code.visual.field.timeFormat')}</span>
                                                <Select value={timeFormatPreference} onValueChange={(value: 'auto' | '12h' | '24h') => handleTimeFormatPreferenceChange(value)}>
                                                    <SelectTrigger aria-label={t('settings.ax-code.visual.field.selectTimeFormatAria')} className="w-fit">
                                        ...
                                        {shouldShow('weekStart') && (
                                            <div className="flex min-w-0 items-center gap-2">
                                                <span className="typography-ui-label text-foreground shrink-0">{t('settings.ax-code.visual.field.weekStartsOn')}</span>
                                                <Select value={weekStartPreference} onValueChange={(value: 'auto' | 'monday' | 'sunday') => handleWeekStartPreferenceChange(value)}>
                                                    <SelectTrigger aria-label={t('settings.ax-code.visual.field.selectWeekStartAria')} className="w-fit">
                        ...
                        {(showPwaInstallNameSetting || showPwaOrientationSetting || showMobileKeyboardModeSetting) && (
                            ...
                            {showPwaInstallNameSetting && (
                                <div className="py-1.5 space-y-1.5">
                                    <div className="flex min-w-0 flex-col">
                                        <span className="typography-ui-label text-foreground">{t('settings.ax-code.visual.field.installAppName')}</span>
                                        <span className="typography-meta text-muted-foreground">{t('settings.ax-code.visual.field.installAppNameHint')}</span>
                                    </div>
                                    <div className="flex w-full max-w-[28rem] items-center gap-2">
                                        <Input
                                            ...
                                            className="h-7"
                                            maxLength={64}
                                            aria-label={t('settings.ax-code.visual.field.pwaInstallAppNameAria')}
                                        />
                                        <Button size="sm"
                                            type="button"
                                            variant="ghost"
                                            ...
                                            aria-label={t('settings.ax-code.visual.actions.resetInstallAppNameAria')}
                            ...
                            {showPwaOrientationSetting && (
                                <div className="py-1.5 space-y-1.5">
                                    <div className="flex min-w-0 flex-col">
                                        <span className="typography-ui-label text-foreground">{t('settings.ax-code.visual.field.installOrientation')}</span>
                                        <span className="typography-meta text-muted-foreground">{t('settings.ax-code.visual.field.installOrientationHint')}</span>
                                    </div>
                                    <div className="flex w-full max-w-[18rem] items-center gap-2">
                                        ...
                                        >
                                            <SelectTrigger aria-label={t('settings.ax-code.visual.field.pwaInstallOrientationAria')} className="w-full">
                                                <SelectValue placeholder={t('settings.ax-code.visual.field.selectOrientationPlaceholder')}>
                                        ...
                                        <Button size="sm"
                                            ...
                                            className="h-7 w-7 px-0 text-muted-foreground hover:text-foreground"
                                            aria-label={t('settings.ax-code.visual.actions.resetInstallOrientationAria')}
                                            title={t('settings.common.actions.reset')}
                                        >
                                            <Icon name="restart" className="h-3.5 w-3.5" />
                                        </Button>
                            ...
                            {showMobileKeyboardModeSetting && (
                                <div className="py-1.5 space-y-1.5">
                                    <div className="flex min-w-0 flex-col">
                                        <span className="typography-ui-label text-foreground">{t('settings.ax-code.visual.field.mobileKeyboardMode')}</span>
                                        <span className="typography-meta text-muted-foreground">{t('settings.ax-code.visual.field.mobileKeyboardModeHint')}</span>
                                    </div>
                                    <div className="flex w-full max-w-[18rem] items-center gap-2">
                                        <Select
                                        ...
                                        >
                                            <SelectTrigger aria-label={t('settings.ax-code.visual.field.mobileKeyboardModeAria')} className="w-full">
                                                <SelectValue placeholder={t('settings.ax-code.visual.field.selectMobileKeyboardModePlaceholder')}>
                                        ...
                                        <Button size="sm"
                                            ...
                                            className="h-7 w-7 px-0 text-muted-foreground hover:text-foreground"
                                            aria-label={t('settings.ax-code.visual.actions.resetMobileKeyboardModeAria')}
                                            title={t('settings.common.actions.reset')}
                                        >
                                            <Icon name="restart" className="h-3.5 w-3.5" />
                                        </Button>
                ...
                {hasLayoutSettings && (
                    <div className="mb-8 space-y-3">
                        <section className="p-2 space-y-0.5">
                            <h4 className="typography-ui-header font-medium text-foreground">{t('settings.ax-code.visual.section.spacingAndLayout')}</h4>
                            <div className="pl-2">

                            {shouldShow('fontSize') && !isMobile && (
                                <div className="flex items-center gap-8 py-1">
                                    <div className="flex min-w-0 flex-col w-56 shrink-0">
                                        <span className="typography-ui-label text-foreground">{t('settings.ax-code.visual.field.interfaceFont')}</span>
                                    </div>
                                    <div className="flex items-center gap-2 w-fit">
                                        <Select value={uiFont} onValueChange={(value) => setUiFont(value as UiFontOption)}>
                                            <SelectTrigger aria-label={t('settings.ax-code.visual.field.selectInterfaceFontAria')} className="w-[13rem]">
                                        ...
                                        <Button size="sm"
                                            ...
                                            className="h-7 w-7 px-0 text-muted-foreground hover:text-foreground"
                                            aria-label={t('settings.ax-code.visual.actions.resetInterfaceFontAria')}
                                            title={t('settings.common.actions.reset')}
                                        >
                                            <Icon name="restart" className="h-3.5 w-3.5" />
                                        </Button>
                            ...
                            {shouldShow('terminalFontSize') && (
                                <div className={cn("py-1", isMobile ? "flex flex-col gap-3" : "flex items-center gap-8")}>
                                    <div className={cn("flex min-w-0 flex-col", isMobile ? "w-full" : "w-56 shrink-0")}>
                                        <span className="typography-ui-label text-foreground">{t('settings.ax-code.visual.field.codeFont')}</span>
                                    </div>
                                    <div className={cn("flex items-center gap-2", isMobile ? "w-full" : "w-fit")}>
                                        <Select value={monoFont} onValueChange={(value) => setMonoFont(value as MonoFontOption)}>
                                            <SelectTrigger aria-label={t('settings.ax-code.visual.field.selectCodeFontAria')} className="w-[13rem]">
                                        ...
                                        <Button size="sm"
                                            ...
                                            className="h-7 w-7 px-0 text-muted-foreground hover:text-foreground"
                                            aria-label={t('settings.ax-code.visual.actions.resetCodeFontAria')}
                                            title={t('settings.common.actions.reset')}
                                        >
                                            <Icon name="restart" className="h-3.5 w-3.5" />
                                        </Button>
                            ...
                            {shouldShow('fontSize') && !isMobile && (
                                <div className="flex items-center gap-8 py-1">
                                    <div className="flex min-w-0 flex-col w-56 shrink-0">
                                        <span className="typography-ui-label text-foreground">{t('settings.ax-code.visual.field.interfaceFontSize')}</span>
                                    </div>
                                    <div className="flex items-center gap-2 w-fit">
                                        <NumberInput
                                            value={fontSize}
                                            ...
                                            max={200}
                                            step={5}
                                            aria-label={t('settings.ax-code.visual.field.fontSizePercentageAria')}
                                            className="w-16"
                                        />
                                        <Button size="sm"
                                            type="button"
                                            ...
                                            className="h-7 w-7 px-0 text-muted-foreground hover:text-foreground"
                                            aria-label={t('settings.ax-code.visual.actions.resetFontSizeAria')}
                                            title={t('settings.common.actions.reset')}
                                        >
                                            <Icon name="restart" className="h-3.5 w-3.5" />
                                        </Button>
                            ...
                            {shouldShow('terminalFontSize') && (
                                <div className={cn("py-1", isMobile ? "flex flex-col gap-3" : "flex items-center gap-8")}>
                                    <div className={cn("flex min-w-0 flex-col", isMobile ? "w-full" : "w-56 shrink-0")}>
                                        <span className="typography-ui-label text-foreground">{t('settings.ax-code.visual.field.terminalFontSize')}</span>
                                    </div>
                                    <div className={cn("flex items-center gap-2", isMobile ? "w-full" : "w-fit")}>
                                        <NumberInput
                                        ...
                                        <Button size="sm"
                                            ...
                                            className="h-7 w-7 px-0 text-muted-foreground hover:text-foreground"
                                            aria-label={t('settings.ax-code.visual.actions.resetTerminalFontSizeAria')}
                                            title={t('settings.common.actions.reset')}
                                        >
                                            <Icon name="restart" className="h-3.5 w-3.5" />
                                        </Button>
                            ...
                            {shouldShow('spacing') && (
                                <div className={cn("py-1", isMobile ? "flex flex-col gap-3" : "flex items-center gap-8")}>
                                    <div className={cn("flex min-w-0 flex-col", isMobile ? "w-full" : "w-56 shrink-0")}>
                                        <span className="typography-ui-label text-foreground">{t('settings.ax-code.visual.field.spacingDensity')}</span>
                                    </div>
                                    <div className={cn("flex items-center gap-2", isMobile ? "w-full" : "w-fit")}>
                                        <NumberInput
                                            value={padding}
                                        ...
                                        <Button size="sm"
                                            ...
                                            className="h-7 w-7 px-0 text-muted-foreground hover:text-foreground"
                                            aria-label={t('settings.ax-code.visual.actions.resetSpacingAria')}
                                            title={t('settings.common.actions.reset')}
                                        >
                                            <Icon name="restart" className="h-3.5 w-3.5" />
                                        </Button>
                                ...
                                <div className={cn("py-1", isMobile ? "flex flex-col gap-3" : "flex items-center gap-8")}>
                                    <div className={cn("flex min-w-0 flex-col", isMobile ? "w-full" : "w-56 shrink-0")}>
                                        <div className="flex items-center gap-1.5">
                                            <span className="typography-ui-label text-foreground">{t('settings.ax-code.visual.field.inputBarOffset')}</span>
                                            <Tooltip>
                                                <TooltipTrigger asChild>
                                                    <Icon name="information" className="h-3.5 w-3.5 text-muted-foreground/60 cursor-help" />
                                                </TooltipTrigger>
                                                <TooltipContent sideOffset={8} className="max-w-xs">
                                                    {t('settings.ax-code.visual.field.inputBarOffsetTooltip')}
                                                </TooltipContent>
                                            </Tooltip>
                                        </div>
                                    </div>
                                    <div className={cn("flex items-center gap-2", isMobile ? "w-full" : "w-fit")}>
                                        ...
                                        <Button size="sm"
                                            ...
                                            className="h-7 w-7 px-0 text-muted-foreground hover:text-foreground"
                                            aria-label={t('settings.ax-code.visual.actions.resetInputBarOffsetAria')}
                                            title={t('settings.common.actions.reset')}
                                        >
                                            <Icon name="restart" className="h-3.5 w-3.5" />
                                        </Button>
                ...
                {hasNavigationSettings && (
                    <div className="space-y-3">
                        <section className="px-2 pb-2 pt-0">
                            <h4 className="typography-ui-header font-medium text-foreground">{t('settings.ax-code.visual.section.navigation')}</h4>
                            {shouldShow('terminalQuickKeys') && !isMobile && (
                                ...
                                >
                                    <Checkbox
                                        ...
                                        ariaLabel={t('settings.ax-code.visual.field.terminalQuickKeysAria')}
                                    />
                                    <div className="flex min-w-0 items-center gap-1.5">
                                        <span className="typography-ui-label text-foreground">{t('settings.ax-code.visual.field.terminalQuickKeys')}</span>
                                        <Tooltip>
                                            <TooltipTrigger asChild>
                                                <Icon name="information" className="h-3.5 w-3.5 text-muted-foreground/60 cursor-help" />
                                            </TooltipTrigger>
                                            <TooltipContent sideOffset={8} className="max-w-xs">
                                                {t('settings.ax-code.visual.field.terminalQuickKeysTooltip')}
                                            </TooltipContent>
                                        </Tooltip>
                                    </div>
                                </div>
                                ...
                                <div className="grid grid-cols-1 gap-y-2 md:grid-cols-[minmax(0,16rem)_minmax(0,16rem)] md:justify-start md:gap-x-2">
                                    {shouldShow('chatRenderMode') && (
                                        <section className="p-2 md:col-span-2">
                                            <h4 className="typography-ui-header font-medium text-foreground">{t('settings.ax-code.visual.section.chatRenderMode')}</h4>
                                            <div role="radiogroup" aria-label={t('settings.ax-code.visual.section.chatRenderModeAria')} className="mt-1 grid w-full max-w-[26rem] grid-cols-1 gap-3 sm:grid-cols-2">
                                    ...
                                    {shouldShow('messageTransport') && (
                                        <section className="p-2 md:col-span-2">
                                            <h4 className="typography-ui-header font-medium text-foreground">{t('settings.ax-code.visual.section.messageStreamTransport')}</h4>
                                    ...
                                    {shouldShow('activityRenderMode') && chatRenderMode === 'sorted' && (
                                        <section className="p-2 md:col-span-2">
                                            <h4 className="typography-ui-header font-medium text-foreground">{t('settings.ax-code.visual.section.activityDefault')}</h4>
                                            <div role="radiogroup" aria-label={t('settings.ax-code.visual.section.activityDefaultAria')} className="mt-0.5 space-y-0">
                                                    ...
                                                    return (
                                                        ...
                                                        >
                                                            <Radio
                                                                ...
                                                                ariaLabel={t('settings.ax-code.visual.field.activityDefaultModeAria', { option: tUnsafe(option.labelKey) })}
                                                            />
                                    ...
                                    {shouldShow('expandedTools') && (
                                        <section className="p-2 md:col-span-2 space-y-0.5">
                                            <div className="typography-ui-header font-medium text-foreground py-1.5">{t('settings.ax-code.visual.section.showToolsOpenedByDefault')}</div>
                                            ...
                                            >
                                                <Checkbox
                                                    ...
                                                    ariaLabel={t('settings.ax-code.visual.field.showExpandedBashToolsAria')}
                                                />
                                                <span className="typography-ui-label text-foreground">{t('settings.ax-code.visual.field.bash')}</span>
                                            </div>
                                            ...
                                            >
                                                <Checkbox
                                                    ...
                                                    ariaLabel={t('settings.ax-code.visual.field.showExpandedEditToolsAria')}
                                                />
                                                <span className="typography-ui-label text-foreground">{t('settings.ax-code.visual.field.editTools')}</span>
                                            </div>
                                        </section>
                                    )}
                                    ...
                                    {shouldShow('userMessageRendering') && (
                                        <section className="p-2">
                                            <h4 className="typography-ui-header font-medium text-foreground">{t('settings.ax-code.visual.section.userMessageRendering')}</h4>
                                            <div role="radiogroup" aria-label={t('settings.ax-code.visual.section.userMessageRenderingAria')} className="mt-0.5 space-y-0">
                                                    ...
                                                    return (
                                                        ...
                                                        >
                                                            <Radio
                                                                ...
                                                                ariaLabel={t('settings.ax-code.visual.field.userMessageRenderingAria', { option: tUnsafe(option.labelKey) })}
                                                            />
                                                            <span className={cn('typography-ui-label font-normal', selected ? 'text-foreground' : 'text-foreground/50')}>
                                                                {tUnsafe(option.labelKey)}
                                                            </span>
                                    ...
                                    {shouldShow('mermaidRendering') && (
                                        <section className="p-2">
                                            <h4 className="typography-ui-header font-medium text-foreground">{t('settings.ax-code.visual.section.mermaidRendering')}</h4>
                                            <div role="radiogroup" aria-label={t('settings.ax-code.visual.section.mermaidRenderingAria')} className="mt-0.5 space-y-0">
                                                    ...
                                                    return (
                                                        ...
                                                        >
                                                            <Radio
                                                                ...
                                                                ariaLabel={t('settings.ax-code.visual.field.mermaidRenderingAria', { option: tUnsafe(option.labelKey) })}
                                                            />
                                                            <span className={cn('typography-ui-label font-normal', selected ? 'text-foreground' : 'text-foreground/50')}>
                                                                {tUnsafe(option.labelKey)}
                                                            </span>
                                    ...
                                    {shouldShow('diffLayout') && !isVSCode && (
                                        <section className="p-2">
                                            <h4 className="typography-ui-header font-medium text-foreground">{t('settings.ax-code.visual.section.diffLayout')}</h4>
                                            <div role="radiogroup" aria-label={t('settings.ax-code.visual.section.diffLayoutAria')} className="mt-0.5 space-y-0">
                                                    ...
                                                    return (
                                                        ...
                                                        >
                                                            <Radio
                                                                ...
                                                                ariaLabel={t('settings.ax-code.visual.field.diffLayoutAria', { option: tUnsafe(option.labelKey) })}
                                                            />
                                                            <span className={cn('typography-ui-label font-normal', selected ? 'text-foreground' : 'text-foreground/50')}>
                                                                {tUnsafe(option.labelKey)}
                                                            </span>
                                    ...
                                    {shouldShow('diffLayout') && !isVSCode && (
                                        <section className="p-2">
                                            <h4 className="typography-ui-header font-medium text-foreground">{t('settings.ax-code.visual.section.diffViewMode')}</h4>
                                            <div role="radiogroup" aria-label={t('settings.ax-code.visual.section.diffViewModeAria')} className="mt-0.5 space-y-0">
                                                    ...
                                                    return (
                                                        ...
                                                        >
                                                            <Radio
                                                                ...
                                                                ariaLabel={t('settings.ax-code.visual.field.diffViewModeAria', { option: tUnsafe(option.labelKey) })}
                                                            />
                                                            <span className={cn('typography-ui-label font-normal', selected ? 'text-foreground' : 'text-foreground/50')}>
                                                                {tUnsafe(option.labelKey)}
                                                            </span>
                                    ...
                                    {shouldShow('reasoning') && (
                                        ...
                                        >
                                            <Checkbox
                                                ...
                                                ariaLabel={t('settings.ax-code.visual.field.showReasoningTracesAria')}
                                            />
                                            <span className="typography-ui-label text-foreground">{t('settings.ax-code.visual.field.showReasoningTraces')}</span>
                                        </div>
                                    )}
                                    ...
                                    {shouldShow('reasoning') && showReasoningTraces && (
                                        ...
                                        >
                                            <Checkbox
                                                ...
                                                ariaLabel={t('settings.ax-code.visual.field.collapsibleThinkingBlocksAria')}
                                            />
                                            <span className="typography-ui-label text-foreground">{t('settings.ax-code.visual.field.collapsibleThinkingBlocks')}</span>
                                        </div>
                                    )}
                                    ...
                                    {shouldShow('stickyUserHeader') && (
                                        ...
                                        >
                                            <Checkbox
                                                ...
                                                ariaLabel={t('settings.ax-code.visual.field.stickyUserHeaderAria')}
                                            />
                                            <span className="typography-ui-label text-foreground">{t('settings.ax-code.visual.field.stickyUserHeader')}</span>
                                        </div>
                                    )}
                                    ...
                                    {shouldShow('wideChatLayout') && (
                                        ...
                                        >
                                            <Checkbox
                                                ...
                                                ariaLabel={t('settings.ax-code.visual.field.wideChatLayoutAria')}
                                            />
                                            <span className="typography-ui-label text-foreground">{t('settings.ax-code.visual.field.wideChatLayout')}</span>
                                        </div>
                                    )}
                                    ...
                                    {shouldShow('splitAssistantMessageActions') && (
                                        ...
                                        >
                                            <Checkbox
                                                ...
                                                ariaLabel={t('settings.ax-code.visual.field.showSplitAssistantMessageActionsAria')}
                                            />
                                            <div className="flex min-w-0 items-center gap-1.5">
                                                <span className="typography-ui-label text-foreground">{t('settings.ax-code.visual.field.showSplitAssistantMessageActions')}</span>
                                                <Tooltip>
                                                    <TooltipTrigger asChild>
                                                        <Icon name="information" className="h-3.5 w-3.5 cursor-help text-muted-foreground/60" />
                                                    </TooltipTrigger>
                                                    <TooltipContent sideOffset={8} className="max-w-xs">
                                                        {t('settings.ax-code.visual.field.showSplitAssistantMessageActionsTooltip')}
                                                    </TooltipContent>
                                                </Tooltip>
                                            </div>
                                        </div>
                                    ...
                                    {shouldShow('showToolFileIcons') && (
                                        ...
                                        >
                                            <Checkbox
                                                ...
                                                ariaLabel={t('settings.ax-code.visual.field.showToolFileIconsAria')}
                                            />
                                            <span className="typography-ui-label text-foreground">{t('settings.ax-code.visual.field.showToolFileIcons')}</span>
                                        </div>
                                    )}
                                    ...
                                    {shouldShow('mobileStatusBar') && isMobile && (
                                        ...
                                        >
                                            <Checkbox
                                                ...
                                                ariaLabel={t('settings.ax-code.visual.field.showMobileStatusBarAria')}
                                            />
                                            <span className="typography-ui-label text-foreground">{t('settings.ax-code.visual.field.showMobileStatusBar')}</span>
                                        </div>
                                    )}
                                    ...
                                    {shouldShow('dotfiles') && !isVSCodeRuntime() && (
                                        ...
                                        >
                                            <Checkbox
                                                ...
                                                ariaLabel={t('settings.ax-code.visual.field.showDotfilesAria')}
                                            />
                                            <span className="typography-ui-label text-foreground">{t('settings.ax-code.visual.field.showDotfiles')}</span>
                                        </div>
                                    )}
                                    ...
                                    {shouldShow('queueMode') && (
                                        ...
                                        >
                                            <Checkbox
                                                ...
                                                ariaLabel={t('settings.ax-code.visual.field.queueMessagesByDefaultAria')}
                                            />
                                            <div className="flex min-w-0 items-center gap-1.5">
                                                <span className="typography-ui-label text-foreground">{t('settings.ax-code.visual.field.queueMessagesByDefault')}</span>
                                                <Tooltip>
                                                    <TooltipTrigger asChild>
                                                        <Icon name="information" className="h-3.5 w-3.5 text-muted-foreground/60 cursor-help" />
                                                    </TooltipTrigger>
                                                    <TooltipContent sideOffset={8} className="max-w-xs">
                                                        {t('settings.ax-code.visual.field.queueMessagesByDefaultTooltip', { modifier: getModifierLabel() })}
                                                    </TooltipContent>
                                                </Tooltip>
                                            </div>
                                        </div>
                                    ...
                                    {shouldShow('persistDraft') && (
                                        ...
                                        >
                                            <Checkbox
                                                ...
                                                ariaLabel={t('settings.ax-code.visual.field.persistDraftMessagesAria')}
                                            />
                                            <span className="typography-ui-label text-foreground">{t('settings.ax-code.visual.field.persistDraftMessages')}</span>
                                        </div>
                                    )}
                                    ...
                                    {!isMobile && shouldShow('inputSpellcheck') && (
                                        ...
                                        >
                                            <Checkbox
                                                ...
                                                ariaLabel={t('settings.ax-code.visual.field.enableSpellcheckInTextInputsAria')}
                                            />
                                            <span className="typography-ui-label text-foreground">{t('settings.ax-code.visual.field.enableSpellcheckInTextInputs')}</span>
                                        </div>
                                    )}
                ...
                {shouldShow('reportUsage') && (
                    <div className="space-y-3">
                        <section className="px-2 pb-2 pt-0">
                            <h4 className="typography-ui-header font-medium text-foreground mb-2">{t('settings.ax-code.visual.section.privacy')}</h4>
                            <div className="flex items-start gap-2 py-1.5">
                                <Checkbox
                                    checked={reportUsage}
                                    onChange={handleReportUsageChange}
                                    ariaLabel={t('settings.ax-code.visual.field.sendAnonymousUsageReportsAria')}
                                />
                                <div className="flex min-w-0 flex-col gap-0.5">
                                    ...
                                    >
                                        <span className="typography-ui-label text-foreground">{t('settings.ax-code.visual.field.sendAnonymousUsageReports')}</span>
                                    </div>
                                    <span className="typography-meta text-muted-foreground pointer-events-none">
                                        {t('settings.ax-code.visual.field.sendAnonymousUsageReportsHint')}
                                    </span>
                                </div>
                            </div>
                        </section>
