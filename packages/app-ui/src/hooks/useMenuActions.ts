...
const MENU_ACTION_EVENT = 'ax-code:menu-action';
const CHECK_FOR_UPDATES_EVENT = 'ax-code:check-for-updates';
...
export const useMenuActions = (
  ...
  const handleAction = React.useCallback(
    (action: MenuAction) => {
      switch (action) {
        ...
        case 'copy': {
          const copyEvent = new Event('ax-code:copy', { cancelable: true });
  ...
  React.useEffect(() => {
    ...
    listen('ax-code:menu-action', (evt) => {
    ...
    listen('ax-code:check-for-updates', () => {
