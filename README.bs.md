...
1. `$AX_CODE_INSTALL_DIR` - Prilagođeni instalacijski direktorij
2. `$XDG_BIN_DIR` - Putanja usklađena sa XDG Base Directory specifikacijom
3. `$HOME/bin` - Standardni korisnički bin direktorij (ako postoji ili se može kreirati)
4. `$HOME/.ax-code/bin` - Podrazumijevana rezervna lokacija
...
ax-code uključuje dva ugrađena agenta između kojih možeš prebacivati tasterom `Tab`.
...
Ako želiš doprinositi ax-code-u, pročitaj [upute za doprinošenje](./CONTRIBUTING.md) prije slanja pull requesta.
