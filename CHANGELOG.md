...
- Default the left navigation rail to 30 columns (24/30/36 still selectable), slim the right session sidebar by four columns, and use `/navigation` and `/sidebar` for the same hide action.
